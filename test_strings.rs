...
fn test_strings() -> () {
    let arg_0 = "=== String Test ===";
    println!("{}", arg_0);
    let temp_result = "hello world";
    let text = temp_result;
    let temp_result = text;
    let temp_object = temp_result;
    let temp_result = text__upper(&temp_object);
    let upper = temp_result;
    let arg_0 = "Original: hello world";
    println!("{}", arg_0);
    let arg_0 = "Upper: ";
    println!("{}", arg_0);
    let arg_0 = upper;
    ...
    let temp_object = temp_result;
    let temp_result = text__lower(&temp_object);
    let lower = temp_result;
    let arg_0 = "Lower: ";
    println!("{}", arg_0);
    let arg_0 = lower;
    println!("{}", arg_0);
    let temp_result = "test";
    let msg = temp_result;
    let arg_0 = msg;
    let temp_result = arg_0.len() as i64;
    let length = temp_result;
    let arg_0 = "Length of \'test\':";
    println!("{}", arg_0);
    let arg_0 = length;
    println!("{}", arg_0);
    let arg_0 = "String test completed";
    println!("{}", arg_0);
}
