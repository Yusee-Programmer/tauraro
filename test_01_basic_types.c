...
tauraro_value_t* x;
tauraro_value_t* y;
tauraro_value_t* name;
tauraro_value_t* is_true;
tauraro_value_t* is_false;
tauraro_value_t* nothing;
tauraro_value_t* a;
tauraro_value_t* b;

int main() {
    tauraro_value_t* var_nothing_temp = NULL;
    ...
    tauraro_value_t* var_name_temp = NULL;
    tauraro_value_t* arg_1 = NULL;
    tauraro_value_t* var_a_temp = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* temp = NULL;
    tauraro_value_t* var_is_true_temp = NULL;
    tauraro_value_t* var_is_false_temp = NULL;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 1: Basic Data Types ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_x_temp = tauraro_value_new(); var_x_temp->type = TAURARO_INT; var_x_temp->data.int_val = 42;
    x = var_x_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Integer x =");
    arg_1 = x;
    ...
    y = var_y_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Float y =");
    arg_1 = y;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_name_temp = tauraro_value_new(); var_name_temp->type = TAURARO_STRING; var_name_temp->data.str_val = strdup("Tauraro");
    name = var_name_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("String name =");
    arg_1 = name;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_is_true_temp = tauraro_value_new(); var_is_true_temp->type = TAURARO_BOOL; var_is_true_temp->data.bool_val = true;
    is_true = var_is_true_temp;
    var_is_false_temp = tauraro_value_new(); var_is_false_temp->type = TAURARO_BOOL; var_is_false_temp->data.bool_val = false;
    is_false = var_is_false_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Boolean is_true =");
    arg_1 = is_true;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Boolean is_false =");
    arg_1 = is_false;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_nothing_temp = tauraro_value_new(); var_nothing_temp->type = TAURARO_NONE;
    nothing = var_nothing_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("None value =");
    arg_1 = nothing;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("10 + 3 =");
    arg_1_left = a;
    arg_1_right = b;
