...
tauraro_value_t* add_numbers(int64_t a, int64_t b) {
    // Local variables
    tauraro_value_t* temp_result = tauraro_value_new(); temp_result->type = TAURARO_NONE;
    return temp_result;
}

tauraro_value_t* add_dynamic(tauraro_value_t* a, tauraro_value_t* b) {
    // Local variables
    tauraro_value_t* temp_result = tauraro_value_new(); temp_result->type = TAURARO_NONE;
    return temp_result;
}
...
int main() {
    ...
    tauraro_value_t* var_f_temp_right = NULL;
    tauraro_value_t* var_a_temp = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* var_f_temp_left = NULL;
    ...
    tauraro_value_t* var_e_temp = NULL;
    tauraro_value_t* var_b_temp = NULL;
    tauraro_value_t* var_z_temp = NULL;
    var_x_temp = tauraro_value_new(); var_x_temp->type = TAURARO_INT; var_x_temp->data.int_val = 10;
    x = var_x_temp; // Typed as int
    var_y_temp = tauraro_value_new(); var_y_temp->type = TAURARO_INT; var_y_temp->data.int_val = 20;
    y = var_y_temp; // Typed as int
    arg_0 = x;
    arg_1 = y;
    temp = tauraro_add_numbers(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_z_temp = temp;
    z = var_z_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Static typing result: ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = z;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_a_temp = tauraro_value_new(); var_a_temp->type = TAURARO_INT; var_a_temp->data.int_val = 15;
    a = var_a_temp;
    var_b_temp = tauraro_value_new(); var_b_temp->type = TAURARO_INT; var_b_temp->data.int_val = 25;
    b = var_b_temp;
    arg_0 = a;
    arg_1 = b;
    temp = tauraro_add_dynamic(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_c_temp = temp;
    c = var_c_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Dynamic typing result: ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = c;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_d_temp = tauraro_value_new(); var_d_temp->type = TAURARO_FLOAT; var_d_temp->data.float_val = 3.14;
    d = var_d_temp; // Typed as float
    var_e_temp = tauraro_value_new(); var_e_temp->type = TAURARO_INT; var_e_temp->data.int_val = 42;
    e = var_e_temp;
    var_f_temp_left = d;
    var_f_temp_right = e;
    var_f_temp = tauraro_add(var_f_temp_left, var_f_temp_right);
    f = var_f_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Mixed types result: ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = f;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
