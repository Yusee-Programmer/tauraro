...
tauraro_value_t* Vector__compute(int argc, tauraro_value_t** argv);
tauraro_value_t* Point__compute(int argc, tauraro_value_t** argv);
...
tauraro_value_t* Vector__compute(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* temp_result_8 = tauraro_object_get_attr(self, "z");
...
int main() {
    ...
    tauraro_class_add_method(class_Vector, "compute", (void*)&Vector__compute);
    ...
    tauraro_class_add_method(class_Point, "compute", (void*)&Point__compute);
    ...
    if (class_Point) {
        ...
        p = temp_result;
        binop_left = total;
        // Object method call: p.compute()
    if (p && p->type == TAURARO_OBJECT) {
        tauraro_object_t* obj_p = (tauraro_object_t*)p->data.obj_val;
        if (obj_p->class_ptr) {
            tauraro_value_t* method = tauraro_class_get_method(obj_p->class_ptr, "compute");
        ...
        temp_left = i;
        temp_right = tauraro_value_new(); temp_right->type = TAURARO_INT; temp_right->data.int_val = 5000000;
        temp = tauraro_lt(temp_left, temp_right);
    }
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Point computation done");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_total_vec_temp = 0;
    total_vec = var_total_vec_temp;
    var_i_temp = 0;
    i = var_i_temp;
    temp_left = i;
    temp_right = 5000000;
    ...
    if (class_Vector) {
        ...
        v = temp_result;
        binop_left = total_vec;
        // Object method call: v.compute()
    if (v && v->type == TAURARO_OBJECT) {
        tauraro_object_t* obj_v = (tauraro_object_t*)v->data.obj_val;
        if (obj_v->class_ptr) {
            tauraro_value_t* method = tauraro_class_get_method(obj_v->class_ptr, "compute");
            if (method && method->type == TAURARO_FUNCTION) {
                // Call method function pointer with self
                typedef tauraro_value_t* (*method_func_t)(int, tauraro_value_t**);
                method_func_t func_ptr = (method_func_t)method->data.ptr_val;
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Vector computation done");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Results computed");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    return 0;
}
