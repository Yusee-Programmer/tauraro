//! COMPLETE C ABI code generator for interoperability and exports
use crate::ir::{IRModule, IRFunction, IRType, IRValue, IRInstruction};
...
"#.to_string()
    ...
    fn generate_conversion_functions(&self) -> String {
        r#"// Type conversion between Tauraro and C
...
tauraro_bool tauraro_string_to_bool(tauraro_string str) {
...
"#.to_string()
    ...
    fn function_to_c_implementation(&self, function: &IRFunction) -> String {
        ...
        match &function.return_type {
            ...
            IRType::Pointer(_) => implementation.push_str("    return NULL;\n"),
            _ => implementation.push_str("    return (tauraro_any)NULL;\n"),
        };
