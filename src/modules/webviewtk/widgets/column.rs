...
pub fn create(args: Vec<Value>) -> Result<Value> {
    ...
    let mut spacing = 0.0;
    let mut style = None;
    let mut main_axis_alignment = "flex-start";
    let mut cross_axis_alignment = "stretch";
    ...
    if let Some(kwargs) = extract_kwargs(&args) {
        ...
        if let Some(val) = kwargs.get("main_axis_alignment") {
            main_axis_alignment = match get_string(val, "start").as_str() {
                "center" => "center",
                "end" => "flex-end",
        ...
        if let Some(val) = kwargs.get("cross_axis_alignment") {
            cross_axis_alignment = match get_string(val, "stretch").as_str() {
                "start" => "flex-start",
                "center" => "center",
                "end" => "flex-end",
                _ => "stretch",
    ...
    obj = obj.with_style("display", "flex")
             ...
             .with_style("justify-content", main_axis_alignment)
             .with_style("align-items", cross_axis_alignment)
    ...
    widget_dict.insert("_widget_type".to_string(), Value::Str("Column".to_string()));
