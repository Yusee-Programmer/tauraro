...
pub fn create(args: Vec<Value>) -> Result<Value> {
    ...
    widget_dict.insert("_widget_type".to_string(), Value::Str("List_tile".to_string()));
    widget_dict.insert("_html".to_string(), Value::Str("<div>list_tile</div>".to_string()));
