...
pub fn create(args: Vec<Value>) -> Result<Value> {
    ...
    widget_dict.insert("_widget_type".to_string(), Value::Str("Gesture_detector".to_string()));
    widget_dict.insert("_html".to_string(), Value::Str("<div>gesture_detector</div>".to_string()));
