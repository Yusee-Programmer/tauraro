...
tauraro_value_t* calculate(tauraro_value_t* x, tauraro_value_t* y) {
    // Local variables
    tauraro_value_t* _ = tauraro_value_new(); _->type = TAURARO_NONE;
    tauraro_value_t* __1 = tauraro_value_new(); __1->type = TAURARO_NONE;
    tauraro_value_t* __2 = tauraro_value_new(); __2->type = TAURARO_NONE;
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Sum:");
    tauraro_value_t* arg_1 = sum_val;
    tauraro_value_t* temp_result = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    tauraro_value_t* arg_0_1 = tauraro_value_new(); arg_0_1->type = TAURARO_STRING; arg_0_1->data.str_val = strdup("Difference:");
    tauraro_value_t* arg_1_1 = diff;
    tauraro_value_t* temp_result = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    tauraro_value_t* arg_0_2 = tauraro_value_new(); arg_0_2->type = TAURARO_STRING; arg_0_2->data.str_val = strdup("Product:");
    tauraro_value_t* arg_1_2 = prod;
    tauraro_value_t* temp_result = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    tauraro_value_t* temp_result_1 = sum_val;
    return temp_result;
}

tauraro_value_t* add(tauraro_value_t* a, tauraro_value_t* b) {
    // Local variables
...
void greet() {
    // Local variables
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Hello from function!");
...
int main() {
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 2: Functions ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    temp = tauraro_greet(0, NULL);
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 5;
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_INT; arg_1->data.int_val = 3;
    temp = tauraro_add(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_result_temp = temp;
    result = var_result_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("add(5, 3) =");
    arg_1 = result;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 10;
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_INT; arg_1->data.int_val = 4;
    temp = tauraro_calculate(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_total_temp = temp;
    total = var_total_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Total:");
    arg_1 = total;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
