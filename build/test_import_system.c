...
int main() {
    ...
    // Import module: math
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Testing User-Defined Module (mymath):");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("square(5) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 5;
    arg_1 = mymath_square(1, (tauraro_value_t*[]){arg_1_method_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("cube(3) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 3;
    arg_1 = mymath_cube(1, (tauraro_value_t*[]){arg_1_method_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("add(10, 20) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 10;
    arg_1_method_arg_1 = tauraro_value_new(); arg_1_method_arg_1->type = TAURARO_INT; arg_1_method_arg_1->data.int_val = 20;
    arg_1 = mymath_add(2, (tauraro_value_t*[]){arg_1_method_arg_0, arg_1_method_arg_1});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("mymath.PI =");
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("math.sqrt(16) =");
    ...
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("math.pow(2, 3) =");
    ...
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("math.pi =");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\nMixed operations:");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    method_arg_0_method_arg_0 = tauraro_value_new(); method_arg_0_method_arg_0->type = TAURARO_INT; method_arg_0_method_arg_0->data.int_val = 16;
    method_arg_0 = tauraro_math_sqrt(1, (tauraro_value_t*[]){method_arg_0_method_arg_0});
    temp = mymath_square(1, (tauraro_value_t*[]){method_arg_0});
    var_result_temp = temp;
    result = var_result_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("mymath.square(math.sqrt(16)) =");
    arg_1 = result;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    return 0;
}
