...
extern tauraro_value_t* tauraro_random_random(int argc, tauraro_value_t** argv);
extern tauraro_value_t* tauraro_random_randint(int argc, tauraro_value_t** argv);
extern tauraro_value_t* tauraro_random_seed(int argc, tauraro_value_t** argv);
...
int main() {
    ...
    tauraro_value_t* var_end_temp = NULL;
    ...
    tauraro_value_t* var_start_temp = NULL;
    // Import module: math
    // Import module: time
    // Import module: random
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Testing Math Module ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("sqrt(16) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 16;
    arg_1 = tauraro_math_sqrt(1, (tauraro_value_t*[]){arg_1_method_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("pow(2, 3) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 2;
    arg_1_method_arg_1 = tauraro_value_new(); arg_1_method_arg_1->type = TAURARO_INT; arg_1_method_arg_1->data.int_val = 3;
    arg_1 = tauraro_math_pow(2, (tauraro_value_t*[]){arg_1_method_arg_0, arg_1_method_arg_1});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("sin(0) =");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 0;
    arg_1 = tauraro_math_sin(1, (tauraro_value_t*[]){arg_1_method_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Current time:");
    arg_1 = start;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Sleeping for 0.1 seconds...");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    method_arg_0 = tauraro_value_new(); method_arg_0->type = TAURARO_FLOAT; method_arg_0->data.float_val = 0.1;
    temp = time_sleep(1, (tauraro_value_t*[]){method_arg_0});
    temp = time_time(0, NULL);
    var_end_temp = temp;
    end = var_end_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Time elapsed:");
    arg_1_left = end;
    arg_1_right = start;
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    method_arg_0 = tauraro_value_new(); method_arg_0->type = TAURARO_INT; method_arg_0->data.int_val = 42;
    temp = random_seed(1, (tauraro_value_t*[]){method_arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("random():");
    arg_1 = tauraro_random_random(0, NULL);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("random():");
    arg_1 = tauraro_random_random(0, NULL);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("randint(1, 10):");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 1;
    arg_1_method_arg_1 = tauraro_value_new(); arg_1_method_arg_1->type = TAURARO_INT; arg_1_method_arg_1->data.int_val = 10;
    arg_1 = tauraro_random_randint(2, (tauraro_value_t*[]){arg_1_method_arg_0, arg_1_method_arg_1});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("randint(1, 10):");
    arg_1_method_arg_0 = tauraro_value_new(); arg_1_method_arg_0->type = TAURARO_INT; arg_1_method_arg_0->data.int_val = 1;
    arg_1_method_arg_1 = tauraro_value_new(); arg_1_method_arg_1->type = TAURARO_INT; arg_1_method_arg_1->data.int_val = 10;
