...
// JSON module - extern declarations
extern tauraro_value_t* tauraro_json_loads(int argc, tauraro_value_t** argv);
extern tauraro_value_t* tauraro_json_dumps(int argc, tauraro_value_t** argv);

// OS module - extern declarations
extern tauraro_value_t* tauraro_os_getcwd(int argc, tauraro_value_t** argv);
extern tauraro_value_t* tauraro_os_listdir(int argc, tauraro_value_t** argv);

// Sys module - extern declarations
extern const char* tauraro_sys_platform;
extern const char* tauraro_sys_version;
extern void tauraro_sys_exit(int argc, tauraro_value_t** argv) __attribute__((noreturn));
...
tauraro_value_t* current_dir;
tauraro_value_t* data;
tauraro_value_t* json_str;
tauraro_value_t* parsed;

int main() {
    tauraro_value_t* var_current_dir_temp = NULL;
    ...
    tauraro_value_t* var_json_str_temp = NULL;
    tauraro_value_t* arg_1 = NULL;
    tauraro_value_t* method_arg_0 = NULL;
    tauraro_value_t* var_parsed_temp = NULL;
    ...
    // Import module: json
    // Test math functions
    method_arg_0 = tauraro_value_new(); method_arg_0->type = TAURARO_INT; method_arg_0->data.int_val = 25;
    temp = math_sqrt(1, (tauraro_value_t*[]){method_arg_0});
    var_result_temp = temp;
    result = var_result_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Square root of 25:");
    arg_1 = result;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    // Test sys functions
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Platform:");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    // Test os functions
    temp = os_getcwd(0, NULL);
    var_current_dir_temp = temp;
    current_dir = var_current_dir_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Current directory:");
    arg_1 = current_dir;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    // Test json functions
    ...
    data = var_data_temp;
    method_arg_0 = data;
    temp = json_dumps(1, (tauraro_value_t*[]){method_arg_0});
    var_json_str_temp = temp;
    json_str = var_json_str_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("JSON string:");
    arg_1 = json_str;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    method_arg_0 = json_str;
    temp = json_loads(1, (tauraro_value_t*[]){method_arg_0});
    var_parsed_temp = temp;
    parsed = var_parsed_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Parsed JSON:");
    arg_1 = parsed;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    return 0;
}
