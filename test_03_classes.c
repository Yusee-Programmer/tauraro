...
void Person____init__(tauraro_value_t* self, tauraro_value_t* name, tauraro_value_t* age) {
    // Local variables
...
void Person__greet(tauraro_value_t* self) {
    // Local variables
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Hello, my name is");
    tauraro_value_t* arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    tauraro_value_t* temp_result = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    tauraro_value_t* arg_0_1 = tauraro_value_new(); arg_0_1->type = TAURARO_STRING; arg_0_1->data.str_val = strdup("I am");
    tauraro_value_t* arg_1_1 = tauraro_value_new(); arg_1_1->type = TAURARO_NONE;
    tauraro_value_t* arg_2 = tauraro_value_new(); arg_2->type = TAURARO_STRING; arg_2->data.str_val = strdup("years old");
    tauraro_value_t* temp_result = tauraro_print(3, (tauraro_value_t*[]){arg_0, arg_1, arg_2});
}
...
int main() {
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 3: OOP ===");
    ...
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_INT; arg_1->data.int_val = 30;
    temp = tauraro_object_create("Person");
    var_person_temp = temp;
    person = var_person_temp;
    temp = tauraro_value_new(); temp->type = TAURARO_NONE;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Person name:");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Person age:");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    temp = tauraro_value_new(); temp->type = TAURARO_INT; temp->data.int_val = 31;
    tauraro_object_set_attr(person, "age", temp);
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Updated age:");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
