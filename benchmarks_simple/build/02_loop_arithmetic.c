...
TauValue sum_squares(TauValue n);
TauValue sum_range(TauValue n);
TauValue factorial(TauValue n);

// Function definitions
int main(int argc, char* argv[]) {
    TauValue result3, fstring_right_1, temp_result, fstring_result_2, n, fstring_left_1, fstring_right_2, binop_right, fstring_left_3, fstring_left_2, fstring_right_3, fstring_result_3, result2, arg_0, binop_left, result1, fstring_result_1;
    temp_result = (TauValue){.type = 0, .value.i = 1000000};
    n = temp_result;
    arg_0 = n;
    temp_result = sum_range(arg_0);
    result1 = temp_result;
    temp_result = (TauValue){.type = 2, .value.s = strdup("Sum 1 to "), .refcount = 1};
    ...
    fstring_right_2 = (TauValue){.type = 2, .value.s = strdup(": "), .refcount = 1};
    // Runtime type checking for + operation
    ...
    arg_0 = (TauValue){.type = 0, .value.i = 100};
    temp_result = sum_squares(arg_0);
    result2 = temp_result;
    temp_result = (TauValue){.type = 2, .value.s = strdup("Sum of squares 1 to 100: "), .refcount = 1};
    fstring_left_1 = temp_result;
    temp_result = result2;
    fstring_right_1 = temp_result;
    // Runtime type checking for + operation
    if ((fstring_left_1.type == 2 || fstring_right_1.type == 2)) {
        ...
        if (fstring_left_1.type == 2) {
            strcpy(temp_concat_rt_4, fstring_left_1.value.s);
        } else if (fstring_left_1.type == 0) {
            char int_buf[64];
            snprintf(int_buf, sizeof(int_buf), "%lld", fstring_left_1.value.i);
            strcpy(temp_concat_rt_4, int_buf);
        } else if (fstring_left_1.type == 3) {
            strcpy(temp_concat_rt_4, fstring_left_1.value.i ? "True" : "False");
        } else if (fstring_left_1.type == 1) {
            char float_buf[64];
            snprintf(float_buf, sizeof(float_buf), "%f", fstring_left_1.value.f);
        ...
        if (fstring_right_1.type == 2) {
            strcat(temp_concat_rt_4, fstring_right_1.value.s);
        } else if (fstring_right_1.type == 0) {
            char int_buf[64];
            snprintf(int_buf, sizeof(int_buf), "%lld", fstring_right_1.value.i);
            strcat(temp_concat_rt_4, int_buf);
        } else if (fstring_right_1.type == 3) {
            strcat(temp_concat_rt_4, fstring_right_1.value.i ? "True" : "False");
        } else if (fstring_right_1.type == 1) {
            char float_buf[64];
            snprintf(float_buf, sizeof(float_buf), "%f", fstring_right_1.value.f);
            strcat(temp_concat_rt_4, float_buf);
        }
    fstring_result_1 = (TauValue){.type = 2, .value.s = strdup(temp_concat_rt_4), .refcount = 1};
    } else {
    fstring_result_1 = (TauValue){.type = 0, .value.i = fstring_left_1.value.i + fstring_right_1.value.i};
    }
    temp_result = fstring_result_1;
    arg_0 = temp_result;
    printf("%s\n", tauraro_str_from_value(&arg_0).value.s);
    arg_0 = (TauValue){.type = 0, .value.i = 20};
    temp_result = factorial(arg_0);
    result3 = temp_result;
    temp_result = (TauValue){.type = 2, .value.s = strdup("Factorial(20): "), .refcount = 1};
    fstring_left_1 = temp_result;
    temp_result = result3;
    fstring_right_1 = temp_result;
    // Runtime type checking for + operation
    if ((fstring_left_1.type == 2 || fstring_right_1.type == 2)) {
        ...
        if (fstring_left_1.type == 2) {
            strcpy(temp_concat_rt_5, fstring_left_1.value.s);
        } else if (fstring_left_1.type == 0) {
            char int_buf[64];
            snprintf(int_buf, sizeof(int_buf), "%lld", fstring_left_1.value.i);
            strcpy(temp_concat_rt_5, int_buf);
        } else if (fstring_left_1.type == 3) {
            strcpy(temp_concat_rt_5, fstring_left_1.value.i ? "True" : "False");
        } else if (fstring_left_1.type == 1) {
            char float_buf[64];
            snprintf(float_buf, sizeof(float_buf), "%f", fstring_left_1.value.f);
        ...
        if (fstring_right_1.type == 2) {
            strcat(temp_concat_rt_5, fstring_right_1.value.s);
        } else if (fstring_right_1.type == 0) {
            char int_buf[64];
            snprintf(int_buf, sizeof(int_buf), "%lld", fstring_right_1.value.i);
            strcat(temp_concat_rt_5, int_buf);
        } else if (fstring_right_1.type == 3) {
            strcat(temp_concat_rt_5, fstring_right_1.value.i ? "True" : "False");
        } else if (fstring_right_1.type == 1) {
            char float_buf[64];
            snprintf(float_buf, sizeof(float_buf), "%f", fstring_right_1.value.f);
            strcat(temp_concat_rt_5, float_buf);
        }
    fstring_result_1 = (TauValue){.type = 2, .value.s = strdup(temp_concat_rt_5), .refcount = 1};
    } else {
    fstring_result_1 = (TauValue){.type = 0, .value.i = fstring_left_1.value.i + fstring_right_1.value.i};
    }
    temp_result = fstring_result_1;
    ...
    if ((binop_left.type == 2 || binop_right.type == 2)) {
        ...
        if (binop_left.type == 2) {
            strcpy(temp_concat_rt_6, binop_left.value.s);
            ...
            strcpy(temp_concat_rt_6, binop_left.value.i ? "True" : "False");
        ...
        if (binop_right.type == 2) {
            strcat(temp_concat_rt_6, binop_right.value.s);
            ...
            strcat(temp_concat_rt_6, binop_right.value.i ? "True" : "False");
        } else if (binop_right.type == 1) {
            char float_buf[64];
            snprintf(float_buf, sizeof(float_buf), "%f", binop_right.value.f);
            strcat(temp_concat_rt_6, float_buf);
        }
    temp_result = (TauValue){.type = 2, .value.s = strdup(temp_concat_rt_6), .refcount = 1};
    } else {
...
TauValue sum_squares(TauValue n) {
    TauValue total, i, temp_result, binop_right, arg_0, binop_left;
        ...
        for(int _for_i_1 = 0; _for_i_1 < _list->size; _for_i_1++) {
            ...
            if ((binop_left.type == 2 && binop_right.type == 0) || (binop_left.type == 0 && binop_right.type == 2)) {
                ...
                if (_count <= 0 || !_str) {
                    ...
                    char* temp_repeat_rt_2 = malloc(_len * _count + 1);
                    temp_repeat_rt_2[0] = '\0';
                    for (long long _i = 0; _i < _count; _i++) strcat(temp_repeat_rt_2, _str);
                    temp_result = (TauValue){.type = 2, .value.s = temp_repeat_rt_2, .refcount = 1};
                }
            } else {
            temp_result = (TauValue){.type = 0, .value.i = binop_left.value.i * binop_right.value.i};
            }
...
TauValue factorial(TauValue n) {
    TauValue arg_1_right, i, temp_result, arg_1_left, arg_1, comp_left, result, binop_right, comp_right, arg_0, binop_left;
    comp_left = n;
    comp_right = (TauValue){.type = 0, .value.i = 1};
    ...
    if ((temp_result.type == 3 ? temp_result.value.i : (temp_result.type == 0 ? (temp_result.value.i != 0) : 1))) {
        temp_result = (TauValue){.type = 0, .value.i = 1};
        return temp_result;
    }
        temp_result = (TauValue){.type = 0, .value.i = 1};
        result = temp_result;
        arg_0 = (TauValue){.type = 0, .value.i = 2};
        temp_result = n;
        arg_1_left = temp_result;
        temp_result = (TauValue){.type = 0, .value.i = 1};
        arg_1_right = temp_result;
        // Runtime type checking for + operation
        if ((arg_1_left.type == 2 || arg_1_right.type == 2)) {
            char temp_concat_rt_1[512] = {0};
            if (arg_1_left.type == 2) {
                strcpy(temp_concat_rt_1, arg_1_left.value.s);
            } else if (arg_1_left.type == 0) {
                char int_buf[64];
                snprintf(int_buf, sizeof(int_buf), "%lld", arg_1_left.value.i);
                strcpy(temp_concat_rt_1, int_buf);
            } else if (arg_1_left.type == 3) {
                strcpy(temp_concat_rt_1, arg_1_left.value.i ? "True" : "False");
            } else if (arg_1_left.type == 1) {
                char float_buf[64];
                snprintf(float_buf, sizeof(float_buf), "%f", arg_1_left.value.f);
                strcpy(temp_concat_rt_1, float_buf);
            }
            if (arg_1_right.type == 2) {
                strcat(temp_concat_rt_1, arg_1_right.value.s);
            } else if (arg_1_right.type == 0) {
                char int_buf[64];
                snprintf(int_buf, sizeof(int_buf), "%lld", arg_1_right.value.i);
                strcat(temp_concat_rt_1, int_buf);
            } else if (arg_1_right.type == 3) {
                strcat(temp_concat_rt_1, arg_1_right.value.i ? "True" : "False");
            } else if (arg_1_right.type == 1) {
                char float_buf[64];
                snprintf(float_buf, sizeof(float_buf), "%f", arg_1_right.value.f);
                strcat(temp_concat_rt_1, float_buf);
            }
        arg_1 = (TauValue){.type = 2, .value.s = strdup(temp_concat_rt_1), .refcount = 1};
        } else {
        arg_1 = (TauValue){.type = 0, .value.i = arg_1_left.value.i + arg_1_right.value.i};
        }
        ...
        if (_for_list_2.type == 4) {
            ...
            for(int _for_i_2 = 0; _for_i_2 < _list->size; _for_i_2++) {
                TauValue i = _list->items[_for_i_2];
                binop_left = result;
                binop_right = i;
                // Runtime type checking for * operation (string repeat)
                if ((binop_left.type == 2 && binop_right.type == 0) || (binop_left.type == 0 && binop_right.type == 2)) {
