...
TauValue fibonacci(TauValue n) {
    TauValue comp_left, arg_0, binop_left, temp_result, arg_0_right, binop_right, arg_0_left, comp_right;
    comp_left = n;
...
int main(int argc, char* argv[]) {
    TauValue fstring_right_1, n, fstring_left_1, fstring_result_1, fstring_right_3, result, fstring_left_2, arg_0, fstring_result_3, temp_result, fstring_right_2, fstring_left_3, fstring_result_2;
    temp_result = (TauValue){.type = 0, .value.i = 30};
    n = temp_result;
    arg_0 = n;
    temp_result = fibonacci(arg_0);
    result = temp_result;
    temp_result = (TauValue){.type = 2, .value.s = strdup("fibonacci("), .refcount = 1};
