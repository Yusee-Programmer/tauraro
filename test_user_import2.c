...
int main() {
    ...
    tauraro_value_t* arg_0_method_arg_0 = NULL;
    char* arg_0_left_1 = NULL;
    tauraro_value_t* mymodule = NULL;
    int64_t arg_0_method_arg_1 = 0;
    tauraro_value_t* arg_0_right_1_attr_object = NULL;
    temp = tauraro_value_new(); temp->type = TAURARO_NONE;
    // Import module: mymodule
    // Test the module
    arg_0_object = mymodule;
    arg_0_method_arg_0 = tauraro_value_new(); arg_0_method_arg_0->type = TAURARO_STRING; arg_0_method_arg_0->data.str_val = strdup("World");
    arg_0 = mymodule__greet(2, (tauraro_value_t*[]){arg_0_object, arg_0_method_arg_0});
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0_object = mymodule;
    arg_0_method_arg_0 = tauraro_value_new(); arg_0_method_arg_0->type = TAURARO_INT; arg_0_method_arg_0->data.int_val = 5;
    arg_0_method_arg_1 = 10;
    tauraro_value_t* arg_0_0_arg_0_method_arg_1_as_value = tauraro_value_new(); arg_0_0_arg_0_method_arg_1_as_value->type = TAURARO_INT; arg_0_0_arg_0_method_arg_1_as_value->data.int_val = arg_0_method_arg_1; arg_0 = mymodule__add(3, (tauraro_value_t*[]){arg_0_object, arg_0_method_arg_0, arg_0_0_arg_0_method_arg_1_as_value});
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("PI = ");
    arg_0_left_1 = arg_0;
    arg_0_right_1_attr_object = mymodule;
    arg_0_right_1 = tauraro_object_get_attr(arg_0_right_1_attr_object, "PI");
