...
fn test_basic() -> () {
    ...
    let fstring_result_1 = { let l = format!("{:?}", &fstring_left_1); let r = format!("{:?}", &fstring_right_1); format!("{}{}", l, r) };
    let temp_result = fstring_result_1;
    let arg_0 = temp_result;
    println!("{}", arg_0);
    let comp_left = z;
    let comp_right = 25;
    let temp_result = comp_left - comp_right;
    if temp_result {
        let arg_0 = "z is greater than 25";
        println!("{}", arg_0);
    } else if temp_result {
        let comp_left = z;
        let comp_right = 15;
        let temp_result = comp_left - comp_right;
        let arg_0 = "z is between 16 and 25";
        println!("{}", arg_0);
    } else {
        let arg_0 = "z is 15 or less";
        println!("{}", arg_0);
    }
    // For loops
    let arg_0 = "Numbers 1-5:";
    println!("{}", arg_0);
    let arg_0 = 5;
