...
int main() {
    tauraro_value_t* arg_3_elem_0 = NULL;
    tauraro_value_t* arg_0_left_1 = NULL;
    tauraro_value_t* arg_2_elem_0 = NULL;
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Loading libm...");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("libm.so.6");
    temp = tauraro_ffi_load_library(arg_0->data.str_val);
    // Define the sqrt function
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Defining sqrt function...");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("libm.so.6");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_STRING; arg_1->data.str_val = strdup("sqrt");
    arg_2 = tauraro_value_new(); arg_2->type = TAURARO_STRING; arg_2->data.str_val = strdup("double");
    arg_3_elem_0 = tauraro_value_new(); arg_3_elem_0->type = TAURARO_STRING; arg_3_elem_0->data.str_val = strdup("double");
    arg_3 = tauraro_list(1, (tauraro_value_t*[]){arg_3_elem_0});
    {
        // Define foreign function from arg_0
        int param_count = arg_3->data.list_val->count;
        const char** param_types = (const char**)malloc(sizeof(char*) * param_count);
        for (int i = 0; i < param_count; i++) {
            tauraro_value_t* param_type = arg_3->data.list_val->items[i];
            if (param_type->type == TAURARO_STRING) {
                param_types[i] = param_type->data.str_val;
            }
        }
        temp = tauraro_ffi_define_function(
            arg_0->data.str_val,
            arg_1->data.str_val,
            arg_2->data.str_val,
            param_types,
    ...
    // Call sqrt using FFI
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Calling sqrt(16.0)...");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("libm.so.6");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_STRING; arg_1->data.str_val = strdup("sqrt");
    arg_2_elem_0 = tauraro_value_new(); arg_2_elem_0->type = TAURARO_FLOAT; arg_2_elem_0->data.float_val = 16;
    arg_2 = tauraro_list(1, (tauraro_value_t*[]){arg_2_elem_0});
    {
        // Call foreign function arg_1 from arg_0
        int arg_count = arg_2->data.list_val->count;
        tauraro_value_t** ffi_args = arg_2->data.list_val->items;
        temp = tauraro_ffi_call_function(
            arg_1->data.str_val,
            ffi_args,
            arg_count
        );
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("libm.so.6");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_STRING; arg_1->data.str_val = strdup("sqrt");
    arg_2_elem_0 = tauraro_value_new(); arg_2_elem_0->type = TAURARO_FLOAT; arg_2_elem_0->data.float_val = 25;
    arg_2 = tauraro_list(1, (tauraro_value_t*[]){arg_2_elem_0});
    {
        // Call foreign function arg_1 from arg_0
        int arg_count = arg_2->data.list_val->count;
    ...
    var_result2_temp = temp;
    result2 = var_result2_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("sqrt(25.0) = ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = result2;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("FFI test completed successfully!");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    return 0;
}
