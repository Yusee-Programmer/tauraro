...
| [`std.crypto`](crypto.md) | Cryptography: SHA-256, HMAC-SHA256, SHA-1, MD5, UUID v3/v4/v5, ULID (incl. monotonic) |
| [`std.encoding`](encoding.md) | Data encoding: JSON, TOML, YAML, Base64, Hex |
