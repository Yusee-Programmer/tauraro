...
__attribute__((malloc,returns_nonnull,hot)) CppExporter* CppExporter_init(CGenerator* gen) {
    ...
    /* pass */
    CGenerator* _cltmp_t3000 = _tr_obj_retain(gen);
...
__attribute__((hot)) TrStr CppExporter__cpp_list_sfx(CppExporter* self, AstType* ty) {
    /* pass */
    return ({ TrStr _at_t3001 = (CGenerator_list_elem_suffix(self->gen, (*((AstType**)List_ptr_get(ty->args, 0LL)))->name)); __auto_type _wr = (CGenerator_list_sfx(self->gen, _at_t3001)); _tr_str_release(_at_t3001); _wr; });
}
...
__attribute__((hot)) TrStr CppExporter__cpp_dict_v_cpp(CppExporter* self, AstType* ty) {
    /* pass */
    return ({ TrStr _at_t3002 = (CppExporter__cpp_dict_vkind(self, ty)); __auto_type _wr = (CppExporter__cpp_slot_cpp(self, _at_t3002)); _tr_str_release(_at_t3002); _wr; });
}
...
__attribute__((hot)) TrStr CppExporter__cpp_tuple_elem_cpp(CppExporter* self, AstType* ty, long long i) {
    /* pass */
    return ({ TrStr _at_t3003 = (CppExporter__cpp_slot_kind(self, (*((AstType**)List_ptr_get(ty->args, i)))->name)); __auto_type _wr = (CppExporter__cpp_slot_cpp(self, _at_t3003)); _tr_str_release(_at_t3003); _wr; });
}
...
__attribute__((hot)) void CppExporter__note_export_ty(CppExporter* self, AstType* ty) {
    ...
    if (((strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("List"))) == 0) || (strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Vec"))) == 0))) {
        ...
        if (CppExporter__cpp_list_ok(self, ty)) {
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_list_elem_kind(self, ty)), _tr_strz(_tr_str_lit("class"))) == 0)) {
                ...
                /* pass */
                ({ TrStr _dkt_t3004 = (CppExporter__cpp_list_sfx(self, ty)); TrStr _dvt_t3005 = (CppExporter__cpp_list_elem_c(self, ty)); _tr_dict_set(self->list_elems, _tr_strz(_dkt_t3004), _tr_str_box(_tr_str_retain(_dvt_t3005))); _tr_str_release(_dkt_t3004); _tr_str_release(_dvt_t3005); });
            }
        }
    }
    /* pass */
    if ((((strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Dict"))) == 0) || (strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Map"))) == 0)) && CppExporter__cpp_dict_ok(self, ty))) {
        /* pass */
        ({ TrStr _dkt_t3006 = (CppExporter__cpp_dict_variant(self, ty)); TrStr _at_t3007 = (CppExporter__cpp_dict_vkind(self, ty)); TrStr _dvt_t3008 = (CppExporter__cpp_slot_c(self, _at_t3007)); _tr_dict_set(self->dict_variants, _tr_strz(_dkt_t3006), _tr_str_box(_tr_str_retain(_dvt_t3008))); _tr_str_release(_dkt_t3006); _tr_str_release(_at_t3007); _tr_str_release(_dvt_t3008); });
        /* pass */
...
__attribute__((hot)) bool CppExporter__cpp_fn_needs_bridge(CppExporter* self, HirFunction* f) {
    /* pass */
    if (({ TrStr _at_t3009 = (CppExporter__cpp_ty_kind(self, f->ret_ty)); __auto_type _wr = (CppExporter__cpp_kind_bridged(self, _at_t3009)); _tr_str_release(_at_t3009); _wr; })) {
        /* pass */
        return true;
    }
    /* pass */
    ...
    while ((i < f->params->len)) {
        /* pass */
        if (({ TrStr _at_t3010 = (CppExporter__cpp_ty_kind(self, ((HirParam*)List_ptr_get(f->params, i))->ty)); __auto_type _wr = (CppExporter__cpp_kind_bridged(self, _at_t3010)); _tr_str_release(_at_t3010); _wr; })) {
            /* pass */
            return true;
        }
        /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_tuple_type_cpp(CppExporter* self, AstType* ty) {
    ...
    while ((i < ty->args->len)) {
        ...
        if ((i > 0LL)) {
            /* pass */
            TrStr _strtmp_t3011 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(s);
            s = _strtmp_t3011;
        }
        /* pass */
        TrStr _strtmp_t3012 = ({ TrStr _cr = (CppExporter__cpp_tuple_elem_cpp(self, ty, i)); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(s);
        s = _strtmp_t3012;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) bool CppExporter__cpp_fn_has_list(CppExporter* self, HirFunction* f) {
    /* pass */
    if (({ TrStr _at_t3013 = (CppExporter__cpp_ty_kind(self, f->ret_ty)); __auto_type _wr = (CppExporter__cpp_kind_marshal(self, _at_t3013)); _tr_str_release(_at_t3013); _wr; })) {
        /* pass */
        return true;
    }
    /* pass */
    ...
    while ((i < f->params->len)) {
        /* pass */
        if (({ TrStr _at_t3014 = (CppExporter__cpp_ty_kind(self, ((HirParam*)List_ptr_get(f->params, i))->ty)); __auto_type _wr = (CppExporter__cpp_kind_marshal(self, _at_t3014)); _tr_str_release(_at_t3014); _wr; })) {
            /* pass */
            return true;
        }
        /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_wrap_fn(CppExporter* self, HirFunction* f) {
    ...
    if (CppExporter__cpp_fn_needs_bridge(self, f)) {
        /* pass */
        TrStr _strtmp_t3015 = _tr_strx_concat(_tr_strz(_tr_str_lit("tr__")), _tr_strz(f->name));
        _tr_str_release(target);
        target = _strtmp_t3015;
    }
    /* pass */
    StringBuilder* wb = StringBuilder_init(256LL);
    /* pass */
    ({ TrStr _sbt_t3016 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_type(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("    inline ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3016); _tr_str_release(_sbt_t3016); });
    /* pass */
    long long i = 0LL;
    /* pass */
    while ((i < f->params->len)) {
        ...
        if ((strcmp(_tr_strz(pn), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3017 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("a")), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(pn);
            pn = _strtmp_t3017;
        }
        /* pass */
        ...
        /* pass */
        ({ TrStr _sbt_t3018 = (CppExporter__cpp_param_decl(self, p->ty, pn)); StringBuilder_append(wb, _sbt_t3018); _tr_str_release(_sbt_t3018); });
        /* pass */
        i = (i + 1LL);
        _tr_str_release(pn);
    }
    ...
    if ((!CppExporter__cpp_fn_has_list(self, f))) {
        ...
        while ((i < f->params->len)) {
            ...
            if ((strcmp(_tr_strz(pn2), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3019 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("a")), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(pn2);
                pn2 = _strtmp_t3019;
            }
            /* pass */
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t3020 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(call_args);
                call_args = _strtmp_t3020;
            }
            /* pass */
            TrStr _strtmp_t3021 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p2->ty, pn2)); TrStr _cres = _tr_strx_concat(_tr_strz(call_args), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(call_args);
            call_args = _strtmp_t3021;
            /* pass */
            i = (i + 1LL);
            _tr_str_release(pn2);
        }
        /* pass */
        ({ TrStr _at_t3022 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(target), _tr_strz(_tr_str_lit("(")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call_args)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t3023 = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_stmt(self, f->ret_ty, _at_t3022)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(") { ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3023); _tr_str_release(_at_t3022); _tr_str_release(_sbt_t3023); });
        /* pass */
        _tr_str_release(target);
        _tr_str_release(call_args);
    ...
    while ((i < f->params->len)) {
        ...
        if ((strcmp(_tr_strz(pn3), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3024 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("a")), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(pn3);
            pn3 = _strtmp_t3024;
        }
        /* pass */
        if ((i > 0LL)) {
            /* pass */
            TrStr _strtmp_t3025 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(call_args);
            call_args = _strtmp_t3025;
        }
        /* pass */
        ...
        if ((strcmp(_tr_strz(pk), _tr_strz(_tr_str_lit("list"))) == 0)) {
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_dict_kkind(self, p3->ty)), _tr_strz(_tr_str_lit("s"))) == 0)) {
                /* pass */
                TrStr _strtmp_t3031 = _tr_str_lit("TrStr{ (char*)_kv.first.c_str(), (long*)0 }");
            ...
            /* pass */
            TrStr _strtmp_t3035 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(tmp));
            _tr_str_release(call_args);
            call_args = _strtmp_t3035;
            /* pass */
            ...
            /* pass */
            ({ TrStr _sbt_t3037 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        TrTuple ")), _tr_strz(tmp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = {};\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3037); _tr_str_release(_sbt_t3037); });
            /* pass */
            long long ti = 0LL;
            /* pass */
            ...
            /* pass */
            TrStr _strtmp_t3041 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(tmp));
            _tr_str_release(call_args);
            call_args = _strtmp_t3041;
            _tr_str_release(tmp);
        } else {
            /* pass */
            TrStr _strtmp_t3042 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p3->ty, pn3)); TrStr _cres = _tr_strx_concat(_tr_strz(call_args), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(call_args);
            call_args = _strtmp_t3042;
        }
        /* pass */
        i = (i + 1LL);
        _tr_str_release(pn3);
    ...
    if ((strcmp(_tr_strz(rk), _tr_strz(_tr_str_lit("void"))) == 0)) {
        /* pass */
        ({ TrStr _sbt_t3043 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _tr_strz(call_expr))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(frees)); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3043); _tr_str_release(_sbt_t3043); });
    } else {
        /* pass */
        ({ TrStr _sbt_t3044 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" _r = "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call_expr)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(frees)); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3044); _tr_str_release(_sbt_t3044); });
        /* pass */
        if ((strcmp(_tr_strz(rk), _tr_strz(_tr_str_lit("list"))) == 0)) {
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_list_elem_kind(self, f->ret_ty)), _tr_strz(_tr_str_lit("class"))) == 0)) {
                ...
                /* pass */
                ({ TrStr _sbt_t3046 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) _v.push_back(")), _tr_strz(ecpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::_wrap((void*)tr__list_ptr_get(_r, _i)));\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3046); _tr_str_release(_sbt_t3046); });
                /* pass */
                ...
                /* pass */
                ({ TrStr _sbt_t3047 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long _n = tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_len(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3047); _tr_str_release(_sbt_t3047); });
                /* pass */
                ({ TrStr _sbt_t3048 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        std::vector<")), _tr_strz(ecpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("> _v; _v.reserve((size_t)_n);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3048); _tr_str_release(_sbt_t3048); });
                /* pass */
                if ((strcmp(_tr_strz((*((AstType**)List_ptr_get(f->ret_ty->args, 0LL)))->name), _tr_strz(_tr_str_lit("str"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t3049 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) { TrStr _s = tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _i); _v.push_back(std::string(_s.data ? _s.data : \"\")); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3049); _tr_str_release(_sbt_t3049); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t3050 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) _v.push_back(tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _i));\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3050); _tr_str_release(_sbt_t3050); });
                }
                /* pass */
                ({ TrStr _sbt_t3051 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_r);\n        return _v;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3051); _tr_str_release(_sbt_t3051); });
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_dict_kkind(self, f->ret_ty)), _tr_strz(_tr_str_lit("i"))) == 0)) {
                /* pass */
                TrStr _strtmp_t3052 = _tr_str_lit("i64");
                _tr_str_release(ksfx);
                ksfx = _strtmp_t3052;
            }
            /* pass */
            ({ TrStr _sbt_t3053 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        void* _ks = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_keys(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3053); _tr_str_release(_sbt_t3053); });
            /* pass */
            ({ TrStr _sbt_t3054 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long _n = tr__list_")), _tr_strz(ksfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_len(_ks);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3054); _tr_str_release(_sbt_t3054); });
            /* pass */
            ({ TrStr _sbt_t3055 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_dict_key_cpp(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        std::map<")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (CppExporter__cpp_dict_v_cpp(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("> _m;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3055); _tr_str_release(_sbt_t3055); });
            /* pass */
            ...
            if ((strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0)) {
                /* pass */
                ({ TrStr _sbt_t3056 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("            TrStr _vv = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _k); _m[_kk2] = std::string(_vv.data ? _vv.data : \"\");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3056); _tr_str_release(_sbt_t3056); });
            } else {
                /* pass */
                ({ TrStr _sbt_t3057 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("            _m[_kk2] = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _k);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3057); _tr_str_release(_sbt_t3057); });
            }
            /* pass */
            StringBuilder_append(wb, _tr_str_lit("        }\n"));
            /* pass */
            ({ TrStr _sbt_t3058 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        tr__list_")), _tr_strz(ksfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_ks); tr__dict_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(vt)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_r);\n        return _m;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3058); _tr_str_release(_sbt_t3058); });
            _tr_str_release(vt);
            _tr_str_release(ksfx);
            ...
            while ((ti < f->ret_ty->args->len)) {
                ...
                if ((strcmp(_tr_strz(sk), _tr_strz(_tr_str_lit("str"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t3059 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        TrStr _ts")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = tr__unbox_str("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); std::string "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ev)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(_ts"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".data ? _ts"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".data : \"\");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3059); _tr_str_release(_sbt_t3059); });
                } else if ((strcmp(_tr_strz(sk), _tr_strz(_tr_str_lit("f64"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t3060 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        double ")), _tr_strz(ev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = tr__unbox_f64("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3060); _tr_str_release(_sbt_t3060); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t3061 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long ")), _tr_strz(ev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = (long long)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3061); _tr_str_release(_sbt_t3061); });
                }
                /* pass */
                if ((ti > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3062 = _tr_strx_concat(_tr_strz(parts), _tr_strz(_tr_str_lit(", ")));
                    _tr_str_release(parts);
                    parts = _strtmp_t3062;
                }
                /* pass */
                TrStr _strtmp_t3063 = _tr_strx_concat(_tr_strz(parts), _tr_strz(ev));
                _tr_str_release(parts);
                parts = _strtmp_t3063;
                /* pass */
                ti = (ti + 1LL);
            ...
            /* pass */
            ({ TrStr _sbt_t3064 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        return std::make_tuple(")), _tr_strz(parts))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3064); _tr_str_release(_sbt_t3064); });
            _tr_str_release(parts);
            ...
            /* pass */
            ({ TrStr _sbt_t3065 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        return ")), _tr_strz(f->ret_ty->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::_wrap(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3065); _tr_str_release(_sbt_t3065); });
        } else {
            /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_class_decl(CppExporter* self, HirClass* c) {
    ...
    /* pass */
    ({ TrStr _sbt_t3066 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    class ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" {\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3066); _tr_str_release(_sbt_t3066); });
    /* pass */
    StringBuilder_append(wb, _tr_str_lit("        void* h_;\n"));
    /* pass */
    ({ TrStr _sbt_t3067 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        explicit ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(void* _p): h_(_p) {}\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3067); _tr_str_release(_sbt_t3067); });
    /* pass */
    StringBuilder_append(wb, _tr_str_lit("    public:\n"));
    /* pass */
    ({ TrStr _sbt_t3068 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        static ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" _wrap(void* _p) { return "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(_p); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3068); _tr_str_release(_sbt_t3068); });
    /* pass */
    ...
    /* pass */
    ({ TrStr _sbt_t3073 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        ~")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("() { if (h_) tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_release(h_); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3073); _tr_str_release(_sbt_t3073); });
    /* pass */
    ...
    if ((iidx >= 0LL)) {
        ...
        /* pass */
        ({ TrStr _sbt_t3074 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        explicit ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3074); _tr_str_release(_sbt_t3074); });
        /* pass */
        ...
        while ((pi < im->params->len)) {
            ...
            if ((emitted > 0LL)) {
                ...
                StringBuilder_append(wb, _tr_str_lit(", "));
                /* pass */
                TrStr _strtmp_t3075 = _tr_strx_concat(_tr_strz(cargs), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(cargs);
                cargs = _strtmp_t3075;
            }
            /* pass */
            ({ TrStr _sbt_t3076 = (CppExporter__cpp_param_decl(self, p->ty, p->name)); StringBuilder_append(wb, _sbt_t3076); _tr_str_release(_sbt_t3076); });
            /* pass */
            TrStr _strtmp_t3077 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p->ty, p->name)); TrStr _cres = _tr_strx_concat(_tr_strz(cargs), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(cargs);
            cargs = _strtmp_t3077;
            /* pass */
            emitted = (emitted + 1LL);
        ...
        /* pass */
        ({ TrStr _sbt_t3078 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("): h_(tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")) {}\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3078); _tr_str_release(_sbt_t3078); });
        _tr_str_release(cargs);
    }
    /* pass */
    long long mi = 0LL;
    ...
    while ((mi < c->methods->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t3079 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_type(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3079); _tr_str_release(_sbt_t3079); });
        /* pass */
        ...
        while ((pj < m->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3080 = (CppExporter__cpp_param_decl(self, mp->ty, mp->name)); StringBuilder_append(wb, _sbt_t3080); _tr_str_release(_sbt_t3080); });
            /* pass */
            TrStr _strtmp_t3081 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(margs), _tr_strz(_tr_str_lit(", ")))); TrStr _cr = (CppExporter__cpp_call_arg(self, mp->ty, mp->name)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        ...
        /* pass */
        ({ TrStr _at_t3082 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(margs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t3083 = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_stmt(self, m->ret_ty, _at_t3082)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(") { ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t3083); _tr_str_release(_at_t3082); _tr_str_release(_sbt_t3083); });
        _tr_str_release(margs);
    }
    /* pass */
    StringBuilder_append(wb, _tr_str_lit("    };\n"));
...
__attribute__((hot)) TrStr CppExporter_generate_cpp_class_bridges(CppExporter* self, HirProgram* prog) {
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            TrStr C = _tr_str_retain(c->name);
            /* pass */
            ({ TrStr _sbt_t3084 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_retain(void* p){ return _tr_obj_retain(p); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3084); _tr_str_release(_sbt_t3084); });
            /* pass */
            ({ TrStr _sbt_t3085 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_release(void* p){ _tr_obj_release(p, _trdrop_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3085); _tr_str_release(_sbt_t3085); });
            /* pass */
            long long iidx = CppExporter__cpp_init_idx(self, c);
            /* pass */
            if ((iidx >= 0LL)) {
                ...
                HirFunction* im = ((HirFunction*)List_ptr_get(c->methods, iidx));
                /* pass */
                ({ TrStr _sbt_t3086 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3086); _tr_str_release(_sbt_t3086); });
                /* pass */
                long long ip = 0LL;
                /* pass */
                long long ie = 0LL;
                ...
                while ((ip < im->params->len)) {
                    ...
                    if ((ie > 0LL)) {
                        ...
                        StringBuilder_append(b, _tr_str_lit(", "));
                        /* pass */
                        TrStr _strtmp_t3087 = _tr_strx_concat(_tr_strz(iargs), _tr_strz(_tr_str_lit(", ")));
                        _tr_str_release(iargs);
                        iargs = _strtmp_t3087;
                    }
                    /* pass */
                    ({ TrStr _sbt_t3088 = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, p->ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(p->name)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3088); _tr_str_release(_sbt_t3088); });
                    /* pass */
                    TrStr _strtmp_t3089 = _tr_strx_concat(_tr_strz(iargs), _tr_strz(p->name));
                    _tr_str_release(iargs);
                    iargs = _strtmp_t3089;
                    /* pass */
                    ie = (ie + 1LL);
            ...
            while ((mi < c->methods->len)) {
                ...
                /* pass */
                ({ TrStr _sbt_t3091 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(void* s"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3091); _tr_str_release(_sbt_t3091); });
                /* pass */
                ...
                while ((pj < m->params->len)) {
                    ...
                    /* pass */
                    ({ TrStr _sbt_t3092 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, mp->ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(", ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(mp->name)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3092); _tr_str_release(_sbt_t3092); });
                    /* pass */
                    TrStr _strtmp_t3093 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(margs), _tr_strz(_tr_str_lit(", ")))); TrStr _cr = (CppExporter__cpp_c_arg(self, mp->ty, mp->name)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                    _tr_str_release(margs);
                    margs = _strtmp_t3093;
                }
                /* pass */
                ...
                if ((strcmp(_tr_strz(CppExporter__cpp_ty_kind(self, m->ret_ty)), _tr_strz(_tr_str_lit("void"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t3094 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(C), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(margs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3094); _tr_str_release(_sbt_t3094); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t3095 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(margs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3095); _tr_str_release(_sbt_t3095); });
                }
                _tr_str_release(margs);
            }
            _tr_str_release(C);
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->functions)))))) {
        ...
        while ((fi < prog->functions->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3096 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3096); _tr_str_release(_sbt_t3096); });
            /* pass */
            ...
            while ((pi2 < f->params->len)) {
                ...
                if ((strcmp(_tr_strz(pn), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3097 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(pi2)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("a")), _cr.data); _tr_str_release(_cr); _cres; });
                    _tr_str_release(pn);
                    pn = _strtmp_t3097;
                }
                /* pass */
                if ((pi2 > 0LL)) {
                    ...
                    StringBuilder_append(b, _tr_str_lit(", "));
                    /* pass */
                    TrStr _strtmp_t3098 = _tr_strx_concat(_tr_strz(fargs), _tr_strz(_tr_str_lit(", ")));
                    _tr_str_release(fargs);
                    fargs = _strtmp_t3098;
                }
                /* pass */
                ({ TrStr _sbt_t3099 = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, p->ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3099); _tr_str_release(_sbt_t3099); });
                /* pass */
                TrStr _strtmp_t3100 = ({ TrStr _cr = (CppExporter__cpp_c_arg(self, p->ty, pn)); TrStr _cres = _tr_strx_concat(_tr_strz(fargs), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(fargs);
                fargs = _strtmp_t3100;
                /* pass */
                pi2 = (pi2 + 1LL);
            ...
            if ((strcmp(_tr_strz(frk), _tr_strz(_tr_str_lit("void"))) == 0)) {
                /* pass */
                ({ TrStr _sbt_t3101 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(f->name), _tr_strz(_tr_str_lit("(")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3101); _tr_str_release(_sbt_t3101); });
                ...
                /* pass */
                ({ TrStr _sbt_t3102 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (void*)")), _tr_strz(f->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3102); _tr_str_release(_sbt_t3102); });
            } else {
                /* pass */
                ({ TrStr _sbt_t3103 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(f->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3103); _tr_str_release(_sbt_t3103); });
            }
            _tr_str_release(fargs);
            _tr_str_release(frk);
        }
    ...
    /* pass */
    ({ TrStr _sbt_t3104 = (CppExporter__cpp_list_bridges(self)); StringBuilder_append(b, _sbt_t3104); _tr_str_release(_sbt_t3104); });
    /* pass */
    StringBuilder_append(b, _tr_str_lit("#ifdef __cplusplus\n}\n#endif\n"));
    /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_list_bridges(CppExporter* self) {
    ...
    while ((di < dk->len)) {
        ...
        if ((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("s"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3110 = _tr_str_lit("TrStr");
            _tr_str_release(kc);
            kc = _strtmp_t3110;
            /* pass */
            TrStr _strtmp_t3111 = _tr_str_lit("_tr_dict_new(8)");
            _tr_str_release(newfn);
            newfn = _strtmp_t3111;
            /* pass */
            TrStr _strtmp_t3112 = _tr_str_lit("_tr_dict_keys((TrMap*)d)");
            _tr_str_release(keysfn);
            keysfn = _strtmp_t3112;
            /* pass */
            TrStr _strtmp_t3113 = _tr_str_lit("_tr_dict_get((TrMap*)d, _tr_strz(k))");
            _tr_str_release(getraw);
            getraw = _strtmp_t3113;
            /* pass */
            TrStr _strtmp_t3114 = _tr_str_lit("_tr_dict_set((TrMap*)d, _tr_strz(k), ");
            _tr_str_release(setpre);
            setpre = _strtmp_t3114;
        }
        /* pass */
        ({ TrStr _sbt_t3115 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new(void){ return (void*)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(newfn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3115); _tr_str_release(_sbt_t3115); });
        /* pass */
        ({ TrStr _sbt_t3116 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_keys(void* d){ return (void*)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(keysfn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3116); _tr_str_release(_sbt_t3116); });
        /* pass */
        ...
        if ((strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("f64"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3117 = _tr_str_lit("double");
            _tr_str_release(vc);
            vc = _strtmp_t3117;
            /* pass */
            TrStr _strtmp_t3118 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("_tr_ptr_to_f64(")), _tr_strz(getraw))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(getval);
            getval = _strtmp_t3118;
            /* pass */
            TrStr _strtmp_t3119 = _tr_strx_concat(_tr_strz(setpre), _tr_strz(_tr_str_lit("_tr_f64_to_ptr(v))")));
            _tr_str_release(setval);
            setval = _strtmp_t3119;
        } else if ((strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3120 = _tr_str_lit("TrStr");
            _tr_str_release(vc);
            vc = _strtmp_t3120;
            /* pass */
            TrStr _strtmp_t3121 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("_tr_str_unbox(")), _tr_strz(getraw))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(getval);
            getval = _strtmp_t3121;
            /* pass */
            TrStr _strtmp_t3122 = _tr_strx_concat(_tr_strz(setpre), _tr_strz(_tr_str_lit("_tr_str_box(v))")));
            _tr_str_release(setval);
            setval = _strtmp_t3122;
        }
        /* pass */
        ({ TrStr _sbt_t3123 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT ")), _tr_strz(vc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__dict_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(V)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(void* d, "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(kc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" k){ return "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(getval)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3123); _tr_str_release(_sbt_t3123); });
        /* pass */
        ({ TrStr _sbt_t3124 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_set(void* d, "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(kc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" k, "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(vc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" v){ "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(setval)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3124); _tr_str_release(_sbt_t3124); });
        /* pass */
        ...
        if (((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("s"))) == 0) && (strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3125 = _tr_str_lit("Dict_free_strval((Dict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t3125;
        } else if (((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("i"))) == 0) && (strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3126 = _tr_str_lit("_tr_idict_free_strval((TrIDict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t3126;
        } else if ((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("i"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3127 = _tr_str_lit("_tr_idict_free((TrIDict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t3127;
        }
        /* pass */
        ({ TrStr _sbt_t3128 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(void* d){ "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(freefn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3128); _tr_str_release(_sbt_t3128); });
        _tr_str_release(V);
        _tr_str_release(kk);
        _tr_str_release(vk);
        _tr_str_release(kc);
...
__attribute__((hot)) TrStr CppExporter_generate_export_cpp_header(CppExporter* self, HirProgram* prog, TrStr ns) {
    ...
    /* pass */
    ({ TrStr _sbt_t3129 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("   link the Tauraro library, and use the `")), _tr_strz(ns))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::` wrappers. */\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t3129); _tr_str_release(_sbt_t3129); });
    /* pass */
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3134 = (CppExporter__cpp_class_bridge_protos(self, c)); StringBuilder_append(sb, _sbt_t3134); _tr_str_release(_sbt_t3134); });
        }
    }
    /* pass */
    long long i = 0LL;
        ...
        while ((i < prog->functions->len)) {
            ...
            if ((!_is_invalid_ptr(((unsigned long long)(f))))) {
                ...
                if (((f->is_export && (!f->is_extern)) && CppExporter__cpp_export_fn_ok(self, f))) {
                    ...
                    if (CppExporter__cpp_fn_needs_bridge(self, f)) {
                        /* pass */
                        ({ TrStr _sbt_t3135 = (CppExporter__cpp_free_fn_bridge_proto(self, f)); StringBuilder_append(sb, _sbt_t3135); _tr_str_release(_sbt_t3135); });
                    } else {
                        /* pass */
                        ...
                        if (_tr_str_starts_with(_tr_strz(sig), _tr_strz(_tr_str_lit("TR_EXPORT ")))) {
                            /* pass */
                            TrStr _strtmp_t3136 = _tr_str_wrap(_tr_str_slice(_tr_strz(sig), 10LL, _tr_strlen(_tr_strz(sig))));
                            _tr_str_release(sig);
                            sig = _strtmp_t3136;
                        }
                        /* pass */
                        ({ TrStr _sbt_t3137 = (_tr_strx_concat(_tr_strz(sig), _tr_strz(_tr_str_lit(";\n")))); StringBuilder_append(sb, _sbt_t3137); _tr_str_release(_sbt_t3137); });
                        _tr_str_release(sig);
                    }
                }
            }
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3139 = (CppExporter__cpp_class_decl(self, c)); StringBuilder_append(sb, _sbt_t3139); _tr_str_release(_sbt_t3139); });
        }
    }
    /* pass */
    i = 0LL;
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->functions)))))) {
        ...
        while ((i < prog->functions->len)) {
            ...
            if ((!_is_invalid_ptr(((unsigned long long)(f))))) {
                ...
                if (((f->is_export && (!f->is_extern)) && CppExporter__cpp_export_fn_ok(self, f))) {
                    /* pass */
                    ({ TrStr _sbt_t3140 = (CppExporter__cpp_wrap_fn(self, f)); StringBuilder_append(sb, _sbt_t3140); _tr_str_release(_sbt_t3140); });
                }
            }
            /* pass */
            i = (i + 1LL);
    ...
    /* pass */
    ({ TrStr _sbt_t3141 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("}  // namespace ")), _tr_strz(ns))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n\n#endif\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t3141); _tr_str_release(_sbt_t3141); });
    /* pass */
    List_TrStr_free(lk);
    List_TrStr_free(dkk);
...
__attribute__((hot)) TrStr CppExporter__cpp_class_bridge_protos(CppExporter* self, HirClass* c) {
    ...
    /* pass */
    ({ TrStr _sbt_t3142 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_retain(void*); void tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_release(void*);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3142); _tr_str_release(_sbt_t3142); });
    /* pass */
    long long iidx = CppExporter__cpp_init_idx(self, c);
    /* pass */
    if ((iidx >= 0LL)) {
        ...
        HirFunction* im = ((HirFunction*)List_ptr_get(c->methods, iidx));
        /* pass */
        ({ TrStr _sbt_t3143 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3143); _tr_str_release(_sbt_t3143); });
        /* pass */
        long long ip = 0LL;
        /* pass */
        long long ie = 0LL;
        ...
        while ((ip < im->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3144 = (CppExporter__cpp_c_ty(self, p->ty)); StringBuilder_append(b, _sbt_t3144); _tr_str_release(_sbt_t3144); });
            /* pass */
            ie = (ie + 1LL);
        }
        /* pass */
    ...
    while ((mi < c->methods->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t3145 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(void*"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3145); _tr_str_release(_sbt_t3145); });
        /* pass */
        long long pj = 0LL;
        /* pass */
        while ((pj < m->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t3146 = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, mp->ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(", ")), _cr.data); _tr_str_release(_cr); _cres; })); StringBuilder_append(b, _sbt_t3146); _tr_str_release(_sbt_t3146); });
        }
        /* pass */
        StringBuilder_append(b, _tr_str_lit(");\n"));
    }
...
__attribute__((hot)) TrStr CppExporter__cpp_free_fn_bridge_proto(CppExporter* self, HirFunction* f) {
    ...
    /* pass */
    ({ TrStr _sbt_t3147 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t3147); _tr_str_release(_sbt_t3147); });
    /* pass */
    long long pi = 0LL;
    /* pass */
    long long e = 0LL;
    ...
    while ((pi < f->params->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t3148 = (CppExporter__cpp_c_ty(self, ((HirParam*)List_ptr_get(f->params, pi))->ty)); StringBuilder_append(b, _sbt_t3148); _tr_str_release(_sbt_t3148); });
        /* pass */
        e = (e + 1LL);
        /* pass */
        pi = (pi + 1LL);
