...
__auto_type val = _t266.data.SAssign.val;
            /* pass */
            __auto_type _t271 = (*tgt);
            if (_t271.tag == HirExpr_EIdent) {
                __auto_type tn = _t271.data.EIdent.name;
...
__auto_type wbody = _t266.data.SWith.body;
    ...
    /* pass */
    HirBlock* _cltmp_t272 = _tr_obj_retain(saved_hb);
    _tr_obj_release(b->cur_hb, _trdrop_HirBlock);
    b->cur_hb = _cltmp_t272;
...
__attribute__((hot)) MirFunction* lower_function(HirFunction* hf) {
    ...
    while ((rbi < b->blocks->len)) {
        ...
        while ((rsi < rblk->stmts->len)) {
            /* pass */
            __auto_type _t273 = (*((MirStmt*)List_ptr_get(rblk->stmts, rsi)));
            if (_t273.tag == MirStmt_MDeclare) {
                __auto_type rv = _t273.data.MDeclare.value;
                collect_raw_borrows(rv, b->unsafe_pinned);
            } else if (_t273.tag == MirStmt_MAssign) {
                __auto_type rv = _t273.data.MAssign.value;
                collect_raw_borrows(rv, b->unsafe_pinned);
            } else if (_t273.tag == MirStmt_MEval) {
                __auto_type rv = _t273.data.MEval.value;
                collect_raw_borrows(rv, b->unsafe_pinned);
            }
            /* pass */
            rsi = (rsi + 1LL);
        ...
        /* pass */
        __auto_type _t274 = (*rblk->term);
        if (_t274.tag == MirTerm_TBranch) {
            __auto_type rc = _t274.data.TBranch.cond;
            collect_raw_borrows(rc, b->unsafe_pinned);
        } else if (_t274.tag == MirTerm_TReturn) {
            __auto_type rv = _t274.data.TReturn.value;
            collect_raw_borrows(rv, b->unsafe_pinned);
        } else if (1) {
            __auto_type _ = _t274;
            /* pass */
    ...
    /* pass */
    LiveSet* _cltmp_t275 = _tr_obj_retain(b->unsafe_pinned);
    _tr_obj_release(mf->unsafe_pinned, _trdrop_LiveSet);
    mf->unsafe_pinned = _cltmp_t275;
    /* pass */
...
__auto_type r = _t276.data.EBinOp.right;
        ...
        __auto_type x = _t276.data.EUnaryOp.expr;
        collect_uses(x, out);
...
__auto_type idx = _t276.data.EIndex._tr_v_index;
    ...
    } else if (_t276.tag == HirExpr_ECast) {
        __auto_type x = _t276.data.ECast.expr;
        collect_uses(x, out);
...
__attribute__((hot)) void collect_raw_borrows(HirExpr* e, LiveSet* out) {
    ...
    /* pass */
    __auto_type _t277 = (*e);
    if (_t277.tag == HirExpr_ECast) {
        __auto_type inner = _t277.data.ECast.expr;
__auto_type ty = _t277.data.ECast.target_ty;
        /* pass */
        ...
        __auto_type op = _t277.data.EUnaryOp.op;
__auto_type inner = _t277.data.EUnaryOp.expr;
        /* pass */
...
__attribute__((hot)) void add_exposed(HirExpr* e, List_TrStr* gen, List_TrStr* kill) {
    ...
    while ((i < tmp->len)) {
        /* pass */
        if (({ TrStr _at_t280 = (List_TrStr_get(tmp, i)); __auto_type _wr = ((!set_contains(kill, _at_t280))); _tr_str_release(_at_t280); _wr; })) {
            /* pass */
            ({ TrStr _at_t281 = (List_TrStr_get(tmp, i)); set_add(gen, _at_t281); _tr_str_release(_at_t281); });
        }
        /* pass */
        i = (i + 1LL);
    }
...
__attribute__((hot)) void block_succs(MirBlock* blk, List_i64* out) {
    ...
    if (_t284.tag == MirTerm_TGoto) {
        __auto_type n = _t284.data.TGoto.target;
        List_i64_append(out, n);
    } else if (_t284.tag == MirTerm_TBranch) {
        __auto_type t = _t284.data.TBranch.t;
__auto_type e = _t284.data.TBranch.e;
        /* pass */
...
__attribute__((hot)) void collect_moves(HirExpr* e, List_TrStr* out) {
    ...
    if (_t285.tag == HirExpr_EIdent) {
        __auto_type nm = _t285.data.EIdent.name;
__auto_type ismv = _t285.data.EIdent.is_move;
        /* pass */
        if (ismv) {
            /* pass */
            set_add(out, nm);
...
__auto_type r = _t285.data.EBinOp.right;
        ...
        collect_moves(x, out);
    } else if (_t285.tag == HirExpr_ECall) {
...
__auto_type idx = _t285.data.EIndex._tr_v_index;
        ...
        collect_moves(x, out);
    } else if (_t285.tag == HirExpr_EIfElse) {
        __auto_type c = _t285.data.EIfElse.cond;
__auto_type t = _t285.data.EIfElse.then_e;
__auto_type f = _t285.data.EIfElse.else_e;
        /* pass */
        collect_moves(c, out);
        /* pass */
        collect_moves(t, out);
...
__attribute__((hot)) TrStr free_target(HirExpr* arg) {
    ...
    /* pass */
    __auto_type _t286 = (*arg);
    if (_t286.tag == HirExpr_EIdent) {
        __auto_type n = _t286.data.EIdent.name;
...
__auto_type args = _t287.data.ECall.args;
        ...
        if ((((unsigned long long)(callee)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t288 = (*callee);
            if (_t288.tag == HirExpr_EIdent) {
                __auto_type cn = _t288.data.EIdent.name;
                /* pass */
...
__attribute__((hot)) void block_gen_own(MirBlock* blk, List_TrStr* out) {
    ...
    while ((i < blk->stmts->len)) {
        ...
        if (_t290.tag == MirStmt_MDeclare) {
            __auto_type p = _t290.data.MDeclare.place;
            set_add(out, p);
        } else if (_t290.tag == MirStmt_MAssign) {
            __auto_type p = _t290.data.MAssign.place;
            set_add(out, p);
        } else if (_t290.tag == MirStmt_MEval) {
            __auto_type _ = _t290.data.MEval.value;
            /* pass */
        }
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) void block_moves(MirBlock* blk, List_TrStr* out) {
    ...
    /* pass */
    __auto_type _t292 = (*blk->term);
    if (_t292.tag == MirTerm_TBranch) {
        __auto_type cond = _t292.data.TBranch.cond;
        collect_moves(cond, out);
    } else if (_t292.tag == MirTerm_TReturn) {
        __auto_type val = _t292.data.TReturn.value;
        /* pass */
        collect_moves(val, out);
        /* pass */
        if ((((unsigned long long)(val)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t293 = (*val);
            if (_t293.tag == HirExpr_EIdent) {
                __auto_type rnm = _t293.data.EIdent.name;
                set_add(out, rnm);
            } else if (1) {
                __auto_type _ = _t293;
                /* pass */
...
__attribute__((hot)) List_ptr* compute_drops(MirFunction* mf, List_ptr* live_out) {
    ...
    while (changed) {
        ...
        while ((b < n)) {
            ...
            if ((preds->len > 0LL)) {
                /* pass */
                LiveSet* _cltmp_t294 = LiveSet_clone(((LiveSet*)List_ptr_get(own_out, List_i64_get(preds, 0LL))));
    ...
    while ((i < n)) {
        ...
        if ((preds2->len > 0LL)) {
            /* pass */
            LiveSet* _cltmp_t295 = LiveSet_clone(((LiveSet*)List_ptr_get(own_out, List_i64_get(preds2, 0LL))));
...
__attribute__((hot)) long long last_use_in_block(MirBlock* blk, TrStr name) {
    ...
    while ((si < blk->stmts->len)) {
        ...
        List_TrStr* tmp = (void*)List_TrStr_new();
        /* pass */
        __auto_type _t296 = (*((MirStmt*)List_ptr_get(blk->stmts, si)));
...
__attribute__((hot)) DropSite* site_for(List_ptr* out, HirBlock* hb) {
    ...
    /* pass */
    HirBlock* _cltmp_t298 = _tr_obj_retain(hb);
    _tr_obj_release(s->hir_block, _trdrop_HirBlock);
    s->hir_block = _cltmp_t298;
    /* pass */
                ...
                while ((si < blk->stmts->len)) {
                    ...
                    if ((!is_creation)) {
                        ...
                        if (_t300.tag == MirStmt_MDeclare) {
                            ...
                            __auto_type ap = _t300.data.MAssign.place;
    ...
    while ((k < mf->borrows->len)) {
        ...
        while ((bn < mf->blocks->len)) {
            ...
            while ((si < blk->stmts->len)) {
                ...
                /* pass */
                __auto_type _t303 = (*stmt);
                if (_t303.tag == MirStmt_MAssign) {
                    __auto_type wp = _t303.data.MAssign.place;
__auto_type wv = _t303.data.MAssign.value;
                    /* pass */
                    sval = wv;
                    /* pass */
                    if ((strcmp(_tr_strz(wp), _tr_strz(be->source)) == 0)) {
                        /* pass */
                        TrStr _strtmp_t304 = _tr_str_lit("assign to");
                        _tr_str_release(invalid_desc);
                        invalid_desc = _strtmp_t304;
                    }
                } else if (_t303.tag == MirStmt_MDeclare) {
                    __auto_type dv = _t303.data.MDeclare.value;
                    sval = dv;
                } else if (_t303.tag == MirStmt_MEval) {
                    __auto_type ev = _t303.data.MEval.value;
                    sval = ev;
                }
                /* pass */
                if (((strcmp(_tr_strz(invalid_desc), _tr_strz(_tr_str_lit(""))) == 0) && _is_mutating_call_on(sval, be->source, mutating_methods))) {
                    /* pass */
                    TrStr _strtmp_t305 = _tr_str_lit("call a mutating method on");
                    _tr_str_release(invalid_desc);
                ...
                if ((strcmp(_tr_strz(invalid_desc), _tr_strz(_tr_str_lit(""))) != 0)) {
                    ...
                    if (borrower_live_after(blk, si, be->borrower, lo)) {
                        /* pass */
                        ({ TrStr _at_t306 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cannot ")), _tr_strz(invalid_desc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" '"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(be->source)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' while it is borrowed by '"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(be->borrower)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' — the borrow is still live"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(out, _at_t306); _tr_str_release(_at_t306); });
                    }
                    ...
                    if (_t307.tag == MirStmt_MDeclare) {
                        __auto_type dn = _t307.data.MDeclare.place;
                        /* pass */
            ...
            while ((j < mf->borrows->len)) {
                ...
                if ((((bj->decl_block == bi->decl_block) && (strcmp(_tr_strz(bi->source), _tr_strz(bj->source)) == 0)) && (bi->is_exclusive || bj->is_exclusive))) {
                    ...
                    while ((bk < blk->stmts->len)) {
                        /* pass */
                        __auto_type _t310 = (*((MirStmt*)List_ptr_get(blk->stmts, bk)));
                        if (_t310.tag == MirStmt_MDeclare) {
                            __auto_type dn = _t310.data.MDeclare.place;
                            /* pass */
    ...
    while ((sk < shps->len)) {
        ...
        while ((bn < mf->blocks->len)) {
            ...
            while ((si < blk->stmts->len)) {
                ...
                if (_t313.tag == MirStmt_MAssign) {
                    __auto_type wp = _t313.data.MAssign.place;
__auto_type wv = _t313.data.MAssign.value;
                    /* pass */
                    sval = wv;
                    /* pass */
                    if ((strcmp(_tr_strz(wp), _tr_strz(pn)) == 0)) {
                        /* pass */
                        TrStr _strtmp_t314 = _tr_str_lit("reassign");
                        _tr_str_release(desc);
                        desc = _strtmp_t314;
                    }
                } else if (_t313.tag == MirStmt_MDeclare) {
                    __auto_type dv = _t313.data.MDeclare.value;
                    sval = dv;
                } else if (_t313.tag == MirStmt_MEval) {
                    __auto_type ev = _t313.data.MEval.value;
                    sval = ev;
                }
                /* pass */
                if (((strcmp(_tr_strz(desc), _tr_strz(_tr_str_lit(""))) == 0) && _is_mutating_call_on(sval, pn, mutating_methods))) {
                    /* pass */
                    TrStr _strtmp_t315 = _tr_str_lit("call a mutating method on");
                    _tr_str_release(desc);
                    desc = _strtmp_t315;
                }
                /* pass */
                if ((strcmp(_tr_strz(desc), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    ({ TrStr _at_t316 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cannot ")), _tr_strz(desc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" '"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' — it is a SHARED `ref` parameter (read-only)"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(out, _at_t316); _tr_str_release(_at_t316); });
                }
                /* pass */
                si = (si + 1LL);
                _tr_str_release(desc);
    ...
    while ((bi < mf->blocks->len)) {
        ...
        if (((((unsigned long long)(blk->hir_block)) != ((unsigned long long)(0LL))) && is_if_body(mf, blk->hir_block))) {
            ...
            while ((pi < dd->items->len)) {
                ...
                /* pass */
                ({ TrStr _at_t317 = (List_TrStr_get(dd->items, pi)); set_add(site->places, _at_t317); _tr_str_release(_at_t317); });
                /* pass */
                pi = (pi + 1LL);
            }
        }
...
__attribute__((hot)) TrStr set_str(List_TrStr* v) {
    ...
    while ((i < v->len)) {
        ...
        /* pass */
        TrStr _strtmp_t319 = ({ TrStr _cr = (List_TrStr_get(v, i)); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(s);
        s = _strtmp_t319;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) TrStr term_str(MirTerm* t) {
    /* pass */
    __auto_type _t320 = (*t);
    if (_t320.tag == MirTerm_TGoto) {
        __auto_type n = _t320.data.TGoto.target;
    ...
    } else if (_t320.tag == MirTerm_TBranch) {
        __auto_type tt = _t320.data.TBranch.t;
__auto_type ee = _t320.data.TBranch.e;
    ...
    } else if (_t320.tag == MirTerm_TReturn) {
        __auto_type _ = _t320.data.TReturn.value;
        return _tr_str_lit("return <expr>");
    } else if (_t320.tag == MirTerm_TReturnVoid) {
        return _tr_str_lit("return");
    } else if (_t320.tag == MirTerm_TUnset) {
...
__attribute__((hot)) TrStr stmt_str(MirStmt* s) {
    /* pass */
    __auto_type _t321 = (*s);
    if (_t321.tag == MirStmt_MDeclare) {
        __auto_type p = _t321.data.MDeclare.place;
    ...
    } else if (_t321.tag == MirStmt_MAssign) {
        __auto_type p = _t321.data.MAssign.place;
        return _tr_strx_concat(_tr_strz(p), _tr_strz(_tr_str_lit(" = <expr>")));
    } else if (_t321.tag == MirStmt_MEval) {
        __auto_type _ = _t321.data.MEval.value;
...
__attribute__((hot)) TrStr dump_mir(MirProgram* mp) {
    ...
    while ((fi < mp->functions->len)) {
        ...
        if ((!f->complete)) {
            /* pass */
            TrStr _strtmp_t322 = _tr_str_lit(" [INCOMPLETE - falls back to HIR]");
            _tr_str_release(tag);
            tag = _strtmp_t322;
        }
        /* pass */
        TrStr _strtmp_t323 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("fn ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(f->params->len)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" params), "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(f->blocks->len)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" blocks"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tag)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(out);
        out = _strtmp_t323;
        /* pass */
        ...
        while ((bi < f->blocks->len)) {
            ...
            /* pass */
            TrStr _strtmp_t326 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("  bb")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(blk->id)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(out);
            out = _strtmp_t326;
            /* pass */
            long long si = 0LL;
            ...
            while ((si < blk->stmts->len)) {
                /* pass */
                TrStr _strtmp_t327 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("    ")))); TrStr _cr = (stmt_str(((MirStmt*)List_ptr_get(blk->stmts, si)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
                _tr_str_release(out);
                out = _strtmp_t327;
                /* pass */
                si = (si + 1LL);
            ...
            /* pass */
            TrStr _strtmp_t328 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("    ")))); TrStr _cr = (term_str(blk->term)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(out);
            out = _strtmp_t328;
            /* pass */
            TrStr _strtmp_t329 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("    ; live_out ")))); TrStr _cr = (set_str(((LiveSet*)List_ptr_get(live, blk->id))->items)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(out);
            out = _strtmp_t329;
            /* pass */
            TrStr _strtmp_t330 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("    ; drop ")))); TrStr _cr = (set_str(((LiveSet*)List_ptr_get(drops, blk->id))->items)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(out);
            out = _strtmp_t330;
            /* pass */
            bi = (bi + 1LL);
