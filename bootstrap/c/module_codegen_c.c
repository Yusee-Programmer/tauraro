...
__attribute__((hot)) void CGenerator_gen_func_body(CGenerator* self, HirBlock* body, long long indent) {
    ...
    if ((self->defer_stack->len > 0LL)) {
        ...
        if ((body->stmts->len > 0LL)) {
            /* pass */
            __auto_type _t177 = (*((HirStmt*)List_ptr_get(body->stmts, (body->stmts->len - 1LL))));
            if (_t177.tag == HirStmt_SReturn) {
...
__attribute__((hot)) char* CGenerator_get_user_decorator_attr(CGenerator* self, char* name) {
    ...
    if ((df->body->stmts->len == 1LL)) {
        /* pass */
        __auto_type _t178 = (*((HirStmt*)List_ptr_get(df->body->stmts, 0LL)));
        if (_t178.tag == HirStmt_SReturn) {
            __auto_type rv = _t178.data.SReturn.val;
            /* pass */
            if ((((unsigned long long)(rv)) != ((unsigned long long)(0LL)))) {
                /* pass */
                __auto_type _t179 = (*rv);
                if (_t179.tag == HirExpr_ELitStr) {
                    __auto_type attr_s = _t179.data.ELitStr.val;
                    /* pass */
...
__attribute__((hot)) char* CGenerator_gen_expr(CGenerator* self, HirExpr* e_ptr) {
    ...
    /* pass */
    __auto_type _t180 = e;
    if (_t180.tag == HirExpr_ELitInt) {
        __auto_type v = _t180.data.ELitInt.val;
        return _tr_str_concat(_tr_int_to_str((long long)(v)), "LL");
    } else if (_t180.tag == HirExpr_ELitFloat) {
        __auto_type v = _t180.data.ELitFloat.val;
        return _tr_float_to_c_lit(v);
    } else if (_t180.tag == HirExpr_ELitStr) {
        __auto_type v = _t180.data.ELitStr.val;
        return _tr_str_concat(_tr_str_concat("\"", _escape_str_for_c(v)), "\"");
    } else if (_t180.tag == HirExpr_ERawStr) {
        __auto_type v = _t180.data.ERawStr.val;
        return _tr_str_concat(_tr_str_concat("\"", _escape_str_for_c(v)), "\"");
    } else if (_t180.tag == HirExpr_ELitBytes) {
        __auto_type v = _t180.data.ELitBytes.val;
        return _tr_str_concat(_tr_str_concat("\"", _escape_str_for_c(v)), "\"");
    } else if (_t180.tag == HirExpr_ELitChar) {
        __auto_type v = _t180.data.ELitChar.val;
        /* pass */
        if ((v == 0LL)) {
            /* pass */
            return "'\\0'";
    ...
    } else if (_t180.tag == HirExpr_ELitBool) {
        __auto_type v = _t180.data.ELitBool.val;
        /* pass */
        if (v) {
            /* pass */
            return "true";
    ...
    } else if (_t180.tag == HirExpr_ELitNone) {
        __auto_type _ = _t180.data.ELitNone.ty;
        return "NULL";
    } else if (_t180.tag == HirExpr_EIdent) {
        __auto_type n = _t180.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        return n;
    } else if (_t180.tag == HirExpr_EBinOp) {
        __auto_type op = _t180.data.EBinOp.op;
__auto_type l = _t180.data.EBinOp.left;
__auto_type r = _t180.data.EBinOp.right;
        return CGenerator_gen_binop(self, op, l, r);
    } else if (_t180.tag == HirExpr_EUnaryOp) {
        __auto_type op = _t180.data.EUnaryOp.op;
__auto_type expr = _t180.data.EUnaryOp.expr;
        return CGenerator_gen_unary(self, op, expr);
    } else if (_t180.tag == HirExpr_ECall) {
        __auto_type callee = _t180.data.ECall.callee;
__auto_type args = _t180.data.ECall.args;
__auto_type call_ty = _t180.data.ECall.ty;
        return CGenerator_gen_call(self, callee, args, call_ty);
    } else if (_t180.tag == HirExpr_EMethodCall) {
        __auto_type o = _t180.data.EMethodCall.obj;
__auto_type m = _t180.data.EMethodCall.method;
__auto_type a = _t180.data.EMethodCall.args;
__auto_type ty = _t180.data.EMethodCall.ty;
        return CGenerator_gen_method_call(self, o, m, a, ty);
    } else if (_t180.tag == HirExpr_EPropAccess) {
        __auto_type o = _t180.data.EPropAccess.obj;
__auto_type p = _t180.data.EPropAccess.prop;
        return CGenerator_gen_prop_access(self, o, p);
    } else if (_t180.tag == HirExpr_EIndex) {
        __auto_type o = _t180.data.EIndex.obj;
__auto_type idx = _t180.data.EIndex.index;
        return CGenerator_gen_index(self, o, idx);
    } else if (_t180.tag == HirExpr_ESizeOf) {
        __auto_type target_ty = _t180.data.ESizeOf.target_ty;
        /* pass */
    ...
    } else if (_t180.tag == HirExpr_ECast) {
        __auto_type expr = _t180.data.ECast.expr;
__auto_type target_ty = _t180.data.ECast.target_ty;
        /* pass */
    ...
    } else if (_t180.tag == HirExpr_EFString) {
        __auto_type parts = _t180.data.EFString.parts;
        return CGenerator_gen_fstring(self, parts);
    } else if (_t180.tag == HirExpr_ETryExpr) {
        __auto_type expr = _t180.data.ETryExpr.expr;
__auto_type ok_ty = _t180.data.ETryExpr.ty;
        /* pass */
    ...
    } else if (_t180.tag == HirExpr_ETuple) {
        __auto_type items = _t180.data.ETuple.items;
        return CGenerator_gen_tuple(self, items);
    } else if (_t180.tag == HirExpr_EList) {
        __auto_type items = _t180.data.EList.items;
__auto_type ty = _t180.data.EList.ty;
        return CGenerator_gen_list_literal(self, items, ty);
    } else if (_t180.tag == HirExpr_EDict) {
        __auto_type keys = _t180.data.EDict.keys;
__auto_type vals = _t180.data.EDict.vals;
__auto_type dict_ty = _t180.data.EDict.ty;
        return CGenerator_gen_dict_literal(self, keys, vals, dict_ty);
    } else if (_t180.tag == HirExpr_EClosure) {
        __auto_type params = _t180.data.EClosure.params;
__auto_type ret_ty = _t180.data.EClosure.ret_ty;
__auto_type body = _t180.data.EClosure.body;
__auto_type captures = _t180.data.EClosure.captures;
        /* pass */
        return CGenerator_gen_closure(self, params, ret_ty, body, captures);
    } else if (_t180.tag == HirExpr_ERange) {
        __auto_type start = _t180.data.ERange.start;
__auto_type end = _t180.data.ERange.end;
__auto_type inclusive = _t180.data.ERange.inclusive;
        /* pass */
        return CGenerator_gen_expr(self, start);
    } else if (_t180.tag == HirExpr_ESuperMethodCall) {
        __auto_type base = _t180.data.ESuperMethodCall.base_class;
__auto_type method = _t180.data.ESuperMethodCall.method;
__auto_type args = _t180.data.ESuperMethodCall.args;
        /* pass */
    ...
    } else if (_t180.tag == HirExpr_ESuperPropAccess) {
        __auto_type base = _t180.data.ESuperPropAccess.base_class;
__auto_type prop = _t180.data.ESuperPropAccess.prop;
        /* pass */
        return _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat("(((", base), "*)self)->"), prop), ")");
    } else if (_t180.tag == HirExpr_EAwait) {
        __auto_type expr = _t180.data.EAwait.expr;
        /* pass */
        return CGenerator_gen_await_call(self, expr);
    } else if (_t180.tag == HirExpr_EAwaitTimeout) {
        __auto_type at_expr = _t180.data.EAwaitTimeout.expr;
__auto_type at_ms = _t180.data.EAwaitTimeout.timeout_ms;
        /* pass */
        return CGenerator_gen_await_timeout_call(self, at_expr, at_ms);
    } else if (_t180.tag == HirExpr_EYield) {
        __auto_type expr = _t180.data.EYield.expr;
        /* pass */
        return CGenerator_gen_expr(self, expr);
    } else if (_t180.tag == HirExpr_ESet) {
        __auto_type items = _t180.data.ESet.items;
        /* pass */
    ...
    } else if (_t180.tag == HirExpr_EListComp) {
        __auto_type element = _t180.data.EListComp.element;
__auto_type generators = _t180.data.EListComp.generators;
        /* pass */
        return CGenerator_gen_list_comp(self, element, generators);
    } else if (_t180.tag == HirExpr_EGeneratorExpr) {
        __auto_type element = _t180.data.EGeneratorExpr.element;
__auto_type generators = _t180.data.EGeneratorExpr.generators;
        /* pass */
        return CGenerator_gen_list_comp(self, element, generators);
    } else if (_t180.tag == HirExpr_ESlice) {
        __auto_type start = _t180.data.ESlice.start;
__auto_type stop = _t180.data.ESlice.stop;
__auto_type step = _t180.data.ESlice.step;
        /* pass */
        ...
        /* pass */
        return "0LL";
    } else if (_t180.tag == HirExpr_EIfElse) {
        __auto_type cond = _t180.data.EIfElse.cond;
__auto_type then_e = _t180.data.EIfElse.then_e;
__auto_type else_e = _t180.data.EIfElse.else_e;
__auto_type ty = _t180.data.EIfElse.ty;
        /* pass */
...
__attribute__((hot)) char* CGenerator_gen_call(CGenerator* self, HirExpr* callee, List_ptr* args, AstType* call_ty) {
    ...
    /* pass */
    __auto_type _t181 = (*callee);
    if (_t181.tag == HirExpr_EPropAccess) {
        __auto_type inner_obj = _t181.data.EPropAccess.obj;
__auto_type variant = _t181.data.EPropAccess.prop;
        /* pass */
        if (((strcmp((char*)variant, (char*)"init") == 0) || (strcmp((char*)variant, (char*)"new") == 0))) {
            /* pass */
            __auto_type _t182 = (*inner_obj);
            if (_t182.tag == HirExpr_EIndex) {
                __auto_type base_expr = _t182.data.EIndex.obj;
__auto_type idx_expr = _t182.data.EIndex.index;
                /* pass */
                __auto_type _t183 = (*base_expr);
                if (_t183.tag == HirExpr_EIdent) {
                    __auto_type gn = _t183.data.EIdent.name;
                    /* pass */
                    if (((strcmp((char*)gn, (char*)"Vec") == 0) || (strcmp((char*)gn, (char*)"List") == 0))) {
                        /* pass */
                        __auto_type _t184 = (*idx_expr);
                        if (_t184.tag == HirExpr_EIdent) {
                            __auto_type elem_n = _t184.data.EIdent.name;
                            /* pass */
    ...
    /* pass */
    __auto_type _t185 = (*callee);
    if (_t185.tag == HirExpr_EIdent) {
        __auto_type raw_n = _t185.data.EIdent.name;
        /* pass */
        base_callee = raw_n;
    } else if (_t185.tag == HirExpr_EIndex) {
        __auto_type base_expr = _t185.data.EIndex.obj;
__auto_type idx_expr = _t185.data.EIndex.index;
__auto_type idx_ty = _t185.data.EIndex.ty;
        /* pass */
        __auto_type _t186 = (*base_expr);
        if (_t186.tag == HirExpr_EIdent) {
            __auto_type n = _t186.data.EIdent.name;
            /* pass */
            if (((((((((strcmp((char*)n, (char*)"alloc") == 0) || (strcmp((char*)n, (char*)"core_alloc_alloc") == 0)) || (strcmp((char*)n, (char*)"dealloc") == 0)) || (strcmp((char*)n, (char*)"Pointer") == 0)) || (strcmp((char*)n, (char*)"resize") == 0)) || (strcmp((char*)n, (char*)"core_alloc_resize") == 0)) || (strcmp((char*)n, (char*)"copy") == 0)) || (strcmp((char*)n, (char*)"core_alloc_copy") == 0))) {
                ...
                has_generic = true;
                /* pass */
                __auto_type _t187 = (*idx_expr);
                if (_t187.tag == HirExpr_EIdent) {
                    __auto_type tname = _t187.data.EIdent.name;
                    /* pass */
    ...
    if ((strcmp((char*)base_callee, (char*)"await_all") == 0)) {
        ...
        while ((aa_i < args->len)) {
            ...
            char* aa_fn = "";
            /* pass */
            List_ptr* aa_call_args = ({ List_ptr* _l__t188 = List_ptr_new(); _l__t188; });
            /* pass */
            __auto_type _t189 = (*((HirExpr*)List_ptr_get(args, aa_i)));
            if (_t189.tag == HirExpr_ECall) {
                __auto_type aa_c = _t189.data.ECall.callee;
__auto_type aa_a = _t189.data.ECall.args;
                /* pass */
                __auto_type _t190 = (*aa_c);
                if (_t190.tag == HirExpr_EIdent) {
                    __auto_type aa_n = _t190.data.EIdent.name;
                    aa_fn = aa_n;
                } else if (1) {
                    __auto_type _ = _t190;
                    /* pass */
    ...
    if (((strcmp((char*)base_callee, (char*)"alloc") == 0) || (strcmp((char*)base_callee, (char*)"core_alloc_alloc") == 0))) {
        ...
        if ((has_generic && (strcmp((char*)generic_ty->name, (char*)"void") != 0))) {
            ...
            /* pass */
            __auto_type _t191 = (*callee);
            if (_t191.tag == HirExpr_EIdent) {
                __auto_type ident_ty = _t191.data.EIdent.ty;
                /* pass */
    ...
    if ((strcmp((char*)base_callee, (char*)"Pointer") == 0)) {
        ...
        if ((args->len > 0LL)) {
            ...
            /* pass */
            __auto_type _t192 = (*callee);
            if (_t192.tag == HirExpr_EIdent) {
                __auto_type ident_ty = _t192.data.EIdent.ty;
                /* pass */
                if ((ident_ty->args->len > 0LL)) {
                    /* pass */
    ...
    /* pass */
    __auto_type _t193 = (*callee);
    if (_t193.tag == HirExpr_EIdent) {
        __auto_type n = _t193.data.EIdent.name;
__auto_type ident_ty = _t193.data.EIdent.ty;
        /* pass */
    ...
    } else if (_t193.tag == HirExpr_EPropAccess) {
        __auto_type obj_inner = _t193.data.EPropAccess.obj;
__auto_type variant = _t193.data.EPropAccess.prop;
        /* pass */
        char* oi_ctor_name = "";
        /* pass */
        __auto_type _t194 = (*obj_inner);
        if (_t194.tag == HirExpr_EIdent) {
            __auto_type oin = _t194.data.EIdent.name;
            oi_ctor_name = oin;
        } else if (1) {
            __auto_type _ = _t194;
            /* pass */
        ...
        if ((strcmp((char*)oi_ctor_name, (char*)"Thread") == 0)) {
            ...
            if (((strcmp((char*)variant, (char*)"spawn") == 0) || (strcmp((char*)variant, (char*)"new") == 0))) {
                ...
                if ((args->len >= 2LL)) {
                    ...
                    char* th2_fn_nm = "";
                    /* pass */
                    __auto_type _t195 = (*((HirExpr*)List_ptr_get(args, 0LL)));
                    if (_t195.tag == HirExpr_EIdent) {
                        __auto_type thn3 = _t195.data.EIdent.name;
                        th2_fn_nm = thn3;
                    } else if (1) {
                        __auto_type _ = _t195;
                        /* pass */
                    ...
                    char* th2_fn_nm2 = "";
                    /* pass */
                    __auto_type _t196 = (*((HirExpr*)List_ptr_get(args, 0LL)));
                    if (_t196.tag == HirExpr_EIdent) {
                        __auto_type thn4 = _t196.data.EIdent.name;
                        th2_fn_nm2 = thn4;
                    } else if (1) {
                        __auto_type _ = _t196;
                        /* pass */
    ...
    /* pass */
    if (((strcmp((char*)callee_ty_n, (char*)"lambda") == 0) || (strcmp((char*)callee_ty_n, (char*)"void*") == 0))) {
        /* pass */
    ...
    if ((_tr_dict_contains(self->classes, callee_cls_ty) && CGenerator_has_method(self, callee_cls_ty, "__call__"))) {
        ...
        if (_t197.tag == HirExpr_EIdent) {
            __auto_type cname = _t197.data.EIdent.name;
            /* pass */
...
__attribute__((hot)) char* CGenerator_gen_method_call(CGenerator* self, HirExpr* obj, char* method, List_ptr* args, AstType* call_ty) {
    ...
    if (((strcmp((char*)t_n, (char*)"void") == 0) || (strcmp((char*)t_n, (char*)"") == 0))) {
        /* pass */
        __auto_type _t198 = (*obj);
        if (_t198.tag == HirExpr_EPropAccess) {
            __auto_type inner_obj_fb = _t198.data.EPropAccess.obj;
__auto_type field_name_fb = _t198.data.EPropAccess.prop;
            /* pass */
        ...
        if ((strcmp((char*)method, (char*)"spawn") == 0)) {
            ...
            if ((args->len >= 2LL)) {
                ...
                if (_t199.tag == HirExpr_EIdent) {
                    __auto_type tpn = _t199.data.EIdent.name;
                    tp_fn_nm = tpn;
                } else if (1) {
                    __auto_type _ = _t199;
                    /* pass */
                ...
                char* tp_fn2_nm = "";
                /* pass */
                __auto_type _t200 = (*((HirExpr*)List_ptr_get(args, 0LL)));
                if (_t200.tag == HirExpr_EIdent) {
                    __auto_type tpn2 = _t200.data.EIdent.name;
                    tp_fn2_nm = tpn2;
                } else if (1) {
                    __auto_type _ = _t200;
                    /* pass */
    ...
    if (((strcmp((char*)t_n, (char*)"Thread") == 0) || (strcmp((char*)obj_s, (char*)"Thread") == 0))) {
        ...
        if ((strcmp((char*)method, (char*)"spawn") == 0)) {
            ...
            if ((args->len >= 3LL)) {
                ...
                char* th_ma_fn = "";
                /* pass */
                __auto_type _t201 = (*((HirExpr*)List_ptr_get(args, 0LL)));
                if (_t201.tag == HirExpr_EIdent) {
                    __auto_type thn_ma = _t201.data.EIdent.name;
                    th_ma_fn = thn_ma;
                } else if (1) {
                    __auto_type _ = _t201;
                    /* pass */
                ...
                char* th_fn_nm = "";
                /* pass */
                __auto_type _t202 = (*((HirExpr*)List_ptr_get(args, 0LL)));
                if (_t202.tag == HirExpr_EIdent) {
                    __auto_type thn = _t202.data.EIdent.name;
                    th_fn_nm = thn;
                } else if (1) {
                    __auto_type _ = _t202;
                    /* pass */
                ...
                if (_t203.tag == HirExpr_EIdent) {
                    __auto_type thn2 = _t203.data.EIdent.name;
                    th_fn_nm2 = thn2;
                } else if (1) {
                    __auto_type _ = _t203;
                    /* pass */
    ...
    if (((((_tr_dict_contains(self->classes, class_name) && (strcmp((char*)class_name, (char*)"Vec") != 0)) && (strcmp((char*)class_name, (char*)"Map") != 0)) && (strcmp((char*)class_name, (char*)"Dict") != 0)) && (strcmp((char*)class_name, (char*)"List") != 0))) {
        ...
        if ((ucls->generics->len > 0LL)) {
            ...
            /* pass */
            __auto_type _t204 = (*obj);
            if (_t204.tag == HirExpr_EPropAccess) {
                __auto_type inner_obj2 = _t204.data.EPropAccess.obj;
__auto_type fld_name2 = _t204.data.EPropAccess.prop;
                /* pass */
    ...
    char* elem_sfx = "ptr";
    /* pass */
    __auto_type _t205 = (*obj);
    if (_t205.tag == HirExpr_EIdent) {
        __auto_type ity = _t205.data.EIdent.ty;
        /* pass */
        if ((ity->args->len > 0LL)) {
            /* pass */
    ...
    } else if (_t205.tag == HirExpr_EMethodCall) {
        __auto_type mty = _t205.data.EMethodCall.ty;
        /* pass */
        if ((mty->args->len > 0LL)) {
            /* pass */
            elem_sfx = CGenerator_list_elem_suffix(self, (*((AstType**)List_ptr_get(mty->args, 0LL)))->name);
        }
    } else if (_t205.tag == HirExpr_ECall) {
        __auto_type cty = _t205.data.ECall.ty;
        /* pass */
        if ((cty->args->len > 0LL)) {
            /* pass */
            elem_sfx = CGenerator_list_elem_suffix(self, (*((AstType**)List_ptr_get(cty->args, 0LL)))->name);
        }
    } else if (_t205.tag == HirExpr_EPropAccess) {
        __auto_type pty = _t205.data.EPropAccess.ty;
        /* pass */
        if ((pty->args->len > 0LL)) {
            /* pass */
...
__attribute__((hot)) char* CGenerator_gen_await_call(CGenerator* self, HirExpr* expr) {
    ...
    /* pass */
    __auto_type _t206 = (*expr);
    if (_t206.tag == HirExpr_ECall) {
        __auto_type callee = _t206.data.ECall.callee;
__auto_type args = _t206.data.ECall.args;
__auto_type call_ty = _t206.data.ECall.ty;
        /* pass */
        char* fn_name = "";
        /* pass */
        __auto_type _t207 = (*callee);
        if (_t207.tag == HirExpr_EIdent) {
            __auto_type n = _t207.data.EIdent.name;
            fn_name = n;
        } else if (1) {
            __auto_type _ = _t207;
            /* pass */
...
__attribute__((hot)) char* CGenerator_gen_await_timeout_call(CGenerator* self, HirExpr* expr, HirExpr* ms_expr) {
    ...
    /* pass */
    __auto_type _t208 = (*expr);
    if (_t208.tag == HirExpr_ECall) {
        __auto_type callee = _t208.data.ECall.callee;
__auto_type args = _t208.data.ECall.args;
__auto_type call_ty = _t208.data.ECall.ty;
        /* pass */
        char* fn_name = "";
        /* pass */
        __auto_type _t209 = (*callee);
        if (_t209.tag == HirExpr_EIdent) {
            __auto_type n = _t209.data.EIdent.name;
            fn_name = n;
        } else if (1) {
            __auto_type _ = _t209;
            /* pass */
...
__auto_type ew_ret_ty = _t210.data.ECall.ty;
        /* pass */
        char* fn_name = "";
        /* pass */
...
__attribute__((hot)) void CGenerator_prescan_stmt_spawns(CGenerator* self, HirStmt* s) {
    ...
    /* pass */
    __auto_type _t212 = (*s);
    if (_t212.tag == HirStmt_SSpawn) {
        __auto_type e = _t212.data.SSpawn.expr;
        /* pass */
        CGenerator_emit_spawn_wrapper_for_expr(self, e);
    } else if (_t212.tag == HirStmt_STaskGroup) {
        __auto_type body = _t212.data.STaskGroup.body;
        /* pass */
        CGenerator_prescan_block_spawns(self, body);
    } else if (_t212.tag == HirStmt_SIf) {
        __auto_type t = _t212.data.SIf.then_b;
__auto_type e = _t212.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t212.tag == HirStmt_SWhile) {
        __auto_type body = _t212.data.SWhile.body;
        /* pass */
        CGenerator_prescan_block_spawns(self, body);
    } else if (_t212.tag == HirStmt_SFor) {
        __auto_type body = _t212.data.SFor.body;
        /* pass */
        CGenerator_prescan_block_spawns(self, body);
    } else if (_t212.tag == HirStmt_SForUnpack) {
        __auto_type body = _t212.data.SForUnpack.body;
        /* pass */
        CGenerator_prescan_block_spawns(self, body);
    } else if (_t212.tag == HirStmt_STry) {
        __auto_type tb = _t212.data.STry.try_body;
__auto_type catches = _t212.data.STry.catches;
__auto_type fin = _t212.data.STry.finally_b;
        /* pass */
    ...
    } else if (_t212.tag == HirStmt_SExpr) {
        __auto_type se = _t212.data.SExpr.expr;
        /* pass */
        CGenerator_prescan_await_all_in_expr(self, se);
    } else if (_t212.tag == HirStmt_SLet) {
        __auto_type se_v = _t212.data.SLet.val;
        /* pass */
        CGenerator_prescan_await_all_in_expr(self, se_v);
    } else if (_t212.tag == HirStmt_SReturn) {
        __auto_type se_r = _t212.data.SReturn.val;
        /* pass */
...
__attribute__((hot)) void CGenerator_prescan_await_all_in_expr(CGenerator* self, HirExpr* e) {
    ...
    /* pass */
    __auto_type _t213 = (*e);
    if (_t213.tag == HirExpr_ECall) {
        __auto_type aa_callee = _t213.data.ECall.callee;
__auto_type aa_args = _t213.data.ECall.args;
        /* pass */
        char* aa_fn_n = "";
        /* pass */
        __auto_type _t214 = (*aa_callee);
        if (_t214.tag == HirExpr_EIdent) {
            __auto_type nn = _t214.data.EIdent.name;
            aa_fn_n = nn;
        } else if (_t214.tag == HirExpr_EPropAccess) {
            __auto_type th_obj2 = _t214.data.EPropAccess.obj;
__auto_type th_var2 = _t214.data.EPropAccess.prop;
            /* pass */
            char* th_ctor2 = "";
            /* pass */
            __auto_type _t215 = (*th_obj2);
            if (_t215.tag == HirExpr_EIdent) {
                __auto_type thn2 = _t215.data.EIdent.name;
                th_ctor2 = thn2;
            } else if (1) {
                __auto_type _ = _t215;
                /* pass */
            ...
            if (((strcmp((char*)th_ctor2, (char*)"Thread") == 0) && ((strcmp((char*)th_var2, (char*)"spawn") == 0) || (strcmp((char*)th_var2, (char*)"new") == 0)))) {
                ...
                if ((aa_args->len >= 1LL)) {
                    ...
                    char* th2_fn_nm = "";
                    /* pass */
                    __auto_type _t216 = (*((HirExpr*)List_ptr_get(aa_args, 0LL)));
                    if (_t216.tag == HirExpr_EIdent) {
                        __auto_type tspn2 = _t216.data.EIdent.name;
                        th2_fn_nm = tspn2;
                    } else if (1) {
                        __auto_type _ = _t216;
                        /* pass */
    ...
    } else if (_t213.tag == HirExpr_EMethodCall) {
        __auto_type pool_obj = _t213.data.EMethodCall.obj;
__auto_type pool_meth = _t213.data.EMethodCall.method;
__auto_type pool_args = _t213.data.EMethodCall.args;
        /* pass */
        if ((strcmp((char*)pool_meth, (char*)"spawn") == 0)) {
            /* pass */
            char* th_ps_nm = "";
            /* pass */
            __auto_type _t217 = (*pool_obj);
            if (_t217.tag == HirExpr_EIdent) {
                __auto_type tpn2 = _t217.data.EIdent.name;
                th_ps_nm = tpn2;
            } else if (1) {
                __auto_type _ = _t217;
                /* pass */
            ...
            if (((strcmp((char*)th_ps_nm, (char*)"Thread") == 0) && (pool_args->len >= 1LL))) {
                ...
                char* th_ps_fn = "";
                /* pass */
                __auto_type _t218 = (*((HirExpr*)List_ptr_get(pool_args, 0LL)));
                if (_t218.tag == HirExpr_EIdent) {
                    __auto_type tpfn = _t218.data.EIdent.name;
                    th_ps_fn = tpfn;
                } else if (1) {
                    __auto_type _ = _t218;
                    /* pass */
        ...
        if (((strcmp((char*)pool_meth, (char*)"spawn") == 0) && (strcmp((char*)hir_expr_type(pool_obj)->name, (char*)"ThreadPool") == 0))) {
            ...
            if ((pool_args->len >= 1LL)) {
                ...
                char* sp_fn_nm = "";
                /* pass */
                __auto_type _t219 = (*((HirExpr*)List_ptr_get(pool_args, 0LL)));
                if (_t219.tag == HirExpr_EIdent) {
                    __auto_type spn = _t219.data.EIdent.name;
                    sp_fn_nm = spn;
                } else if (1) {
                    __auto_type _ = _t219;
                    /* pass */
...
__auto_type call_ty = _t221.data.ECall.ty;
    ...
    } else if (_t220.tag == HirExpr_EAwaitTimeout) {
        __auto_type ato_inner = _t220.data.EAwaitTimeout.expr;
__auto_type ato_ms = _t220.data.EAwaitTimeout.timeout_ms;
        /* pass */
        if ((!_is_invalid_ptr(((unsigned long long)(ato_inner))))) {
            /* pass */
            __auto_type _t223 = (*ato_inner);
            if (_t223.tag == HirExpr_ECall) {
                __auto_type ato_callee = _t223.data.ECall.callee;
__auto_type ato_args = _t223.data.ECall.args;
__auto_type ato_call_ty = _t223.data.ECall.ty;
                /* pass */
                char* ato_fn_nm = "";
                /* pass */
                __auto_type _t224 = (*ato_callee);
                if (_t224.tag == HirExpr_EIdent) {
                    __auto_type nn = _t224.data.EIdent.name;
                    ato_fn_nm = nn;
                } else if (1) {
                    __auto_type _ = _t224;
                    /* pass */
    ...
    } else if (_t220.tag == HirExpr_ECall) {
        __auto_type callee = _t220.data.ECall.callee;
__auto_type args = _t220.data.ECall.args;
        /* pass */
    ...
    } else if (_t220.tag == HirExpr_EBinOp) {
        __auto_type l = _t220.data.EBinOp.left;
__auto_type r = _t220.data.EBinOp.right;
        /* pass */
        CGenerator_prescan_expr_awaits(self, l);
        /* pass */
        CGenerator_prescan_expr_awaits(self, r);
    } else if (_t220.tag == HirExpr_EMethodCall) {
        __auto_type obj = _t220.data.EMethodCall.obj;
__auto_type margs = _t220.data.EMethodCall.args;
        /* pass */
...
__attribute__((hot)) void CGenerator_prescan_stmt_awaits(CGenerator* self, HirStmt* s) {
    ...
    /* pass */
    __auto_type _t225 = (*s);
    if (_t225.tag == HirStmt_SExpr) {
        __auto_type e = _t225.data.SExpr.expr;
        CGenerator_prescan_expr_awaits(self, e);
    } else if (_t225.tag == HirStmt_SLet) {
        __auto_type v = _t225.data.SLet.val;
        CGenerator_prescan_expr_awaits(self, v);
    } else if (_t225.tag == HirStmt_SReturn) {
        __auto_type v = _t225.data.SReturn.val;
        CGenerator_prescan_expr_awaits(self, v);
    } else if (_t225.tag == HirStmt_SIf) {
        __auto_type cond = _t225.data.SIf.cond;
__auto_type t = _t225.data.SIf.then_b;
__auto_type e = _t225.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t225.tag == HirStmt_SWhile) {
        __auto_type cond = _t225.data.SWhile.cond;
__auto_type body = _t225.data.SWhile.body;
        /* pass */
        CGenerator_prescan_expr_awaits(self, cond);
        /* pass */
        CGenerator_prescan_block_awaits(self, body);
    } else if (_t225.tag == HirStmt_SFor) {
        __auto_type iter = _t225.data.SFor.iter;
__auto_type body = _t225.data.SFor.body;
        /* pass */
        CGenerator_prescan_expr_awaits(self, iter);
        /* pass */
        CGenerator_prescan_block_awaits(self, body);
    } else if (_t225.tag == HirStmt_SForUnpack) {
        __auto_type iter = _t225.data.SForUnpack.iter;
__auto_type body = _t225.data.SForUnpack.body;
        /* pass */
        CGenerator_prescan_expr_awaits(self, iter);
        /* pass */
        CGenerator_prescan_block_awaits(self, body);
    } else if (_t225.tag == HirStmt_STry) {
        __auto_type tb = _t225.data.STry.try_body;
__auto_type catches = _t225.data.STry.catches;
__auto_type fin = _t225.data.STry.finally_b;
        /* pass */
    ...
    } else if (_t225.tag == HirStmt_STaskGroup) {
        __auto_type body = _t225.data.STaskGroup.body;
        CGenerator_prescan_block_awaits(self, body);
    } else if (_t225.tag == HirStmt_SMultiLet) {
        __auto_type v = _t225.data.SMultiLet.val;
        CGenerator_prescan_expr_awaits(self, v);
    } else if (_t225.tag == HirStmt_SAssign) {
        __auto_type tgt = _t225.data.SAssign.target;
__auto_type v = _t225.data.SAssign.val;
        /* pass */
...
__attribute__((hot)) void CGenerator_gen_stmt(CGenerator* self, HirStmt* s_ptr, long long indent) {
    ...
    __auto_type pad = _indent_str(indent);
    /* pass */
    __auto_type _t226 = (*s_ptr);
    if (_t226.tag == HirStmt_SExpr) {
        __auto_type e = _t226.data.SExpr.expr;
        /* pass */
        if ((((unsigned long long)(e)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t227 = (*e);
            if (_t227.tag == HirExpr_ETryExpr) {
                __auto_type inner_try = _t227.data.ETryExpr.expr;
                /* pass */
    ...
    } else if (_t226.tag == HirStmt_SDefer) {
        __auto_type inner_defer = _t226.data.SDefer.stmt;
        /* pass */
    ...
    } else if (_t226.tag == HirStmt_SReturn) {
        __auto_type e = _t226.data.SReturn.val;
        /* pass */
        if ((self->defer_stack->len > 0LL)) {
            /* pass */
        ...
        if ((((unsigned long long)(e)) == ((unsigned long long)(0LL)))) {
            ...
            /* pass */
            __auto_type _t228 = (*e);
            if (_t228.tag == HirExpr_ETryExpr) {
                __auto_type inner_try2 = _t228.data.ETryExpr.expr;
__auto_type ok_ty2 = _t228.data.ETryExpr.ty;
                /* pass */
    ...
    } else if (_t226.tag == HirStmt_SLet) {
        __auto_type n = _t226.data.SLet.name;
__auto_type is_const = _t226.data.SLet.is_const;
__auto_type is_shared = _t226.data.SLet.is_shared;
__auto_type ty = _t226.data.SLet.ty;
__auto_type v = _t226.data.SLet.val;
        /* pass */
        ...
        if (((strcmp((char*)c_ty, (char*)"List_ptr*") == 0) && (((unsigned long long)(v)) != ((unsigned long long)(0LL))))) {
            ...
            /* pass */
            __auto_type _t229 = (*v);
            if (_t229.tag == HirExpr_ECall) {
                __auto_type call_ty = _t229.data.ECall.ty;
                /* pass */
            ...
            } else if (_t229.tag == HirExpr_EMethodCall) {
                __auto_type hobj_mc = _t229.data.EMethodCall.obj;
__auto_type _m = _t229.data.EMethodCall.method;
__auto_type iargs = _t229.data.EMethodCall.args;
__auto_type call_ty = _t229.data.EMethodCall.ty;
                /* pass */
                if ((((strcmp((char*)call_ty->name, (char*)"Vec") == 0) || (strcmp((char*)call_ty->name, (char*)"List") == 0)) && (call_ty->args->len > 0LL))) {
                    /* pass */
                    _init_sfx = CGenerator_list_elem_suffix(self, (*((AstType**)List_ptr_get(call_ty->args, 0LL)))->name);
        ...
        if ((((unsigned long long)(v)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t230 = (*v);
            if (_t230.tag == HirExpr_ETryExpr) {
                __auto_type inner_try3 = _t230.data.ETryExpr.expr;
__auto_type ok_ty3 = _t230.data.ETryExpr.ty;
                /* pass */
        ...
        if ((((unsigned long long)(v)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t231 = (*v);
            if (_t231.tag == HirExpr_EClosure) {
                __auto_type cl_params = _t231.data.EClosure.params;
__auto_type cl_ret_ty = _t231.data.EClosure.ret_ty;
__auto_type cl_body = _t231.data.EClosure.body;
__auto_type cl_caps = _t231.data.EClosure.captures;
                /* pass */
                self->closure_count = (self->closure_count + 1LL);
                /* pass */
        ...
        if (is_const) {
            ...
            if ((((unsigned long long)(v)) != ((unsigned long long)(0LL)))) {
                /* pass */
                __auto_type _t232 = (*v);
                if (_t232.tag == HirExpr_EMethodCall) {
                    __auto_type au_obj = _t232.data.EMethodCall.obj;
__auto_type au_method = _t232.data.EMethodCall.method;
                    /* pass */
        ...
        if ((((unsigned long long)(v)) != ((unsigned long long)(0LL)))) {
            ...
            if (is_shared) {
                ...
                if (_t233.tag == HirExpr_EIdent) {
                    __auto_type vn = _t233.data.EIdent.name;
                    /* pass */
                ...
                if ((strcmp((char*)init_s, (char*)"") == 0)) {
                    /* pass */
                    __auto_type _t234 = (*v);
                    if (_t234.tag == HirExpr_EList) {
                        __auto_type items = _t234.data.EList.items;
__auto_type list_ty = _t234.data.EList.ty;
                        /* pass */
                    ...
                    } else if (_t234.tag == HirExpr_EDict) {
                        __auto_type d_keys = _t234.data.EDict.keys;
__auto_type d_vals = _t234.data.EDict.vals;
__auto_type d_ty = _t234.data.EDict.ty;
                        /* pass */
        ...
        /* pass */
        _tr_dict_set(self->decl_vars, n, true);
    } else if (_t226.tag == HirStmt_SAssign) {
        __auto_type t = _t226.data.SAssign.target;
__auto_type v = _t226.data.SAssign.val;
        /* pass */
        __auto_type _t235 = (*t);
        if (_t235.tag == HirExpr_EIdent) {
            __auto_type n = _t235.data.EIdent.name;
            /* pass */
            if ((!_tr_dict_contains(self->decl_vars, n))) {
                /* pass */
        ...
        } else if (_t235.tag == HirExpr_EIndex) {
            __auto_type idx_obj = _t235.data.EIndex.obj;
__auto_type idx_key = _t235.data.EIndex.index;
            /* pass */
        ...
        } else if (_t235.tag == HirExpr_EMethodCall) {
            __auto_type mc_obj = _t235.data.EMethodCall.obj;
__auto_type mc_meth = _t235.data.EMethodCall.method;
__auto_type mc_args = _t235.data.EMethodCall.args;
            /* pass */
        ...
        /* pass */
        __auto_type _t236 = (*v);
        if (_t236.tag == HirExpr_EList) {
            __auto_type litems = _t236.data.EList.items;
__auto_type list_ty = _t236.data.EList.ty;
            /* pass */
    ...
    } else if (_t226.tag == HirStmt_SIf) {
        __auto_type c = _t226.data.SIf.cond;
__auto_type t = _t226.data.SIf.then_b;
__auto_type e = _t226.data.SIf.else_b;
        /* pass */
        ...
        while (going) {
            ...
            if (_is_invalid_ptr(((unsigned long long)(cur->stmts)))) {
                ...
                /* pass */
                __auto_type _t237 = (*((HirStmt*)List_ptr_get(cur->stmts, 0LL)));
                if (_t237.tag == HirStmt_SIf) {
                    __auto_type ic = _t237.data.SIf.cond;
__auto_type it = _t237.data.SIf.then_b;
__auto_type ie = _t237.data.SIf.else_b;
                    /* pass */
        ...
        /* pass */
        CGenerator_w(self, _tr_str_concat(pad, "}\n"));
    } else if (_t226.tag == HirStmt_SWhile) {
        __auto_type c = _t226.data.SWhile.cond;
__auto_type b = _t226.data.SWhile.body;
        /* pass */
        ...
        /* pass */
        CGenerator_w(self, _tr_str_concat(pad, "}\n"));
    } else if (_t226.tag == HirStmt_SFor) {
        __auto_type var = _t226.data.SFor.var;
__auto_type iter = _t226.data.SFor.iter;
__auto_type body = _t226.data.SFor.body;
        /* pass */
    ...
    } else if (_t226.tag == HirStmt_SForUnpack) {
        __auto_type vars = _t226.data.SForUnpack.vars;
__auto_type iter = _t226.data.SForUnpack.iter;
__auto_type body = _t226.data.SForUnpack.body;
        /* pass */
        CGenerator_gen_for_unpack(self, vars, iter, body, indent);
    } else if (_t226.tag == HirStmt_SMatch) {
        __auto_type e = _t226.data.SMatch.expr;
__auto_type arms = _t226.data.SMatch.arms;
        /* pass */
        CGenerator_gen_match(self, e, arms, indent);
    } else if (_t226.tag == HirStmt_STry) {
        __auto_type try_body = _t226.data.STry.try_body;
__auto_type catches = _t226.data.STry.catches;
__auto_type finally_b = _t226.data.STry.finally_b;
        /* pass */
        CGenerator_gen_try(self, try_body, catches, finally_b, indent);
    } else if (_t226.tag == HirStmt_SRaise) {
        __auto_type e = _t226.data.SRaise.val;
        /* pass */
        if ((strcmp((char*)self->cur_throws_ty, (char*)"") != 0)) {
            /* pass */
    ...
    } else if (_t226.tag == HirStmt_SAssert) {
        __auto_type cond = _t226.data.SAssert.cond;
__auto_type msg = _t226.data.SAssert.msg;
        /* pass */
    ...
    } else if (_t226.tag == HirStmt_SUnsafe) {
        __auto_type b = _t226.data.SUnsafe.body;
        /* pass */
        CGenerator_w(self, _tr_str_concat(pad, "/* unsafe block */\n"));
        /* pass */
        CGenerator_gen_block(self, b, indent);
    } else if (_t226.tag == HirStmt_SWith) {
        __auto_type items = _t226.data.SWith.items;
__auto_type aliases = _t226.data.SWith.aliases;
__auto_type body = _t226.data.SWith.body;
        /* pass */
        ...
        while ((wi < items->len)) {
            ...
            char* cast_alias = "";
            /* pass */
            __auto_type _t238 = (*with_item);
            if (_t238.tag == HirExpr_ECast) {
                __auto_type wi_inner = _t238.data.ECast.expr;
__auto_type wi_cast_ty = _t238.data.ECast.target_ty;
                /* pass */
                actual_wi = wi_inner;
                /* pass */
        ...
        while ((rei >= 0LL)) {
            ...
            /* pass */
            __auto_type _t239 = (*with_item_exit);
            if (_t239.tag == HirExpr_ECast) {
                __auto_type we_inner = _t239.data.ECast.expr;
                /* pass */
    ...
    } else if (_t226.tag == HirStmt_SAsm) {
        __auto_type code = _t226.data.SAsm.code;
__auto_type outputs = _t226.data.SAsm.outputs;
__auto_type inputs = _t226.data.SAsm.inputs;
__auto_type clobbers = _t226.data.SAsm.clobbers;
        /* pass */
    ...
    } else if (_t226.tag == HirStmt_SSpawn) {
        __auto_type e = _t226.data.SSpawn.expr;
        /* pass */
        __auto_type _t240 = (*e);
        if (_t240.tag == HirExpr_ECall) {
            __auto_type callee = _t240.data.ECall.callee;
__auto_type args = _t240.data.ECall.args;
            /* pass */
            char* sp_fn = "";
            /* pass */
            __auto_type _t241 = (*callee);
            if (_t241.tag == HirExpr_EIdent) {
                __auto_type n = _t241.data.EIdent.name;
                sp_fn = n;
            } else if (1) {
                __auto_type _ = _t241;
                /* pass */
    ...
    } else if (_t226.tag == HirStmt_STaskGroup) {
        __auto_type body = _t226.data.STaskGroup.body;
        /* pass */
    ...
    } else if (_t226.tag == HirStmt_SGpuBlock) {
        __auto_type body = _t226.data.SGpuBlock.body;
        /* pass */
        ...
        /* pass */
        CGenerator_w(self, _tr_str_concat(pad, "}\n"));
    } else if (_t226.tag == HirStmt_SBreak) {
        CGenerator_w(self, _tr_str_concat(pad, "break;\n"));
    } else if (_t226.tag == HirStmt_SContinue) {
        CGenerator_w(self, _tr_str_concat(pad, "continue;\n"));
    } else if (_t226.tag == HirStmt_SPass) {
        CGenerator_w(self, _tr_str_concat(pad, "/* pass */\n"));
    } else if (_t226.tag == HirStmt_SFree) {
        __auto_type name = _t226.data.SFree.name;
    ...
    } else if (_t226.tag == HirStmt_SMultiLet) {
        __auto_type names = _t226.data.SMultiLet.names;
__auto_type is_mut = _t226.data.SMultiLet.is_mut;
__auto_type val = _t226.data.SMultiLet.val;
        /* pass */
        CGenerator_gen_multi_let(self, names, is_mut, val, indent);
    } else if (_t226.tag == HirStmt_SChanSelect) {
        __auto_type cs_arms = _t226.data.SChanSelect.cases;
        /* pass */
...
__attribute__((hot)) void CGenerator_gen_for_loop(CGenerator* self, char* var, HirExpr* iter, HirBlock* body, long long indent) {
    ...
    /* pass */
    __auto_type _t242 = (*iter);
    if (_t242.tag == HirExpr_ECall) {
        __auto_type callee = _t242.data.ECall.callee;
__auto_type args = _t242.data.ECall.args;
        /* pass */
        __auto_type _t243 = (*callee);
        if (_t243.tag == HirExpr_EIdent) {
            __auto_type n = _t243.data.EIdent.name;
            /* pass */
    ...
    /* pass */
    CGenerator_w(self, _tr_str_concat(_tr_str_concat(_tr_str_concat(pad, "{ long long "), tmp), "_i = 0;\n"));
    /* pass */
    ...
    /* pass */
    CGenerator_w(self, _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat(pad, "  while ("), tmp), "_i < "), tmp), "_col->len) {\n"));
    /* pass */
    ...
    CGenerator_gen_block(self, body, (indent + 2LL));
    /* pass */
    CGenerator_w(self, _tr_str_concat(_tr_str_concat(_tr_str_concat(pad, "    "), tmp), "_i++;\n"));
    /* pass */
    CGenerator_w(self, _tr_str_concat(pad, "  }\n"));
    /* pass */
    CGenerator_w(self, _tr_str_concat(pad, "}\n"));
...
__attribute__((hot)) void CGenerator_gen_for_unpack(CGenerator* self, List_str* vars, HirExpr* iter, HirBlock* body, long long indent) {
    ...
    char* tmp = CGenerator_next_temp(self);
    /* pass */
    __auto_type _t244 = (*iter);
    if (_t244.tag == HirExpr_ECall) {
        __auto_type eu_callee = _t244.data.ECall.callee;
__auto_type eu_args = _t244.data.ECall.args;
        /* pass */
        __auto_type _t245 = (*eu_callee);
        if (_t245.tag == HirExpr_EIdent) {
            __auto_type eu_n = _t245.data.EIdent.name;
            /* pass */
    ...
    if (_t246.tag == HirExpr_EMethodCall) {
        __auto_type di_obj = _t246.data.EMethodCall.obj;
__auto_type di_meth = _t246.data.EMethodCall.method;
        /* pass */
            ...
            if (((arm->kind != 2LL) && (arm->kind != 3LL))) {
                ...
                if ((arm->kind == 0LL)) {
                    ...
                    if ((!_is_invalid_ptr(((unsigned long long)(arm->chan_expr))))) {
                        /* pass */
                        __auto_type _t247 = (*arm->chan_expr);
                        if (_t247.tag == HirExpr_EMethodCall) {
                            __auto_type rc_obj = _t247.data.EMethodCall.obj;
__auto_type rc_meth = _t247.data.EMethodCall.method;
                            /* pass */
                    ...
                    if ((!_is_invalid_ptr(((unsigned long long)(arm->chan_expr))))) {
                        /* pass */
                        __auto_type _t248 = (*arm->chan_expr);
                        if (_t248.tag == HirExpr_EMethodCall) {
                            __auto_type sc_obj = _t248.data.EMethodCall.obj;
__auto_type sc_meth = _t248.data.EMethodCall.method;
__auto_type sc_args = _t248.data.EMethodCall.args;
                            /* pass */
...
__attribute__((hot)) void CGenerator_gen_match(CGenerator* self, HirExpr* expr, List_ptr* arms, long long indent) {
    ...
    if (has_any_guard) {
        ...
        while ((gi < arms->len)) {
            ...
            char* gbindings = "";
            /* pass */
            __auto_type _t249 = garm->pat;
            if (_t249.tag == Pattern_PLitInt) {
                __auto_type v = _t249.data.PLitInt.val;
                gcond = _tr_str_concat(_tr_str_concat(_tr_str_concat(subj, " == "), _tr_int_to_str((long long)(v))), "LL");
            } else if (_t249.tag == Pattern_PLitBool) {
                __auto_type v = _t249.data.PLitBool.val;
                /* pass */
                if (v) {
                    /* pass */
                    gcond = subj;
            ...
            } else if (_t249.tag == Pattern_PLitStr) {
                __auto_type v = _t249.data.PLitStr.val;
                gcond = _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat("_tr_str_eq(", subj), ", \""), _escape_str_for_c(v)), "\")");
            } else if (_t249.tag == Pattern_PVariant) {
                __auto_type tn = _t249.data.PVariant.type_name;
__auto_type vn = _t249.data.PVariant.variant;
                /* pass */
                char* gpv = vn;
                /* pass */
            ...
            } else if (_t249.tag == Pattern_PVariantBind) {
                __auto_type tn = _t249.data.PVariantBind.type_name;
__auto_type vn = _t249.data.PVariantBind.variant;
__auto_type field = _t249.data.PVariantBind.field;
                /* pass */
            ...
            } else if (_t249.tag == Pattern_PVariantBindMany) {
                __auto_type tn = _t249.data.PVariantBindMany.type_name;
__auto_type vn = _t249.data.PVariantBindMany.variant;
__auto_type fields = _t249.data.PVariantBindMany.fields;
                /* pass */
                gcond = _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat(subj, ".tag == "), tn), "_"), vn);
                /* pass */
                long long _gbi = 0LL;
            ...
            } else if (_t249.tag == Pattern_PBind) {
                __auto_type gn = _t249.data.PBind.name;
                /* pass */
                gcond = "1";
                /* pass */
            ...
            } else if (_t249.tag == Pattern_PWild) {
                gcond = "1";
            } else if (1) {
                __auto_type _ = _t249;
                gcond = "1";
    ...
    while ((i < arms->len)) {
        ...
        char* bindings = "";
        /* pass */
        __auto_type _t250 = arm->pat;
        if (_t250.tag == Pattern_PLitInt) {
            __auto_type v = _t250.data.PLitInt.val;
            cond = _tr_str_concat(_tr_str_concat(_tr_str_concat(subj, " == "), _tr_int_to_str((long long)(v))), "LL");
        } else if (_t250.tag == Pattern_PLitBool) {
            __auto_type v = _t250.data.PLitBool.val;
            /* pass */
            if (v) {
                /* pass */
                cond = subj;
        ...
        } else if (_t250.tag == Pattern_PLitStr) {
            __auto_type v = _t250.data.PLitStr.val;
            cond = _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat("_tr_str_eq(", subj), ", \""), _escape_str_for_c(v)), "\")");
        } else if (_t250.tag == Pattern_PVariant) {
            __auto_type tn = _t250.data.PVariant.type_name;
__auto_type vn = _t250.data.PVariant.variant;
            /* pass */
            char* pv_vn = vn;
            /* pass */
            if (((strcmp((char*)tn, (char*)"Option") == 0) && ((strcmp((char*)vn, (char*)"") == 0) || (strcmp((char*)vn, (char*)"none") == 0)))) {
        ...
        } else if (_t250.tag == Pattern_PVariantBind) {
            __auto_type tn = _t250.data.PVariantBind.type_name;
__auto_type vn = _t250.data.PVariantBind.variant;
__auto_type field = _t250.data.PVariantBind.field;
            /* pass */
        ...
        } else if (_t250.tag == Pattern_PVariantBindMany) {
            __auto_type tn = _t250.data.PVariantBindMany.type_name;
__auto_type vn = _t250.data.PVariantBindMany.variant;
__auto_type fields = _t250.data.PVariantBindMany.fields;
            /* pass */
            cond = _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat(subj, ".tag == "), tn), "_"), vn);
            /* pass */
            long long _bi = 0LL;
        ...
        } else if (_t250.tag == Pattern_PBind) {
            __auto_type n = _t250.data.PBind.name;
            /* pass */
            cond = "1";
            /* pass */
            _tr_dict_set(self->decl_vars, n, true);
        ...
        } else if (_t250.tag == Pattern_PWild) {
            cond = "1";
        } else if (_t250.tag == Pattern_POr) {
            __auto_type pats = _t250.data.POr.patterns;
            /* pass */
            char* or_conds = "";
            /* pass */
            long long oi = 0LL;
            ...
            while ((oi < pats->len)) {
                ...
                char* pc = "1";
                /* pass */
                __auto_type _t251 = pp;
                if (_t251.tag == Pattern_PVariant) {
                    __auto_type tn = _t251.data.PVariant.type_name;
__auto_type vn = _t251.data.PVariant.variant;
                    /* pass */
                    char* or_vn = vn;
                    /* pass */
                    if (((strcmp((char*)tn, (char*)"Option") == 0) && ((strcmp((char*)vn, (char*)"") == 0) || (strcmp((char*)vn, (char*)"none") == 0)))) {
                ...
                } else if (_t251.tag == Pattern_PLitInt) {
                    __auto_type vi = _t251.data.PLitInt.val;
                    pc = _tr_str_concat(_tr_str_concat(_tr_str_concat(subj, " == "), _tr_int_to_str((long long)(vi))), "LL");
                } else if (_t251.tag == Pattern_PLitStr) {
                    __auto_type vs = _t251.data.PLitStr.val;
                    pc = _tr_str_concat(_tr_str_concat(_tr_str_concat(_tr_str_concat("_tr_str_eq(", subj), ", \""), _escape_str_for_c(vs)), "\")");
                } else if (_t251.tag == Pattern_PLitBool) {
                    __auto_type bv = _t251.data.PLitBool.val;
                    /* pass */
                    if (bv) {
                        /* pass */
                        pc = subj;
                ...
                } else if (_t251.tag == Pattern_PBind) {
                    __auto_type bn = _t251.data.PBind.name;
                    /* pass */
                    pc = "1";
                    /* pass */
...
__attribute__((hot)) void CGenerator_register_program(CGenerator* self, HirProgram* prog) {
    ...
    while ((i < prog->functions->len)) {
        /* pass */
        _tr_dict_set(self->functions, ((HirFunction*)List_ptr_get(prog->functions, i))->name, ((HirFunction*)List_ptr_get(prog->functions, i)));
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) void CGenerator_scan_mono_expr(CGenerator* self, HirExpr* e) {
    ...
    /* pass */
    __auto_type _t252 = (*e);
    if (_t252.tag == HirExpr_ECall) {
        __auto_type callee = _t252.data.ECall.callee;
__auto_type args = _t252.data.ECall.args;
        /* pass */
        ...
        /* pass */
        __auto_type _t253 = (*callee);
        if (_t253.tag == HirExpr_EIdent) {
            __auto_type mn = _t253.data.EIdent.name;
            /* pass */
    ...
    } else if (_t252.tag == HirExpr_EMethodCall) {
        __auto_type obj = _t252.data.EMethodCall.obj;
__auto_type margs = _t252.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t252.tag == HirExpr_EBinOp) {
        __auto_type bl = _t252.data.EBinOp.left;
__auto_type br = _t252.data.EBinOp.right;
        /* pass */
        CGenerator_scan_mono_expr(self, bl);
        /* pass */
        CGenerator_scan_mono_expr(self, br);
    } else if (_t252.tag == HirExpr_EUnaryOp) {
        __auto_type ue = _t252.data.EUnaryOp.expr;
        /* pass */
...
__attribute__((hot)) void CGenerator_scan_mono_stmt(CGenerator* self, HirStmt* s_ptr) {
    ...
    /* pass */
    __auto_type _t254 = (*s_ptr);
    if (_t254.tag == HirStmt_SLet) {
        __auto_type ty = _t254.data.SLet.ty;
__auto_type val = _t254.data.SLet.val;
        /* pass */
    ...
    } else if (_t254.tag == HirStmt_SExpr) {
        __auto_type expr = _t254.data.SExpr.expr;
        /* pass */
        if ((((unsigned long long)(expr)) != ((unsigned long long)(0LL)))) {
            /* pass */
            CGenerator_scan_mono_expr(self, expr);
        }
    } else if (_t254.tag == HirStmt_SReturn) {
        __auto_type val = _t254.data.SReturn.val;
        /* pass */
        if ((((unsigned long long)(val)) != ((unsigned long long)(0LL)))) {
            /* pass */
            CGenerator_scan_mono_expr(self, val);
        }
    } else if (_t254.tag == HirStmt_SIf) {
        __auto_type cond_s = _t254.data.SIf.cond;
__auto_type then_b = _t254.data.SIf.then_b;
__auto_type else_b = _t254.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t254.tag == HirStmt_SWhile) {
        __auto_type cond_s2 = _t254.data.SWhile.cond;
__auto_type body = _t254.data.SWhile.body;
        /* pass */
    ...
    } else if (_t254.tag == HirStmt_SFor) {
        __auto_type body = _t254.data.SFor.body;
        /* pass */
        CGenerator_scan_mono_block(self, body);
    } else if (_t254.tag == HirStmt_SForUnpack) {
        __auto_type body = _t254.data.SForUnpack.body;
        /* pass */
        CGenerator_scan_mono_block(self, body);
    } else if (_t254.tag == HirStmt_SMatch) {
        __auto_type subj_s = _t254.data.SMatch.expr;
__auto_type arms = _t254.data.SMatch.arms;
        /* pass */
    ...
    } else if (_t254.tag == HirStmt_STry) {
        __auto_type try_body = _t254.data.STry.try_body;
__auto_type catches = _t254.data.STry.catches;
__auto_type finally_b = _t254.data.STry.finally_b;
        /* pass */
    ...
    } else if (_t254.tag == HirStmt_SUnsafe) {
        __auto_type body = _t254.data.SUnsafe.body;
        /* pass */
        CGenerator_scan_mono_block(self, body);
    } else if (_t254.tag == HirStmt_STaskGroup) {
        __auto_type body = _t254.data.STaskGroup.body;
        /* pass */
        CGenerator_scan_mono_block(self, body);
    } else if (1) {
        __auto_type _ = _t254;
...
__attribute__((hot)) char* CGenerator_generate_module_compat(CGenerator* self, List_str* all_decl_modules, List_ptr* all_decls) {
    ...
    while ((i < all_decl_modules->len)) {
        ...
        if ((strcmp((char*)mod_dp, (char*)"") != 0)) {
            ...
            /* pass */
            __auto_type _t255 = (*((Decl*)List_ptr_get(all_decls, i)));
            if (_t255.tag == Decl_DClass) {
                __auto_type c = _t255.data.DClass.cls;
                /* pass */
                if ((c->generics->len == 0LL)) {
                    /* pass */
            ...
            } else if (_t255.tag == Decl_DEnum) {
                __auto_type e = _t255.data.DEnum.enm;
                /* pass */
            ...
            } else if (_t255.tag == Decl_DInterface) {
                __auto_type iface = _t255.data.DInterface.iface;
                /* pass */
                if ((iface->generics->len == 0LL)) {
                    /* pass */
