...
__auto_type val = _t134.data.SAssign.val;
        ...
        if ((((unsigned long long)(val)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t143 = (*val);
            if (_t143.tag == Expr_EIdent) {
                __auto_type sa_src = _t143.data.EIdent.name;
                /* pass */
        ...
        if ((((unsigned long long)(target)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t144 = (*target);
            if (_t144.tag == Expr_EIdent) {
                __auto_type pd_tgt = _t144.data.EIdent.name;
        ...
        if ((((unsigned long long)(target)) != ((unsigned long long)(0LL)))) {
            ...
            if (_t145.tag == Expr_EIdent) {
                __auto_type pc_tgt = _t145.data.EIdent.name;
...
__auto_type else_b = _t134.data.SIf.else_b;
        ...
        if ((((unsigned long long)(cond)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t146 = (*cond);
            if (_t146.tag == Expr_EIdent) {
                __auto_type t5_name = _t146.data.EIdent.name;
                /* pass */
...
__auto_type body = _t134.data.SForUnpack.body;
        ...
        /* pass */
        __auto_type _t147 = (*h_iter_fu);
        if (_t147.tag == HirExpr_ECall) {
            __auto_type fu_callee = _t147.data.ECall.callee;
__auto_type fu_args = _t147.data.ECall.args;
            /* pass */
            __auto_type _t148 = (*fu_callee);
            if (_t148.tag == HirExpr_EIdent) {
                __auto_type fu_fn = _t148.data.EIdent.name;
                /* pass */
        ...
        } else if (_t147.tag == HirExpr_EMethodCall) {
            __auto_type fu_obj = _t147.data.EMethodCall.obj;
__auto_type fu_meth = _t147.data.EMethodCall.method;
            /* pass */
...
__auto_type arms = _t134.data.SMatch.arms;
        ...
        while ((k < arms->len)) {
            ...
            /* pass */
            __auto_type _t149 = arm->pat;
            if (_t149.tag == Pattern_PWild) {
                ex_has_wild = true;
            } else if (_t149.tag == Pattern_PBind) {
                __auto_type _ = _t149.data.PBind.name;
                ex_has_wild = true;
            } else if (_t149.tag == Pattern_PVariant) {
                __auto_type ex_vn = _t149.data.PVariant.variant;
                List_str_append(ex_covered, ex_vn);
            } else if (_t149.tag == Pattern_PVariantBind) {
                __auto_type ex_vn2 = _t149.data.PVariantBind.variant;
                List_str_append(ex_covered, ex_vn2);
            } else if (_t149.tag == Pattern_PVariantBindMany) {
                __auto_type ex_vn3 = _t149.data.PVariantBindMany.variant;
...
__attribute__((hot)) void Sema_declare_pattern_binds_typed(Sema* self, Pattern pat, AstType* subj_ty) {
    /* pass */
    __auto_type _t150 = pat;
    if (_t150.tag == Pattern_PBind) {
        __auto_type name = _t150.data.PBind.name;
        Sema_declare(self, name, SymbolKind_make_SVariable(), box_asttype(subj_ty), false);
    } else if (_t150.tag == Pattern_PVariantBind) {
        __auto_type type_name = _t150.data.PVariantBind.type_name;
__auto_type variant_name = _t150.data.PVariantBind.variant;
__auto_type field = _t150.data.PVariantBind.field;
        /* pass */
        ...
        __auto_type type_name = _t150.data.PVariantBindMany.type_name;
__auto_type variant_name = _t150.data.PVariantBindMany.variant;
__auto_type fields = _t150.data.PVariantBindMany.fields;
        /* pass */
        long long _pi = 0LL;
        /* pass */
    ...
    } else if (_t150.tag == Pattern_PTuple) {
        __auto_type first = _t150.data.PTuple.first;
__auto_type second = _t150.data.PTuple.second;
        /* pass */
    ...
    } else if (_t150.tag == Pattern_POr) {
        __auto_type pats = _t150.data.POr.patterns;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < pats->len)) {
...
__attribute__((hot)) HirExpr* Sema_lower_expr(Sema* self, Expr* e_ptr) {
    ...
    /* pass */
    __auto_type _t151 = e;
    if (_t151.tag == Expr_ELitInt) {
        __auto_type v = _t151.data.ELitInt.val;
        return box_hirexpr(HirExpr_ctor_ELitInt(v, AstType_init("int")));
    } else if (_t151.tag == Expr_ELitFloat) {
        __auto_type v = _t151.data.ELitFloat.val;
        return box_hirexpr(HirExpr_ctor_ELitFloat(v, AstType_init("float")));
    } else if (_t151.tag == Expr_ELitStr) {
        __auto_type v = _t151.data.ELitStr.val;
        return box_hirexpr(HirExpr_ctor_ELitStr(v, AstType_init("str")));
    } else if (_t151.tag == Expr_ERawStr) {
        __auto_type v = _t151.data.ERawStr.val;
        return box_hirexpr(HirExpr_ctor_ERawStr(v, AstType_init("str")));
    } else if (_t151.tag == Expr_ELitBytes) {
        __auto_type v = _t151.data.ELitBytes.val;
        return box_hirexpr(HirExpr_ctor_ELitBytes(v, AstType_init("Bytes")));
    } else if (_t151.tag == Expr_ELitBool) {
        __auto_type v = _t151.data.ELitBool.val;
        return box_hirexpr(HirExpr_ctor_ELitBool(v, AstType_init("bool")));
    } else if (_t151.tag == Expr_ELitChar) {
        __auto_type v = _t151.data.ELitChar.val;
        return box_hirexpr(HirExpr_ctor_ELitChar(v, AstType_init("char")));
    } else if (_t151.tag == Expr_ELitNone) {
        return box_hirexpr(HirExpr_ctor_ELitNone(AstType_init("None")));
    } else if (_t151.tag == Expr_EIdent) {
        __auto_type name = _t151.data.EIdent.name;
        /* pass */
        Symbol* sym = Sema_resolve(self, name);
        /* pass */
        AstType* ty = (*sym->ty);
    ...
    } else if (_t151.tag == Expr_EBinOp) {
        __auto_type op = _t151.data.EBinOp.op;
__auto_type left = _t151.data.EBinOp.left;
__auto_type right = _t151.data.EBinOp.right;
        /* pass */
    ...
    } else if (_t151.tag == Expr_EUnaryOp) {
        __auto_type op = _t151.data.EUnaryOp.op;
__auto_type expr = _t151.data.EUnaryOp.expr;
        /* pass */
    ...
    } else if (_t151.tag == Expr_ECall) {
        __auto_type callee = _t151.data.ECall.callee;
__auto_type args = _t151.data.ECall.args;
        /* pass */
        if ((((unsigned long long)(callee)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t152 = (*callee);
            if (_t152.tag == Expr_EIdent) {
                __auto_type ato_n = _t152.data.EIdent.name;
                /* pass */
        ...
        while ((p23_k < args->len)) {
            ...
            if ((((unsigned long long)(p23_arg)) != ((unsigned long long)(0LL)))) {
                /* pass */
                __auto_type _t153 = (*p23_arg);
                if (_t153.tag == Expr_EIdent) {
                    __auto_type p23_n = _t153.data.EIdent.name;
                    p23_nm = p23_n;
                } else if (1) {
                    __auto_type _ = _t153;
                    /* pass */
        ...
        if (_t154.tag == Expr_EIdent) {
            __auto_type n = _t154.data.EIdent.name;
            /* pass */
        ...
        } else if (_t154.tag == Expr_EIndex) {
            __auto_type base = _t154.data.EIndex.obj;
__auto_type idx = _t154.data.EIndex.index;
            /* pass */
            __auto_type _t155 = (*base);
            if (_t155.tag == Expr_EIdent) {
                __auto_type gn = _t155.data.EIdent.name;
                /* pass */
                if (((strcmp((char*)gn, (char*)"alloc") == 0) || (strcmp((char*)gn, (char*)"dealloc") == 0))) {
                    /* pass */
                    __auto_type _t156 = (*idx);
                    if (_t156.tag == Expr_EIdent) {
                        __auto_type tn = _t156.data.EIdent.name;
                        /* pass */
                        ret_ty = AstType_init("Pointer");
                        /* pass */
                    ...
                    /* pass */
                    __auto_type _t157 = (*idx);
                    if (_t157.tag == Expr_EIdent) {
                        __auto_type tn = _t157.data.EIdent.name;
                        /* pass */
                    ...
                    if (_t158.tag == Expr_EIdent) {
                        __auto_type targ_ca = _t158.data.EIdent.name;
                    ...
                    if (_t159.tag == Expr_EIdent) {
                        __auto_type farg_c = _t159.data.EIdent.name;
                        /* pass */
        ...
        } else if (_t154.tag == Expr_EPropAccess) {
            __auto_type obj = _t154.data.EPropAccess.obj;
__auto_type variant = _t154.data.EPropAccess.prop;
            /* pass */
            __auto_type _t160 = (*obj);
            if (_t160.tag == Expr_EIdent) {
                __auto_type type_name = _t160.data.EIdent.name;
                /* pass */
                if (_tr_dict_contains(self->enums, type_name)) {
                    /* pass */
            ...
            } else if (_t160.tag == Expr_EIndex) {
                __auto_type base2 = _t160.data.EIndex.obj;
__auto_type idx2 = _t160.data.EIndex.index;
                /* pass */
                if (((strcmp((char*)variant, (char*)"init") == 0) || (strcmp((char*)variant, (char*)"new") == 0))) {
                    /* pass */
                    __auto_type _t161 = (*base2);
                    if (_t161.tag == Expr_EIdent) {
                        __auto_type gn2 = _t161.data.EIdent.name;
                        /* pass */
                        if ((((((strcmp((char*)gn2, (char*)"Pointer") == 0) || (strcmp((char*)gn2, (char*)"List") == 0)) || (strcmp((char*)gn2, (char*)"Vec") == 0)) || (strcmp((char*)gn2, (char*)"Map") == 0)) || (strcmp((char*)gn2, (char*)"Dict") == 0))) {
                            /* pass */
                            __auto_type _t162 = (*idx2);
                            if (_t162.tag == Expr_EIdent) {
                                __auto_type tn2 = _t162.data.EIdent.name;
                                /* pass */
                            ...
                            ret_ty = AstType_init(gn2);
                            /* pass */
                            __auto_type _t163 = (*idx2);
                            if (_t163.tag == Expr_EIdent) {
                                __auto_type targ_cb = _t163.data.EIdent.name;
        ...
        if ((((unsigned long long)(callee)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t164 = (*callee);
            if (_t164.tag == Expr_EIdent) {
                __auto_type aa_nm = _t164.data.EIdent.name;
                /* pass */
        ...
        if ((((unsigned long long)(callee)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t165 = (*callee);
            if (_t165.tag == Expr_EIdent) {
                __auto_type df_nm = _t165.data.EIdent.name;
                /* pass */
                if (((strcmp((char*)df_nm, (char*)"dealloc") == 0) && (args->len > 0LL))) {
                    ...
                    if ((((unsigned long long)(df_arg0)) != ((unsigned long long)(0LL)))) {
                        /* pass */
                        __auto_type _t166 = (*df_arg0);
                        if (_t166.tag == Expr_EIdent) {
                            __auto_type df_ptr = _t166.data.EIdent.name;
                            /* pass */
        ...
        /* pass */
        return box_hirexpr(HirExpr_ctor_ECall(hcallee, hl, ret_ty));
    } else if (_t151.tag == Expr_EMethodCall) {
        __auto_type obj = _t151.data.EMethodCall.obj;
__auto_type method = _t151.data.EMethodCall.method;
__auto_type args = _t151.data.EMethodCall.args;
        /* pass */
        ...
        if (((((strcmp((char*)method, (char*)"push") == 0) || (strcmp((char*)method, (char*)"pop") == 0)) || (strcmp((char*)method, (char*)"insert") == 0)) || (strcmp((char*)method, (char*)"remove") == 0))) {
            ...
            char* pc_obj_nm = "";
            /* pass */
            __auto_type _t167 = (*obj);
            if (_t167.tag == Expr_EIdent) {
                __auto_type pc_src = _t167.data.EIdent.name;
                pc_obj_nm = pc_src;
            } else if (1) {
                __auto_type _ = _t167;
                /* pass */
        ...
        char* _bm_obj_nm = "";
        /* pass */
        __auto_type _t168 = (*obj);
        if (_t168.tag == Expr_EIdent) {
            __auto_type _bm_n = _t168.data.EIdent.name;
            _bm_obj_nm = _bm_n;
        } else if (1) {
            __auto_type _ = _t168;
            /* pass */
        ...
        if (((strcmp((char*)method, (char*)"init") == 0) || (strcmp((char*)method, (char*)"new") == 0))) {
            ...
            if (((strcmp((char*)hobj_ty->name, (char*)"void") == 0) || (strcmp((char*)hobj_ty->name, (char*)"") == 0))) {
                /* pass */
                __auto_type _t169 = (*hobj);
                if (_t169.tag == HirExpr_EIdent) {
                    __auto_type recv_nm = _t169.data.EIdent.name;
                    ret_ty = AstType_init(recv_nm);
                } else if (_t169.tag == HirExpr_EIndex) {
                    __auto_type idx_base = _t169.data.EIndex.obj;
__auto_type idx_arg = _t169.data.EIndex.index;
                    /* pass */
                    __auto_type _t170 = (*idx_base);
                    if (_t170.tag == HirExpr_EIdent) {
                        __auto_type gn = _t170.data.EIdent.name;
                        /* pass */
                        ret_ty = AstType_init(gn);
                        /* pass */
                        __auto_type _t171 = (*idx_arg);
                        if (_t171.tag == HirExpr_EIdent) {
                            __auto_type tn = _t171.data.EIdent.name;
                            List_ptr_append(ret_ty->args, box_asttype(AstType_init(tn)));
                        } else if (1) {
                            __auto_type _ = _t171;
                            /* pass */
    ...
    } else if (_t151.tag == Expr_EPropAccess) {
        __auto_type obj = _t151.data.EPropAccess.obj;
__auto_type prop = _t151.data.EPropAccess.prop;
        /* pass */
        HirExpr* hobj = Sema_lower_expr(self, obj);
        /* pass */
    ...
    } else if (_t151.tag == Expr_EIndex) {
        __auto_type obj = _t151.data.EIndex.obj;
__auto_type idx_inner = _t151.data.EIndex.index;
        /* pass */
        ...
        char* obj_name = "";
        /* pass */
        __auto_type _t172 = (*obj);
        if (_t172.tag == Expr_EIdent) {
            __auto_type n = _t172.data.EIdent.name;
            obj_name = n;
        } else if (1) {
            __auto_type _ = _t172;
            /* pass */
        ...
        /* pass */
        __auto_type _t173 = (*idx_inner);
        if (_t173.tag == Expr_EIdent) {
            __auto_type iname = _t173.data.EIdent.name;
            /* pass */
            bool is_param = false;
            /* pass */
    ...
    } else if (_t151.tag == Expr_ESizeOf) {
        __auto_type ty = _t151.data.ESizeOf.ty;
        /* pass */
    ...
    } else if (_t151.tag == Expr_ECast) {
        __auto_type expr = _t151.data.ECast.expr;
__auto_type ty = _t151.data.ECast.ty;
        /* pass */
        if ((((unsigned long long)(ty)) == ((unsigned long long)(0LL)))) {
            /* pass */
    ...
    } else if (_t151.tag == Expr_EFString) {
        __auto_type parts = _t151.data.EFString.parts;
        /* pass */
    ...
    } else if (_t151.tag == Expr_ETuple) {
        __auto_type items = _t151.data.ETuple.items;
        /* pass */
    ...
    } else if (_t151.tag == Expr_EList) {
        __auto_type items = _t151.data.EList.items;
        /* pass */
        List_ptr* hitems = (void*)List_ptr_new();
        /* pass */
        long long n = 0LL;
    ...
    } else if (_t151.tag == Expr_EClosure) {
        __auto_type params = _t151.data.EClosure.params;
__auto_type ret_ty = _t151.data.EClosure.ret_ty;
__auto_type body = _t151.data.EClosure.body;
__auto_type is_async = _t151.data.EClosure.is_async;
        /* pass */
        Sema_enter_scope(self);
        /* pass */
        List_ptr* hparams = (void*)List_ptr_new();
    ...
    } else if (_t151.tag == Expr_EIfElse) {
        __auto_type cond = _t151.data.EIfElse.cond;
__auto_type then_e = _t151.data.EIfElse.then_expr;
__auto_type else_e = _t151.data.EIfElse.else_expr;
        /* pass */
        HirExpr* hcond = Sema_lower_expr(self, cond);
        /* pass */
    ...
    } else if (_t151.tag == Expr_ETryExpr) {
        __auto_type inner = _t151.data.ETryExpr.expr;
        /* pass */
    ...
    } else if (_t151.tag == Expr_EAwait) {
        __auto_type inner_await = _t151.data.EAwait.expr;
        /* pass */
        if ((!self->in_async_fn)) {
            /* pass */
    ...
    } else if (_t151.tag == Expr_EDict) {
        __auto_type keys = _t151.data.EDict.keys;
__auto_type vals = _t151.data.EDict.vals;
        /* pass */
    ...
    } else if (_t151.tag == Expr_EListComp) {
        __auto_type element = _t151.data.EListComp.element;
__auto_type generators = _t151.data.EListComp.generators;
        /* pass */
        Sema_enter_scope(self);
        /* pass */
    ...
    } else if (_t151.tag == Expr_EGeneratorExpr) {
        __auto_type element = _t151.data.EGeneratorExpr.element;
__auto_type generators = _t151.data.EGeneratorExpr.generators;
        /* pass */
        Sema_enter_scope(self);
        /* pass */
    ...
    } else if (_t151.tag == Expr_ESuperMethodCall) {
        __auto_type base_class = _t151.data.ESuperMethodCall.base_class;
__auto_type method = _t151.data.ESuperMethodCall.method;
__auto_type args = _t151.data.ESuperMethodCall.args;
        /* pass */
    ...
    } else if (_t151.tag == Expr_ESuperPropAccess) {
        __auto_type base_class = _t151.data.ESuperPropAccess.base_class;
__auto_type prop = _t151.data.ESuperPropAccess.prop;
        /* pass */
...
__attribute__((hot)) bool Sema_block_returns(Sema* self, Block* b) {
    ...
    while ((last_idx > 0LL)) {
        ...
        if ((((unsigned long long)(sl_s)) == ((unsigned long long)(0LL)))) {
            ...
            bool is_sline = false;
            /* pass */
            __auto_type _t174 = (*sl_s);
            if (_t174.tag == Stmt_SLine) {
                __auto_type _ = _t174.data.SLine.n;
                is_sline = true;
            } else if (1) {
                __auto_type _ = _t174;
                /* pass */
    ...
    /* pass */
    __auto_type _t175 = (*last_s);
    if (_t175.tag == Stmt_SReturn) {
        __auto_type _ = _t175.data.SReturn.val;
        return true;
    } else if (_t175.tag == Stmt_SRaise) {
        __auto_type _ = _t175.data.SRaise.val;
        return true;
    } else if (_t175.tag == Stmt_SUnsafe) {
        __auto_type body = _t175.data.SUnsafe.body;
        return Sema_block_returns(self, body);
    } else if (_t175.tag == Stmt_SIf) {
        __auto_type cond = _t175.data.SIf.cond;
__auto_type then_b = _t175.data.SIf.then_b;
__auto_type elifs = _t175.data.SIf.elifs;
__auto_type else_b = _t175.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t175.tag == Stmt_SMatch) {
        __auto_type subj = _t175.data.SMatch.expr;
__auto_type arms = _t175.data.SMatch.arms;
        /* pass */
        bool has_wild = false;
        /* pass */
        bool all_ret = true;
        ...
        while ((mi < arms->len)) {
            ...
            /* pass */
            __auto_type _t176 = arm->pat;
            if (_t176.tag == Pattern_PWild) {
                has_wild = true;
            } else if (_t176.tag == Pattern_PBind) {
                __auto_type _ = _t176.data.PBind.name;
                has_wild = true;
            } else if (1) {
                __auto_type _ = _t176;
                /* pass */
