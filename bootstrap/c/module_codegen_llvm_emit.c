...
__attribute__((malloc,returns_nonnull,hot)) LlvmEmitter* LlvmEmitter_init(LModule* m) {
    ...
    /* pass */
    LModule* _cltmp_t2896 = _tr_obj_retain(m);
...
__attribute__((hot)) void LlvmEmitter_store_vreg(LlvmEmitter* self, long long v, TrStr ty, TrStr val) {
    /* pass */
    ({ TrStr _at_t2899 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  store ")), _tr_strz(ty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(val)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr %v"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(v)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2899); _tr_str_release(_at_t2899); });
}
...
__attribute__((hot)) void LlvmEmitter_emit_inst(LlvmEmitter* self, LInst inst) {
    /* pass */
    __auto_type _t2901 = inst;
    if (_t2901.tag == LInst_IConst) {
        __auto_type dst = _t2901.data.IConst.dst;
__auto_type v = _t2901.data.IConst.v;
        /* pass */
        if ((strcmp(_tr_strz(LlvmEmitter_vty(self, dst)), _tr_strz(_tr_str_lit("double"))) == 0)) {
            /* pass */
            ({ TrStr _at_t2902 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_ll_hexpad16(v)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  store double 0x")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr %v"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(dst)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2902); _tr_str_release(_at_t2902); });
        } else {
            /* pass */
            ({ TrStr _at_t2903 = (_tr_str_wrap(_tr_int_to_str((long long)(v)))); LlvmEmitter_store_vreg(self, dst, _tr_str_lit("i64"), _at_t2903); _tr_str_release(_at_t2903); });
        }
    } else if (_t2901.tag == LInst_IStr) {
        __auto_type dst = _t2901.data.IStr.dst;
__auto_type str_idx = _t2901.data.IStr.str_idx;
        /* pass */
        ({ TrStr _at_t2904 = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(str_idx)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("@.str.")), _cr.data); _tr_str_release(_cr); _cres; })); LlvmEmitter_store_vreg(self, dst, _tr_str_lit("ptr"), _at_t2904); _tr_str_release(_at_t2904); });
    } else if (_t2901.tag == LInst_IBinOp) {
        __auto_type dst = _t2901.data.IBinOp.dst;
__auto_type op = _t2901.data.IBinOp.op;
__auto_type a = _t2901.data.IBinOp.a;
__auto_type b = _t2901.data.IBinOp.b;
        /* pass */
    ...
    } else if (_t2901.tag == LInst_IFBinOp) {
        __auto_type dst = _t2901.data.IFBinOp.dst;
__auto_type op = _t2901.data.IFBinOp.op;
__auto_type a = _t2901.data.IFBinOp.a;
__auto_type b = _t2901.data.IFBinOp.b;
        /* pass */
    ...
    } else if (_t2901.tag == LInst_IIToF) {
        __auto_type dst = _t2901.data.IIToF.dst;
__auto_type src = _t2901.data.IIToF.src;
        /* pass */
        ...
        _tr_str_release(si);
        _tr_str_release(rf);
    } else if (_t2901.tag == LInst_IFToI) {
        __auto_type dst = _t2901.data.IFToI.dst;
__auto_type src = _t2901.data.IFToI.src;
        /* pass */
        ...
        _tr_str_release(sf);
        _tr_str_release(ri);
    } else if (_t2901.tag == LInst_ILoadVar) {
        __auto_type dst = _t2901.data.ILoadVar.dst;
__auto_type name = _t2901.data.ILoadVar.name;
        /* pass */
        ...
        _tr_str_release(vt);
        _tr_str_release(t);
    } else if (_t2901.tag == LInst_IStoreVar) {
        __auto_type name = _t2901.data.IStoreVar.name;
__auto_type src = _t2901.data.IStoreVar.src;
        /* pass */
        TrStr st = LlvmEmitter_vty(self, src);
        /* pass */
        TrStr ls = LlvmEmitter_load_vreg_as(self, src, st);
        /* pass */
        ({ TrStr _at_t2915 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  store ")), _tr_strz(st))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ls)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr %var_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2915); _tr_str_release(_at_t2915); });
        _tr_str_release(st);
        _tr_str_release(ls);
    } else if (_t2901.tag == LInst_ILoadGlobal) {
        __auto_type dst = _t2901.data.ILoadGlobal.dst;
__auto_type gidx = _t2901.data.ILoadGlobal.gidx;
        /* pass */
        TrStr gt = _ll_ty(List_i64_get(self->m->global_types, gidx));
        /* pass */
        TrStr tg = LlvmEmitter_newtmp(self);
        /* pass */
        ({ TrStr _at_t2916 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _tr_strz(tg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = load "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gt)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr @g."))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gidx)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2916); _tr_str_release(_at_t2916); });
        /* pass */
        LlvmEmitter_store_vreg(self, dst, gt, tg);
        _tr_str_release(gt);
        _tr_str_release(tg);
    } else if (_t2901.tag == LInst_IStoreGlobal) {
        __auto_type gidx = _t2901.data.IStoreGlobal.gidx;
__auto_type src = _t2901.data.IStoreGlobal.src;
        /* pass */
        TrStr gt2 = LlvmEmitter_vty(self, src);
        /* pass */
        TrStr lg = LlvmEmitter_load_vreg_as(self, src, gt2);
        /* pass */
        ({ TrStr _at_t2917 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  store ")), _tr_strz(gt2))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lg)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr @g."))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gidx)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2917); _tr_str_release(_at_t2917); });
        _tr_str_release(gt2);
        _tr_str_release(lg);
    } else if (_t2901.tag == LInst_ICall) {
        __auto_type dst = _t2901.data.ICall.dst;
__auto_type callee = _t2901.data.ICall.callee;
__auto_type args = _t2901.data.ICall.args;
        /* pass */
        LlvmEmitter_emit_call(self, dst, callee, args);
    } else if (_t2901.tag == LInst_IFCall1) {
        __auto_type dst = _t2901.data.IFCall1.dst;
__auto_type callee = _t2901.data.IFCall1.callee;
__auto_type arg = _t2901.data.IFCall1.arg;
        /* pass */
        ...
        if ((dst >= 0LL)) {
            /* pass */
            TrStr _strtmp_t2918 = LlvmEmitter_vty(self, dst);
            _tr_str_release(rt1);
            rt1 = _strtmp_t2918;
        }
        /* pass */
        ...
        _tr_str_release(a1);
        _tr_str_release(rt1);
    } else if (_t2901.tag == LInst_IFCallF) {
        __auto_type dst = _t2901.data.IFCallF.dst;
__auto_type callee = _t2901.data.IFCallF.callee;
__auto_type arg = _t2901.data.IFCallF.arg;
        /* pass */
        ...
        _tr_str_release(a2);
        _tr_str_release(r2);
    } else if (_t2901.tag == LInst_IFCall2F) {
        __auto_type dst = _t2901.data.IFCall2F.dst;
__auto_type callee = _t2901.data.IFCall2F.callee;
__auto_type a = _t2901.data.IFCall2F.a;
__auto_type b = _t2901.data.IFCall2F.b;
        /* pass */
...
__auto_type src = _t2901.data.IFBits.src;
        ...
        _tr_str_release(bd);
        _tr_str_release(bx);
    } else if (_t2901.tag == LInst_IAddrVar) {
        __auto_type dst = _t2901.data.IAddrVar.dst;
__auto_type name = _t2901.data.IAddrVar.name;
        /* pass */
        ({ TrStr _at_t2925 = (_tr_strx_concat(_tr_strz(_tr_str_lit("%var_")), _tr_strz(name))); LlvmEmitter_store_vreg(self, dst, _tr_str_lit("ptr"), _at_t2925); _tr_str_release(_at_t2925); });
    } else if (_t2901.tag == LInst_IAddrGlobal) {
        __auto_type dst = _t2901.data.IAddrGlobal.dst;
__auto_type gidx = _t2901.data.IAddrGlobal.gidx;
        /* pass */
        ({ TrStr _at_t2926 = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gidx)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("@g.")), _cr.data); _tr_str_release(_cr); _cres; })); LlvmEmitter_store_vreg(self, dst, _tr_str_lit("ptr"), _at_t2926); _tr_str_release(_at_t2926); });
    } else if (_t2901.tag == LInst_IFuncAddr) {
        __auto_type dst = _t2901.data.IFuncAddr.dst;
__auto_type fname = _t2901.data.IFuncAddr.fname;
        /* pass */
        ({ TrStr _at_t2927 = (_tr_strx_concat(_tr_strz(_tr_str_lit("@")), _tr_strz(fname))); LlvmEmitter_store_vreg(self, dst, _tr_str_lit("ptr"), _at_t2927); _tr_str_release(_at_t2927); });
    } else if (_t2901.tag == LInst_ICallInd) {
        __auto_type dst = _t2901.data.ICallInd.dst;
__auto_type fnreg = _t2901.data.ICallInd.fnreg;
__auto_type iargs = _t2901.data.ICallInd.args;
        /* pass */
        ...
        while ((ii2 < iargs->len)) {
            ...
            if ((ii2 > 0LL)) {
                /* pass */
                TrStr _strtmp_t2928 = _tr_strx_concat(_tr_strz(ind_args), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(ind_args);
                ind_args = _strtmp_t2928;
            }
            /* pass */
            TrStr _strtmp_t2929 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(ind_args), _tr_strz(iaty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ial)); _tr_str_release(_cl); _cres; });
            _tr_str_release(ind_args);
            ind_args = _strtmp_t2929;
            /* pass */
            ii2 = (ii2 + 1LL);
        ...
        _tr_str_release(fp);
        _tr_str_release(ind_ret);
    } else if (_t2901.tag == LInst_IAsm) {
        __auto_type code = _t2901.data.IAsm.code;
__auto_type cons = _t2901.data.IAsm.cons;
        /* pass */
        ({ TrStr _at_t2933 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_ll_str_escape(code)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  call void asm sideeffect \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\", \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cons)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\"()\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2933); _tr_str_release(_at_t2933); });
    } else if (_t2901.tag == LInst_ILoad) {
        __auto_type dst = _t2901.data.ILoad.dst;
__auto_type base = _t2901.data.ILoad.base;
__auto_type off = _t2901.data.ILoad.off;
__auto_type aclass = _t2901.data.ILoad.aclass;
        /* pass */
        ...
        if ((off != 0LL)) {
            /* pass */
            TrStr _strtmp_t2934 = LlvmEmitter_newtmp(self);
            _tr_str_release(lep);
            lep = _strtmp_t2934;
            /* pass */
        ...
        _tr_str_release(lv);
    } else if (_t2901.tag == LInst_IStore) {
        __auto_type base = _t2901.data.IStore.base;
__auto_type off = _t2901.data.IStore.off;
__auto_type src = _t2901.data.IStore.src;
__auto_type aclass = _t2901.data.IStore.aclass;
        /* pass */
        ...
        if ((off != 0LL)) {
            /* pass */
            TrStr _strtmp_t2937 = LlvmEmitter_newtmp(self);
            _tr_str_release(sep);
            sep = _strtmp_t2937;
            /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2939 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  store ")), _tr_strz(ssty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ssv)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sep)); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tbaa_suffix(aclass)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2939); _tr_str_release(_at_t2939); });
        _tr_str_release(sbp);
        _tr_str_release(sep);
        _tr_str_release(ssty);
        _tr_str_release(ssv);
    } else if (_t2901.tag == LInst_ILoadB) {
        __auto_type dst = _t2901.data.ILoadB.dst;
__auto_type base = _t2901.data.ILoadB.base;
__auto_type off = _t2901.data.ILoadB.off;
        /* pass */
        ...
        _tr_str_release(bb);
        _tr_str_release(bz);
    } else if (_t2901.tag == LInst_IStoreB) {
        __auto_type base = _t2901.data.IStoreB.base;
__auto_type off = _t2901.data.IStoreB.off;
__auto_type src = _t2901.data.IStoreB.src;
        /* pass */
...
__attribute__((hot)) void LlvmEmitter_emit_call(LlvmEmitter* self, long long dst, TrStr callee, List_i64* args) {
    ...
    while ((ai < args->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t2948 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t2948;
        }
        /* pass */
        TrStr _strtmp_t2949 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(arglist), _tr_strz(aty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(al)); _tr_str_release(_cl); _cres; });
        _tr_str_release(arglist);
        arglist = _strtmp_t2949;
        /* pass */
        ai = (ai + 1LL);
        _tr_str_release(aty);
        _tr_str_release(al);
    ...
    if (LModule_is_user_fn(self->m, callee)) {
        /* pass */
        TrStr _strtmp_t2950 = LlvmEmitter_user_ret_ty(self, callee);
        _tr_str_release(retty);
        retty = _strtmp_t2950;
    } else if ((dst >= 0LL)) {
        /* pass */
        TrStr _strtmp_t2951 = LlvmEmitter_vty(self, dst);
        _tr_str_release(retty);
        retty = _strtmp_t2951;
    }
    /* pass */
...
__attribute__((hot)) void LlvmEmitter_emit_term(LlvmEmitter* self, LTerm t) {
    /* pass */
    __auto_type _t2954 = t;
    if (_t2954.tag == LTerm_TRetInt) {
        __auto_type v = _t2954.data.TRetInt.v;
        /* pass */
        if (self->cur_main) {
            /* pass */
            ({ TrStr _at_t2955 = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(v)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ret i32 ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2955); _tr_str_release(_at_t2955); });
            ...
            /* pass */
            ({ TrStr _at_t2956 = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(v)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ret i64 ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2956); _tr_str_release(_at_t2956); });
        }
    } else if (_t2954.tag == LTerm_TRetVal) {
        __auto_type v = _t2954.data.TRetVal.v;
        /* pass */
        if (self->cur_main) {
            /* pass */
            ...
            /* pass */
            ({ TrStr _at_t2958 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  ret i32 ")), _tr_strz(tr))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2958); _tr_str_release(_at_t2958); });
            _tr_str_release(lv);
            _tr_str_release(tr);
        } else {
            /* pass */
            ...
            /* pass */
            ({ TrStr _at_t2959 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  ret ")), _tr_strz(self->cur_ret))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lv2)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2959); _tr_str_release(_at_t2959); });
            _tr_str_release(lv2);
        }
    } else if (_t2954.tag == LTerm_TRetVoid) {
        /* pass */
        if (self->cur_main) {
            /* pass */
    ...
    } else if (_t2954.tag == LTerm_TBr) {
        __auto_type target = _t2954.data.TBr.target;
        /* pass */
        ({ TrStr _at_t2960 = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(target)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  br label %bb")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2960); _tr_str_release(_at_t2960); });
    } else if (_t2954.tag == LTerm_TCondBr) {
        __auto_type cond = _t2954.data.TCondBr.cond;
__auto_type then_b = _t2954.data.TCondBr.then_b;
__auto_type else_b = _t2954.data.TCondBr.else_b;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2962 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  br i1 ")), _tr_strz(c))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", label %bb"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(then_b)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", label %bb"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(else_b)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2962); _tr_str_release(_at_t2962); });
        _tr_str_release(lc);
        _tr_str_release(c);
    } else if (_t2954.tag == LTerm_TUnset) {
        /* pass */
...
__attribute__((hot)) void LlvmEmitter_emit_function(LlvmEmitter* self, LFunc* lf) {
    ...
    self->tmp = 0LL;
    /* pass */
    LFunc* _cltmp_t2963 = _tr_obj_retain(lf);
    _tr_obj_release(self->cur, _trdrop_LFunc);
    self->cur = _cltmp_t2963;
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2964 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("define ")), _tr_strz(self->cur_ret))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" @"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fname)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2964); _tr_str_release(_at_t2964); });
    /* pass */
    if (main_args) {
        /* pass */
        ...
        while ((pi < lf->params->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2965 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(pty), _tr_strz(_tr_str_lit(" %arg_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn)); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2965); _tr_str_release(_at_t2965); });
            /* pass */
            pi = (pi + 1LL);
            _tr_str_release(pn);
            _tr_str_release(pty);
    ...
    while ((vi < lf->vars->len)) {
        ...
        if ((van > 0LL)) {
            /* pass */
            ({ TrStr _at_t2966 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  %var_")), _tr_strz(vn))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = alloca ["))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(van)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" x i64]\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2966); _tr_str_release(_at_t2966); });
        } else {
            /* pass */
            ({ TrStr _at_t2967 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  %var_")), _tr_strz(vn))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = alloca "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_ll_ty(LFunc_var_type(lf, vn))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2967); _tr_str_release(_at_t2967); });
        }
        /* pass */
        vi = (vi + 1LL);
        _tr_str_release(vn);
    ...
    if (main_args) {
        ...
        /* pass */
        ({ TrStr _at_t2969 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(lf->params, 0LL)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  store ptr %argl, ptr %var_")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2969); _tr_str_release(_at_t2969); });
    } else {
        /* pass */
        long long pi = 0LL;
        /* pass */
        while ((pi < lf->params->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2970 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("  store ")), _tr_strz(pty2))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" %arg_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn2)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", ptr %var_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn2)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2970); _tr_str_release(_at_t2970); });
            /* pass */
            pi = (pi + 1LL);
            _tr_str_release(pn2);
    ...
    while ((bi < lf->blocks->len)) {
        ...
        /* pass */
        ({ TrStr _at_t2971 = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(blk->id)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("bb")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2971); _tr_str_release(_at_t2971); });
        /* pass */
        long long ii = 0LL;
        /* pass */
...
__attribute__((hot)) void LlvmEmitter_emit_extern_decls(LlvmEmitter* self) {
    ...
    while ((fi < self->m->funcs->len)) {
        ...
        /* pass */
        LFunc* _cltmp_t2972 = _tr_obj_retain(lf);
        _tr_obj_release(self->cur, _trdrop_LFunc);
        self->cur = _cltmp_t2972;
        /* pass */
        long long bi = 0LL;
        /* pass */
        while ((bi < lf->blocks->len)) {
...
__auto_type args = _t2973.data.ICall.args;
        ...
        if ((dst >= 0LL)) {
            /* pass */
            TrStr _strtmp_t2974 = LlvmEmitter_vty(self, dst);
            _tr_str_release(retty);
            retty = _strtmp_t2974;
        }
        /* pass */
        ...
        while ((ai < args->len)) {
            ...
            if ((ai > 0LL)) {
                /* pass */
                TrStr _strtmp_t2975 = _tr_strx_concat(_tr_strz(params), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(params);
                params = _strtmp_t2975;
            }
            /* pass */
            TrStr _strtmp_t2976 = ({ TrStr _cr = (LlvmEmitter_vty(self, List_i64_get(args, ai))); TrStr _cres = _tr_strx_concat(_tr_strz(params), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(params);
            params = _strtmp_t2976;
            /* pass */
            ai = (ai + 1LL);
        }
        /* pass */
        ...
        if (((strcmp(_tr_strz(retty), _tr_strz(_tr_str_lit("ptr"))) == 0) && _is_fresh_alloc_ret(callee))) {
            /* pass */
            TrStr _strtmp_t2977 = _tr_str_lit("noalias ");
            _tr_str_release(_na);
            _na = _strtmp_t2977;
        }
        /* pass */
        ({ TrStr _at_t2978 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("declare ")), _tr_strz(_na))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(retty)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" @"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(callee)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(params)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2978); _tr_str_release(_at_t2978); });
        _tr_str_release(retty);
        _tr_str_release(params);
        _tr_str_release(_na);
...
__auto_type callee = _t2973.data.IFCall1.callee;
        ...
        if ((dst >= 0LL)) {
            /* pass */
            TrStr _strtmp_t2979 = LlvmEmitter_vty(self, dst);
            _tr_str_release(rt1);
            rt1 = _strtmp_t2979;
        }
        /* pass */
        ...
        _tr_dict_set(seen, _tr_strz(callee), true);
        /* pass */
        ({ TrStr _at_t2981 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("declare double @")), _tr_strz(callee))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(double)\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2981); _tr_str_release(_at_t2981); });
        ...
        _tr_dict_set(seen, _tr_strz(callee), true);
        /* pass */
        ({ TrStr _at_t2982 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("declare double @")), _tr_strz(callee))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(double, double)\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2982); _tr_str_release(_at_t2982); });
    } else if (1) {
...
__attribute__((hot)) TrStr LlvmEmitter_emit_module(LlvmEmitter* self) {
    ...
    while ((si < self->m->strings->len)) {
        ...
        /* pass */
        ({ TrStr _at_t2983 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(si)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("@.str.")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = private unnamed_addr constant ["))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(blen)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" x i8] c\""))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_ll_str_escape(s)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\\00\"\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2983); _tr_str_release(_at_t2983); });
        /* pass */
        si = (si + 1LL);
        _tr_str_release(s);
    }
    ...
    while ((gi < self->m->globals->len)) {
        ...
        if ((gan > 0LL)) {
            /* pass */
            ({ TrStr _at_t2984 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gi)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("@g.")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = internal global ["))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gan)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" x i64] zeroinitializer\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2984); _tr_str_release(_at_t2984); });
        } else {
            /* pass */
            ...
            if ((strcmp(_tr_strz(gty), _tr_strz(_tr_str_lit("double"))) == 0)) {
                /* pass */
                TrStr _strtmp_t2985 = _tr_str_lit("0.0");
            ...
            if ((strcmp(_tr_strz(gty), _tr_strz(_tr_str_lit("ptr"))) == 0)) {
                /* pass */
                TrStr _strtmp_t2986 = _tr_str_lit("null");
                _tr_str_release(init);
                init = _strtmp_t2986;
            }
            /* pass */
            ({ TrStr _at_t2987 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(gi)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("@g.")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = internal global "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gty)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(init)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); LlvmEmitter_w(self, _at_t2987); _tr_str_release(_at_t2987); });
            _tr_str_release(gty);
            _tr_str_release(init);
        }
        /* pass */
