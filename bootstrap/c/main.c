...
__attribute__((hot)) TrStr detect_c_compiler() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3675 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3675;
    }
    /* pass */
    if (({ TrStr _aet_t3676 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("gcc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3676.data) == 0LL)); _tr_str_release(_aet_t3676); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("gcc");
    }
    /* pass */
    if (({ TrStr _aet_t3677 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3677.data) == 0LL)); _tr_str_release(_aet_t3677); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
    /* pass */
    if (({ TrStr _aet_t3678 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3678.data) == 0LL)); _tr_str_release(_aet_t3678); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("cc");
    }
    /* pass */
    if (({ TrStr _aet_t3679 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3679.data) == 0LL)); _tr_str_release(_aet_t3679); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
...
__attribute__((hot)) bool is_clang_compiler(TrStr cc) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3680 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3680;
    }
    /* pass */
    ...
    if (_tr_str_eq(_tr_strz(cc), _tr_strz(_tr_str_lit("cc")))) {
        /* pass */
        _tr_str_release(null_dev);
        return ({ TrStr _aet_t3681 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" --version 2>&1 | grep -qi clang")))); __auto_type _wr = ((_tr_system(_aet_t3681.data) == 0LL)); _tr_str_release(_aet_t3681); _wr; });
    }
    /* pass */
    _tr_str_release(null_dev);
    return false;
...
__attribute__((hot)) bool mingw_regex_libs_link(TrStr cc, TrStr cross_flags) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3682 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3682;
    }
    /* pass */
    ...
    /* pass */
    long long rc = ({ TrStr _aet_t3683 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cc), _tr_strz(cross_flags))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(probe_c)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -lsystre -ltre -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(probe_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" >"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(null_dev)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3683.data)); _tr_str_release(_aet_t3683); _wr; });
    /* pass */
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t3684 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("del \"")), _tr_strz(probe_c))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(probe_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" >nul 2>nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3684.data); _tr_str_release(_aet_t3684); });
    } else {
        /* pass */
        ({ TrStr _aet_t3685 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(probe_c))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(probe_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3685.data); _tr_str_release(_aet_t3685); });
    }
    /* pass */
    _tr_str_release(null_dev);
...
__attribute__((hot)) TrStr pkg_config_query(TrStr name, TrStr kind) {
    ...
    /* pass */
    long long rc = ({ TrStr _aet_t3687 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("pkg-config ")), _tr_strz(kind))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" > \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tmp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(null_dev)); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3687.data)); _tr_str_release(_aet_t3687); _wr; });
    /* pass */
    if ((rc != 0LL)) {
        /* pass */
        _tr_str_release(null_dev);
    ...
    while ((mi < mod_file_paths->len)) {
        ...
        while ((li < lines->len)) {
            ...
            if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-shim:"))) {
                /* pass */
                TrStr _strtmp_t3689 = ({ TrStr _wt_t3688 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 19LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3688.data))); _tr_str_release(_wt_t3688); _wr; });
                _tr_str_release(shim);
                shim = _strtmp_t3689;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-cflags:"))) {
                /* pass */
                TrStr _strtmp_t3691 = ({ TrStr _wt_t3690 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 21LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3690.data))); _tr_str_release(_wt_t3690); _wr; });
                _tr_str_release(cflags);
                cflags = _strtmp_t3691;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-linkflags:"))) {
                /* pass */
                TrStr _strtmp_t3693 = ({ TrStr _wt_t3692 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 24LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3692.data))); _tr_str_release(_wt_t3692); _wr; });
                _tr_str_release(linkflags);
                linkflags = _strtmp_t3693;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-lib:"))) {
                /* pass */
                ({ TrStr _wt_t3694 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 18LL, _tr_strlen(_tr_strz(ln))))); TrStr _at_t3695 = (_tr_str_wrap(_tr_str_strip(_wt_t3694.data))); List_TrStr_append(libs, _at_t3695); _tr_str_release(_wt_t3694); _tr_str_release(_at_t3695); });
        ...
        if ((strcmp(_tr_strz(shim), _tr_strz(_tr_str_lit(""))) != 0)) {
            ...
            if ((!file_exists(shim_src))) {
                ...
                if (file_exists(cand)) {
                    /* pass */
                    TrStr _strtmp_t3696 = _tr_str_retain(cand);
                    _tr_str_release(shim_src);
                    shim_src = _strtmp_t3696;
                } else {
                    /* pass */
            ...
            if ((!_tr_dict_contains(seen, _tr_strz(shim_src)))) {
                ...
                if (is_c_only) {
                    /* pass */
                    TrStr _strtmp_t3697 = _tr_strx_concat(_tr_strz(_tr_str_lit("C\n")), _tr_strz(shim_txt));
                    _tr_str_release(cache_key);
                    cache_key = _strtmp_t3697;
                }
                /* pass */
                bool need = true;
                /* pass */
                ...
                if (need) {
                    ...
                    if (is_c_only) {
                        ...
                        if ((!_tr_str_contains(_tr_strz(cflags), _tr_strz(_tr_str_lit("-std"))))) {
                            /* pass */
                            TrStr _strtmp_t3699 = _tr_str_lit(" -std=c++17");
                            _tr_str_release(stdflag);
                            stdflag = _strtmp_t3699;
                        }
                        /* pass */
                        ...
                        if (lto) {
                            /* pass */
                            TrStr _strtmp_t3700 = _tr_str_lit(" -flto");
                            _tr_str_release(ltof);
                            ltof = _strtmp_t3700;
                        }
                        /* pass */
                        TrStr _strtmp_t3701 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cxx), _tr_strz(_tr_str_lit(" -O")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(opt_level)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ltof)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(stdflag)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -c \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(shim_src)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cflags)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(oname)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(ccmd);
                        ccmd = _strtmp_t3701;
                        /* pass */
                        if (verbose) {
                ...
                while ((bi < libs->len)) {
                    /* pass */
                    ({ TrStr _at_t3702 = (({ TrStr _cr = (List_TrStr_get(libs, bi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3702); _tr_str_release(_at_t3702); });
                    /* pass */
                    bi = (bi + 1LL);
                }
...
__attribute__((hot)) TrStr linker_script_cortex_m() {
    ...
    /* pass */
    TrStr _strtmp_t3703 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_tr_reset)\n")));
    _tr_str_release(s);
    s = _strtmp_t3703;
    /* pass */
    TrStr _strtmp_t3704 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("MEMORY {\n")));
    _tr_str_release(s);
    s = _strtmp_t3704;
    /* pass */
    TrStr _strtmp_t3705 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  FLASH (rx)  : ORIGIN = 0x00000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3705;
    /* pass */
    TrStr _strtmp_t3706 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM   (rwx) : ORIGIN = 0x20000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3706;
    /* pass */
    TrStr _strtmp_t3707 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3707;
    /* pass */
    TrStr _strtmp_t3708 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3708;
    /* pass */
    TrStr _strtmp_t3709 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .isr_vector : { KEEP(*(.isr_vector)) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3709;
    /* pass */
    TrStr _strtmp_t3710 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { *(.text*) *(.rodata*) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3710;
    /* pass */
    TrStr _strtmp_t3711 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _sidata = LOADADDR(.data);\n")));
    _tr_str_release(s);
    s = _strtmp_t3711;
    /* pass */
    TrStr _strtmp_t3712 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { _sdata = .; *(.data*) _edata = .; } > RAM AT > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3712;
    /* pass */
    TrStr _strtmp_t3713 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3713;
    /* pass */
    TrStr _strtmp_t3714 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(8);\n")));
    _tr_str_release(s);
    s = _strtmp_t3714;
    /* pass */
    TrStr _strtmp_t3715 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3715;
    /* pass */
    TrStr _strtmp_t3716 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = ORIGIN(RAM) + LENGTH(RAM);\n")));
    _tr_str_release(s);
    s = _strtmp_t3716;
    /* pass */
    TrStr _strtmp_t3717 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3717;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr linker_script_riscv() {
    ...
    /* pass */
    TrStr _strtmp_t3718 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_start)\n")));
    _tr_str_release(s);
    s = _strtmp_t3718;
    /* pass */
    TrStr _strtmp_t3719 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("MEMORY {\n")));
    _tr_str_release(s);
    s = _strtmp_t3719;
    /* pass */
    TrStr _strtmp_t3720 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM (rwx) : ORIGIN = 0x80000000, LENGTH = 128M\n")));
    _tr_str_release(s);
    s = _strtmp_t3720;
    /* pass */
    TrStr _strtmp_t3721 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3721;
    /* pass */
    TrStr _strtmp_t3722 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3722;
    /* pass */
    TrStr _strtmp_t3723 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { KEEP(*(.text.init)) *(.text*) *(.rodata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3723;
    /* pass */
    TrStr _strtmp_t3724 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { *(.data*) *(.sdata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3724;
    /* pass */
    TrStr _strtmp_t3725 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* .sbss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3725;
    /* pass */
    TrStr _strtmp_t3726 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(16);\n")));
    _tr_str_release(s);
    s = _strtmp_t3726;
    /* pass */
    TrStr _strtmp_t3727 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3727;
    /* pass */
    TrStr _strtmp_t3728 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = .;\n")));
    _tr_str_release(s);
    s = _strtmp_t3728;
    /* pass */
    TrStr _strtmp_t3729 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3729;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr uefi_zig_stub(TrStr entry_name, bool has_heap_init, long long heap_size_mb) {
    ...
    /* pass */
    TrStr _strtmp_t3730 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const std = @import(\"std\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3730;
    /* pass */
    TrStr _strtmp_t3731 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const uefi = std.os.uefi;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3731;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3732 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn tauraro_heap_init(base: [*]u8, size: usize) void;\n")));
        _tr_str_release(s);
        s = _strtmp_t3732;
    }
    /* pass */
    TrStr _strtmp_t3733 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(fb: [*]u32, width: c_longlong, height: c_longlong, pitch: c_longlong) void;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3733;
    /* pass */
    TrStr _strtmp_t3734 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const HEAP_SIZE: usize = ")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(heap_size_mb)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" * 1024 * 1024;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3734;
    /* pass */
    TrStr _strtmp_t3735 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("pub fn main() void {\n")));
    _tr_str_release(s);
    s = _strtmp_t3735;
    /* pass */
    TrStr _strtmp_t3736 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const bs = uefi.system_table.boot_services.?;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3736;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3737 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const heap_bytes = bs.allocatePool(.loader_data, HEAP_SIZE) catch return;\n")));
        _tr_str_release(s);
        s = _strtmp_t3737;
        /* pass */
        TrStr _strtmp_t3738 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    tauraro_heap_init(heap_bytes.ptr, HEAP_SIZE);\n\n")));
        _tr_str_release(s);
        s = _strtmp_t3738;
    }
    /* pass */
    TrStr _strtmp_t3739 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const gop = (bs.locateProtocol(uefi.protocol.GraphicsOutput, null) catch return) orelse return;\n")));
    _tr_str_release(s);
    s = _strtmp_t3739;
    /* pass */
    TrStr _strtmp_t3740 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const mode = gop.mode;\n")));
    _tr_str_release(s);
    s = _strtmp_t3740;
    /* pass */
    TrStr _strtmp_t3741 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const fb: [*]u32 = @ptrFromInt(mode.frame_buffer_base);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3741;
    /* pass */
    TrStr _strtmp_t3742 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3742;
    /* pass */
    TrStr _strtmp_t3743 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        fb,\n")));
    _tr_str_release(s);
    s = _strtmp_t3743;
    /* pass */
    TrStr _strtmp_t3744 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.horizontal_resolution),\n")));
    _tr_str_release(s);
    s = _strtmp_t3744;
    /* pass */
    TrStr _strtmp_t3745 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.vertical_resolution),\n")));
    _tr_str_release(s);
    s = _strtmp_t3745;
    /* pass */
    TrStr _strtmp_t3746 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.pixels_per_scan_line),\n")));
    _tr_str_release(s);
    s = _strtmp_t3746;
    /* pass */
    TrStr _strtmp_t3747 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    );\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3747;
    /* pass */
    TrStr _strtmp_t3748 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3748;
    /* pass */
    TrStr _strtmp_t3749 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        asm volatile (\"hlt\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3749;
    /* pass */
    ...
    s = _strtmp_t3750;
    /* pass */
    TrStr _strtmp_t3751 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3751;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr uefi_zig_stub_frame(TrStr entry_name, bool has_heap_init, long long heap_size_mb) {
    ...
    /* pass */
    TrStr _strtmp_t3752 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const std = @import(\"std\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3752;
    /* pass */
    TrStr _strtmp_t3753 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const uefi = std.os.uefi;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3753;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3754 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn tauraro_heap_init(base: [*]u8, size: usize) void;\n")));
        _tr_str_release(s);
        s = _strtmp_t3754;
    }
    /* pass */
    TrStr _strtmp_t3755 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(fb: [*]u32, width: c_longlong, height: c_longlong, pitch: c_longlong, mouse_x: c_longlong, mouse_y: c_longlong, mouse_down: bool, has_key: bool, key_code: c_longlong) bool;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3755;
    /* pass */
    TrStr _strtmp_t3756 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const HEAP_SIZE: usize = ")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(heap_size_mb)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" * 1024 * 1024;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3756;
    /* pass */
    TrStr _strtmp_t3757 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("pub fn main() void {\n")));
    _tr_str_release(s);
    s = _strtmp_t3757;
    /* pass */
    TrStr _strtmp_t3758 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const bs = uefi.system_table.boot_services.?;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3758;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3759 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const heap_bytes = bs.allocatePool(.loader_data, HEAP_SIZE) catch return;\n")));
        _tr_str_release(s);
        s = _strtmp_t3759;
        /* pass */
        TrStr _strtmp_t3760 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    tauraro_heap_init(heap_bytes.ptr, HEAP_SIZE);\n\n")));
        _tr_str_release(s);
        s = _strtmp_t3760;
    }
    /* pass */
    TrStr _strtmp_t3761 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const gop = (bs.locateProtocol(uefi.protocol.GraphicsOutput, null) catch return) orelse return;\n")));
    _tr_str_release(s);
    s = _strtmp_t3761;
    /* pass */
    TrStr _strtmp_t3762 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const mode = gop.mode;\n")));
    _tr_str_release(s);
    s = _strtmp_t3762;
    /* pass */
    TrStr _strtmp_t3763 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const fb: [*]u32 = @ptrFromInt(mode.frame_buffer_base);\n")));
    _tr_str_release(s);
    s = _strtmp_t3763;
    /* pass */
    TrStr _strtmp_t3764 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const width: i64 = @intCast(mode.info.horizontal_resolution);\n")));
    _tr_str_release(s);
    s = _strtmp_t3764;
    /* pass */
    TrStr _strtmp_t3765 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const height: i64 = @intCast(mode.info.vertical_resolution);\n")));
    _tr_str_release(s);
    s = _strtmp_t3765;
    /* pass */
    TrStr _strtmp_t3766 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const pitch: i64 = @intCast(mode.info.pixels_per_scan_line);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3766;
    /* pass */
    TrStr _strtmp_t3767 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const pointer = bs.locateProtocol(uefi.protocol.SimplePointer, null) catch null;\n")));
    _tr_str_release(s);
    s = _strtmp_t3767;
    /* pass */
    TrStr _strtmp_t3768 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    var mouse_x: i64 = @divTrunc(width, 2);\n")));
    _tr_str_release(s);
    s = _strtmp_t3768;
    /* pass */
    TrStr _strtmp_t3769 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    var mouse_y: i64 = @divTrunc(height, 2);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3769;
    /* pass */
    TrStr _strtmp_t3770 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3770;
    /* pass */
    TrStr _strtmp_t3771 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var mouse_down = false;\n")));
    _tr_str_release(s);
    s = _strtmp_t3771;
    /* pass */
    TrStr _strtmp_t3772 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (pointer) |ptr| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3772;
    /* pass */
    TrStr _strtmp_t3773 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            if (ptr.getState()) |st| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3773;
    /* pass */
    TrStr _strtmp_t3774 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_x += st.relative_movement_x;\n")));
    _tr_str_release(s);
    s = _strtmp_t3774;
    /* pass */
    TrStr _strtmp_t3775 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_y += st.relative_movement_y;\n")));
    _tr_str_release(s);
    s = _strtmp_t3775;
    /* pass */
    TrStr _strtmp_t3776 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_x < 0) mouse_x = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3776;
    /* pass */
    TrStr _strtmp_t3777 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_y < 0) mouse_y = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3777;
    /* pass */
    TrStr _strtmp_t3778 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_x >= width) mouse_x = width - 1;\n")));
    _tr_str_release(s);
    s = _strtmp_t3778;
    /* pass */
    TrStr _strtmp_t3779 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_y >= height) mouse_y = height - 1;\n")));
    _tr_str_release(s);
    s = _strtmp_t3779;
    /* pass */
    TrStr _strtmp_t3780 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_down = st.left_button;\n")));
    _tr_str_release(s);
    s = _strtmp_t3780;
    /* pass */
    TrStr _strtmp_t3781 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            } else |_| {}\n")));
    _tr_str_release(s);
    s = _strtmp_t3781;
    /* pass */
    TrStr _strtmp_t3782 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        }\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3782;
    /* pass */
    TrStr _strtmp_t3783 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var has_key = false;\n")));
    _tr_str_release(s);
    s = _strtmp_t3783;
    /* pass */
    TrStr _strtmp_t3784 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var key_code: i64 = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3784;
    /* pass */
    TrStr _strtmp_t3785 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (uefi.system_table.con_in) |con_in| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3785;
    /* pass */
    TrStr _strtmp_t3786 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            if (con_in.readKeyStroke()) |k| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3786;
    /* pass */
    TrStr _strtmp_t3787 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                has_key = true;\n")));
    _tr_str_release(s);
    s = _strtmp_t3787;
    /* pass */
    TrStr _strtmp_t3788 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                key_code = k.unicode_char;\n")));
    _tr_str_release(s);
    s = _strtmp_t3788;
    /* pass */
    TrStr _strtmp_t3789 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            } else |_| {}\n")));
    _tr_str_release(s);
    s = _strtmp_t3789;
    /* pass */
    TrStr _strtmp_t3790 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        }\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3790;
    /* pass */
    TrStr _strtmp_t3791 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        const keep_going = ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(fb, width, height, pitch, mouse_x, mouse_y, mouse_down, has_key, key_code);\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3791;
    /* pass */
    TrStr _strtmp_t3792 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (!keep_going) break;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3792;
    /* pass */
    TrStr _strtmp_t3793 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        bs.stall(16_000) catch {};\n")));
    _tr_str_release(s);
    s = _strtmp_t3793;
    /* pass */
    TrStr _strtmp_t3794 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    }\n")));
    _tr_str_release(s);
    s = _strtmp_t3794;
    /* pass */
    TrStr _strtmp_t3795 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3795;
    /* pass */
    TrStr _strtmp_t3796 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        asm volatile (\"hlt\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3796;
    /* pass */
    ...
    s = _strtmp_t3797;
    /* pass */
    TrStr _strtmp_t3798 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3798;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr detect_cross_compiler(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3799 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3799;
    }
    /* pass */
    if (_tr_str_contains(_tr_strz(triple), _tr_strz(_tr_str_lit("android")))) {
        ...
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3800 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("ANDROID_NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3800;
        }
        /* pass */
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3801 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3801;
        }
        /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3803 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3803.data) == 0LL)); _tr_str_release(_aet_t3803); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
...
__attribute__((hot)) TrStr detect_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3804 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3804;
    }
    /* pass */
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3805 = path_to_native(z);
        _tr_str_release(z);
        z = _strtmp_t3805;
    }
    /* pass */
...
__attribute__((hot)) bool activate_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3806 = path_to_native(zdir);
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3807 = _tr_str_lit(";");
        _tr_str_release(sep);
        sep = _strtmp_t3807;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _aet_t3808 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(zdir), _tr_strz(sep))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur)); _tr_str_release(_cl); _cres; })); _tr_setenv(_tr_strz(_tr_str_lit("PATH")), _aet_t3808.data); _tr_str_release(_aet_t3808); });
    /* pass */
    _tr_str_release(zbin);
    _tr_str_release(zdir);
    _tr_str_release(sep);
...
__attribute__((hot)) TrStr detect_lld_flag() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3809 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3809;
    }
    /* pass */
    TrStr ext = _tr_str_lit("");
    /* pass */
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3810 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3810;
    }
    /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3813 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("ld.lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3813.data) == 0LL)); _tr_str_release(_aet_t3813); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
    ...
    /* pass */
    if (({ TrStr _aet_t3814 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3814.data) == 0LL)); _tr_str_release(_aet_t3814); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
...
__attribute__((hot)) TrStr resolve_cross_driver(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3815 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3815;
    }
    /* pass */
    if (({ TrStr _aet_t3816 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3816.data) == 0LL)); _tr_str_release(_aet_t3816); _wr; })) {
        /* pass */
...
__attribute__((hot)) TrStr find_native_abi_c(TrStr input_path) {
    ...
    /* pass */
    if (({ TrStr _at_t3817 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3817)); _tr_str_release(_at_t3817); _wr; })) {
        /* pass */
        return _tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")));
    }
    /* pass */
    if (({ TrStr _at_t3818 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3818)); _tr_str_release(_at_t3818); _wr; })) {
        /* pass */
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        /* pass */
        if (({ TrStr _at_t3819 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3819)); _tr_str_release(_at_t3819); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            return _tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")));
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3820 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3820)); _tr_str_release(_at_t3820); _wr; });
        /* pass */
        if (({ TrStr _at_t3821 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3821)); _tr_str_release(_at_t3821); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
        ...
        /* pass */
        TrStr gp = ({ TrStr _at_t3822 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3822)); _tr_str_release(_at_t3822); _wr; });
        /* pass */
        if (({ TrStr _at_t3823 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3823)); _tr_str_release(_at_t3823); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src_dir);
...
__attribute__((hot)) TrStr read_runtime_header(TrStr bin_path, TrStr input_path) {
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        TrStr src_dir = dir_of_path(input_path);
        /* pass */
        if (({ TrStr _at_t3824 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3824)); _tr_str_release(_at_t3824); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            return ({ TrStr _at_t3825 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3825)); _tr_str_release(_at_t3825); _wr; });
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3826 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3826)); _tr_str_release(_at_t3826); _wr; });
        /* pass */
        if (({ TrStr _at_t3827 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3827)); _tr_str_release(_at_t3827); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3828 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3828)); _tr_str_release(_at_t3828); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3829 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3829)); _tr_str_release(_at_t3829); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3830 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3830)); _tr_str_release(_at_t3830); _wr; });
        }
        /* pass */
        TrStr gp = ({ TrStr _at_t3831 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3831)); _tr_str_release(_at_t3831); _wr; });
        /* pass */
        if (({ TrStr _at_t3832 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3832)); _tr_str_release(_at_t3832); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3833 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3833)); _tr_str_release(_at_t3833); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3834 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3834)); _tr_str_release(_at_t3834); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3835 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3835)); _tr_str_release(_at_t3835); _wr; });
        }
        _tr_str_release(src_dir);
        _tr_str_release(parent);
    }
...
__attribute__((hot)) TrStr out_dir_prefix(TrStr out_dir) {
    ...
    if ((!(_tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("/"))) || _tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("\\")))))) {
        /* pass */
        TrStr _strtmp_t3836 = _tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit("/")));
        _tr_str_release(d);
        d = _strtmp_t3836;
    }
    /* pass */
...
__attribute__((hot)) TrStr resolve_output_stem(TrStr input_path, TrStr output_path, TrStr out_dir) {
    ...
    if (((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0) && has_path_sep(output_path))) {
        /* pass */
        ({ TrStr _at_t3837 = (dir_of_path(output_path)); make_dir(_at_t3837); _tr_str_release(_at_t3837); });
        /* pass */
    ...
    /* pass */
    return ({ TrStr _at_t3838 = (get_filename(input_path)); __auto_type _wr = (({ TrStr _cr = (strip_extension(_at_t3838)); TrStr _cres = _tr_strx_concat(_tr_strz(pref), _cr.data); _tr_str_release(_cr); _cres; })); _tr_str_release(_at_t3838); _wr; });
}
...
__attribute__((hot)) TrStr ensure_builtin_dirs(TrStr build_dir, TrStr dot_path) {
    ...
    while (true) {
        ...
        if ((c == 46LL)) {
            ...
            /* pass */
            TrStr _strtmp_t3839 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(current), _tr_strz(seg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("/"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(current);
            current = _strtmp_t3839;
            /* pass */
            make_dir(current);
            /* pass */
            start = (i + 1LL);
...
__attribute__((hot)) void make_dir(TrStr path) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t3840 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(path)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("mkdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3840.data); _tr_str_release(_aet_t3840); });
    } else {
        /* pass */
        ({ TrStr _aet_t3841 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("mkdir -p \"")), _tr_strz(path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3841.data); _tr_str_release(_aet_t3841); });
    }
}
...
__attribute__((hot)) long long compile_all_c(List_TrStr* c_files, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3842 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3842;
        /* pass */
        TrStr _strtmp_t3843 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3843;
        /* pass */
        TrStr _strtmp_t3844 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3844;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3845 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3846 = _tr_str_lit(" -static");
    ...
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3847 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3847;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3848 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3848;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3849 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3849;
    }
    /* pass */
    ...
    while ((i < c_files->len)) {
        /* pass */
        TrStr _strtmp_t3850 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(c_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3850;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3852 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3852;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3853 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3853;
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3854 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -fsanitize=address,undefined -g")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3854;
    }
    /* pass */
    if (out_is_windows(target, triple)) {
        ...
        if (need_wsa) {
            /* pass */
            TrStr _strtmp_t3855 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3855;
        }
        /* pass */
        if ((need_systre && mingw_regex_libs_link(cc, cross_flags))) {
            /* pass */
            TrStr _strtmp_t3856 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lsystre -ltre")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3856;
        }
        /* pass */
        if (need_psapi) {
            /* pass */
            TrStr _strtmp_t3857 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lpsapi")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3857;
        }
    }
...
__attribute__((hot)) long long compile_all_c_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode, bool build_shared, bool link_cxx, bool use_lto) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3858 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3858;
        /* pass */
        TrStr _strtmp_t3859 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3859;
        /* pass */
        TrStr _strtmp_t3860 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3860;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3861 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3862 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3862;
    }
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -fno-strict-aliasing -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3863 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3863;
    }
    /* pass */
    TrStr native_flags = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3864 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3864;
    }
    /* pass */
    TrStr overflow_flag = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3865 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3865;
    }
    /* pass */
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3866 = _tr_str_lit(" -fsanitize=address,undefined -g");
        _tr_str_release(dbg);
        dbg = _strtmp_t3866;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3867 = _tr_str_lit(" -fPIC");
        _tr_str_release(pic);
        pic = _strtmp_t3867;
    }
    /* pass */
    ...
    if (use_lto) {
        /* pass */
        TrStr _strtmp_t3868 = _tr_str_lit(" -flto");
        _tr_str_release(lto_flag);
        lto_flag = _strtmp_t3868;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3869 = _tr_str_lit(" -shared");
        _tr_str_release(shared_flag);
        shared_flag = _strtmp_t3869;
    }
    /* pass */
    ...
    if (link_cxx) {
        /* pass */
        TrStr _strtmp_t3870 = cxx_of(cc);
        _tr_str_release(link_driver);
        link_driver = _strtmp_t3870;
    }
    /* pass */
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t3871 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3871;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < link_paths->len)) {
        /* pass */
        TrStr _strtmp_t3872 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(link_paths, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3872;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3873 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3873;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3874 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3874;
    /* pass */
    if (out_is_windows(target, triple)) {
        /* pass */
        TrStr _strtmp_t3875 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3875;
        /* pass */
        ...
        while ((oi < o_files->len)) {
            /* pass */
            if (({ TrStr _aet_t3876 = (List_TrStr_get(o_files, oi)); __auto_type _wr = (_tr_str_contains(_aet_t3876.data, _tr_strz(_tr_str_lit("regex.o")))); _tr_str_release(_aet_t3876); _wr; })) {
                /* pass */
                need_systre2 = true;
            }
            /* pass */
            if (({ TrStr _aet_t3877 = (List_TrStr_get(o_files, oi)); __auto_type _wr = (_tr_str_contains(_aet_t3877.data, _tr_strz(_tr_str_lit("prof.o")))); _tr_str_release(_aet_t3877); _wr; })) {
                /* pass */
                need_psapi2 = true;
            }
            /* pass */
        ...
        if ((need_systre2 && mingw_regex_libs_link(cc, cross_flags))) {
            /* pass */
            TrStr _strtmp_t3878 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lsystre -ltre")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3878;
        }
        /* pass */
        if (need_psapi2) {
            /* pass */
            TrStr _strtmp_t3879 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lpsapi")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3879;
        }
    }
...
__attribute__((hot)) long long compile_wasm_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, TrStr opt_level, bool verbose, long long memory_mb) {
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t3881 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3881;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) long long compile_c_to_exe(TrStr c_path, TrStr exe_path, TrStr opt_level, bool verbose) {
    ...
    /* pass */
    TrStr out_dir = ({ TrStr _at_t3882 = (dir_of_path(c_path)); __auto_type _wr = (strip_trailing_sep(_at_t3882)); _tr_str_release(_at_t3882); _wr; });
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -fno-strict-aliasing -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3883 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3883;
    }
    /* pass */
...
__attribute__((hot)) void _print_diag(TrStr level, TrStr msg) {
    ...
    if ((fix_idx >= 0LL)) {
        /* pass */
        TrStr _strtmp_t3885 = ({ TrStr _wt_t3884 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), 0LL, fix_idx))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3884.data))); _tr_str_release(_wt_t3884); _wr; });
        _tr_str_release(main_part);
        main_part = _strtmp_t3885;
        /* pass */
        TrStr _strtmp_t3887 = ({ TrStr _wt_t3886 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), (fix_idx + 4LL), _tr_strlen(_tr_strz(msg))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3886.data))); _tr_str_release(_wt_t3886); _wr; });
        _tr_str_release(fix_part);
        fix_part = _strtmp_t3887;
    }
    /* pass */
    ...
    if ((pe > 0LL)) {
        ...
        if ((ln > 0LL)) {
            /* pass */
            TrStr _strtmp_t3888 = _tr_str_retain(head);
            _tr_str_release(loc_str);
            loc_str = _strtmp_t3888;
            /* pass */
            TrStr _strtmp_t3889 = loc_file(head);
            _tr_str_release(file_path);
            file_path = _strtmp_t3889;
            /* pass */
            line_no = ln;
            /* pass */
            TrStr _strtmp_t3890 = _tr_str_wrap(_tr_str_slice(_tr_strz(main_part), (pe + 2LL), _tr_strlen(_tr_strz(main_part))));
    ...
    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
        /* pass */
        TrStr _strtmp_t3891 = c_yellow(level);
        _tr_str_release(lvl);
        lvl = _strtmp_t3891;
    }
    /* pass */
    ...
    if ((_tr_strlen(_tr_strz(loc_str)) > 0LL)) {
        ...
        if ((_tr_strlen(_tr_strz(file_path)) > 0LL)) {
            /* pass */
            TrStr _strtmp_t3892 = read_file(file_path);
            _tr_str_release(src);
            src = _strtmp_t3892;
        }
        /* pass */
        if ((_tr_strlen(_tr_strz(src)) > 0LL)) {
            ...
            if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
                ...
                if ((col > 0LL)) {
                    ...
                    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t3893 = c_yellow(underline);
...
__attribute__((hot)) void cleanup_build(TrStr build_dir, List_TrStr* all_c_files) {
    ...
    while ((di < all_c_files->len)) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            ({ TrStr _at_t3894 = (List_TrStr_get(all_c_files, di)); TrStr _aet_t3895 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3894)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3895.data); _tr_str_release(_at_t3894); _tr_str_release(_aet_t3895); });
        } else {
            /* pass */
            ({ TrStr _aet_t3896 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(all_c_files, di)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3896.data); _tr_str_release(_aet_t3896); });
        }
        /* pass */
        di = (di + 1LL);
    }
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _at_t3897 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_types.h")))); TrStr _aet_t3898 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3897)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3898.data); _tr_str_release(_at_t3897); _tr_str_release(_aet_t3898); });
        /* pass */
        ({ TrStr _at_t3899 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); TrStr _aet_t3900 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3899)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3900.data); _tr_str_release(_at_t3899); _tr_str_release(_aet_t3900); });
        /* pass */
        ({ TrStr _at_t3901 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("include")))); TrStr _aet_t3902 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3901)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir /S /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3902.data); _tr_str_release(_at_t3901); _tr_str_release(_aet_t3902); });
        /* pass */
        ({ TrStr _aet_t3903 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(build_dir)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3903.data); _tr_str_release(_aet_t3903); });
    } else {
        /* pass */
        ({ TrStr _aet_t3904 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_types.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3904.data); _tr_str_release(_aet_t3904); });
        /* pass */
        ({ TrStr _aet_t3905 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_rt.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3905.data); _tr_str_release(_aet_t3905); });
        /* pass */
        ({ TrStr _aet_t3906 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -rf \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3906.data); _tr_str_release(_aet_t3906); });
        /* pass */
        ({ TrStr _aet_t3907 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3907.data); _tr_str_release(_aet_t3907); });
    }
}
...
__attribute__((hot)) void run_fmt(TrStr path0, bool write_in_place) {
    ...
    if (((!file_exists(path)) && (!str_ends_with_dot_tr(path)))) {
        /* pass */
        TrStr _strtmp_t3908 = _tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".tr")));
...
__attribute__((hot)) int main(int _tr_c_argc, char** _tr_c_argv) {
    ...
    if ((args->len >= 2LL)) {
        ...
        if ((((strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("fmt"))) == 0) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("lint"))) == 0)) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("bindgen"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3909 = _tr_str_retain(a1);
            _tr_str_release(subcmd);
            subcmd = _strtmp_t3909;
        }
    }
    /* pass */
        ...
        while ((bk < args->len)) {
            ...
            if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--pkg"))) == 0) && ((bk + 1LL) < args->len))) {
                ...
                if ((strcmp(_tr_strz(pkgcf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3910 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkgcf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_extra);
                    bg_extra = _strtmp_t3910;
                }
                /* pass */
                if ((strcmp(_tr_strz(pkglf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3911 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_pkglibs), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkglf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_pkglibs);
                    bg_pkglibs = _strtmp_t3911;
                }
                ...
                /* pass */
                TrStr _strtmp_t3914 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -I\"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                ...
                /* pass */
                TrStr _strtmp_t3915 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -D")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(bg_extra);
                ...
                /* pass */
                TrStr _strtmp_t3916 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -isystem \"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                ...
                /* pass */
                TrStr _strtmp_t3917 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ba)); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                ...
                if ((strcmp(_tr_strz(bg_header), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3918 = _tr_str_retain(ba);
                    _tr_str_release(bg_header);
                    bg_header = _strtmp_t3918;
                }
            }
            /* pass */
            bk = (bk + 1LL);
        ...
        while ((fk < args->len)) {
            ...
            if (((strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("-w"))) == 0) || (strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("--write"))) == 0))) {
                ...
                if ((strcmp(_tr_strz(fpath), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3919 = _tr_str_retain(fa);
    ...
    while ((i < args->len)) {
        ...
        if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--version"))) == 0)) {
            ...
            _tr_str_release(out_dir);
            out_dir = _strtmp_t3926;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--link"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3927 = (List_TrStr_get(args, i)); List_TrStr_append(link_paths, _at_t3927); _tr_str_release(_at_t3927); });
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-l"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3928 = (({ TrStr _cr = (List_TrStr_get(args, i)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3928); _tr_str_release(_at_t3928); });
            ...
            i = (i + 1LL);
            /* pass */
            wasm_memory_mb = ({ TrStr _at_t3936 = (List_TrStr_get(args, i)); __auto_type _wr = (parse_uint_arg(_at_t3936, 64LL)); _tr_str_release(_at_t3936); _wr; });
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--freestanding"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3937 = _tr_str_lit("TAURARO_KERNEL");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3937;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--no-std"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3938 = _tr_str_lit("TAURARO_NO_OS");
            _tr_str_release(tier_define);
            ...
            if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3939 = _tr_str_retain(arg);
    ...
    if (((!file_exists(input_path)) && (!str_ends_with_dot_tr(input_path)))) {
        /* pass */
        TrStr _strtmp_t3940 = _tr_strx_concat(_tr_strz(input_path), _tr_strz(_tr_str_lit(".tr")));
        _tr_str_release(input_path);
    ...
    /* pass */
    TrStr bin_dir = ({ TrStr _at_t3941 = (_tr_str_wrap(_tr_exe_dir())); __auto_type _wr = (strip_trailing_sep_inline(_at_t3941)); _tr_str_release(_at_t3941); _wr; });
    /* pass */
    ModuleResolver_add_search_path(resolver, bin_dir);
    /* pass */
    ({ TrStr _at_t3942 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/std")))); ModuleResolver_add_search_path(resolver, _at_t3942); _tr_str_release(_at_t3942); });
    /* pass */
    ({ TrStr _at_t3943 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages")))); ModuleResolver_add_search_path(resolver, _at_t3943); _tr_str_release(_at_t3943); });
    /* pass */
    ({ TrStr _at_t3944 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages/sites")))); ModuleResolver_add_search_path(resolver, _at_t3944); _tr_str_release(_at_t3944); });
    /* pass */
    ...
    if ((strcmp(_tr_strz(tauraro_path_env), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        while ((epi < ep_count)) {
            /* pass */
            ({ TrStr _at_t3945 = (get_path_env_entry(tauraro_path_env, epi)); ModuleResolver_add_search_path(resolver, _at_t3945); _tr_str_release(_at_t3945); });
            /* pass */
            epi = (epi + 1LL);
        }
    }
    ...
    if ((sema->warnings->len > 0LL)) {
        ...
        while ((wk < sema->warnings->len)) {
            /* pass */
            ({ TrStr _at_t3946 = (List_TrStr_get(sema->warnings, wk)); _print_diag(_tr_str_lit("warning"), _at_t3946); _tr_str_release(_at_t3946); });
            /* pass */
            wk = (wk + 1LL);
        }
    }
    ...
    if ((sema->errors->len > 0LL)) {
        ...
        while ((k < sema->errors->len)) {
            /* pass */
            ({ TrStr _at_t3947 = (List_TrStr_get(sema->errors, k)); _print_diag(_tr_str_lit("error"), _at_t3947); _tr_str_release(_at_t3947); });
            /* pass */
            k = (k + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("gpu"))) == 0)) {
        ...
        if ((!gpu_gen->ok)) {
            /* pass */
            ({ TrStr _at_t3948 = (_tr_strx_concat(_tr_strz(_tr_str_lit("[GPU] ")), _tr_strz(gpu_gen->fail_note))); _print_diag(_tr_str_lit("error"), _at_t3948); _tr_str_release(_at_t3948); });
            /* pass */
            exit((int)(1LL));
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("llvm"))) == 0)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3949 = resolve_target_triple(target);
            _tr_str_release(lx_triple);
            lx_triple = _strtmp_t3949;
            /* pass */
            lx_is_cross = true;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            /* pass */
            TrStr _strtmp_t3950 = target_extra_flags(lx_triple);
            _tr_str_release(lx_tflags);
            lx_tflags = _strtmp_t3950;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3951 = _tr_str_lit("nul");
                _tr_str_release(lx_xnull);
                lx_xnull = _strtmp_t3951;
            }
            /* pass */
            if (({ TrStr _aet_t3952 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3952.data) == 0LL)); _tr_str_release(_aet_t3952); _wr; })) {
                /* pass */
                TrStr lx_zt = zig_target_of(lx_triple);
                /* pass */
                if ((strcmp(_tr_strz(lx_zt), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3953 = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -target ")), _tr_strz(lx_zt));
                    _tr_str_release(lx_xcc);
                    lx_xcc = _strtmp_t3953;
                    /* pass */
                    lx_via_zig = true;
                }
            }
            /* pass */
            if (({ TrStr _aet_t3954 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((strcmp(_tr_strz(lx_xcc), _tr_strz(_tr_str_lit(""))) == 0) && (_tr_system(_aet_t3954.data) == 0LL))); _tr_str_release(_aet_t3954); _wr; })) {
                /* pass */
                TrStr _strtmp_t3955 = _tr_strx_concat(_tr_strz(_tr_str_lit("clang --target=")), _tr_strz(lx_triple));
                _tr_str_release(lx_xcc);
                lx_xcc = _strtmp_t3955;
            }
            /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) {
                /* pass */
                TrStr _strtmp_t3956 = _tr_str_lit(".wasm");
            ...
            /* pass */
            TrStr _strtmp_t3958 = _tr_str_lit(".exe");
            _tr_str_release(lx_ext);
            lx_ext = _strtmp_t3958;
        }
        /* pass */
        TrStr lx_exe = ({ TrStr _at_t3959 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3959, lx_ext)); _tr_str_release(_at_t3959); _wr; });
        /* pass */
        ...
        if (((lx_is_cross && _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && _tr_str_contains(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("define i32 @main()"))))) {
            /* pass */
            TrStr _strtmp_t3960 = _tr_strx_concat(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("\n@__main_void = hidden alias i32 (), ptr @main\n")));
            _tr_str_release(llvm_ir);
            llvm_ir = _strtmp_t3960;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            /* pass */
            TrStr _strtmp_t3961 = _tr_str_retain(lx_xcc);
            _tr_str_release(lx_cc);
            lx_cc = _strtmp_t3961;
            /* pass */
            TrStr _strtmp_t3962 = _tr_str_retain(lx_tflags);
            _tr_str_release(lx_xflags);
            lx_xflags = _strtmp_t3962;
            /* pass */
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3963 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xflags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_xflags);
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3965 = _tr_str_lit("nul");
            _tr_str_release(lx_null);
            lx_null = _strtmp_t3965;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3966 = _tr_strx_concat(_tr_strz(lx_libs), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -lucrtbase -mconsole")));
            _tr_str_release(lx_libs);
            lx_libs = _strtmp_t3966;
            /* pass */
            TrStr _strtmp_t3967 = _tr_strx_concat(_tr_strz(lx_libs_gcc), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt")));
            _tr_str_release(lx_libs_gcc);
            lx_libs_gcc = _strtmp_t3967;
        }
        /* pass */
        bool lx_built = false;
        /* pass */
        if (lx_is_cross) {
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3968 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_cg);
                lx_cg = _strtmp_t3968;
            }
            /* pass */
            if (({ TrStr _aet_t3969 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" -c \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3969.data) != 0LL)); _tr_str_release(_aet_t3969); _wr; })) {
                /* pass */
            ...
            if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm"))) || _tr_str_contains(_tr_strz(lx_tflags), _tr_strz(_tr_str_lit("nostdlib"))))) {
                /* pass */
                TrStr _strtmp_t3970 = _tr_str_lit("");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3970;
            } else if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("windows"))) || _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("mingw"))))) {
                /* pass */
                TrStr _strtmp_t3971 = _tr_str_lit(" -lm -lws2_32 -lbcrypt -mconsole");
                _tr_str_release(lx_xlibs);
            ...
            if (((!_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && (!lx_via_zig))) {
                /* pass */
                TrStr _strtmp_t3972 = detect_lld_flag();
                _tr_str_release(lx_xld);
                lx_xld = _strtmp_t3972;
            }
            /* pass */
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3973 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_xlink);
                lx_xlink = _strtmp_t3973;
            }
            /* pass */
            TrStr _strtmp_t3974 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xlibs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xld)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(lx_xlink);
            ...
            /* pass */
            if (({ TrStr _aet_t3975 = (read_file(_tr_str_lit("build/llvm_link.log"))); __auto_type _wr = ((((((!lx_built) && lx_via_zig) && _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm32-unknown-unknown")))) && file_exists(_tr_str_lit("build/llvm_link.log"))) && _tr_str_contains(_aet_t3975.data, _tr_strz(_tr_str_lit("undefined symbol"))))); _tr_str_release(_aet_t3975); _wr; })) {
                /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3976 = _tr_str_lit("x86_64-pc-windows-gnu");
            _tr_str_release(lx_tri);
            lx_tri = _strtmp_t3976;
        }
        /* pass */
        ...
        if ((lx_inproc == 0LL)) {
            /* pass */
            if (({ TrStr _aet_t3977 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3977.data) == 0LL)); _tr_str_release(_aet_t3977); _wr; })) {
                /* pass */
                lx_built = true;
            }
        }
        /* pass */
        if (({ TrStr _aet_t3978 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3978.data) == 0LL))); _tr_str_release(_aet_t3978); _wr; })) {
            /* pass */
        ...
        /* pass */
        if (({ TrStr _aet_t3979 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3979.data) == 0LL))); _tr_str_release(_aet_t3979); _wr; })) {
            /* pass */
            TrStr lx_llc_tri = _tr_str_lit("");
            /* pass */
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3980 = _tr_str_lit(" -mtriple=x86_64-pc-windows-gnu");
                _tr_str_release(lx_llc_tri);
                lx_llc_tri = _strtmp_t3980;
            }
            /* pass */
            if (({ TrStr _aet_t3981 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -O2 -filetype=obj")), _tr_strz(lx_llc_tri))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o build/llvm_out.o 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3981.data) == 0LL)); _tr_str_release(_aet_t3981); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3982 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3982.data) == 0LL)); _tr_str_release(_aet_t3982); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        /* pass */
        if (({ TrStr _aet_t3983 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3983.data) == 0LL))); _tr_str_release(_aet_t3983); _wr; })) {
            /* pass */
            TrStr lx_zrto = _tr_str_lit("build/llvm_runtime_zig.o");
            /* pass */
            if (({ TrStr _aet_t3984 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (dir_of_path(lx_abi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -O2 -w -c \"-I")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_abi)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_zrto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3984.data) == 0LL)); _tr_str_release(_aet_t3984); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3985 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -O")), _tr_strz(opt_level))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_zrto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3985.data) == 0LL)); _tr_str_release(_aet_t3985); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        if (run_after) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3986 = path_to_native(lx_run);
                _tr_str_release(lx_run);
                lx_run = _strtmp_t3986;
            }
            /* pass */
            ({ TrStr _aet_t3987 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(lx_run))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); exit((int)(_tr_system(_aet_t3987.data))); _tr_str_release(_aet_t3987); });
        }
        /* pass */
        _tr_str_release(subcmd);
        _tr_str_release(input_path);
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("native"))) == 0)) {
        ...
        /* pass */
        TrStr nat_out = ({ TrStr _at_t3988 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3988, _tr_str_lit(".o"))); _tr_str_release(_at_t3988); _wr; });
        /* pass */
    ...
    /* pass */
    TrStr rt_h = ({ TrStr _at_t3989 = (List_TrStr_get(args, 0LL)); __auto_type _wr = (read_runtime_header(_at_t3989, input_path)); _tr_str_release(_at_t3989); _wr; });
    /* pass */
    ...
    /* pass */
    TrStr _strtmp_t3990 = ({ TrStr _cr = (CGenerator_generate_module_compat(c_gen, resolver->all_decl_modules, resolver->all_decls)); TrStr _cres = _tr_strx_concat(_tr_strz(types_h), _cr.data); _tr_str_release(_cr); _cres; });
    _tr_str_release(types_h);
    types_h = _strtmp_t3990;
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3991 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";static")));
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3992 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";debug")));
        _tr_str_release(flags_sig);
    ...
    if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3993 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";sysroot=")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; });
        _tr_str_release(flags_sig);
    ...
    if ((strcmp(_tr_strz(rt_h), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _at_t3994 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); write_file(_at_t3994, rt_h); _tr_str_release(_at_t3994); });
    }
    /* pass */
    ...
    while ((mi < resolver->mod_dot_paths->len)) {
        ...
        while ((k < resolver->all_decl_modules->len)) {
            ...
            if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k)), _tr_strz(dot_path)) == 0)) {
                /* pass */
                __auto_type _t3995 = (*((Decl*)List_ptr_get(resolver->all_decls, k)));
                if (_t3995.tag == Decl_DClass) {
                    __auto_type c = _t3995.data.DClass.cls;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(c->name), true);
                } else if (_t3995.tag == Decl_DFunction) {
                    __auto_type f = _t3995.data.DFunction.func;
                    /* pass */
                    _tr_dict_set(fn_set, _tr_strz(f->name), true);
                    _tr_obj_release(f, _trdrop_FunctionDef);
                } else if (_t3995.tag == Decl_DEnum) {
                    __auto_type e = _t3995.data.DEnum.enm;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(e->name), true);
                } else if (_t3995.tag == Decl_DInterface) {
                    __auto_type iface = _t3995.data.DInterface.iface;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(iface->name), true);
                } else if (_t3995.tag == Decl_DExtend) {
                    __auto_type target = _t3995.data.DExtend.target;
__auto_type methods = _t3995.data.DExtend.methods;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(target), true);
                    _tr_str_release(target);
                } else if (1) {
                    __auto_type _ = _t3995;
                    /* pass */
                }
            }
            /* pass */
        ...
        if (is_builtin_mod(dot_path)) {
            /* pass */
            TrStr _strtmp_t3996 = ensure_builtin_dirs(build_dir, dot_path);
            ...
            /* pass */
            TrStr _strtmp_t3997 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("module_")))); TrStr _cr = (dot_to_safe(dot_path)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".c"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(c_path);
        ...
        if ((c_gen->emit_line_info && (mi < resolver->mod_file_paths->len))) {
            /* pass */
            c_gen->cur_src_file = ({ TrStr _at_t3998 = (List_TrStr_get(resolver->mod_file_paths, mi)); __auto_type _wr = (to_fwd_slashes(_at_t3998)); _tr_str_release(_at_t3998); _wr; });
        }
        /* pass */
    ...
    while ((k2 < resolver->all_decl_modules->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k2)), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            __auto_type _t3999 = (*((Decl*)List_ptr_get(resolver->all_decls, k2)));
            if (_t3999.tag == Decl_DClass) {
                __auto_type c = _t3999.data.DClass.cls;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(c->name), true);
            } else if (_t3999.tag == Decl_DFunction) {
                __auto_type f = _t3999.data.DFunction.func;
                /* pass */
                _tr_dict_set(main_fn_set, _tr_strz(f->name), true);
                _tr_obj_release(f, _trdrop_FunctionDef);
            } else if (_t3999.tag == Decl_DEnum) {
                __auto_type e = _t3999.data.DEnum.enm;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(e->name), true);
            } else if (_t3999.tag == Decl_DInterface) {
                __auto_type iface = _t3999.data.DInterface.iface;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(iface->name), true);
            } else if (_t3999.tag == Decl_DExtend) {
                __auto_type target = _t3999.data.DExtend.target;
__auto_type methods = _t3999.data.DExtend.methods;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(target), true);
                _tr_str_release(target);
            } else if (1) {
                __auto_type _ = _t3999;
                /* pass */
            }
        }
        /* pass */
    ...
    if (export_cpp) {
        /* pass */
        TrStr _strtmp_t4000 = ({ TrStr _cr = (CppExporter_generate_cpp_class_bridges(cpp_exporter, hir)); TrStr _cres = _tr_strx_concat(_tr_strz(main_c), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(main_c);
        main_c = _strtmp_t4000;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            ({ TrStr _at_t4001 = (linker_script_riscv()); write_file(emit_ld, _at_t4001); _tr_str_release(_at_t4001); });
        } else {
            /* pass */
            ({ TrStr _at_t4002 = (linker_script_cortex_m()); write_file(emit_ld, _at_t4002); _tr_str_release(_at_t4002); });
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("c"))) == 0)) {
        ...
        while ((pi < (all_c_files->len - 1LL))) {
            /* pass */
            ({ TrStr _at_t4003 = (List_TrStr_get(all_c_files, pi)); ({ printf("%s", _tr_strz(({ TrStr _cr = (get_filename(_at_t4003)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _cr.data); _tr_str_release(_cr); _cres; }))); printf("\n"); }); _tr_str_release(_at_t4003); });
            /* pass */
            pi = (pi + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(exe_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t4004 = _tr_str_lit("a");
            ...
            if ((((long long)((*(en_p + (en_len - 3LL))))) == 101LL)) {
                ...
                if ((((long long)((*(en_p + (en_len - 2LL))))) == 120LL)) {
                    ...
                    if ((((long long)((*(en_p + (en_len - 1LL))))) == 101LL)) {
                        /* pass */
                        TrStr _strtmp_t4005 = _tr_str_wrap(_tr_str_slice(_tr_strz(exe_name), 0LL, (en_len - 4LL)));
                        _tr_str_release(exe_name);
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t4006 = resolve_target_triple(target);
        _tr_str_release(tgt_triple);
        tgt_triple = _strtmp_t4006;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (out_win) {
            /* pass */
            TrStr _strtmp_t4007 = _tr_str_lit(".dll");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t4007;
        } else {
            /* pass */
            TrStr _strtmp_t4008 = _tr_str_lit(".so");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t4008;
        }
    } else if (out_win) {
        /* pass */
        TrStr _strtmp_t4009 = _tr_str_lit(".exe");
        _tr_str_release(exe_ext);
        ...
        /* pass */
        TrStr _strtmp_t4010 = _tr_str_lit(".wasm");
        _tr_str_release(exe_ext);
    ...
    if (lib_mode) {
        ...
        if (export_cpp) {
            ...
            if ((strcmp(_tr_strz(ns), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t4011 = _tr_str_lit("tauraro");
                _tr_str_release(ns);
                ns = _strtmp_t4011;
            }
            /* pass */
    ...
    if (((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0) && (!lib_mode))) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t4013 = ({ TrStr _at_t4012 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t4012)); _tr_str_release(_at_t4012); _wr; });
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t4014 = _tr_str_lit(" -mcpu=cortex_m3 -mthumb");
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            TrStr _strtmp_t4015 = _tr_str_lit(" -march=rv64imac -mabi=lp64 -mcmodel=medany");
            _tr_str_release(bm_arch);
        ...
        if ((!bm_is_zig)) {
            /* pass */
            TrStr _strtmp_t4016 = detect_lld_flag();
            _tr_str_release(bm_lld);
            bm_lld = _strtmp_t4016;
        }
        /* pass */
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t4017 = _tr_str_lit(" -nostartfiles");
            _tr_str_release(bm_nostdlib);
            bm_nostdlib = _strtmp_t4017;
            /* pass */
            TrStr _strtmp_t4018 = _tr_str_lit(" -fno-sanitize=undefined");
            _tr_str_release(bm_ubsan);
            bm_ubsan = _strtmp_t4018;
            /* pass */
            TrStr _strtmp_t4019 = _tr_str_lit("");
            _tr_str_release(bm_libgcc);
            bm_libgcc = _strtmp_t4019;
        }
        /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit("uefi-x64"))) == 0) && (!lib_mode))) {
        ...
        if (uefi_is_frame) {
            /* pass */
            TrStr _strtmp_t4026 = uefi_zig_stub_frame(uefi_entry, uefi_has_heap_init, 64LL);
            _tr_str_release(uefi_stub_src);
            uefi_stub_src = _strtmp_t4026;
        } else {
            /* pass */
            TrStr _strtmp_t4027 = uefi_zig_stub(uefi_entry, uefi_has_heap_init, 16LL);
            _tr_str_release(uefi_stub_src);
        ...
        /* pass */
        TrStr _strtmp_t4028 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -I \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -I \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t4028;
        /* pass */
        TrStr _strtmp_t4029 = _tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -cflags -U_WIN32 -U_WIN64 -U_MSC_VER -mno-stack-arg-probe -- ")));
        _tr_str_release(uefi_cmd);
        ...
        while ((uci < all_c_files->len)) {
            /* pass */
            TrStr _strtmp_t4030 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit("\"")))); TrStr _cr = (List_TrStr_get(all_c_files, uci)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; });
            _tr_str_release(uefi_cmd);
        ...
        /* pass */
        TrStr _strtmp_t4031 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit("\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(uefi_stub_path)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t4031;
        /* pass */
        TrStr _strtmp_t4032 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -fno-strip -femit-bin=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(uefi_efi)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>build/uefi_link.log"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
    ...
    if ((!no_auto_cpp)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t4034 = ({ TrStr _at_t4033 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t4033)); _tr_str_release(_at_t4033); _wr; });
            _tr_str_release(cc0);
            cc0 = _strtmp_t4034;
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if ((gpu_gen->ok && (gpu_gen->n_kernels > 0LL))) {
            ...
            if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit("nvptx"))) == 0)) {
                /* pass */
                TrStr _strtmp_t4035 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=nvptx64-nvidia-cuda -mcpu=sm_50 \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t4035;
            } else {
                /* pass */
                TrStr _strtmp_t4036 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=spirv64-unknown-unknown -filetype=obj \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
    ...
    if (run_after) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t4037 = path_to_native(run_path);
            _tr_str_release(run_path);
            run_path = _strtmp_t4037;
        }
        /* pass */
        long long run_rc = ({ TrStr _aet_t4038 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(run_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t4038.data)); _tr_str_release(_aet_t4038); _wr; });
        /* pass */
        exit((int)(run_rc));
    }
    _tr_str_release(subcmd);
