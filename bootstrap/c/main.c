...
__attribute__((hot)) TrStr detect_c_compiler() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t2232 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t2232;
    }
    /* pass */
    if (({ TrStr _aet_t2233 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("gcc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t2233.data) == 0LL)); _tr_str_release(_aet_t2233); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("gcc");
    }
    /* pass */
    if (({ TrStr _aet_t2234 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t2234.data) == 0LL)); _tr_str_release(_aet_t2234); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
    /* pass */
    if (({ TrStr _aet_t2235 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t2235.data) == 0LL)); _tr_str_release(_aet_t2235); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
...
__attribute__((hot)) bool is_clang_compiler(TrStr cc) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t2236 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t2236;
    }
    /* pass */
    ...
    if (_tr_str_eq(_tr_strz(cc), _tr_strz(_tr_str_lit("cc")))) {
        /* pass */
        _tr_str_release(null_dev);
        return ({ TrStr _aet_t2237 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" --version 2>&1 | grep -qi clang")))); __auto_type _wr = ((_tr_system(_aet_t2237.data) == 0LL)); _tr_str_release(_aet_t2237); _wr; });
    }
    /* pass */
    _tr_str_release(null_dev);
    return false;
...
__attribute__((hot)) TrStr detect_cross_compiler(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t2238 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t2238;
    }
    /* pass */
    if (_tr_str_contains(_tr_strz(triple), _tr_strz(_tr_str_lit("android")))) {
        ...
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t2239 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("ANDROID_NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t2239;
        }
        /* pass */
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t2240 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t2240;
        }
        /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t2242 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t2242.data) == 0LL)); _tr_str_release(_aet_t2242); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
...
__attribute__((hot)) TrStr read_runtime_header(TrStr bin_path, TrStr input_path) {
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        /* pass */
        if (({ TrStr _at_t2243 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t2243)); _tr_str_release(_at_t2243); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            return ({ TrStr _at_t2244 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t2244)); _tr_str_release(_at_t2244); _wr; });
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t2245 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t2245)); _tr_str_release(_at_t2245); _wr; });
        /* pass */
        if (({ TrStr _at_t2246 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t2246)); _tr_str_release(_at_t2246); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t2247 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t2247)); _tr_str_release(_at_t2247); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t2248 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t2248)); _tr_str_release(_at_t2248); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t2249 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t2249)); _tr_str_release(_at_t2249); _wr; });
        }
        /* pass */
        TrStr gp = ({ TrStr _at_t2250 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t2250)); _tr_str_release(_at_t2250); _wr; });
        /* pass */
        if (({ TrStr _at_t2251 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t2251)); _tr_str_release(_at_t2251); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            ...
            return ({ TrStr _at_t2252 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t2252)); _tr_str_release(_at_t2252); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t2253 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t2253)); _tr_str_release(_at_t2253); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t2254 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t2254)); _tr_str_release(_at_t2254); _wr; });
        }
        _tr_str_release(src_dir);
        _tr_str_release(parent);
    }
...
__attribute__((hot)) TrStr ensure_builtin_dirs(TrStr build_dir, TrStr dot_path) {
    ...
    while (true) {
        ...
        if ((c == 46LL)) {
            ...
            /* pass */
            TrStr _strtmp_t2255 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(current), _tr_strz(seg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("/"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(current);
            current = _strtmp_t2255;
            /* pass */
            make_dir(current);
            /* pass */
            start = (i + 1LL);
...
__attribute__((hot)) void make_dir(TrStr path) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t2256 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(path)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("mkdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2256.data); _tr_str_release(_aet_t2256); });
    } else {
        /* pass */
        ({ TrStr _aet_t2257 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("mkdir -p \"")), _tr_strz(path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2257.data); _tr_str_release(_aet_t2257); });
    }
}
...
__attribute__((hot)) long long compile_all_c(List_TrStr* c_files, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t2258 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t2258;
        /* pass */
        TrStr _strtmp_t2259 = detect_cross_compiler(triple);
        _tr_str_release(cc);
        cc = _strtmp_t2259;
        /* pass */
        TrStr _strtmp_t2260 = _tr_strx_concat(_tr_strz(_tr_str_lit(" --target=")), _tr_strz(triple));
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t2260;
        /* pass */
        TrStr _strtmp_t2261 = ({ TrStr _cr = (target_extra_flags(triple)); TrStr _cres = _tr_strx_concat(_tr_strz(cross_flags), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t2261;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t2262 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t2262;
        }
    }
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t2263 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t2263;
    }
    /* pass */
    ...
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t2264 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t2264;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t2265 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t2265;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t2266 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t2266;
    }
    /* pass */
    ...
    while ((i < c_files->len)) {
        /* pass */
        TrStr _strtmp_t2267 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(c_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t2267;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t2269 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t2269;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t2270 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t2270;
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t2271 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -fsanitize=address,undefined -g")));
        _tr_str_release(cmd);
        cmd = _strtmp_t2271;
    }
    /* pass */
    if (_tr_is_windows()) {
        ...
        if (need_wsa) {
            /* pass */
            TrStr _strtmp_t2272 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -mconsole")));
            _tr_str_release(cmd);
            cmd = _strtmp_t2272;
        }
    }
...
__attribute__((hot)) long long compile_all_c_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode, bool build_shared) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t2273 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t2273;
        /* pass */
        TrStr _strtmp_t2274 = detect_cross_compiler(triple);
        _tr_str_release(cc);
        cc = _strtmp_t2274;
        /* pass */
        TrStr _strtmp_t2275 = _tr_strx_concat(_tr_strz(_tr_str_lit(" --target=")), _tr_strz(triple));
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t2275;
        /* pass */
        TrStr _strtmp_t2276 = ({ TrStr _cr = (target_extra_flags(triple)); TrStr _cres = _tr_strx_concat(_tr_strz(cross_flags), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t2276;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t2277 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t2278 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t2278;
    }
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t2279 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t2279;
    }
    /* pass */
    TrStr native_flags = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t2280 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t2280;
    }
    /* pass */
    TrStr overflow_flag = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t2281 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t2281;
    }
    /* pass */
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t2282 = _tr_str_lit(" -fsanitize=address,undefined -g");
        _tr_str_release(dbg);
        dbg = _strtmp_t2282;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t2283 = _tr_str_lit(" -fPIC");
        _tr_str_release(pic);
        pic = _strtmp_t2283;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t2284 = _tr_str_lit(" -shared");
        _tr_str_release(shared_flag);
        shared_flag = _strtmp_t2284;
    }
    /* pass */
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t2285 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t2285;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < link_paths->len)) {
        /* pass */
        TrStr _strtmp_t2286 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(link_paths, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t2286;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t2287 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t2287;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t2288 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t2288;
    /* pass */
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t2289 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -mconsole")));
        _tr_str_release(cmd);
        cmd = _strtmp_t2289;
    }
    /* pass */
...
__attribute__((hot)) long long compile_c_to_exe(TrStr c_path, TrStr exe_path, TrStr opt_level, bool verbose) {
    ...
    /* pass */
    TrStr out_dir = ({ TrStr _at_t2290 = (dir_of_path(c_path)); __auto_type _wr = (strip_trailing_sep(_at_t2290)); _tr_str_release(_at_t2290); _wr; });
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t2291 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t2291;
    }
    /* pass */
...
__attribute__((hot)) void _print_diag(TrStr level, TrStr msg) {
    ...
    if ((fix_idx >= 0LL)) {
        /* pass */
        TrStr _strtmp_t2293 = ({ TrStr _wt_t2292 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), 0LL, fix_idx))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t2292.data))); _tr_str_release(_wt_t2292); _wr; });
        _tr_str_release(main_part);
        main_part = _strtmp_t2293;
        /* pass */
        TrStr _strtmp_t2295 = ({ TrStr _wt_t2294 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), (fix_idx + 4LL), _tr_strlen(_tr_strz(msg))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t2294.data))); _tr_str_release(_wt_t2294); _wr; });
        _tr_str_release(fix_part);
        fix_part = _strtmp_t2295;
    }
    /* pass */
    ...
    if ((pe > 0LL)) {
        ...
        if ((ln > 0LL)) {
            /* pass */
            TrStr _strtmp_t2296 = _tr_str_retain(head);
            _tr_str_release(loc_str);
            loc_str = _strtmp_t2296;
            /* pass */
            TrStr _strtmp_t2297 = loc_file(head);
            _tr_str_release(file_path);
            file_path = _strtmp_t2297;
            /* pass */
            line_no = ln;
            /* pass */
            TrStr _strtmp_t2298 = _tr_str_wrap(_tr_str_slice(_tr_strz(main_part), (pe + 2LL), _tr_strlen(_tr_strz(main_part))));
    ...
    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2299 = c_yellow(level);
        _tr_str_release(lvl);
        lvl = _strtmp_t2299;
    }
    /* pass */
    ...
    if ((_tr_strlen(_tr_strz(loc_str)) > 0LL)) {
        ...
        if ((_tr_strlen(_tr_strz(file_path)) > 0LL)) {
            /* pass */
            TrStr _strtmp_t2300 = read_file(file_path);
            _tr_str_release(src);
            src = _strtmp_t2300;
        }
        /* pass */
        if ((_tr_strlen(_tr_strz(src)) > 0LL)) {
            ...
            if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
                ...
                if ((col > 0LL)) {
                    ...
                    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t2301 = c_yellow(underline);
...
__attribute__((hot)) void cleanup_build(TrStr build_dir, List_TrStr* all_c_files) {
    ...
    while ((di < all_c_files->len)) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            ({ TrStr _at_t2302 = (List_TrStr_get(all_c_files, di)); TrStr _aet_t2303 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t2302)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2303.data); _tr_str_release(_at_t2302); _tr_str_release(_aet_t2303); });
        } else {
            /* pass */
            ({ TrStr _aet_t2304 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(all_c_files, di)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2304.data); _tr_str_release(_aet_t2304); });
        }
        /* pass */
        di = (di + 1LL);
    }
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _at_t2305 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_types.h")))); TrStr _aet_t2306 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t2305)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2306.data); _tr_str_release(_at_t2305); _tr_str_release(_aet_t2306); });
        /* pass */
        ({ TrStr _at_t2307 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); TrStr _aet_t2308 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t2307)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2308.data); _tr_str_release(_at_t2307); _tr_str_release(_aet_t2308); });
        /* pass */
        ({ TrStr _at_t2309 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("include")))); TrStr _aet_t2310 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t2309)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir /S /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2310.data); _tr_str_release(_at_t2309); _tr_str_release(_aet_t2310); });
        /* pass */
        ({ TrStr _aet_t2311 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(build_dir)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2311.data); _tr_str_release(_aet_t2311); });
    } else {
        /* pass */
        ({ TrStr _aet_t2312 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_types.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2312.data); _tr_str_release(_aet_t2312); });
        /* pass */
        ({ TrStr _aet_t2313 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_rt.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2313.data); _tr_str_release(_aet_t2313); });
        /* pass */
        ({ TrStr _aet_t2314 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -rf \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2314.data); _tr_str_release(_aet_t2314); });
        /* pass */
        ({ TrStr _aet_t2315 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t2315.data); _tr_str_release(_aet_t2315); });
    }
}
...
__attribute__((hot)) void run_fmt(TrStr path0, bool write_in_place) {
    ...
    if (((!file_exists(path)) && (!str_ends_with_dot_tr(path)))) {
        /* pass */
        TrStr _strtmp_t2316 = _tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".tr")));
...
__attribute__((hot)) int main(int argc, char** argv) {
    ...
    if ((args->len >= 2LL)) {
        ...
        if (((strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("fmt"))) == 0) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("lint"))) == 0))) {
            /* pass */
            TrStr _strtmp_t2317 = _tr_str_retain(a1);
            _tr_str_release(subcmd);
            subcmd = _strtmp_t2317;
        }
    }
    /* pass */
        ...
        while ((fk < args->len)) {
            ...
            if (((strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("-w"))) == 0) || (strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("--write"))) == 0))) {
                ...
                if ((strcmp(_tr_strz(fpath), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t2318 = _tr_str_retain(fa);
    ...
    while ((i < args->len)) {
        ...
        if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--version"))) == 0)) {
            ...
            backend = _strtmp_t2320;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-o"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t2321 = List_TrStr_get(args, i);
            _tr_str_release(output_path);
            output_path = _strtmp_t2321;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--link"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t2322 = (List_TrStr_get(args, i)); List_TrStr_append(link_paths, _at_t2322); _tr_str_release(_at_t2322); });
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-l"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t2323 = (({ TrStr _cr = (List_TrStr_get(args, i)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t2323); _tr_str_release(_at_t2323); });
            ...
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t2329 = List_TrStr_get(args, i);
            _tr_str_release(target);
            target = _strtmp_t2329;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--sysroot"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t2330 = List_TrStr_get(args, i);
            _tr_str_release(sysroot);
            sysroot = _strtmp_t2330;
            ...
            if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t2331 = _tr_str_retain(arg);
                _tr_str_release(input_path);
                input_path = _strtmp_t2331;
            }
        }
        /* pass */
        i = (i + 1LL);
    ...
    if (((!file_exists(input_path)) && (!str_ends_with_dot_tr(input_path)))) {
        /* pass */
        TrStr _strtmp_t2332 = _tr_strx_concat(_tr_strz(input_path), _tr_strz(_tr_str_lit(".tr")));
        _tr_str_release(input_path);
        input_path = _strtmp_t2332;
    }
    /* pass */
    if (verbose) {
        /* pass */
    ...
    /* pass */
    TrStr bin_dir = ({ TrStr _at_t2333 = (_tr_str_wrap(_tr_exe_dir())); __auto_type _wr = (strip_trailing_sep_inline(_at_t2333)); _tr_str_release(_at_t2333); _wr; });
    /* pass */
    ModuleResolver_add_search_path(resolver, bin_dir);
    /* pass */
    ({ TrStr _at_t2334 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/std")))); ModuleResolver_add_search_path(resolver, _at_t2334); _tr_str_release(_at_t2334); });
    /* pass */
    ({ TrStr _at_t2335 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages")))); ModuleResolver_add_search_path(resolver, _at_t2335); _tr_str_release(_at_t2335); });
    /* pass */
    ({ TrStr _at_t2336 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages/sites")))); ModuleResolver_add_search_path(resolver, _at_t2336); _tr_str_release(_at_t2336); });
    /* pass */
    ...
    if ((strcmp(_tr_strz(tauraro_path_env), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        while ((epi < ep_count)) {
            /* pass */
            ({ TrStr _at_t2337 = (get_path_env_entry(tauraro_path_env, epi)); ModuleResolver_add_search_path(resolver, _at_t2337); _tr_str_release(_at_t2337); });
            /* pass */
            epi = (epi + 1LL);
        }
    }
    ...
    if ((sema->warnings->len > 0LL)) {
        ...
        while ((wk < sema->warnings->len)) {
            /* pass */
            ({ TrStr _at_t2338 = (List_TrStr_get(sema->warnings, wk)); _print_diag(_tr_str_lit("warning"), _at_t2338); _tr_str_release(_at_t2338); });
            /* pass */
            wk = (wk + 1LL);
        }
    }
    ...
    if ((sema->errors->len > 0LL)) {
        ...
        while ((k < sema->errors->len)) {
            /* pass */
            ({ TrStr _at_t2339 = (List_TrStr_get(sema->errors, k)); _print_diag(_tr_str_lit("error"), _at_t2339); _tr_str_release(_at_t2339); });
            /* pass */
            k = (k + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("llvm"))) == 0)) {
        ...
        if ((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t2340 = ({ TrStr _cl = (strip_extension(input_path)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".ll"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(output_path);
            output_path = _strtmp_t2340;
        }
        /* pass */
    ...
    /* pass */
    TrStr rt_h = ({ TrStr _at_t2341 = (List_TrStr_get(args, 0LL)); __auto_type _wr = (read_runtime_header(_at_t2341, input_path)); _tr_str_release(_at_t2341); _wr; });
    /* pass */
    ...
    /* pass */
    TrStr _strtmp_t2342 = ({ TrStr _cr = (CGenerator_generate_module_compat(c_gen, resolver->all_decl_modules, resolver->all_decls)); TrStr _cres = _tr_strx_concat(_tr_strz(types_h), _cr.data); _tr_str_release(_cr); _cres; });
    _tr_str_release(types_h);
    types_h = _strtmp_t2342;
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t2343 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";static")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t2343;
    }
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t2344 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";debug")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t2344;
    }
    /* pass */
    if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t2345 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";sysroot=")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; });
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t2345;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(rt_h), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _at_t2346 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); write_file(_at_t2346, rt_h); _tr_str_release(_at_t2346); });
    }
    /* pass */
    ...
    while ((mi < resolver->mod_dot_paths->len)) {
        ...
        while ((k < resolver->all_decl_modules->len)) {
            ...
            if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k)), _tr_strz(dot_path)) == 0)) {
                /* pass */
                __auto_type _t2347 = (*((Decl*)List_ptr_get(resolver->all_decls, k)));
                if (_t2347.tag == Decl_DClass) {
                    __auto_type c = _t2347.data.DClass.cls;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(c->name), true);
                } else if (_t2347.tag == Decl_DFunction) {
                    __auto_type f = _t2347.data.DFunction.func;
                    /* pass */
                    _tr_dict_set(fn_set, _tr_strz(f->name), true);
                    _tr_obj_release(f, _trdrop_FunctionDef);
                } else if (_t2347.tag == Decl_DEnum) {
                    __auto_type e = _t2347.data.DEnum.enm;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(e->name), true);
                } else if (_t2347.tag == Decl_DInterface) {
                    __auto_type iface = _t2347.data.DInterface.iface;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(iface->name), true);
                } else if (_t2347.tag == Decl_DExtend) {
                    __auto_type target = _t2347.data.DExtend.target;
__auto_type methods = _t2347.data.DExtend.methods;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(target), true);
                    _tr_str_release(target);
                } else if (1) {
                    __auto_type _ = _t2347;
                    /* pass */
                }
            }
            /* pass */
        ...
        if (is_builtin_mod(dot_path)) {
            /* pass */
            TrStr _strtmp_t2348 = ensure_builtin_dirs(build_dir, dot_path);
            _tr_str_release(c_path);
            c_path = _strtmp_t2348;
            /* pass */
        ...
        if ((c_gen->emit_line_info && (mi < resolver->mod_file_paths->len))) {
            /* pass */
            c_gen->cur_src_file = ({ TrStr _at_t2350 = (List_TrStr_get(resolver->mod_file_paths, mi)); __auto_type _wr = (to_fwd_slashes(_at_t2350)); _tr_str_release(_at_t2350); _wr; });
        }
        /* pass */
    ...
    while ((k2 < resolver->all_decl_modules->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k2)), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            __auto_type _t2351 = (*((Decl*)List_ptr_get(resolver->all_decls, k2)));
            if (_t2351.tag == Decl_DClass) {
                __auto_type c = _t2351.data.DClass.cls;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(c->name), true);
            } else if (_t2351.tag == Decl_DFunction) {
                __auto_type f = _t2351.data.DFunction.func;
                /* pass */
                _tr_dict_set(main_fn_set, _tr_strz(f->name), true);
                _tr_obj_release(f, _trdrop_FunctionDef);
            } else if (_t2351.tag == Decl_DEnum) {
                __auto_type e = _t2351.data.DEnum.enm;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(e->name), true);
            } else if (_t2351.tag == Decl_DInterface) {
                __auto_type iface = _t2351.data.DInterface.iface;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(iface->name), true);
            } else if (_t2351.tag == Decl_DExtend) {
                __auto_type target = _t2351.data.DExtend.target;
__auto_type methods = _t2351.data.DExtend.methods;
                /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("c"))) == 0)) {
        ...
        while ((pi < (all_c_files->len - 1LL))) {
            /* pass */
            ({ TrStr _at_t2352 = (List_TrStr_get(all_c_files, pi)); ({ printf("%s", _tr_strz(({ TrStr _cr = (get_filename(_at_t2352)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _cr.data); _tr_str_release(_cr); _cres; }))); printf("\n"); }); _tr_str_release(_at_t2352); });
            /* pass */
            pi = (pi + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t2353 = _tr_str_retain(output_path);
        _tr_str_release(exe_name);
        exe_name = _strtmp_t2353;
    } else {
        /* pass */
        TrStr _strtmp_t2355 = ({ TrStr _at_t2354 = (get_filename(input_path)); __auto_type _wr = (strip_extension(_at_t2354)); _tr_str_release(_at_t2354); _wr; });
        _tr_str_release(exe_name);
        exe_name = _strtmp_t2355;
    }
    /* pass */
    if ((strcmp(_tr_strz(exe_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t2356 = _tr_str_lit("a");
        _tr_str_release(exe_name);
            ...
            if ((((long long)((*(en_p + (en_len - 3LL))))) == 101LL)) {
                ...
                if ((((long long)((*(en_p + (en_len - 2LL))))) == 120LL)) {
                    ...
                    if ((((long long)((*(en_p + (en_len - 1LL))))) == 101LL)) {
                        /* pass */
                        TrStr _strtmp_t2357 = _tr_str_wrap(_tr_str_slice(_tr_strz(exe_name), 0LL, (en_len - 4LL)));
                        _tr_str_release(exe_name);
                        exe_name = _strtmp_t2357;
                    }
                }
            }
        }
    ...
    if (lib_mode) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t2358 = _tr_str_lit(".dll");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t2358;
        } else {
            /* pass */
            TrStr _strtmp_t2359 = _tr_str_lit(".so");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t2359;
        }
    } else if ((!_tr_is_windows())) {
        /* pass */
        TrStr _strtmp_t2360 = _tr_str_lit("");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t2360;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t2361 = _tr_strx_concat(_tr_strz(exe_name), _tr_strz(exe_ext));
        _tr_str_release(exe_path);
        exe_path = _strtmp_t2361;
    } else {
        /* pass */
        TrStr _strtmp_t2362 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(exe_name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(exe_ext)); _tr_str_release(_cl); _cres; });
        _tr_str_release(exe_path);
        exe_path = _strtmp_t2362;
    }
    /* pass */
    if (lib_mode) {
        /* pass */
        ...
        if ((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t2363 = _tr_strx_concat(_tr_strz(exe_name), _tr_strz(_tr_str_lit(".h")));
            _tr_str_release(hdr_path);
            hdr_path = _strtmp_t2363;
        }
        /* pass */
    ...
    if (run_after) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t2364 = path_to_native(run_path);
            _tr_str_release(run_path);
            run_path = _strtmp_t2364;
        }
        /* pass */
        long long run_rc = ({ TrStr _aet_t2365 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(run_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t2365.data)); _tr_str_release(_aet_t2365); _wr; });
        /* pass */
        exit((int)(run_rc));
    }
    _tr_str_release(subcmd);
