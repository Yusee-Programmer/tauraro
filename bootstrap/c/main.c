...
__attribute__((hot)) TrStr detect_c_compiler() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3481 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3481;
    }
    /* pass */
    if (({ TrStr _aet_t3482 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("gcc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3482.data) == 0LL)); _tr_str_release(_aet_t3482); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("gcc");
    }
    /* pass */
    if (({ TrStr _aet_t3483 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3483.data) == 0LL)); _tr_str_release(_aet_t3483); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
    /* pass */
    if (({ TrStr _aet_t3484 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3484.data) == 0LL)); _tr_str_release(_aet_t3484); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("cc");
    }
    /* pass */
    if (({ TrStr _aet_t3485 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3485.data) == 0LL)); _tr_str_release(_aet_t3485); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
...
__attribute__((hot)) bool is_clang_compiler(TrStr cc) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3486 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3486;
    }
    /* pass */
    ...
    if (_tr_str_eq(_tr_strz(cc), _tr_strz(_tr_str_lit("cc")))) {
        /* pass */
        _tr_str_release(null_dev);
        return ({ TrStr _aet_t3487 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" --version 2>&1 | grep -qi clang")))); __auto_type _wr = ((_tr_system(_aet_t3487.data) == 0LL)); _tr_str_release(_aet_t3487); _wr; });
    }
    /* pass */
    _tr_str_release(null_dev);
    return false;
...
__attribute__((hot)) TrStr pkg_config_query(TrStr name, TrStr kind) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3488 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3488;
    }
    /* pass */
    TrStr tmp = _tr_str_lit("_tr_pkgcfg.txt");
    /* pass */
    long long rc = ({ TrStr _aet_t3489 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("pkg-config ")), _tr_strz(kind))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" > \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tmp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(null_dev)); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3489.data)); _tr_str_release(_aet_t3489); _wr; });
    /* pass */
    if ((rc != 0LL)) {
        /* pass */
        _tr_str_release(null_dev);
    ...
    while ((mi < mod_file_paths->len)) {
        ...
        while ((li < lines->len)) {
            ...
            if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-shim:"))) {
                /* pass */
                TrStr _strtmp_t3491 = ({ TrStr _wt_t3490 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 19LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3490.data))); _tr_str_release(_wt_t3490); _wr; });
                _tr_str_release(shim);
                shim = _strtmp_t3491;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-cflags:"))) {
                /* pass */
                TrStr _strtmp_t3493 = ({ TrStr _wt_t3492 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 21LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3492.data))); _tr_str_release(_wt_t3492); _wr; });
                _tr_str_release(cflags);
                cflags = _strtmp_t3493;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-linkflags:"))) {
                /* pass */
                TrStr _strtmp_t3495 = ({ TrStr _wt_t3494 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 24LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3494.data))); _tr_str_release(_wt_t3494); _wr; });
                _tr_str_release(linkflags);
                linkflags = _strtmp_t3495;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-lib:"))) {
                /* pass */
                ({ TrStr _wt_t3496 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 18LL, _tr_strlen(_tr_strz(ln))))); TrStr _wt_t3497 = (_tr_str_wrap(_tr_str_strip(_wt_t3496.data))); TrStr _wt_t3498 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 18LL, _tr_strlen(_tr_strz(ln))))); TrStr _at_t3499 = (_tr_str_wrap(_tr_str_strip(_wt_t3498.data))); List_TrStr_append(libs, _at_t3499); _tr_str_release(_wt_t3496); _tr_str_release(_wt_t3497); _tr_str_release(_wt_t3498); _tr_str_release(_at_t3499); });
        ...
        if ((strcmp(_tr_strz(shim), _tr_strz(_tr_str_lit(""))) != 0)) {
            ...
            if ((!file_exists(shim_src))) {
                ...
                if (file_exists(cand)) {
                    /* pass */
                    TrStr _strtmp_t3500 = _tr_str_retain(cand);
                    _tr_str_release(shim_src);
                    shim_src = _strtmp_t3500;
                } else {
                    /* pass */
            ...
            if ((!_tr_dict_contains(seen, _tr_strz(shim_src)))) {
                ...
                if (is_c_only) {
                    /* pass */
                    TrStr _strtmp_t3501 = _tr_strx_concat(_tr_strz(_tr_str_lit("C\n")), _tr_strz(shim_txt));
                    _tr_str_release(cache_key);
                    cache_key = _strtmp_t3501;
                }
                /* pass */
                bool need = true;
                /* pass */
                ...
                if (need) {
                    ...
                    if (is_c_only) {
                        ...
                        if ((!_tr_str_contains(_tr_strz(cflags), _tr_strz(_tr_str_lit("-std"))))) {
                            /* pass */
                            TrStr _strtmp_t3503 = _tr_str_lit(" -std=c++17");
                            _tr_str_release(stdflag);
                            stdflag = _strtmp_t3503;
                        }
                        /* pass */
                        ...
                        if (lto) {
                            /* pass */
                            TrStr _strtmp_t3504 = _tr_str_lit(" -flto");
                            _tr_str_release(ltof);
                            ltof = _strtmp_t3504;
                        }
                        /* pass */
                        TrStr _strtmp_t3505 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cxx), _tr_strz(_tr_str_lit(" -O")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(opt_level)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ltof)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(stdflag)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -c \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(shim_src)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cflags)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(oname)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(ccmd);
                        ccmd = _strtmp_t3505;
                        /* pass */
                        if (verbose) {
                ...
                while ((bi < libs->len)) {
                    /* pass */
                    ({ TrStr _at_t3506 = (({ TrStr _cr = (List_TrStr_get(libs, bi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3506); _tr_str_release(_at_t3506); });
                    /* pass */
                    bi = (bi + 1LL);
                }
...
__attribute__((hot)) TrStr linker_script_cortex_m() {
    ...
    /* pass */
    TrStr _strtmp_t3507 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_tr_reset)\n")));
    _tr_str_release(s);
    s = _strtmp_t3507;
    /* pass */
    TrStr _strtmp_t3508 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("MEMORY {\n")));
    _tr_str_release(s);
    s = _strtmp_t3508;
    /* pass */
    TrStr _strtmp_t3509 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  FLASH (rx)  : ORIGIN = 0x00000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3509;
    /* pass */
    TrStr _strtmp_t3510 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM   (rwx) : ORIGIN = 0x20000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3510;
    /* pass */
    TrStr _strtmp_t3511 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3511;
    /* pass */
    TrStr _strtmp_t3512 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3512;
    /* pass */
    TrStr _strtmp_t3513 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .isr_vector : { KEEP(*(.isr_vector)) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3513;
    /* pass */
    TrStr _strtmp_t3514 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { *(.text*) *(.rodata*) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3514;
    /* pass */
    TrStr _strtmp_t3515 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _sidata = LOADADDR(.data);\n")));
    _tr_str_release(s);
    s = _strtmp_t3515;
    /* pass */
    TrStr _strtmp_t3516 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { _sdata = .; *(.data*) _edata = .; } > RAM AT > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3516;
    /* pass */
    TrStr _strtmp_t3517 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3517;
    /* pass */
    TrStr _strtmp_t3518 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(8);\n")));
    _tr_str_release(s);
    s = _strtmp_t3518;
    /* pass */
    TrStr _strtmp_t3519 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3519;
    /* pass */
    TrStr _strtmp_t3520 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = ORIGIN(RAM) + LENGTH(RAM);\n")));
    _tr_str_release(s);
    s = _strtmp_t3520;
    /* pass */
    TrStr _strtmp_t3521 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3521;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr linker_script_riscv() {
    ...
    /* pass */
    TrStr _strtmp_t3522 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_start)\n")));
    _tr_str_release(s);
    s = _strtmp_t3522;
    /* pass */
    TrStr _strtmp_t3523 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("MEMORY {\n")));
    _tr_str_release(s);
    s = _strtmp_t3523;
    /* pass */
    TrStr _strtmp_t3524 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM (rwx) : ORIGIN = 0x80000000, LENGTH = 128M\n")));
    _tr_str_release(s);
    s = _strtmp_t3524;
    /* pass */
    ...
    s = _strtmp_t3525;
    /* pass */
    TrStr _strtmp_t3526 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3526;
    /* pass */
    TrStr _strtmp_t3527 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { KEEP(*(.text.init)) *(.text*) *(.rodata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3527;
    /* pass */
    TrStr _strtmp_t3528 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { *(.data*) *(.sdata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3528;
    /* pass */
    TrStr _strtmp_t3529 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* .sbss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3529;
    /* pass */
    TrStr _strtmp_t3530 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(16);\n")));
    _tr_str_release(s);
    s = _strtmp_t3530;
    /* pass */
    TrStr _strtmp_t3531 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3531;
    /* pass */
    TrStr _strtmp_t3532 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = .;\n")));
    _tr_str_release(s);
    s = _strtmp_t3532;
    /* pass */
    TrStr _strtmp_t3533 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3533;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr detect_cross_compiler(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3534 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3534;
    }
    /* pass */
    if (_tr_str_contains(_tr_strz(triple), _tr_strz(_tr_str_lit("android")))) {
        ...
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3535 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("ANDROID_NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3535;
        }
        /* pass */
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3536 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3536;
        }
        /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3538 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3538.data) == 0LL)); _tr_str_release(_aet_t3538); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
...
__attribute__((hot)) TrStr detect_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3539 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3539;
    }
    /* pass */
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3540 = path_to_native(z);
        _tr_str_release(z);
        z = _strtmp_t3540;
    }
    /* pass */
...
__attribute__((hot)) bool activate_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3541 = path_to_native(zdir);
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3542 = _tr_str_lit(";");
        _tr_str_release(sep);
        sep = _strtmp_t3542;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _aet_t3543 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(zdir), _tr_strz(sep))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur)); _tr_str_release(_cl); _cres; })); _tr_setenv(_tr_strz(_tr_str_lit("PATH")), _aet_t3543.data); _tr_str_release(_aet_t3543); });
    /* pass */
    _tr_str_release(zbin);
    _tr_str_release(zdir);
    _tr_str_release(sep);
...
__attribute__((hot)) TrStr detect_lld_flag() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3545 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3545;
    }
    /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3548 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("ld.lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3548.data) == 0LL)); _tr_str_release(_aet_t3548); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
    ...
    /* pass */
    if (({ TrStr _aet_t3549 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3549.data) == 0LL)); _tr_str_release(_aet_t3549); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
...
__attribute__((hot)) TrStr resolve_cross_driver(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        ...
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3550;
    }
    /* pass */
    if (({ TrStr _aet_t3551 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3551.data) == 0LL)); _tr_str_release(_aet_t3551); _wr; })) {
        /* pass */
...
__attribute__((hot)) TrStr find_native_abi_c(TrStr input_path) {
    ...
    /* pass */
    if (({ TrStr _at_t3552 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3552)); _tr_str_release(_at_t3552); _wr; })) {
        /* pass */
        return _tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")));
    }
    /* pass */
    if (({ TrStr _at_t3553 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3553)); _tr_str_release(_at_t3553); _wr; })) {
        /* pass */
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        /* pass */
        if (({ TrStr _at_t3554 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3554)); _tr_str_release(_at_t3554); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            return _tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")));
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3555 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3555)); _tr_str_release(_at_t3555); _wr; });
        /* pass */
        if (({ TrStr _at_t3556 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3556)); _tr_str_release(_at_t3556); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
        ...
        /* pass */
        TrStr gp = ({ TrStr _at_t3557 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3557)); _tr_str_release(_at_t3557); _wr; });
        /* pass */
        if (({ TrStr _at_t3558 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3558)); _tr_str_release(_at_t3558); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src_dir);
...
__attribute__((hot)) TrStr read_runtime_header(TrStr bin_path, TrStr input_path) {
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        TrStr src_dir = dir_of_path(input_path);
        /* pass */
        if (({ TrStr _at_t3559 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3559)); _tr_str_release(_at_t3559); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            return ({ TrStr _at_t3560 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3560)); _tr_str_release(_at_t3560); _wr; });
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3561 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3561)); _tr_str_release(_at_t3561); _wr; });
        /* pass */
        if (({ TrStr _at_t3562 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3562)); _tr_str_release(_at_t3562); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3563 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3563)); _tr_str_release(_at_t3563); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3564 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3564)); _tr_str_release(_at_t3564); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3565 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3565)); _tr_str_release(_at_t3565); _wr; });
        }
        /* pass */
        TrStr gp = ({ TrStr _at_t3566 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3566)); _tr_str_release(_at_t3566); _wr; });
        /* pass */
        if (({ TrStr _at_t3567 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3567)); _tr_str_release(_at_t3567); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3568 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3568)); _tr_str_release(_at_t3568); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3569 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3569)); _tr_str_release(_at_t3569); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3570 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3570)); _tr_str_release(_at_t3570); _wr; });
        }
        _tr_str_release(src_dir);
        _tr_str_release(parent);
    }
...
__attribute__((hot)) TrStr out_dir_prefix(TrStr out_dir) {
    ...
    if ((!(_tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("/"))) || _tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("\\")))))) {
        /* pass */
        TrStr _strtmp_t3571 = _tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit("/")));
        _tr_str_release(d);
        d = _strtmp_t3571;
    }
    /* pass */
...
__attribute__((hot)) TrStr resolve_output_stem(TrStr input_path, TrStr output_path, TrStr out_dir) {
    ...
    if (((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0) && has_path_sep(output_path))) {
        /* pass */
        ({ TrStr _at_t3572 = (dir_of_path(output_path)); make_dir(_at_t3572); _tr_str_release(_at_t3572); });
        /* pass */
    ...
    /* pass */
    return ({ TrStr _at_t3573 = (get_filename(input_path)); __auto_type _wr = (({ TrStr _cr = (strip_extension(_at_t3573)); TrStr _cres = _tr_strx_concat(_tr_strz(pref), _cr.data); _tr_str_release(_cr); _cres; })); _tr_str_release(_at_t3573); _wr; });
}
...
__attribute__((hot)) TrStr ensure_builtin_dirs(TrStr build_dir, TrStr dot_path) {
    ...
    while (true) {
        ...
        if ((c == 46LL)) {
            ...
            /* pass */
            TrStr _strtmp_t3574 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(current), _tr_strz(seg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("/"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(current);
            current = _strtmp_t3574;
            /* pass */
            make_dir(current);
            /* pass */
            start = (i + 1LL);
...
__attribute__((hot)) void make_dir(TrStr path) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t3575 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(path)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("mkdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3575.data); _tr_str_release(_aet_t3575); });
    } else {
        /* pass */
        ({ TrStr _aet_t3576 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("mkdir -p \"")), _tr_strz(path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3576.data); _tr_str_release(_aet_t3576); });
    }
}
...
__attribute__((hot)) long long compile_all_c(List_TrStr* c_files, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3577 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3577;
        /* pass */
        TrStr _strtmp_t3578 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3578;
        /* pass */
        TrStr _strtmp_t3579 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3579;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3580 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3580;
        }
    }
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3581 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3581;
    }
    /* pass */
    ...
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3582 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3582;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3583 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3583;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3584 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3584;
    }
    /* pass */
    ...
    while ((i < c_files->len)) {
        /* pass */
        TrStr _strtmp_t3585 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(c_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3585;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3587 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3587;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3588 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3588;
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3589 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -fsanitize=address,undefined -g")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3589;
    }
    /* pass */
    if (out_is_windows(target, triple)) {
        ...
        if (need_wsa) {
            /* pass */
            TrStr _strtmp_t3590 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3590;
        }
    }
...
__attribute__((hot)) long long compile_all_c_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode, bool build_shared, bool link_cxx, bool use_lto) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3591 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3591;
        /* pass */
        TrStr _strtmp_t3592 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3592;
        /* pass */
        TrStr _strtmp_t3593 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3593;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3594 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3594;
        }
    }
    /* pass */
    TrStr static_flag = _tr_str_lit("");
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3595 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3595;
    }
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3596 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3596;
    }
    /* pass */
    TrStr native_flags = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3597 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3597;
    }
    /* pass */
    TrStr overflow_flag = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3598 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3598;
    }
    /* pass */
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3599 = _tr_str_lit(" -fsanitize=address,undefined -g");
        _tr_str_release(dbg);
        dbg = _strtmp_t3599;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3600 = _tr_str_lit(" -fPIC");
        _tr_str_release(pic);
        pic = _strtmp_t3600;
    }
    /* pass */
    ...
    if (use_lto) {
        /* pass */
        TrStr _strtmp_t3601 = _tr_str_lit(" -flto");
        _tr_str_release(lto_flag);
        lto_flag = _strtmp_t3601;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3602 = _tr_str_lit(" -shared");
        _tr_str_release(shared_flag);
        shared_flag = _strtmp_t3602;
    }
    /* pass */
    ...
    if (link_cxx) {
        /* pass */
        TrStr _strtmp_t3603 = cxx_of(cc);
        _tr_str_release(link_driver);
        link_driver = _strtmp_t3603;
    }
    /* pass */
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t3604 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3604;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3606 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3606;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3607 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3607;
    /* pass */
    if (out_is_windows(target, triple)) {
        /* pass */
        TrStr _strtmp_t3608 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3608;
    }
    /* pass */
...
__attribute__((hot)) long long compile_c_to_exe(TrStr c_path, TrStr exe_path, TrStr opt_level, bool verbose) {
    ...
    /* pass */
    TrStr out_dir = ({ TrStr _at_t3609 = (dir_of_path(c_path)); __auto_type _wr = (strip_trailing_sep(_at_t3609)); _tr_str_release(_at_t3609); _wr; });
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3610 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3610;
    }
    /* pass */
...
__attribute__((hot)) void _print_diag(TrStr level, TrStr msg) {
    ...
    if ((fix_idx >= 0LL)) {
        /* pass */
        TrStr _strtmp_t3612 = ({ TrStr _wt_t3611 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), 0LL, fix_idx))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3611.data))); _tr_str_release(_wt_t3611); _wr; });
        _tr_str_release(main_part);
        main_part = _strtmp_t3612;
        /* pass */
        TrStr _strtmp_t3614 = ({ TrStr _wt_t3613 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), (fix_idx + 4LL), _tr_strlen(_tr_strz(msg))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3613.data))); _tr_str_release(_wt_t3613); _wr; });
        _tr_str_release(fix_part);
        fix_part = _strtmp_t3614;
    }
    /* pass */
    ...
    if ((pe > 0LL)) {
        ...
        if ((ln > 0LL)) {
            /* pass */
            TrStr _strtmp_t3615 = _tr_str_retain(head);
            _tr_str_release(loc_str);
            loc_str = _strtmp_t3615;
            /* pass */
            TrStr _strtmp_t3616 = loc_file(head);
            _tr_str_release(file_path);
            file_path = _strtmp_t3616;
            /* pass */
            line_no = ln;
            /* pass */
            TrStr _strtmp_t3617 = _tr_str_wrap(_tr_str_slice(_tr_strz(main_part), (pe + 2LL), _tr_strlen(_tr_strz(main_part))));
    ...
    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
        /* pass */
        TrStr _strtmp_t3618 = c_yellow(level);
        _tr_str_release(lvl);
        lvl = _strtmp_t3618;
    }
    /* pass */
    ...
    if ((_tr_strlen(_tr_strz(loc_str)) > 0LL)) {
        ...
        if ((_tr_strlen(_tr_strz(file_path)) > 0LL)) {
            /* pass */
            TrStr _strtmp_t3619 = read_file(file_path);
            _tr_str_release(src);
            src = _strtmp_t3619;
        }
        /* pass */
        if ((_tr_strlen(_tr_strz(src)) > 0LL)) {
            ...
            if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
                ...
                if ((col > 0LL)) {
                    ...
                    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t3620 = c_yellow(underline);
...
__attribute__((hot)) void cleanup_build(TrStr build_dir, List_TrStr* all_c_files) {
    ...
    while ((di < all_c_files->len)) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            ({ TrStr _at_t3621 = (List_TrStr_get(all_c_files, di)); TrStr _aet_t3622 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3621)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3622.data); _tr_str_release(_at_t3621); _tr_str_release(_aet_t3622); });
        } else {
            /* pass */
            ({ TrStr _aet_t3623 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(all_c_files, di)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3623.data); _tr_str_release(_aet_t3623); });
        }
        /* pass */
        di = (di + 1LL);
    }
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _at_t3624 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_types.h")))); TrStr _aet_t3625 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3624)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3625.data); _tr_str_release(_at_t3624); _tr_str_release(_aet_t3625); });
        /* pass */
        ({ TrStr _at_t3626 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); TrStr _aet_t3627 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3626)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3627.data); _tr_str_release(_at_t3626); _tr_str_release(_aet_t3627); });
        /* pass */
        ({ TrStr _at_t3628 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("include")))); TrStr _aet_t3629 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3628)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir /S /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3629.data); _tr_str_release(_at_t3628); _tr_str_release(_aet_t3629); });
        /* pass */
        ({ TrStr _aet_t3630 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(build_dir)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3630.data); _tr_str_release(_aet_t3630); });
    } else {
        /* pass */
        ({ TrStr _aet_t3631 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_types.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3631.data); _tr_str_release(_aet_t3631); });
        /* pass */
        ({ TrStr _aet_t3632 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_rt.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3632.data); _tr_str_release(_aet_t3632); });
        /* pass */
        ({ TrStr _aet_t3633 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -rf \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3633.data); _tr_str_release(_aet_t3633); });
        /* pass */
        ({ TrStr _aet_t3634 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3634.data); _tr_str_release(_aet_t3634); });
    }
}
...
__attribute__((hot)) void run_fmt(TrStr path0, bool write_in_place) {
    ...
    if (((!file_exists(path)) && (!str_ends_with_dot_tr(path)))) {
        /* pass */
        TrStr _strtmp_t3635 = _tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".tr")));
...
__attribute__((hot)) int main(int argc, char** argv) {
    ...
    if ((args->len >= 2LL)) {
        ...
        if ((((strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("fmt"))) == 0) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("lint"))) == 0)) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("bindgen"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3636 = _tr_str_retain(a1);
            _tr_str_release(subcmd);
            subcmd = _strtmp_t3636;
        }
    }
    /* pass */
        ...
        while ((bk < args->len)) {
            ...
            if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--pkg"))) == 0) && ((bk + 1LL) < args->len))) {
                ...
                if ((strcmp(_tr_strz(pkgcf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3637 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkgcf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_extra);
                    bg_extra = _strtmp_t3637;
                }
                /* pass */
                if ((strcmp(_tr_strz(pkglf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3638 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_pkglibs), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkglf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_pkglibs);
                    bg_pkglibs = _strtmp_t3638;
                }
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-o"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3639 = List_TrStr_get(args, (bk + 1LL));
                _tr_str_release(bg_out);
                bg_out = _strtmp_t3639;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--cc"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3640 = List_TrStr_get(args, (bk + 1LL));
                ...
                /* pass */
                TrStr _strtmp_t3641 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -I\"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                ...
                /* pass */
                TrStr _strtmp_t3642 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -D")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3642;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-isystem"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3643 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -isystem \"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3643;
                /* pass */
                bk = (bk + 1LL);
                ...
                /* pass */
                TrStr _strtmp_t3644 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ba)); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3644;
            } else if ((!str_starts_with(ba, _tr_str_lit("-")))) {
                /* pass */
                if ((strcmp(_tr_strz(bg_header), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3645 = _tr_str_retain(ba);
                    _tr_str_release(bg_header);
                    bg_header = _strtmp_t3645;
                }
            }
            /* pass */
            bk = (bk + 1LL);
        ...
        while ((fk < args->len)) {
            ...
            if (((strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("-w"))) == 0) || (strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("--write"))) == 0))) {
                ...
                if ((strcmp(_tr_strz(fpath), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3646 = _tr_str_retain(fa);
    ...
    while ((i < args->len)) {
        ...
        if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--version"))) == 0)) {
            ...
            _tr_str_release(out_dir);
            out_dir = _strtmp_t3653;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--link"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3654 = (List_TrStr_get(args, i)); List_TrStr_append(link_paths, _at_t3654); _tr_str_release(_at_t3654); });
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-l"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3655 = (({ TrStr _cr = (List_TrStr_get(args, i)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3655); _tr_str_release(_at_t3655); });
            ...
            /* pass */
            TrStr _strtmp_t3656 = _tr_str_lit("0");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3656;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O1"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3657 = _tr_str_lit("1");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3657;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O2"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3658 = _tr_str_lit("2");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3658;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O3"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3659 = _tr_str_lit("3");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3659;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-Os"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3660 = _tr_str_lit("s");
            _tr_str_release(opt_level);
            ...
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3661 = List_TrStr_get(args, i);
            _tr_str_release(target);
            target = _strtmp_t3661;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--sysroot"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3662 = List_TrStr_get(args, i);
            _tr_str_release(sysroot);
            sysroot = _strtmp_t3662;
            ...
            /* pass */
            TrStr _strtmp_t3663 = _tr_str_lit("TAURARO_KERNEL");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3663;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--no-std"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3664 = _tr_str_lit("TAURARO_NO_OS");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3664;
            ...
            if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3665 = _tr_str_retain(arg);
                _tr_str_release(input_path);
                input_path = _strtmp_t3665;
            }
        }
        /* pass */
        i = (i + 1LL);
    ...
    if (((!file_exists(input_path)) && (!str_ends_with_dot_tr(input_path)))) {
        /* pass */
        TrStr _strtmp_t3666 = _tr_strx_concat(_tr_strz(input_path), _tr_strz(_tr_str_lit(".tr")));
        _tr_str_release(input_path);
        input_path = _strtmp_t3666;
    }
    /* pass */
    ...
    /* pass */
    TrStr bin_dir = ({ TrStr _at_t3667 = (_tr_str_wrap(_tr_exe_dir())); __auto_type _wr = (strip_trailing_sep_inline(_at_t3667)); _tr_str_release(_at_t3667); _wr; });
    /* pass */
    ModuleResolver_add_search_path(resolver, bin_dir);
    /* pass */
    ({ TrStr _at_t3668 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/std")))); ModuleResolver_add_search_path(resolver, _at_t3668); _tr_str_release(_at_t3668); });
    /* pass */
    ({ TrStr _at_t3669 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages")))); ModuleResolver_add_search_path(resolver, _at_t3669); _tr_str_release(_at_t3669); });
    /* pass */
    ({ TrStr _at_t3670 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages/sites")))); ModuleResolver_add_search_path(resolver, _at_t3670); _tr_str_release(_at_t3670); });
    /* pass */
    ...
    if ((strcmp(_tr_strz(tauraro_path_env), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        while ((epi < ep_count)) {
            /* pass */
            ({ TrStr _at_t3671 = (get_path_env_entry(tauraro_path_env, epi)); ModuleResolver_add_search_path(resolver, _at_t3671); _tr_str_release(_at_t3671); });
            /* pass */
            epi = (epi + 1LL);
        }
    }
    ...
    if ((sema->warnings->len > 0LL)) {
        ...
        while ((wk < sema->warnings->len)) {
            /* pass */
            ({ TrStr _at_t3672 = (List_TrStr_get(sema->warnings, wk)); _print_diag(_tr_str_lit("warning"), _at_t3672); _tr_str_release(_at_t3672); });
            /* pass */
            wk = (wk + 1LL);
        }
    }
    ...
    if ((sema->errors->len > 0LL)) {
        ...
        while ((k < sema->errors->len)) {
            /* pass */
            ({ TrStr _at_t3673 = (List_TrStr_get(sema->errors, k)); _print_diag(_tr_str_lit("error"), _at_t3673); _tr_str_release(_at_t3673); });
            /* pass */
            k = (k + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("gpu"))) == 0)) {
        ...
        if ((!gpu_gen->ok)) {
            /* pass */
            ({ TrStr _at_t3674 = (_tr_strx_concat(_tr_strz(_tr_str_lit("[GPU] ")), _tr_strz(gpu_gen->fail_note))); _print_diag(_tr_str_lit("error"), _at_t3674); _tr_str_release(_at_t3674); });
            /* pass */
            exit((int)(1LL));
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("llvm"))) == 0)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3675 = resolve_target_triple(target);
            _tr_str_release(lx_triple);
            lx_triple = _strtmp_t3675;
            /* pass */
            lx_is_cross = true;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            /* pass */
            TrStr _strtmp_t3676 = target_extra_flags(lx_triple);
            _tr_str_release(lx_tflags);
            lx_tflags = _strtmp_t3676;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_is_windows()) {
                ...
                lx_xnull = _strtmp_t3677;
            }
            /* pass */
            if (({ TrStr _aet_t3678 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3678.data) == 0LL)); _tr_str_release(_aet_t3678); _wr; })) {
                /* pass */
                TrStr lx_zt = zig_target_of(lx_triple);
                /* pass */
                if ((strcmp(_tr_strz(lx_zt), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3679 = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -target ")), _tr_strz(lx_zt));
                    _tr_str_release(lx_xcc);
                    lx_xcc = _strtmp_t3679;
                    /* pass */
                    lx_via_zig = true;
                }
            }
            /* pass */
            if (({ TrStr _aet_t3680 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((strcmp(_tr_strz(lx_xcc), _tr_strz(_tr_str_lit(""))) == 0) && (_tr_system(_aet_t3680.data) == 0LL))); _tr_str_release(_aet_t3680); _wr; })) {
                /* pass */
                TrStr _strtmp_t3681 = _tr_strx_concat(_tr_strz(_tr_str_lit("clang --target=")), _tr_strz(lx_triple));
                _tr_str_release(lx_xcc);
                lx_xcc = _strtmp_t3681;
            }
            /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) {
                /* pass */
                TrStr _strtmp_t3682 = _tr_str_lit(".wasm");
                _tr_str_release(lx_ext);
                lx_ext = _strtmp_t3682;
                ...
                /* pass */
                TrStr _strtmp_t3683 = _tr_str_lit(".exe");
                _tr_str_release(lx_ext);
                lx_ext = _strtmp_t3683;
            }
        } else if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3684 = _tr_str_lit(".exe");
            _tr_str_release(lx_ext);
            lx_ext = _strtmp_t3684;
        }
        /* pass */
        TrStr lx_exe = ({ TrStr _at_t3685 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3685, lx_ext)); _tr_str_release(_at_t3685); _wr; });
        /* pass */
        ...
        if (((lx_is_cross && _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && _tr_str_contains(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("define i32 @main()"))))) {
            /* pass */
            TrStr _strtmp_t3686 = _tr_strx_concat(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("\n@__main_void = hidden alias i32 (), ptr @main\n")));
            _tr_str_release(llvm_ir);
            llvm_ir = _strtmp_t3686;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3691 = _tr_str_lit("nul");
            _tr_str_release(lx_null);
            lx_null = _strtmp_t3691;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3692 = _tr_strx_concat(_tr_strz(lx_libs), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -lucrtbase -mconsole")));
            _tr_str_release(lx_libs);
            lx_libs = _strtmp_t3692;
            /* pass */
            TrStr _strtmp_t3693 = _tr_strx_concat(_tr_strz(lx_libs_gcc), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt")));
            _tr_str_release(lx_libs_gcc);
            lx_libs_gcc = _strtmp_t3693;
        }
        /* pass */
        bool lx_built = false;
        /* pass */
        if (lx_is_cross) {
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3694 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_cg);
                lx_cg = _strtmp_t3694;
            }
            /* pass */
            if (({ TrStr _aet_t3695 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" -c \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3695.data) != 0LL)); _tr_str_release(_aet_t3695); _wr; })) {
                /* pass */
            ...
            if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm"))) || _tr_str_contains(_tr_strz(lx_tflags), _tr_strz(_tr_str_lit("nostdlib"))))) {
                /* pass */
                TrStr _strtmp_t3696 = _tr_str_lit("");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3696;
            } else if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("windows"))) || _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("mingw"))))) {
                /* pass */
                TrStr _strtmp_t3697 = _tr_str_lit(" -lm -lws2_32 -lbcrypt -mconsole");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3697;
            }
            /* pass */
            ...
            if (((!_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && (!lx_via_zig))) {
                /* pass */
                TrStr _strtmp_t3698 = detect_lld_flag();
                _tr_str_release(lx_xld);
                lx_xld = _strtmp_t3698;
            }
            /* pass */
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3699 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_xlink);
                lx_xlink = _strtmp_t3699;
            }
            /* pass */
            TrStr _strtmp_t3700 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xlibs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xld)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(lx_xlink);
            lx_xlink = _strtmp_t3700;
            /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3701 = _tr_str_lit("x86_64-pc-windows-gnu");
            _tr_str_release(lx_tri);
            lx_tri = _strtmp_t3701;
        }
        /* pass */
        ...
        if ((lx_inproc == 0LL)) {
            /* pass */
            if (({ TrStr _aet_t3702 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3702.data) == 0LL)); _tr_str_release(_aet_t3702); _wr; })) {
                /* pass */
                lx_built = true;
            }
        }
        /* pass */
        if (({ TrStr _aet_t3703 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3703.data) == 0LL))); _tr_str_release(_aet_t3703); _wr; })) {
            /* pass */
        ...
        /* pass */
        if (({ TrStr _aet_t3704 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3704.data) == 0LL))); _tr_str_release(_aet_t3704); _wr; })) {
            /* pass */
            TrStr lx_llc_tri = _tr_str_lit("");
            /* pass */
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3705 = _tr_str_lit(" -mtriple=x86_64-pc-windows-gnu");
                _tr_str_release(lx_llc_tri);
                lx_llc_tri = _strtmp_t3705;
            }
            /* pass */
            if (({ TrStr _aet_t3706 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -O2 -filetype=obj")), _tr_strz(lx_llc_tri))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o build/llvm_out.o 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3706.data) == 0LL)); _tr_str_release(_aet_t3706); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3707 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3707.data) == 0LL)); _tr_str_release(_aet_t3707); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        /* pass */
        if (({ TrStr _aet_t3708 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3708.data) == 0LL))); _tr_str_release(_aet_t3708); _wr; })) {
            /* pass */
            TrStr lx_zrto = _tr_str_lit("build/llvm_runtime_zig.o");
            /* pass */
            if (({ TrStr _aet_t3709 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (dir_of_path(lx_abi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -O2 -w -c \"-I")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_abi)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_zrto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3709.data) == 0LL)); _tr_str_release(_aet_t3709); _wr; })) {
                /* pass */
        ...
        if (run_after) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3711 = path_to_native(lx_run);
                _tr_str_release(lx_run);
                lx_run = _strtmp_t3711;
            }
            /* pass */
            ({ TrStr _aet_t3712 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(lx_run))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); exit((int)(_tr_system(_aet_t3712.data))); _tr_str_release(_aet_t3712); });
        }
        /* pass */
        _tr_str_release(subcmd);
        _tr_str_release(input_path);
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("native"))) == 0)) {
        ...
        /* pass */
        TrStr nat_out = ({ TrStr _at_t3713 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3713, _tr_str_lit(".o"))); _tr_str_release(_at_t3713); _wr; });
        /* pass */
    ...
    /* pass */
    TrStr rt_h = ({ TrStr _at_t3714 = (List_TrStr_get(args, 0LL)); __auto_type _wr = (read_runtime_header(_at_t3714, input_path)); _tr_str_release(_at_t3714); _wr; });
    /* pass */
    ...
    /* pass */
    TrStr _strtmp_t3715 = ({ TrStr _cr = (CGenerator_generate_module_compat(c_gen, resolver->all_decl_modules, resolver->all_decls)); TrStr _cres = _tr_strx_concat(_tr_strz(types_h), _cr.data); _tr_str_release(_cr); _cres; });
    _tr_str_release(types_h);
    types_h = _strtmp_t3715;
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3716 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";static")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3716;
    }
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3717 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";debug")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3717;
    }
    /* pass */
    if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3718 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";sysroot=")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; });
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3718;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(rt_h), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _at_t3719 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); write_file(_at_t3719, rt_h); _tr_str_release(_at_t3719); });
    }
    /* pass */
    ...
    while ((mi < resolver->mod_dot_paths->len)) {
        ...
        while ((k < resolver->all_decl_modules->len)) {
            ...
            if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k)), _tr_strz(dot_path)) == 0)) {
                /* pass */
                __auto_type _t3720 = (*((Decl*)List_ptr_get(resolver->all_decls, k)));
                if (_t3720.tag == Decl_DClass) {
                    __auto_type c = _t3720.data.DClass.cls;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(c->name), true);
                } else if (_t3720.tag == Decl_DFunction) {
                    __auto_type f = _t3720.data.DFunction.func;
                    /* pass */
                    _tr_dict_set(fn_set, _tr_strz(f->name), true);
                    _tr_obj_release(f, _trdrop_FunctionDef);
                } else if (_t3720.tag == Decl_DEnum) {
                    __auto_type e = _t3720.data.DEnum.enm;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(e->name), true);
                } else if (_t3720.tag == Decl_DInterface) {
                    __auto_type iface = _t3720.data.DInterface.iface;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(iface->name), true);
                } else if (_t3720.tag == Decl_DExtend) {
                    __auto_type target = _t3720.data.DExtend.target;
__auto_type methods = _t3720.data.DExtend.methods;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(target), true);
                    _tr_str_release(target);
                } else if (1) {
                    __auto_type _ = _t3720;
                    /* pass */
                }
            }
            /* pass */
        ...
        if (is_builtin_mod(dot_path)) {
            /* pass */
            TrStr _strtmp_t3721 = ensure_builtin_dirs(build_dir, dot_path);
            _tr_str_release(c_path);
            c_path = _strtmp_t3721;
            /* pass */
            depth = get_dot_depth(dot_path);
        } else {
            /* pass */
            TrStr _strtmp_t3722 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("module_")))); TrStr _cr = (dot_to_safe(dot_path)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".c"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(c_path);
            c_path = _strtmp_t3722;
            /* pass */
            depth = 0LL;
        }
        /* pass */
        if ((c_gen->emit_line_info && (mi < resolver->mod_file_paths->len))) {
            /* pass */
            c_gen->cur_src_file = ({ TrStr _at_t3723 = (List_TrStr_get(resolver->mod_file_paths, mi)); __auto_type _wr = (to_fwd_slashes(_at_t3723)); _tr_str_release(_at_t3723); _wr; });
        }
        /* pass */
    ...
    while ((k2 < resolver->all_decl_modules->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k2)), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            __auto_type _t3724 = (*((Decl*)List_ptr_get(resolver->all_decls, k2)));
...
__auto_type methods = _t3724.data.DExtend.methods;
    ...
    if (export_cpp) {
        /* pass */
        TrStr _strtmp_t3725 = ({ TrStr _cr = (CppExporter_generate_cpp_class_bridges(cpp_exporter, hir)); TrStr _cres = _tr_strx_concat(_tr_strz(main_c), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(main_c);
        main_c = _strtmp_t3725;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            ({ TrStr _at_t3726 = (linker_script_riscv()); write_file(emit_ld, _at_t3726); _tr_str_release(_at_t3726); });
        } else {
            /* pass */
            ({ TrStr _at_t3727 = (linker_script_cortex_m()); write_file(emit_ld, _at_t3727); _tr_str_release(_at_t3727); });
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("c"))) == 0)) {
        ...
        while ((pi < (all_c_files->len - 1LL))) {
            /* pass */
            ({ TrStr _at_t3728 = (List_TrStr_get(all_c_files, pi)); ({ printf("%s", _tr_strz(({ TrStr _cr = (get_filename(_at_t3728)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _cr.data); _tr_str_release(_cr); _cres; }))); printf("\n"); }); _tr_str_release(_at_t3728); });
            /* pass */
            pi = (pi + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(exe_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t3729 = _tr_str_lit("a");
        _tr_str_release(exe_name);
        exe_name = _strtmp_t3729;
    }
    /* pass */
            ...
            if ((((long long)((*(en_p + (en_len - 3LL))))) == 101LL)) {
                ...
                if ((((long long)((*(en_p + (en_len - 2LL))))) == 120LL)) {
                    ...
                    if ((((long long)((*(en_p + (en_len - 1LL))))) == 101LL)) {
                        /* pass */
                        TrStr _strtmp_t3730 = _tr_str_wrap(_tr_str_slice(_tr_strz(exe_name), 0LL, (en_len - 4LL)));
                        _tr_str_release(exe_name);
                        exe_name = _strtmp_t3730;
                    }
                }
            }
        }
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3731 = resolve_target_triple(target);
        _tr_str_release(tgt_triple);
        tgt_triple = _strtmp_t3731;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (out_win) {
            /* pass */
            TrStr _strtmp_t3732 = _tr_str_lit(".dll");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3732;
        } else {
            /* pass */
            TrStr _strtmp_t3733 = _tr_str_lit(".so");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3733;
        }
    } else if (out_win) {
        /* pass */
        TrStr _strtmp_t3734 = _tr_str_lit(".exe");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3734;
    } else if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0) && _tr_str_contains(_tr_strz(tgt_triple), _tr_strz(_tr_str_lit("wasm"))))) {
        /* pass */
        TrStr _strtmp_t3735 = _tr_str_lit(".wasm");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3735;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (export_cpp) {
            ...
            if ((strcmp(_tr_strz(ns), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3736 = _tr_str_lit("tauraro");
                _tr_str_release(ns);
                ns = _strtmp_t3736;
            }
            /* pass */
    ...
    if (((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0) && (!lib_mode))) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3738 = ({ TrStr _at_t3737 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3737)); _tr_str_release(_at_t3737); _wr; });
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            TrStr _strtmp_t3739 = _tr_str_lit(" -march=rv64imac -mabi=lp64 -mcmodel=medany");
            _tr_str_release(bm_arch);
            bm_arch = _strtmp_t3739;
        }
        /* pass */
        ...
        if ((!_tr_str_contains(_tr_strz(bm_cc), _tr_strz(_tr_str_lit("zig"))))) {
            /* pass */
            TrStr _strtmp_t3740 = detect_lld_flag();
            _tr_str_release(bm_lld);
            bm_lld = _strtmp_t3740;
        }
        /* pass */
    ...
    if ((!no_auto_cpp)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3745 = ({ TrStr _at_t3744 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3744)); _tr_str_release(_at_t3744); _wr; });
            _tr_str_release(cc0);
            cc0 = _strtmp_t3745;
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if ((gpu_gen->ok && (gpu_gen->n_kernels > 0LL))) {
            ...
            if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit("nvptx"))) == 0)) {
                /* pass */
                TrStr _strtmp_t3746 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=nvptx64-nvidia-cuda -mcpu=sm_50 \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3746;
            } else {
                /* pass */
                TrStr _strtmp_t3747 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=spirv64-unknown-unknown -filetype=obj \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3747;
            }
            /* pass */
    ...
    if (run_after) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3748 = path_to_native(run_path);
            _tr_str_release(run_path);
            run_path = _strtmp_t3748;
        }
        /* pass */
        long long run_rc = ({ TrStr _aet_t3749 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(run_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3749.data)); _tr_str_release(_aet_t3749); _wr; });
        /* pass */
        exit((int)(run_rc));
    }
    _tr_str_release(subcmd);
