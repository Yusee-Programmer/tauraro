...
__attribute__((hot)) TrStr detect_cross_compiler(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3560 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3560;
    }
    /* pass */
    if (_tr_str_contains(_tr_strz(triple), _tr_strz(_tr_str_lit("android")))) {
        ...
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3561 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("ANDROID_NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3561;
        }
        /* pass */
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3562 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3562;
        }
        /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3564 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3564.data) == 0LL)); _tr_str_release(_aet_t3564); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
...
__attribute__((hot)) TrStr detect_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3565 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3565;
    }
    /* pass */
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3566 = path_to_native(z);
        _tr_str_release(z);
        z = _strtmp_t3566;
    }
    /* pass */
...
__attribute__((hot)) bool activate_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3567 = path_to_native(zdir);
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3568 = _tr_str_lit(";");
        _tr_str_release(sep);
        sep = _strtmp_t3568;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _aet_t3569 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(zdir), _tr_strz(sep))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur)); _tr_str_release(_cl); _cres; })); _tr_setenv(_tr_strz(_tr_str_lit("PATH")), _aet_t3569.data); _tr_str_release(_aet_t3569); });
    /* pass */
    _tr_str_release(zbin);
    _tr_str_release(zdir);
    _tr_str_release(sep);
...
__attribute__((hot)) TrStr detect_lld_flag() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3570 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3570;
    }
    /* pass */
    TrStr ext = _tr_str_lit("");
    /* pass */
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3571 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3571;
    }
    /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3574 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("ld.lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3574.data) == 0LL)); _tr_str_release(_aet_t3574); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
    ...
    /* pass */
    if (({ TrStr _aet_t3575 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3575.data) == 0LL)); _tr_str_release(_aet_t3575); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
...
__attribute__((hot)) TrStr resolve_cross_driver(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3576 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3576;
    }
    /* pass */
    if (({ TrStr _aet_t3577 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3577.data) == 0LL)); _tr_str_release(_aet_t3577); _wr; })) {
        /* pass */
...
__attribute__((hot)) TrStr find_native_abi_c(TrStr input_path) {
    ...
    /* pass */
    if (({ TrStr _at_t3578 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3578)); _tr_str_release(_at_t3578); _wr; })) {
        /* pass */
        return _tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")));
    }
    /* pass */
    if (({ TrStr _at_t3579 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3579)); _tr_str_release(_at_t3579); _wr; })) {
        /* pass */
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        /* pass */
        if (({ TrStr _at_t3580 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3580)); _tr_str_release(_at_t3580); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            return _tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")));
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3581 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3581)); _tr_str_release(_at_t3581); _wr; });
        /* pass */
        if (({ TrStr _at_t3582 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3582)); _tr_str_release(_at_t3582); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
        ...
        /* pass */
        TrStr gp = ({ TrStr _at_t3583 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3583)); _tr_str_release(_at_t3583); _wr; });
        /* pass */
        if (({ TrStr _at_t3584 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3584)); _tr_str_release(_at_t3584); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src_dir);
...
__attribute__((hot)) TrStr read_runtime_header(TrStr bin_path, TrStr input_path) {
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        TrStr src_dir = dir_of_path(input_path);
        /* pass */
        if (({ TrStr _at_t3585 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3585)); _tr_str_release(_at_t3585); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            return ({ TrStr _at_t3586 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3586)); _tr_str_release(_at_t3586); _wr; });
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3587 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3587)); _tr_str_release(_at_t3587); _wr; });
        /* pass */
        if (({ TrStr _at_t3588 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3588)); _tr_str_release(_at_t3588); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3589 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3589)); _tr_str_release(_at_t3589); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3590 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3590)); _tr_str_release(_at_t3590); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3591 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3591)); _tr_str_release(_at_t3591); _wr; });
        }
        /* pass */
        TrStr gp = ({ TrStr _at_t3592 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3592)); _tr_str_release(_at_t3592); _wr; });
        /* pass */
        if (({ TrStr _at_t3593 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3593)); _tr_str_release(_at_t3593); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3594 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3594)); _tr_str_release(_at_t3594); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3595 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3595)); _tr_str_release(_at_t3595); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3596 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3596)); _tr_str_release(_at_t3596); _wr; });
        }
        _tr_str_release(src_dir);
        _tr_str_release(parent);
    }
...
__attribute__((hot)) TrStr out_dir_prefix(TrStr out_dir) {
    ...
    if ((!(_tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("/"))) || _tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("\\")))))) {
        /* pass */
        TrStr _strtmp_t3597 = _tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit("/")));
        _tr_str_release(d);
        d = _strtmp_t3597;
    }
    /* pass */
...
__attribute__((hot)) TrStr resolve_output_stem(TrStr input_path, TrStr output_path, TrStr out_dir) {
    ...
    if (((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0) && has_path_sep(output_path))) {
        /* pass */
        ({ TrStr _at_t3598 = (dir_of_path(output_path)); make_dir(_at_t3598); _tr_str_release(_at_t3598); });
        /* pass */
...
__attribute__((hot)) TrStr ensure_builtin_dirs(TrStr build_dir, TrStr dot_path) {
    ...
    while (true) {
        ...
        if ((c == 46LL)) {
            ...
            /* pass */
            TrStr _strtmp_t3600 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(current), _tr_strz(seg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("/"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(current);
            current = _strtmp_t3600;
            /* pass */
            make_dir(current);
            /* pass */
            start = (i + 1LL);
...
__attribute__((hot)) void make_dir(TrStr path) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t3601 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(path)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("mkdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3601.data); _tr_str_release(_aet_t3601); });
    } else {
        /* pass */
        ({ TrStr _aet_t3602 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("mkdir -p \"")), _tr_strz(path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3602.data); _tr_str_release(_aet_t3602); });
    }
}
...
__attribute__((hot)) long long compile_all_c(List_TrStr* c_files, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3603 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3603;
        /* pass */
        TrStr _strtmp_t3604 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3604;
        /* pass */
        TrStr _strtmp_t3605 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3605;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3606 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3606;
        }
    }
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3607 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3607;
    }
    /* pass */
    ...
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3608 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3608;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3609 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3609;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3610 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3610;
    }
    /* pass */
    ...
    while ((i < c_files->len)) {
        /* pass */
        TrStr _strtmp_t3611 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(c_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3611;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3613 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3613;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3614 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3614;
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3615 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -fsanitize=address,undefined -g")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3615;
    }
    /* pass */
    if (out_is_windows(target, triple)) {
        ...
        if (need_wsa) {
            /* pass */
            TrStr _strtmp_t3616 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3616;
        }
    }
...
__attribute__((hot)) long long compile_all_c_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode, bool build_shared, bool link_cxx, bool use_lto) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3617 = resolve_target_triple(target);
        _tr_str_release(triple);
        triple = _strtmp_t3617;
        /* pass */
        TrStr _strtmp_t3618 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3618;
        /* pass */
        TrStr _strtmp_t3619 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3619;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3620 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3620;
        }
    }
    /* pass */
    TrStr static_flag = _tr_str_lit("");
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3621 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3621;
    }
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3622 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3622;
    }
    /* pass */
    TrStr native_flags = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3623 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3623;
    }
    /* pass */
    TrStr overflow_flag = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3624 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3624;
    }
    /* pass */
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3625 = _tr_str_lit(" -fsanitize=address,undefined -g");
        _tr_str_release(dbg);
        dbg = _strtmp_t3625;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3626 = _tr_str_lit(" -fPIC");
        _tr_str_release(pic);
        pic = _strtmp_t3626;
    }
    /* pass */
    ...
    if (use_lto) {
        /* pass */
        TrStr _strtmp_t3627 = _tr_str_lit(" -flto");
        _tr_str_release(lto_flag);
        lto_flag = _strtmp_t3627;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3628 = _tr_str_lit(" -shared");
        _tr_str_release(shared_flag);
        shared_flag = _strtmp_t3628;
    }
    /* pass */
    ...
    if (link_cxx) {
        /* pass */
        TrStr _strtmp_t3629 = cxx_of(cc);
        _tr_str_release(link_driver);
        link_driver = _strtmp_t3629;
    }
    /* pass */
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t3630 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3630;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < link_paths->len)) {
        /* pass */
        TrStr _strtmp_t3631 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(link_paths, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3631;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3632 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3632;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3633 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3633;
    /* pass */
    if (out_is_windows(target, triple)) {
        /* pass */
        TrStr _strtmp_t3634 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3634;
    }
    /* pass */
...
__attribute__((hot)) long long compile_c_to_exe(TrStr c_path, TrStr exe_path, TrStr opt_level, bool verbose) {
    ...
    /* pass */
    TrStr out_dir = ({ TrStr _at_t3635 = (dir_of_path(c_path)); __auto_type _wr = (strip_trailing_sep(_at_t3635)); _tr_str_release(_at_t3635); _wr; });
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3636 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3636;
    }
    /* pass */
...
__attribute__((hot)) void _print_diag(TrStr level, TrStr msg) {
    ...
    if ((fix_idx >= 0LL)) {
        /* pass */
        TrStr _strtmp_t3638 = ({ TrStr _wt_t3637 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), 0LL, fix_idx))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3637.data))); _tr_str_release(_wt_t3637); _wr; });
        _tr_str_release(main_part);
        main_part = _strtmp_t3638;
        /* pass */
        TrStr _strtmp_t3640 = ({ TrStr _wt_t3639 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), (fix_idx + 4LL), _tr_strlen(_tr_strz(msg))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3639.data))); _tr_str_release(_wt_t3639); _wr; });
        _tr_str_release(fix_part);
        fix_part = _strtmp_t3640;
    }
    /* pass */
    ...
    if ((pe > 0LL)) {
        ...
        if ((ln > 0LL)) {
            /* pass */
            TrStr _strtmp_t3641 = _tr_str_retain(head);
            _tr_str_release(loc_str);
            loc_str = _strtmp_t3641;
            /* pass */
            TrStr _strtmp_t3642 = loc_file(head);
            _tr_str_release(file_path);
            file_path = _strtmp_t3642;
            /* pass */
            line_no = ln;
            /* pass */
            TrStr _strtmp_t3643 = _tr_str_wrap(_tr_str_slice(_tr_strz(main_part), (pe + 2LL), _tr_strlen(_tr_strz(main_part))));
    ...
    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
        /* pass */
        TrStr _strtmp_t3644 = c_yellow(level);
        _tr_str_release(lvl);
        lvl = _strtmp_t3644;
    }
    /* pass */
    ...
    if ((_tr_strlen(_tr_strz(loc_str)) > 0LL)) {
        ...
        if ((_tr_strlen(_tr_strz(file_path)) > 0LL)) {
            /* pass */
            TrStr _strtmp_t3645 = read_file(file_path);
            _tr_str_release(src);
            src = _strtmp_t3645;
        }
        /* pass */
        if ((_tr_strlen(_tr_strz(src)) > 0LL)) {
            ...
            if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
                ...
                if ((col > 0LL)) {
                    ...
                    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t3646 = c_yellow(underline);
...
__attribute__((hot)) void cleanup_build(TrStr build_dir, List_TrStr* all_c_files) {
    ...
    while ((di < all_c_files->len)) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            ({ TrStr _at_t3647 = (List_TrStr_get(all_c_files, di)); TrStr _aet_t3648 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3647)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3648.data); _tr_str_release(_at_t3647); _tr_str_release(_aet_t3648); });
        } else {
            /* pass */
            ({ TrStr _aet_t3649 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(all_c_files, di)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3649.data); _tr_str_release(_aet_t3649); });
        }
        /* pass */
        di = (di + 1LL);
    }
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _at_t3650 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_types.h")))); TrStr _aet_t3651 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3650)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3651.data); _tr_str_release(_at_t3650); _tr_str_release(_aet_t3651); });
        /* pass */
        ({ TrStr _at_t3652 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); TrStr _aet_t3653 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3652)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3653.data); _tr_str_release(_at_t3652); _tr_str_release(_aet_t3653); });
        /* pass */
        ({ TrStr _at_t3654 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("include")))); TrStr _aet_t3655 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3654)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir /S /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3655.data); _tr_str_release(_at_t3654); _tr_str_release(_aet_t3655); });
        /* pass */
        ({ TrStr _aet_t3656 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(build_dir)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3656.data); _tr_str_release(_aet_t3656); });
    } else {
        /* pass */
        ({ TrStr _aet_t3657 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_types.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3657.data); _tr_str_release(_aet_t3657); });
        /* pass */
        ({ TrStr _aet_t3658 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_rt.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3658.data); _tr_str_release(_aet_t3658); });
        /* pass */
        ({ TrStr _aet_t3659 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -rf \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3659.data); _tr_str_release(_aet_t3659); });
        /* pass */
        ({ TrStr _aet_t3660 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3660.data); _tr_str_release(_aet_t3660); });
    }
}
...
__attribute__((hot)) void run_fmt(TrStr path0, bool write_in_place) {
    ...
    if (((!file_exists(path)) && (!str_ends_with_dot_tr(path)))) {
        /* pass */
        TrStr _strtmp_t3661 = _tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".tr")));
...
__attribute__((hot)) int main(int argc, char** argv) {
    ...
    if ((args->len >= 2LL)) {
        ...
        if ((((strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("fmt"))) == 0) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("lint"))) == 0)) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("bindgen"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3662 = _tr_str_retain(a1);
            _tr_str_release(subcmd);
            subcmd = _strtmp_t3662;
        }
    }
    /* pass */
        ...
        while ((bk < args->len)) {
            ...
            if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--pkg"))) == 0) && ((bk + 1LL) < args->len))) {
                ...
                if ((strcmp(_tr_strz(pkgcf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3663 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkgcf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_extra);
                    bg_extra = _strtmp_t3663;
                }
                /* pass */
                if ((strcmp(_tr_strz(pkglf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3664 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_pkglibs), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkglf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_pkglibs);
                    bg_pkglibs = _strtmp_t3664;
                }
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-o"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3665 = List_TrStr_get(args, (bk + 1LL));
                _tr_str_release(bg_out);
                bg_out = _strtmp_t3665;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--cc"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3666 = List_TrStr_get(args, (bk + 1LL));
                ...
                /* pass */
                TrStr _strtmp_t3667 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -I\"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3667;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-D"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3668 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -D")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3668;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-isystem"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3669 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -isystem \"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3669;
                /* pass */
                bk = (bk + 1LL);
                ...
                /* pass */
                TrStr _strtmp_t3670 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ba)); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3670;
            } else if ((!str_starts_with(ba, _tr_str_lit("-")))) {
                /* pass */
                if ((strcmp(_tr_strz(bg_header), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3671 = _tr_str_retain(ba);
                    _tr_str_release(bg_header);
                    bg_header = _strtmp_t3671;
                }
            }
            /* pass */
            bk = (bk + 1LL);
        ...
        while ((fk < args->len)) {
            ...
            if (((strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("-w"))) == 0) || (strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("--write"))) == 0))) {
                ...
                if ((strcmp(_tr_strz(fpath), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3672 = _tr_str_retain(fa);
    ...
    while ((i < args->len)) {
        ...
        if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--version"))) == 0)) {
            ...
            /* pass */
            TrStr _strtmp_t3682 = _tr_str_lit("0");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3682;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O1"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3683 = _tr_str_lit("1");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3683;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O2"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3684 = _tr_str_lit("2");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3684;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O3"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3685 = _tr_str_lit("3");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3685;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-Os"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3686 = _tr_str_lit("s");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3686;
            ...
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3687 = List_TrStr_get(args, i);
            _tr_str_release(target);
            target = _strtmp_t3687;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--sysroot"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3688 = List_TrStr_get(args, i);
            _tr_str_release(sysroot);
            sysroot = _strtmp_t3688;
            ...
            /* pass */
            TrStr _strtmp_t3689 = _tr_str_lit("TAURARO_KERNEL");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3689;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--no-std"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3690 = _tr_str_lit("TAURARO_NO_OS");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3690;
            ...
            if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3691 = _tr_str_retain(arg);
                _tr_str_release(input_path);
                input_path = _strtmp_t3691;
            }
        }
        /* pass */
        i = (i + 1LL);
    ...
    if (((!file_exists(input_path)) && (!str_ends_with_dot_tr(input_path)))) {
        /* pass */
        TrStr _strtmp_t3692 = _tr_strx_concat(_tr_strz(input_path), _tr_strz(_tr_str_lit(".tr")));
        _tr_str_release(input_path);
        input_path = _strtmp_t3692;
    }
    /* pass */
    ...
    /* pass */
    TrStr bin_dir = ({ TrStr _at_t3693 = (_tr_str_wrap(_tr_exe_dir())); __auto_type _wr = (strip_trailing_sep_inline(_at_t3693)); _tr_str_release(_at_t3693); _wr; });
    /* pass */
    ModuleResolver_add_search_path(resolver, bin_dir);
    /* pass */
    ({ TrStr _at_t3694 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/std")))); ModuleResolver_add_search_path(resolver, _at_t3694); _tr_str_release(_at_t3694); });
    /* pass */
    ({ TrStr _at_t3695 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages")))); ModuleResolver_add_search_path(resolver, _at_t3695); _tr_str_release(_at_t3695); });
    /* pass */
    ({ TrStr _at_t3696 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages/sites")))); ModuleResolver_add_search_path(resolver, _at_t3696); _tr_str_release(_at_t3696); });
    /* pass */
    ...
    if ((strcmp(_tr_strz(tauraro_path_env), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        while ((epi < ep_count)) {
            /* pass */
            ({ TrStr _at_t3697 = (get_path_env_entry(tauraro_path_env, epi)); ModuleResolver_add_search_path(resolver, _at_t3697); _tr_str_release(_at_t3697); });
            /* pass */
            epi = (epi + 1LL);
        }
    }
    ...
    if ((sema->warnings->len > 0LL)) {
        ...
        while ((wk < sema->warnings->len)) {
            /* pass */
            ({ TrStr _at_t3698 = (List_TrStr_get(sema->warnings, wk)); _print_diag(_tr_str_lit("warning"), _at_t3698); _tr_str_release(_at_t3698); });
            /* pass */
            wk = (wk + 1LL);
        }
    }
    ...
    if ((sema->errors->len > 0LL)) {
        ...
        while ((k < sema->errors->len)) {
            /* pass */
            ({ TrStr _at_t3699 = (List_TrStr_get(sema->errors, k)); _print_diag(_tr_str_lit("error"), _at_t3699); _tr_str_release(_at_t3699); });
            /* pass */
            k = (k + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("gpu"))) == 0)) {
        ...
        if ((!gpu_gen->ok)) {
            /* pass */
            ({ TrStr _at_t3700 = (_tr_strx_concat(_tr_strz(_tr_str_lit("[GPU] ")), _tr_strz(gpu_gen->fail_note))); _print_diag(_tr_str_lit("error"), _at_t3700); _tr_str_release(_at_t3700); });
            /* pass */
            exit((int)(1LL));
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("llvm"))) == 0)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3701 = resolve_target_triple(target);
            _tr_str_release(lx_triple);
            lx_triple = _strtmp_t3701;
            /* pass */
            lx_is_cross = true;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            /* pass */
            TrStr _strtmp_t3702 = target_extra_flags(lx_triple);
            _tr_str_release(lx_tflags);
            lx_tflags = _strtmp_t3702;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3703 = _tr_str_lit("nul");
                _tr_str_release(lx_xnull);
                lx_xnull = _strtmp_t3703;
            }
            /* pass */
            if (({ TrStr _aet_t3704 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3704.data) == 0LL)); _tr_str_release(_aet_t3704); _wr; })) {
                /* pass */
                TrStr lx_zt = zig_target_of(lx_triple);
                /* pass */
                if ((strcmp(_tr_strz(lx_zt), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3705 = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -target ")), _tr_strz(lx_zt));
                    _tr_str_release(lx_xcc);
                    lx_xcc = _strtmp_t3705;
                    /* pass */
                    lx_via_zig = true;
                }
            }
            /* pass */
            if (({ TrStr _aet_t3706 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((strcmp(_tr_strz(lx_xcc), _tr_strz(_tr_str_lit(""))) == 0) && (_tr_system(_aet_t3706.data) == 0LL))); _tr_str_release(_aet_t3706); _wr; })) {
                /* pass */
                TrStr _strtmp_t3707 = _tr_strx_concat(_tr_strz(_tr_str_lit("clang --target=")), _tr_strz(lx_triple));
                _tr_str_release(lx_xcc);
                lx_xcc = _strtmp_t3707;
            }
            /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) {
                ...
                /* pass */
                TrStr _strtmp_t3709 = _tr_str_lit(".exe");
                _tr_str_release(lx_ext);
                lx_ext = _strtmp_t3709;
            }
        } else if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3710 = _tr_str_lit(".exe");
            _tr_str_release(lx_ext);
            lx_ext = _strtmp_t3710;
        }
        /* pass */
        TrStr lx_exe = ({ TrStr _at_t3711 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3711, lx_ext)); _tr_str_release(_at_t3711); _wr; });
        /* pass */
        ...
        if (((lx_is_cross && _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && _tr_str_contains(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("define i32 @main()"))))) {
            /* pass */
            TrStr _strtmp_t3712 = _tr_strx_concat(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("\n@__main_void = hidden alias i32 (), ptr @main\n")));
            _tr_str_release(llvm_ir);
            llvm_ir = _strtmp_t3712;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3717 = _tr_str_lit("nul");
            _tr_str_release(lx_null);
            lx_null = _strtmp_t3717;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3718 = _tr_strx_concat(_tr_strz(lx_libs), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -lucrtbase -mconsole")));
            _tr_str_release(lx_libs);
            lx_libs = _strtmp_t3718;
            /* pass */
            TrStr _strtmp_t3719 = _tr_strx_concat(_tr_strz(lx_libs_gcc), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt")));
            _tr_str_release(lx_libs_gcc);
            lx_libs_gcc = _strtmp_t3719;
        }
        /* pass */
        bool lx_built = false;
        /* pass */
        if (lx_is_cross) {
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3720 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_cg);
                lx_cg = _strtmp_t3720;
            }
            /* pass */
            if (({ TrStr _aet_t3721 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" -c \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3721.data) != 0LL)); _tr_str_release(_aet_t3721); _wr; })) {
                /* pass */
            ...
            if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm"))) || _tr_str_contains(_tr_strz(lx_tflags), _tr_strz(_tr_str_lit("nostdlib"))))) {
                /* pass */
                TrStr _strtmp_t3722 = _tr_str_lit("");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3722;
            } else if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("windows"))) || _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("mingw"))))) {
                /* pass */
                TrStr _strtmp_t3723 = _tr_str_lit(" -lm -lws2_32 -lbcrypt -mconsole");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3723;
            }
            /* pass */
            ...
            if (((!_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && (!lx_via_zig))) {
                /* pass */
                TrStr _strtmp_t3724 = detect_lld_flag();
                _tr_str_release(lx_xld);
                lx_xld = _strtmp_t3724;
            }
            /* pass */
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3725 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_xlink);
                lx_xlink = _strtmp_t3725;
            }
            /* pass */
            TrStr _strtmp_t3726 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xlibs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xld)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(lx_xlink);
            lx_xlink = _strtmp_t3726;
            /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3727 = _tr_str_lit("x86_64-pc-windows-gnu");
            _tr_str_release(lx_tri);
            lx_tri = _strtmp_t3727;
        }
        /* pass */
        ...
        /* pass */
        if (({ TrStr _aet_t3730 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3730.data) == 0LL))); _tr_str_release(_aet_t3730); _wr; })) {
            /* pass */
            TrStr lx_llc_tri = _tr_str_lit("");
            /* pass */
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3731 = _tr_str_lit(" -mtriple=x86_64-pc-windows-gnu");
                _tr_str_release(lx_llc_tri);
                lx_llc_tri = _strtmp_t3731;
            }
            /* pass */
            if (({ TrStr _aet_t3732 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -O2 -filetype=obj")), _tr_strz(lx_llc_tri))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o build/llvm_out.o 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3732.data) == 0LL)); _tr_str_release(_aet_t3732); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3733 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3733.data) == 0LL)); _tr_str_release(_aet_t3733); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        /* pass */
        if (({ TrStr _aet_t3734 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3734.data) == 0LL))); _tr_str_release(_aet_t3734); _wr; })) {
            /* pass */
            TrStr lx_zrto = _tr_str_lit("build/llvm_runtime_zig.o");
            /* pass */
            if (({ TrStr _aet_t3735 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (dir_of_path(lx_abi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -O2 -w -c \"-I")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_abi)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_zrto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3735.data) == 0LL)); _tr_str_release(_aet_t3735); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3736 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -O")), _tr_strz(opt_level))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_zrto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3736.data) == 0LL)); _tr_str_release(_aet_t3736); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        if (run_after) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3737 = path_to_native(lx_run);
                _tr_str_release(lx_run);
                lx_run = _strtmp_t3737;
            }
            /* pass */
            ({ TrStr _aet_t3738 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(lx_run))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); exit((int)(_tr_system(_aet_t3738.data))); _tr_str_release(_aet_t3738); });
        }
        /* pass */
        _tr_str_release(subcmd);
        _tr_str_release(input_path);
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("native"))) == 0)) {
        ...
        /* pass */
        TrStr nat_out = ({ TrStr _at_t3739 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3739, _tr_str_lit(".o"))); _tr_str_release(_at_t3739); _wr; });
        /* pass */
    ...
    /* pass */
    TrStr rt_h = ({ TrStr _at_t3740 = (List_TrStr_get(args, 0LL)); __auto_type _wr = (read_runtime_header(_at_t3740, input_path)); _tr_str_release(_at_t3740); _wr; });
    /* pass */
    ...
    /* pass */
    TrStr _strtmp_t3741 = ({ TrStr _cr = (CGenerator_generate_module_compat(c_gen, resolver->all_decl_modules, resolver->all_decls)); TrStr _cres = _tr_strx_concat(_tr_strz(types_h), _cr.data); _tr_str_release(_cr); _cres; });
    _tr_str_release(types_h);
    types_h = _strtmp_t3741;
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3742 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";static")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3742;
    }
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3743 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";debug")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3743;
    }
    /* pass */
    if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3744 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";sysroot=")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; });
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3744;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(rt_h), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _at_t3745 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); write_file(_at_t3745, rt_h); _tr_str_release(_at_t3745); });
    }
    /* pass */
    ...
    while ((mi < resolver->mod_dot_paths->len)) {
        ...
        while ((k < resolver->all_decl_modules->len)) {
            ...
            if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k)), _tr_strz(dot_path)) == 0)) {
                /* pass */
                __auto_type _t3746 = (*((Decl*)List_ptr_get(resolver->all_decls, k)));
                if (_t3746.tag == Decl_DClass) {
                    __auto_type c = _t3746.data.DClass.cls;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(c->name), true);
                } else if (_t3746.tag == Decl_DFunction) {
                    __auto_type f = _t3746.data.DFunction.func;
                    /* pass */
                    _tr_dict_set(fn_set, _tr_strz(f->name), true);
                    _tr_obj_release(f, _trdrop_FunctionDef);
                } else if (_t3746.tag == Decl_DEnum) {
                    __auto_type e = _t3746.data.DEnum.enm;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(e->name), true);
                } else if (_t3746.tag == Decl_DInterface) {
                    __auto_type iface = _t3746.data.DInterface.iface;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(iface->name), true);
                } else if (_t3746.tag == Decl_DExtend) {
                    __auto_type target = _t3746.data.DExtend.target;
__auto_type methods = _t3746.data.DExtend.methods;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(target), true);
                    _tr_str_release(target);
                } else if (1) {
                    __auto_type _ = _t3746;
                    /* pass */
                }
            }
            /* pass */
        ...
        if (is_builtin_mod(dot_path)) {
            /* pass */
            TrStr _strtmp_t3747 = ensure_builtin_dirs(build_dir, dot_path);
            _tr_str_release(c_path);
            c_path = _strtmp_t3747;
            /* pass */
            depth = get_dot_depth(dot_path);
        } else {
            /* pass */
            TrStr _strtmp_t3748 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("module_")))); TrStr _cr = (dot_to_safe(dot_path)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".c"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(c_path);
            c_path = _strtmp_t3748;
            /* pass */
            depth = 0LL;
        }
        /* pass */
        if ((c_gen->emit_line_info && (mi < resolver->mod_file_paths->len))) {
            /* pass */
            c_gen->cur_src_file = ({ TrStr _at_t3749 = (List_TrStr_get(resolver->mod_file_paths, mi)); __auto_type _wr = (to_fwd_slashes(_at_t3749)); _tr_str_release(_at_t3749); _wr; });
        }
        /* pass */
    ...
    while ((k2 < resolver->all_decl_modules->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k2)), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            __auto_type _t3750 = (*((Decl*)List_ptr_get(resolver->all_decls, k2)));
            if (_t3750.tag == Decl_DClass) {
                __auto_type c = _t3750.data.DClass.cls;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(c->name), true);
            } else if (_t3750.tag == Decl_DFunction) {
                __auto_type f = _t3750.data.DFunction.func;
                /* pass */
                _tr_dict_set(main_fn_set, _tr_strz(f->name), true);
                _tr_obj_release(f, _trdrop_FunctionDef);
            } else if (_t3750.tag == Decl_DEnum) {
                __auto_type e = _t3750.data.DEnum.enm;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(e->name), true);
            } else if (_t3750.tag == Decl_DInterface) {
                __auto_type iface = _t3750.data.DInterface.iface;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(iface->name), true);
            } else if (_t3750.tag == Decl_DExtend) {
                __auto_type target = _t3750.data.DExtend.target;
__auto_type methods = _t3750.data.DExtend.methods;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(target), true);
                _tr_str_release(target);
            } else if (1) {
                __auto_type _ = _t3750;
                /* pass */
            }
        }
        /* pass */
    ...
    if (export_cpp) {
        /* pass */
        TrStr _strtmp_t3751 = ({ TrStr _cr = (CppExporter_generate_cpp_class_bridges(cpp_exporter, hir)); TrStr _cres = _tr_strx_concat(_tr_strz(main_c), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(main_c);
        main_c = _strtmp_t3751;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            ({ TrStr _at_t3752 = (linker_script_riscv()); write_file(emit_ld, _at_t3752); _tr_str_release(_at_t3752); });
        } else {
            /* pass */
            ({ TrStr _at_t3753 = (linker_script_cortex_m()); write_file(emit_ld, _at_t3753); _tr_str_release(_at_t3753); });
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("c"))) == 0)) {
        ...
        while ((pi < (all_c_files->len - 1LL))) {
            /* pass */
            ({ TrStr _at_t3754 = (List_TrStr_get(all_c_files, pi)); ({ printf("%s", _tr_strz(({ TrStr _cr = (get_filename(_at_t3754)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _cr.data); _tr_str_release(_cr); _cres; }))); printf("\n"); }); _tr_str_release(_at_t3754); });
            /* pass */
            pi = (pi + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(exe_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t3755 = _tr_str_lit("a");
        _tr_str_release(exe_name);
        exe_name = _strtmp_t3755;
    }
    /* pass */
            ...
            if ((((long long)((*(en_p + (en_len - 3LL))))) == 101LL)) {
                ...
                if ((((long long)((*(en_p + (en_len - 2LL))))) == 120LL)) {
                    ...
                    if ((((long long)((*(en_p + (en_len - 1LL))))) == 101LL)) {
                        /* pass */
                        TrStr _strtmp_t3756 = _tr_str_wrap(_tr_str_slice(_tr_strz(exe_name), 0LL, (en_len - 4LL)));
                        _tr_str_release(exe_name);
                        exe_name = _strtmp_t3756;
                    }
                }
            }
        }
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3757 = resolve_target_triple(target);
        _tr_str_release(tgt_triple);
        tgt_triple = _strtmp_t3757;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (out_win) {
            /* pass */
            TrStr _strtmp_t3758 = _tr_str_lit(".dll");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3758;
        } else {
            /* pass */
            TrStr _strtmp_t3759 = _tr_str_lit(".so");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3759;
        }
    } else if (out_win) {
        /* pass */
        TrStr _strtmp_t3760 = _tr_str_lit(".exe");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3760;
    } else if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0) && _tr_str_contains(_tr_strz(tgt_triple), _tr_strz(_tr_str_lit("wasm"))))) {
        /* pass */
        TrStr _strtmp_t3761 = _tr_str_lit(".wasm");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3761;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (export_cpp) {
            ...
            if ((strcmp(_tr_strz(ns), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3762 = _tr_str_lit("tauraro");
                _tr_str_release(ns);
                ns = _strtmp_t3762;
            }
            /* pass */
    ...
    if (((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0) && (!lib_mode))) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3764 = ({ TrStr _at_t3763 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3763)); _tr_str_release(_at_t3763); _wr; });
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t3765 = _tr_str_lit(" -mcpu=cortex_m3 -mthumb");
            _tr_str_release(bm_arch);
            bm_arch = _strtmp_t3765;
        }
        /* pass */
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            TrStr _strtmp_t3766 = _tr_str_lit(" -march=rv64imac -mabi=lp64 -mcmodel=medany");
            _tr_str_release(bm_arch);
            bm_arch = _strtmp_t3766;
        }
        /* pass */
        ...
        if ((!bm_is_zig)) {
            /* pass */
            TrStr _strtmp_t3767 = detect_lld_flag();
            _tr_str_release(bm_lld);
            bm_lld = _strtmp_t3767;
        }
        /* pass */
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t3768 = _tr_str_lit(" -nostartfiles");
            _tr_str_release(bm_nostdlib);
            bm_nostdlib = _strtmp_t3768;
            /* pass */
            TrStr _strtmp_t3769 = _tr_str_lit(" -fno-sanitize=undefined");
            _tr_str_release(bm_ubsan);
            bm_ubsan = _strtmp_t3769;
            /* pass */
            TrStr _strtmp_t3770 = _tr_str_lit("");
            _tr_str_release(bm_libgcc);
            bm_libgcc = _strtmp_t3770;
        }
        /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit("uefi-x64"))) == 0) && (!lib_mode))) {
        ...
        /* pass */
        if (hir_has_export_fn(hir, _tr_str_lit("tauraro_uefi_main"))) {
            /* pass */
            TrStr _strtmp_t3774 = _tr_str_lit("tauraro_uefi_main");
            _tr_str_release(uefi_entry);
            uefi_entry = _strtmp_t3774;
        } else if (hir_has_export_fn(hir, _tr_str_lit("tauraro_ui_render"))) {
            /* pass */
            TrStr _strtmp_t3775 = _tr_str_lit("tauraro_ui_render");
            _tr_str_release(uefi_entry);
            uefi_entry = _strtmp_t3775;
        }
        /* pass */
        if ((strcmp(_tr_strz(uefi_entry), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            /* pass */
            ({ printf("%s", _tr_strz(_tr_str_lit("       named tauraro_uefi_main (or tauraro_ui_render), with signature"))); printf("\n"); });
            /* pass */
            ({ printf("%s", _tr_strz(_tr_str_lit("       (fb: Pointer[u32], width: int, height: int, pitch: int) -> void"))); printf("\n"); });
            /* pass */
            ({ printf("%s", _tr_strz(_tr_str_lit("       it is called once, after firmware hands over a GOP framebuffer."))); printf("\n"); });
            /* pass */
            exit((int)(1LL));
        }
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t3776 = (uefi_zig_stub(uefi_entry, uefi_has_heap_init, 16LL)); write_file(uefi_stub_path, _at_t3776); _tr_str_release(_at_t3776); });
        /* pass */
        ...
        /* pass */
        TrStr _strtmp_t3777 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -I \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -I \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3777;
        /* pass */
        TrStr _strtmp_t3778 = _tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -cflags -U_WIN32 -U_WIN64 -U_MSC_VER -- ")));
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3778;
        /* pass */
        long long uci = 0LL;
        /* pass */
        while ((uci < all_c_files->len)) {
            ...
            _tr_str_release(uefi_cmd);
            uefi_cmd = _strtmp_t3779;
            /* pass */
            uci = (uci + 1LL);
        }
        /* pass */
        TrStr _strtmp_t3780 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit("\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(uefi_stub_path)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3780;
        /* pass */
    ...
    if ((!no_auto_cpp)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3783 = ({ TrStr _at_t3782 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3782)); _tr_str_release(_at_t3782); _wr; });
            _tr_str_release(cc0);
            cc0 = _strtmp_t3783;
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if ((gpu_gen->ok && (gpu_gen->n_kernels > 0LL))) {
            ...
            if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit("nvptx"))) == 0)) {
                /* pass */
                TrStr _strtmp_t3784 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=nvptx64-nvidia-cuda -mcpu=sm_50 \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3784;
            } else {
                /* pass */
                TrStr _strtmp_t3785 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=spirv64-unknown-unknown -filetype=obj \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3785;
            }
            /* pass */
    ...
    if (run_after) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3786 = path_to_native(run_path);
            _tr_str_release(run_path);
            run_path = _strtmp_t3786;
        }
        /* pass */
        long long run_rc = ({ TrStr _aet_t3787 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(run_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3787.data)); _tr_str_release(_aet_t3787); _wr; });
        /* pass */
        exit((int)(run_rc));
    }
    _tr_str_release(subcmd);
