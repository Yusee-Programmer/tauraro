...
__attribute__((hot)) char* LlvmGenerator_gen_expr(LlvmGenerator* self, HirExpr* e_ptr) {
    ...
    /* pass */
    __auto_type _t263 = e;
    if (_t263.tag == HirExpr_ELitInt) {
        __auto_type v = _t263.data.ELitInt.val;
__auto_type ty = _t263.data.ELitInt.ty;
        /* pass */
        ...
        /* pass */
        return reg;
    } else if (_t263.tag == HirExpr_ELitBool) {
        __auto_type v = _t263.data.ELitBool.val;
        /* pass */
        char* reg = LlvmGenerator_next_reg(self);
        /* pass */
        char* bval = "0";
        ...
        /* pass */
        return reg;
    } else if (_t263.tag == HirExpr_ELitFloat) {
        __auto_type v = _t263.data.ELitFloat.val;
__auto_type ty = _t263.data.ELitFloat.ty;
        /* pass */
        char* reg = LlvmGenerator_next_reg(self);
        /* pass */
        LlvmGenerator_w(self, "    ");
        ...
        /* pass */
        return reg;
    } else if (_t263.tag == HirExpr_ELitStr) {
        __auto_type v = _t263.data.ELitStr.val;
        /* pass */
        char* reg = LlvmGenerator_next_reg(self);
        /* pass */
        ...
        /* pass */
        return reg;
    } else if (_t263.tag == HirExpr_ELitNone) {
        __auto_type _ = _t263.data.ELitNone.ty;
        /* pass */
        return "null";
    } else if (_t263.tag == HirExpr_EIdent) {
        __auto_type name = _t263.data.EIdent.name;
__auto_type is_move = _t263.data.EIdent.is_move;
        /* pass */
        char* reg = LlvmGenerator_next_reg(self);
        /* pass */
        LlvmGenerator_w(self, "    ");
        ...
        __auto_type op = _t263.data.EBinOp.op;
__auto_type left = _t263.data.EBinOp.left;
__auto_type right = _t263.data.EBinOp.right;
__auto_type ty = _t263.data.EBinOp.ty;
        /* pass */
...
__attribute__((hot)) char* LlvmGenerator_gen_call_llvm(LlvmGenerator* self, HirExpr* callee, List_ptr* args) {
    ...
    if (_t264.tag == HirExpr_EIdent) {
        __auto_type n = _t264.data.EIdent.name;
...
__attribute__((hot)) void LlvmGenerator_gen_stmt(LlvmGenerator* self, HirStmt* s_ptr) {
    ...
    } else if (_t265.tag == HirStmt_SLet) {
        __auto_type name = _t265.data.SLet.name;
__auto_type ownership = _t265.data.SLet.ownership;
__auto_type is_mut = _t265.data.SLet.is_mut;
__auto_type is_const = _t265.data.SLet.is_const;
__auto_type is_shared = _t265.data.SLet.is_shared;
...
__auto_type body = _t265.data.SWhile.body;
    ...
    } else if (_t265.tag == HirStmt_SPass) {
        /* pass */
        /* pass */
    } else if (1) {
        __auto_type _ = _t265;
