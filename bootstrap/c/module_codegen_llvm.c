...
__attribute__((hot)) void LlvmGenerator_emit_type_decls(LlvmGenerator* self, HirProgram* prog) {
    ...
    while ((i < prog->classes->len)) {
        ...
        while ((fi < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2911 = (llvm_type(((HirField*)List_ptr_get(c->fields, fi))->ty)); LlvmGenerator_w(self, _at_t2911); _tr_str_release(_at_t2911); });
            /* pass */
            first = false;
            /* pass */
            fi = (fi + 1LL);
...
__attribute__((hot)) void LlvmGenerator_emit_func_sig(LlvmGenerator* self, HirFunction* f, TrStr class_name) {
    ...
    while ((i < f->params->len)) {
        ...
        /* pass */
        ({ TrStr _at_t2912 = (llvm_type(p->ty)); LlvmGenerator_w(self, _at_t2912); _tr_str_release(_at_t2912); });
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit(" %"));
        /* pass */
...
__attribute__((hot)) TrStr LlvmGenerator_gen_expr(LlvmGenerator* self, HirExpr* e_ptr) {
    ...
    __auto_type e = (*e_ptr);
    /* pass */
    __auto_type _t2913 = e;
    if (_t2913.tag == HirExpr_ELitInt) {
        __auto_type v = _t2913.data.ELitInt.val;
__auto_type ty = _t2913.data.ELitInt.ty;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2914 = (_tr_str_wrap(_tr_int_to_str((long long)(v)))); LlvmGenerator_w(self, _at_t2914); _tr_str_release(_at_t2914); });
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("\n"));
        /* pass */
        TrStr _ad_f_t2915 = ty->name;
        TrStr _ad_f_t2916 = ty->from_param;
        _tr_str_release(_ad_f_t2915);
        _tr_str_release(_ad_f_t2916);
        _tr_str_release(lty);
        return reg;
    } else if (_t2913.tag == HirExpr_ELitBool) {
        __auto_type v = _t2913.data.ELitBool.val;
        /* pass */
        TrStr reg = LlvmGenerator_next_reg(self);
        /* pass */
        ...
        if (v) {
            /* pass */
            TrStr _strtmp_t2917 = _tr_str_lit("1");
        ...
        _tr_str_release(bval);
        return reg;
    } else if (_t2913.tag == HirExpr_ELitFloat) {
        __auto_type v = _t2913.data.ELitFloat.val;
__auto_type ty = _t2913.data.ELitFloat.ty;
        /* pass */
        TrStr reg = LlvmGenerator_next_reg(self);
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("    "));
        ...
        /* pass */
        ({ TrStr _at_t2918 = (_tr_str_wrap(_tr_float_to_str((double)(v)))); LlvmGenerator_w(self, _at_t2918); _tr_str_release(_at_t2918); });
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("\n"));
        /* pass */
        TrStr _ad_f_t2919 = ty->name;
        TrStr _ad_f_t2920 = ty->from_param;
        _tr_str_release(_ad_f_t2919);
        _tr_str_release(_ad_f_t2920);
        return reg;
    } else if (_t2913.tag == HirExpr_ELitStr) {
        __auto_type v = _t2913.data.ELitStr.val;
        /* pass */
        TrStr reg = LlvmGenerator_next_reg(self);
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2921 = (_tr_str_wrap(_tr_int_to_str((long long)(len)))); LlvmGenerator_w(self, _at_t2921); _tr_str_release(_at_t2921); });
        /* pass */
        ...
        return reg;
    } else if (_t2913.tag == HirExpr_ELitNone) {
        __auto_type _ = _t2913.data.ELitNone.ty;
        /* pass */
        TrStr _ad_f_t2922 = _->name;
        TrStr _ad_f_t2923 = _->from_param;
        _tr_str_release(_ad_f_t2922);
        _tr_str_release(_ad_f_t2923);
        return _tr_str_lit("null");
    } else if (_t2913.tag == HirExpr_EIdent) {
        __auto_type name = _t2913.data.EIdent.name;
__auto_type is_move = _t2913.data.EIdent.is_move;
        /* pass */
        TrStr reg = LlvmGenerator_next_reg(self);
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("    "));
        ...
        /* pass */
        return reg;
    } else if (_t2913.tag == HirExpr_EBinOp) {
        __auto_type op = _t2913.data.EBinOp.op;
__auto_type left = _t2913.data.EBinOp.left;
__auto_type right = _t2913.data.EBinOp.right;
__auto_type ty = _t2913.data.EBinOp.ty;
        /* pass */
        return LlvmGenerator_gen_binop_llvm(self, op, left, right, ty);
    } else if (_t2913.tag == HirExpr_ECall) {
        __auto_type callee = _t2913.data.ECall.callee;
__auto_type args = _t2913.data.ECall.args;
        /* pass */
...
__attribute__((hot)) TrStr LlvmGenerator_gen_binop_llvm(LlvmGenerator* self, TrStr op, HirExpr* left, HirExpr* right, AstType* ty) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2924 = _tr_str_lit("add");
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2925 = _tr_str_lit("sub");
        _tr_str_release(instr);
        instr = _strtmp_t2925;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("*"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2926 = _tr_str_lit("mul");
        _tr_str_release(instr);
        instr = _strtmp_t2926;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("/"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2927 = _tr_str_lit("sdiv");
        _tr_str_release(instr);
        instr = _strtmp_t2927;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("%"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2928 = _tr_str_lit("srem");
        _tr_str_release(instr);
        instr = _strtmp_t2928;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("&"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2929 = _tr_str_lit("and");
        _tr_str_release(instr);
        instr = _strtmp_t2929;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("|"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2930 = _tr_str_lit("or");
        _tr_str_release(instr);
        instr = _strtmp_t2930;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("^"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2931 = _tr_str_lit("xor");
        _tr_str_release(instr);
        instr = _strtmp_t2931;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<<"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2932 = _tr_str_lit("shl");
        _tr_str_release(instr);
        instr = _strtmp_t2932;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit(">>"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2933 = _tr_str_lit("ashr");
        _tr_str_release(instr);
        instr = _strtmp_t2933;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
        /* pass */
        TrStr _strtmp_t2934 = _tr_str_lit("icmp eq");
        _tr_str_release(instr);
        instr = _strtmp_t2934;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("!="))) == 0)) {
        /* pass */
        TrStr _strtmp_t2935 = _tr_str_lit("icmp ne");
        _tr_str_release(instr);
        instr = _strtmp_t2935;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2936 = _tr_str_lit("icmp slt");
        _tr_str_release(instr);
        instr = _strtmp_t2936;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<="))) == 0)) {
        /* pass */
        TrStr _strtmp_t2937 = _tr_str_lit("icmp sle");
        _tr_str_release(instr);
        instr = _strtmp_t2937;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit(">"))) == 0)) {
        /* pass */
        TrStr _strtmp_t2938 = _tr_str_lit("icmp sgt");
        _tr_str_release(instr);
        instr = _strtmp_t2938;
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit(">="))) == 0)) {
        /* pass */
        TrStr _strtmp_t2939 = _tr_str_lit("icmp sge");
        _tr_str_release(instr);
        instr = _strtmp_t2939;
    }
    /* pass */
...
__attribute__((hot)) TrStr LlvmGenerator_gen_call_llvm(LlvmGenerator* self, HirExpr* callee, List_ptr* args) {
    ...
    /* pass */
    __auto_type _t2940 = (*callee);
    if (_t2940.tag == HirExpr_EIdent) {
        __auto_type n = _t2940.data.EIdent.name;
__auto_type is_move = _t2940.data.EIdent.is_move;
        TrStr _strtmp_t2941 = _tr_str_retain(n);
        _tr_str_release(callee_name);
        callee_name = _strtmp_t2941;
    } else if (1) {
    ...
    if ((strcmp(_tr_strz(callee_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t2942 = _tr_str_lit("unknown");
        _tr_str_release(callee_name);
        callee_name = _strtmp_t2942;
    }
    /* pass */
    LlvmGenerator_w(self, _tr_str_lit("    "));
    /* pass */
    ...
    while ((i < args->len)) {
        ...
        /* pass */
        ({ TrStr _at_t2943 = (llvm_type(arg_ty)); LlvmGenerator_w(self, _at_t2943); _tr_str_release(_at_t2943); });
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit(" "));
        /* pass */
        ...
        TrStr _ad_f_t2944 = arg_ty->name;
        TrStr _ad_f_t2945 = arg_ty->from_param;
        _tr_str_release(_ad_f_t2944);
        _tr_str_release(_ad_f_t2945);
    }
    /* pass */
    LlvmGenerator_w(self, _tr_str_lit(")\n"));
    /* pass */
...
__attribute__((hot)) void LlvmGenerator_gen_stmt(LlvmGenerator* self, HirStmt* s_ptr) {
    ...
    __auto_type s = (*s_ptr);
    /* pass */
    __auto_type _t2946 = s;
    if (_t2946.tag == HirStmt_SExpr) {
        __auto_type e = _t2946.data.SExpr.expr;
        /* pass */
        LlvmGenerator_gen_expr(self, e);
    } else if (_t2946.tag == HirStmt_SReturn) {
        __auto_type e = _t2946.data.SReturn.val;
        /* pass */
        if ((((unsigned long long)(e)) == ((unsigned long long)(0LL)))) {
            ...
            /* pass */
            ({ TrStr _at_t2947 = (llvm_type(ty)); LlvmGenerator_w(self, _at_t2947); _tr_str_release(_at_t2947); });
            /* pass */
            LlvmGenerator_w(self, _tr_str_lit(" "));
            /* pass */
    ...
    } else if (_t2946.tag == HirStmt_SLet) {
        __auto_type name = _t2946.data.SLet.name;
__auto_type ownership = _t2946.data.SLet.ownership;
__auto_type is_mut = _t2946.data.SLet.is_mut;
__auto_type is_const = _t2946.data.SLet.is_const;
__auto_type is_shared = _t2946.data.SLet.is_shared;
__auto_type ty = _t2946.data.SLet.ty;
__auto_type val = _t2946.data.SLet.val;
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("    %"));
        /* pass */
        LlvmGenerator_w(self, name);
        ...
        /* pass */
        ({ TrStr _at_t2948 = (llvm_type(ty)); LlvmGenerator_w(self, _at_t2948); _tr_str_release(_at_t2948); });
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("\n"));
        /* pass */
        if ((((unsigned long long)(val)) != ((unsigned long long)(0LL)))) {
            ...
            /* pass */
            ({ TrStr _at_t2949 = (llvm_type(ty)); LlvmGenerator_w(self, _at_t2949); _tr_str_release(_at_t2949); });
            /* pass */
            LlvmGenerator_w(self, _tr_str_lit(" "));
            /* pass */
            LlvmGenerator_w(self, v);
        ...
        TrStr _ad_f_t2950 = ty->name;
        TrStr _ad_f_t2951 = ty->from_param;
        _tr_str_release(_ad_f_t2950);
        _tr_str_release(_ad_f_t2951);
    } else if (_t2946.tag == HirStmt_SIf) {
        __auto_type cond = _t2946.data.SIf.cond;
__auto_type then_b = _t2946.data.SIf.then_b;
__auto_type else_b = _t2946.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t2946.tag == HirStmt_SWhile) {
        __auto_type cond = _t2946.data.SWhile.cond;
__auto_type body = _t2946.data.SWhile.body;
        /* pass */
        ...
        _tr_str_release(end_lbl);
        _tr_str_release(cond_v);
    } else if (_t2946.tag == HirStmt_SBreak) {
        __auto_type _ = _t2946.data.SBreak.val;
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("    ; break (unresolved in stub)\n"));
    } else if (_t2946.tag == HirStmt_SContinue) {
        /* pass */
        LlvmGenerator_w(self, _tr_str_lit("    ; continue (unresolved in stub)\n"));
    } else if (_t2946.tag == HirStmt_SPass) {
        /* pass */
        /* pass */
    } else if (1) {
...
__attribute__((hot)) TrStr LlvmGenerator_generate(LlvmGenerator* self, HirProgram* prog) {
    ...
    while ((i < prog->functions->len)) {
        ...
        if (f->is_extern) {
            ...
            /* pass */
            ({ TrStr _at_t2952 = (llvm_type(f->ret_ty)); LlvmGenerator_w(self, _at_t2952); _tr_str_release(_at_t2952); });
            /* pass */
            LlvmGenerator_w(self, _tr_str_lit(" @"));
            /* pass */
