...
__attribute__((hot)) void Parser_skip_newlines_and_indent(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t20.tag == Token_Newline || _t20.tag == Token_Indent || _t20.tag == Token_Dedent)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            going = true;
...
__attribute__((hot)) void Parser_expect_newline(Parser* self) {
    ...
    if ((_t21.tag == Token_Newline || _t21.tag == Token_Semicolon)) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t21;
...
__attribute__((hot)) void Parser_emit_diag(Parser* self, TrStr msg, TrStr hint) {
    ...
    if ((_tr_strlen(_tr_strz(self->current_file)) > 0LL)) {
        /* pass */
        TrStr _strtmp_t23 = self->current_file;
        _tr_str_release(loc);
        loc = _strtmp_t23;
    }
    /* pass */
    ...
    if ((col > 0LL)) {
        /* pass */
        TrStr _strtmp_t24 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(head), _tr_strz(_tr_str_lit(":")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(col)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
    ...
    if (((_tr_strlen(_tr_strz(self->src_text)) > 0LL) && (ln > 0LL))) {
        ...
        if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
            ...
            if ((col > 0LL)) {
                ...
                /* pass */
                ({ TrStr _at_t25 = (repeat_char(_tr_str_lit("^"), width)); printf("%s\n", _tr_strz(({ TrStr _cl = (({ TrStr _cl = (c_dim(gbar)); TrStr _cr = (_spaces((col - 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cr = (c_red(_at_t25)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; }))); _tr_str_release(_at_t25); });
            }
...
__attribute__((hot)) TrStr Parser_consume_ident(Parser* self) {
    ...
    if (_t26.tag == Token_Ident) {
        __auto_type name = _t26.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_retain(name);
    } else if (_t26.tag == Token_KwInt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("int");
    } else if (_t26.tag == Token_KwFloat) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("float");
    } else if (_t26.tag == Token_KwBool) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("bool");
    } else if ((_t26.tag == Token_KwStr || _t26.tag == Token_KwString)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("str");
    } else if (_t26.tag == Token_KwChar) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("char");
    } else if (_t26.tag == Token_KwVoid) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("void");
    } else if (_t26.tag == Token_KwExtend) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("extend");
    } else if (_t26.tag == Token_KwNone) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("None");
    } else if (_t26.tag == Token_KwLambda) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("lambda");
    } else if (_t26.tag == Token_KwSpawn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("spawn");
    } else if (_t26.tag == Token_KwAsync) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) TrStr Parser_consume_module_ident(Parser* self) {
    ...
    } else if (_t27.tag == Token_KwIn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return _tr_str_lit("in");
    } else if (_t27.tag == Token_KwIs) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) AstType* Parser_parse_type(Parser* self) {
    ...
    if (_t28.tag == Token_KwNone) {
        ...
        __auto_type _ = _t28;
        /* pass */
        TrStr _strtmp_t29 = Parser_consume_ident(self);
        _tr_str_release(name);
        name = _strtmp_t29;
    }
    /* pass */
    ...
    if (_t30.tag == Token_LBracket) {
        ...
        while (going) {
            ...
            if ((_t31.tag == Token_RBracket || _t31.tag == Token_Eof)) {
                /* pass */
                going = false;
            } else if (1) {
                __auto_type _ = _t31;
...
__attribute__((hot)) List_ptr* Parser_parse_param_list(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t34.tag == Token_RParen || _t34.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t34;
            ...
            if ((strcmp(_tr_strz(item_name), _tr_strz(_tr_str_lit(""))) != 0)) {
                ...
                if (_t35.tag == Token_Colon) {
                    ...
                    if ((strcmp(_tr_strz(item_name), _tr_strz(_tr_str_lit("ref"))) == 0)) {
                        ...
                        /* pass */
                        TrStr _strtmp_t36 = bt->name;
                        _tr_str_release(item_name);
                        item_name = _strtmp_t36;
                    }
                }
                /* pass */
...
__attribute__((hot)) Block* Parser_parse_block(Parser* self) {
    ...
    if (_t38.tag == Token_Indent) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (_t38.tag == Token_Newline) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_skip_newlines_and_indent(self);
    ...
    if (is_inline) {
        ...
        while (semi_going) {
            ...
            if (_t39.tag == Token_Semicolon) {
                /* pass */
                self->pos = (self->pos + 1LL);
                /* pass */
                __auto_type _t40 = Parser_peek(self);
                if ((_t40.tag == Token_Newline || _t40.tag == Token_Eof || _t40.tag == Token_Dedent)) {
                    /* pass */
                    /* pass */
                } else if (1) {
                    __auto_type _ = _t40;
                ...
                if ((self->pos > 0LL)) {
                    /* pass */
                    __auto_type _t41 = List_Token_get(self->tokens, (self->pos - 1LL));
                    if (_t41.tag == Token_Semicolon) {
                        /* pass */
                        __auto_type _t42 = Parser_peek(self);
                        if ((_t42.tag == Token_Newline || _t42.tag == Token_Eof || _t42.tag == Token_Dedent)) {
                            /* pass */
                            /* pass */
                        } else if (1) {
                            __auto_type _ = _t42;
    ...
    while (going) {
        ...
        if ((_t43.tag == Token_Dedent || _t43.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t43;
        ...
        if (going) {
            ...
            if ((_t44.tag == Token_Dedent || _t44.tag == Token_Eof)) {
                /* pass */
                going = false;
            } else if (1) {
                __auto_type _ = _t44;
...
__attribute__((hot)) Stmt* Parser_parse_stmt(Parser* self) {
    ...
    if (_t46.tag == Token_KwReturn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t47 = Parser_peek(self);
        if ((_t47.tag == Token_Newline || _t47.tag == Token_Dedent || _t47.tag == Token_Eof)) {
            /* pass */
    ...
    } else if (_t46.tag == Token_KwBreak) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_expect_newline(self);
    ...
    } else if (_t46.tag == Token_KwContinue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_expect_newline(self);
    ...
    } else if (_t46.tag == Token_KwRaise) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* e = Parser_parse_expr(self);
    ...
    } else if (_t46.tag == Token_KwDefer) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t46.tag == Token_KwWith) {
        /* pass */
        return Parser_parse_with_stmt(self);
    } else if (_t46.tag == Token_KwTry) {
        /* pass */
        return Parser_parse_try_stmt(self);
    } else if (_t46.tag == Token_KwAssert) {
        /* pass */
        return Parser_parse_assert_stmt(self);
    } else if (_t46.tag == Token_KwFrom) {
        /* pass */
        Parser_parse_from_import(self);
        /* pass */
        return box_stmt(Stmt_make_SPass());
    } else if (_t46.tag == Token_KwImport) {
        /* pass */
        Parser_parse_import(self);
        /* pass */
        return box_stmt(Stmt_make_SPass());
    } else if (_t46.tag == Token_KwClass) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t46.tag == Token_KwEnum) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t46.tag == Token_KwInterface) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t46.tag == Token_KwExtend) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t46.tag == Token_KwDef) {
        /* pass */
    ...
    if (_t49.tag == Token_Ident) {
        __auto_type cs_nm = _t49.data.Ident.name;
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_try_stmt(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_KwExcept().tag)) {
        ...
        if ((Parser_peek(self).tag != Token_make_Colon().tag)) {
            ...
            if (_t51.tag == Token_Ident) {
                __auto_type _ = _t51.data.Ident.name;
                /* pass */
            ...
            if (is_bare_var) {
                /* pass */
                TrStr _strtmp_t52 = Parser_consume_ident(self);
                _tr_str_release(err_name);
                err_name = _strtmp_t52;
            } else {
                /* pass */
                ...
                if ((Parser_peek(self).tag == Token_make_KwAs().tag)) {
                    ...
                    self->pos = (self->pos + 1LL);
                    /* pass */
                    TrStr _strtmp_t53 = Parser_consume_ident(self);
                    _tr_str_release(err_name);
                    err_name = _strtmp_t53;
                }
            }
        }
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_with_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if ((((unsigned long long)(item_e)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t56 = (*item_e);
            if (_t56.tag == Expr_ECast) {
                __auto_type cast_inner = _t56.data.ECast.expr;
__auto_type cast_ty_ptr = _t56.data.ECast.ty;
                /* pass */
                if ((((unsigned long long)(cast_ty_ptr)) != ((unsigned long long)(0LL)))) {
                    /* pass */
                    TrStr _strtmp_t57 = (*cast_ty_ptr)->name;
...
__attribute__((hot)) Stmt* Parser_parse_asm_stmt(Parser* self) {
    ...
    while (reading) {
        ...
        if (_t60.tag == Token_StrLit) {
            __auto_type s = _t60.data.StrLit.val;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    if ((parts->len > 0LL)) {
        /* pass */
        TrStr _strtmp_t63 = List_TrStr_get(parts, 0LL);
    ...
    if ((parts->len > 1LL)) {
        /* pass */
        TrStr _strtmp_t64 = List_TrStr_get(parts, 1LL);
    ...
    if ((parts->len > 2LL)) {
        /* pass */
        TrStr _strtmp_t65 = List_TrStr_get(parts, 2LL);
        _tr_str_release(ins);
        ins = _strtmp_t65;
    }
    /* pass */
    if ((parts->len > 3LL)) {
        /* pass */
        TrStr _strtmp_t66 = List_TrStr_get(parts, 3LL);
...
__attribute__((hot)) Stmt* Parser_parse_chan_select_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if (_t68.tag == Token_KwCase) {
            ...
            if (_t69.tag == Token_Ident) {
                __auto_type arm_nm = _t69.data.Ident.name;
                /* pass */
                if ((strcmp(_tr_strz(arm_nm), _tr_strz(_tr_str_lit("default"))) == 0)) {
                    ...
                    if (_t70.tag == Token_Eq) {
                        ...
                        /* pass */
                        TrStr _strtmp_t71 = _tr_str_retain(arm_nm);
            ...
            _tr_str_release(var_nm);
        } else if ((_t68.tag == Token_Dedent || _t68.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t68.tag == Token_Newline) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t68;
...
__attribute__((hot)) Stmt* Parser_parse_let_stmt(Parser* self, bool is_mut) {
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t73 = (Parser_consume_ident(self)); List_TrStr_append(names, _at_t73); _tr_str_release(_at_t73); });
        }
        /* pass */
        __auto_type _t74 = Parser_peek(self);
        if (_t74.tag == Token_Eq) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t74;
...
__attribute__((hot)) Stmt* Parser_parse_for_stmt(Parser* self) {
    ...
    if (((!for_is_ref) && (strcmp(_tr_strz(var), _tr_strz(_tr_str_lit("ref"))) == 0))) {
        ...
        if (_t86.tag == Token_KwIn) {
            /* pass */
        } else if (_t86.tag == Token_Comma) {
            /* pass */
        } else if (1) {
            __auto_type _ = _t86;
            /* pass */
            for_is_ref = true;
            /* pass */
            TrStr _strtmp_t87 = Parser_consume_ident(self);
            _tr_str_release(var);
            var = _strtmp_t87;
        }
    }
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t88 = (Parser_consume_ident(self)); List_TrStr_append(unpack_vars, _at_t88); _tr_str_release(_at_t88); });
        }
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_match_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t93.tag == Token_Dedent || _t93.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t93;
        ...
        if (going) {
            ...
            if ((_t95.tag == Token_Newline || _t95.tag == Token_Indent)) {
                /* pass */
...
__attribute__((hot)) Pattern Parser_parse_pattern(Parser* self) {
    ...
    if (_t98.tag == Token_Ident) {
        __auto_type type_name = _t98.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t99 = Parser_peek(self);
        if (_t99.tag == Token_Dot) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ...
            if (_t100.tag == Token_LParen) {
                ...
                if ((fields->len == 1LL)) {
                    /* pass */
                    return ({ TrStr _at_t101 = (List_TrStr_get(fields, 0LL)); __auto_type _wr = (Pattern_ctor_PVariantBind(type_name, variant, _at_t101)); _tr_str_release(_at_t101); _wr; });
                }
                /* pass */
    ...
    } else if (_t98.tag == Token_IntLit) {
        __auto_type v = _t98.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitInt(v);
    } else if (_t98.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(true);
    } else if (_t98.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(false);
    } else if (_t98.tag == Token_StrLit) {
        __auto_type s = _t98.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_assign_or_expr_stmt(Parser* self) {
    ...
    if (_t102.tag == Token_Colon) {
        /* pass */
        __auto_type _t103 = (*lhs);
        if (_t103.tag == Expr_EIdent) {
            __auto_type name = _t103.data.EIdent.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    } else if (_t102.tag == Token_PlusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
    ...
    } else if (_t102.tag == Token_MinusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("-"), lhs, rhs))));
    } else if (_t102.tag == Token_StarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), lhs, rhs))));
    } else if (_t102.tag == Token_SlashEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), lhs, rhs))));
    } else if (_t102.tag == Token_PercentEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), lhs, rhs))));
    } else if (_t102.tag == Token_FloorDivEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), lhs, rhs))));
    } else if (_t102.tag == Token_StarStarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("&"), lhs, rhs))));
    } else if (_t102.tag == Token_PipeEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("|"), lhs, rhs))));
    } else if (_t102.tag == Token_CaretEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("^"), lhs, rhs))));
    } else if (_t102.tag == Token_LtLtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("<<"), lhs, rhs))));
    } else if (_t102.tag == Token_GtGtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
...
__attribute__((hot)) Expr* Parser_parse_comparison(Parser* self) {
    ...
    if (_t105.tag == Token_EqEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("=="), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_NotEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("!="), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_Lt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("<"), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_Gt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit(">"), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_LtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("<="), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_GtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit(">="), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_KwIs) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("is"), left, Parser_parse_bitor_expr(self)));
    } else if (_t105.tag == Token_KwIn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Expr* Parser_parse_multiplicative(Parser* self) {
    ...
    while (true) {
        ...
        if (_t108.tag == Token_Star) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), left, Parser_parse_power(self)));
        } else if (_t108.tag == Token_Slash) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), left, Parser_parse_power(self)));
        } else if (_t108.tag == Token_Percent) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), left, Parser_parse_power(self)));
        } else if (_t108.tag == Token_FloorDiv) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), left, Parser_parse_power(self)));
...
__attribute__((hot)) Expr* Parser_parse_unary(Parser* self) {
    ...
    if (_t109.tag == Token_Minus) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("-"), Parser_parse_unary(self)));
    } else if (_t109.tag == Token_Tilde) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("~"), Parser_parse_unary(self)));
    } else if (_t109.tag == Token_Amp) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("&"), Parser_parse_unary(self)));
    } else if (_t109.tag == Token_Star) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("*"), Parser_parse_unary(self)));
...
__attribute__((hot)) Expr* Parser_parse_postfix(Parser* self) {
    ...
    while (true) {
        ...
        } else if (_t110.tag == Token_LParen) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            e = box_expr(Expr_ctor_ECall(e, Parser_parse_arg_list(self)));
        } else if (_t110.tag == Token_LBracket) {
            /* pass */
        ...
        } else if (_t110.tag == Token_Question) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            e = box_expr(Expr_ctor_ETryExpr(e));
        } else if (_t110.tag == Token_KwAs) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
...
__attribute__((hot)) void Parser_emit_diag_at(Parser* self, long long ln, long long col, TrStr msg, TrStr hint) {
    ...
    if ((_tr_strlen(_tr_strz(self->current_file)) > 0LL)) {
        /* pass */
        TrStr _strtmp_t112 = self->current_file;
        _tr_str_release(loc);
        loc = _strtmp_t112;
    }
    /* pass */
    ...
    if ((col > 0LL)) {
        /* pass */
        TrStr _strtmp_t113 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(head), _tr_strz(_tr_str_lit(":")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(col)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(head);
        head = _strtmp_t113;
    }
    /* pass */
...
__attribute__((hot)) void Parser_expect_rparen(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t114.tag == Token_RParen) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t114;
        /* pass */
        ({ TrStr _at_t115 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '(' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t115, _tr_str_lit("add the matching ')'.")); _tr_str_release(_at_t115); });
    }
}
...
__attribute__((hot)) void Parser_expect_rbracket(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t116.tag == Token_RBracket) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t116;
        /* pass */
        ({ TrStr _at_t117 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '[' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t117, _tr_str_lit("add the matching ']'.")); _tr_str_release(_at_t117); });
    }
}
...
__attribute__((hot)) void Parser_expect_rbrace(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t118.tag == Token_RBrace) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t118;
        /* pass */
        ({ TrStr _at_t119 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '{' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t119, _tr_str_lit("add the matching '}'.")); _tr_str_release(_at_t119); });
    }
}
...
__attribute__((hot)) List_ptr* Parser_parse_arg_list(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t120.tag == Token_RParen || _t120.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t120;
...
__attribute__((hot)) Expr* Parser_parse_primary(Parser* self) {
    ...
    if (_t122.tag == Token_IntLit) {
        __auto_type v = _t122.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitInt(v));
    } else if (_t122.tag == Token_FloatLit) {
        __auto_type v = _t122.data.FloatLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitFloat(v));
    } else if (_t122.tag == Token_StrLit) {
        __auto_type s = _t122.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t122.tag == Token_TripleStrLit) {
        __auto_type s = _t122.data.TripleStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t122.tag == Token_RawStrLit) {
        __auto_type s = _t122.data.RawStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ERawStr(s));
    } else if (_t122.tag == Token_ByteStrLit) {
        __auto_type s = _t122.data.ByteStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBytes(s));
    } else if (_t122.tag == Token_FStrLit) {
        __auto_type s = _t122.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Parser_parse_fstring(self, s);
    } else if (_t122.tag == Token_CharLit) {
        __auto_type v = _t122.data.CharLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitChar(v));
    } else if (_t122.tag == Token_BoolLit) {
        __auto_type v = _t122.data.BoolLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(v));
    } else if (_t122.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(true));
    } else if (_t122.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(false));
    } else if (_t122.tag == Token_KwNone) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_make_ELitNone());
    } else if (_t122.tag == Token_KwInt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("int")));
    } else if (_t122.tag == Token_KwFloat) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("float")));
    } else if (_t122.tag == Token_KwBool) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("bool")));
    } else if ((_t122.tag == Token_KwStr || _t122.tag == Token_KwString)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("str")));
    } else if (_t122.tag == Token_KwChar) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("char")));
    } else if (_t122.tag == Token_KwVoid) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("void")));
    } else if (_t122.tag == Token_KwSuper) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        ...
        if ((Parser_peek(self).tag == Token_make_LParen().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            TrStr _strtmp_t123 = Parser_consume_ident(self);
            _tr_str_release(super_base);
            super_base = _strtmp_t123;
            /* pass */
            if ((Parser_peek(self).tag == Token_make_RParen().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
        ...
        if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
            ...
            if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
                ...
                self->pos = (self->pos + 1LL);
                /* pass */
                TrStr _strtmp_t124 = _tr_str_retain(super_next);
                _tr_str_release(super_base);
                super_base = _strtmp_t124;
                /* pass */
    ...
    } else if (_t122.tag == Token_Ident) {
        __auto_type name = _t122.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(name));
    } else if (_t122.tag == Token_KwSizeOf) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t125 = Parser_peek(self);
        if (_t125.tag == Token_LParen) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t125;
    ...
    } else if (_t122.tag == Token_LParen) {
        /* pass */
    ...
    } else if (_t122.tag == Token_LBracket) {
        /* pass */
    ...
    } else if (_t122.tag == Token_LBrace) {
        /* pass */
    ...
    } else if (_t122.tag == Token_KwTry) {
        /* pass */
        Stmt* st = Parser_parse_try_stmt(self);
        /* pass */
        __auto_type _t129 = (*st);
        if (_t129.tag == Stmt_STry) {
            __auto_type try_body = _t129.data.STry.try_body;
__auto_type catches = _t129.data.STry.catches;
__auto_type finally_b = _t129.data.STry.finally_b;
            /* pass */
    ...
    } else if (_t122.tag == Token_KwAwait) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EAwait(Parser_parse_expr(self)));
    } else if (_t122.tag == Token_KwYield) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EYield(Parser_parse_expr(self)));
    } else if ((_t122.tag == Token_KwDef || _t122.tag == Token_KwAsync)) {
        /* pass */
        bool is_async = false;
        /* pass */
        ...
        __auto_type raw = _t122.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    if ((!Parser_at_end(self))) {
        ...
        if (_t133.tag == Token_Newline) {
            /* pass */
            TrStr _strtmp_t134 = _tr_str_lit("end of line");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t134;
            /* pass */
            TrStr _strtmp_t135 = _tr_str_lit("an expression was expected before the end of this line - check for a missing value or trailing operator.");
            _tr_str_release(hint);
            hint = _strtmp_t135;
        } else if (_t133.tag == Token_Indent) {
            /* pass */
            TrStr _strtmp_t136 = _tr_str_lit("indentation");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t136;
            /* pass */
            TrStr _strtmp_t137 = _tr_str_lit("check that this line's indentation matches the surrounding block.");
            _tr_str_release(hint);
            hint = _strtmp_t137;
        } else if (_t133.tag == Token_Dedent) {
            /* pass */
            TrStr _strtmp_t138 = _tr_str_lit("dedent");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t138;
            /* pass */
            TrStr _strtmp_t139 = _tr_str_lit("check that this block is properly indented and closed.");
            _tr_str_release(hint);
            hint = _strtmp_t139;
        } else if (_t133.tag == Token_Ident) {
            __auto_type n = _t133.data.Ident.name;
            /* pass */
            TrStr _strtmp_t140 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("identifier '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t140;
            /* pass */
            TrStr _strtmp_t141 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("an operator, ':' or end of statement was expected before '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'."))); _tr_str_release(_cl); _cres; });
            _tr_str_release(hint);
            hint = _strtmp_t141;
        } else if (_t133.tag == Token_KwMut) {
            TrStr _strtmp_t142 = _tr_str_lit("keyword 'mut'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t142;
        } else if (_t133.tag == Token_KwConst) {
            TrStr _strtmp_t143 = _tr_str_lit("keyword 'const'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t143;
        } else if (_t133.tag == Token_KwPub) {
            TrStr _strtmp_t144 = _tr_str_lit("keyword 'pub'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t144;
        } else if (_t133.tag == Token_KwReturn) {
            TrStr _strtmp_t145 = _tr_str_lit("keyword 'return'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t145;
        } else if (_t133.tag == Token_KwIf) {
            TrStr _strtmp_t146 = _tr_str_lit("keyword 'if'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t146;
        } else if (_t133.tag == Token_KwWhile) {
            TrStr _strtmp_t147 = _tr_str_lit("keyword 'while'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t147;
        } else if (_t133.tag == Token_Comma) {
            /* pass */
            TrStr _strtmp_t148 = _tr_str_lit("','");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t148;
            /* pass */
            TrStr _strtmp_t149 = _tr_str_lit("remove the extra ',' or add the missing item before it.");
            _tr_str_release(hint);
            hint = _strtmp_t149;
        } else if (_t133.tag == Token_Colon) {
            /* pass */
            TrStr _strtmp_t150 = _tr_str_lit("':'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t150;
            /* pass */
            TrStr _strtmp_t151 = _tr_str_lit("remove the extra ':' or check the statement before it is complete.");
            _tr_str_release(hint);
            hint = _strtmp_t151;
        } else if (_t133.tag == Token_RParen) {
            /* pass */
            TrStr _strtmp_t152 = _tr_str_lit("')'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t152;
            /* pass */
            TrStr _strtmp_t153 = _tr_str_lit("check for an extra ')' or a missing matching '('.");
            _tr_str_release(hint);
            hint = _strtmp_t153;
        } else if (_t133.tag == Token_RBracket) {
            /* pass */
            TrStr _strtmp_t154 = _tr_str_lit("']'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t154;
            /* pass */
            TrStr _strtmp_t155 = _tr_str_lit("check for an extra ']' or a missing matching '['.");
            _tr_str_release(hint);
            hint = _strtmp_t155;
        } else if (_t133.tag == Token_RBrace) {
            /* pass */
            TrStr _strtmp_t156 = _tr_str_lit("'}'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t156;
            /* pass */
            TrStr _strtmp_t157 = _tr_str_lit("check for an extra '}' or a missing matching '{'.");
            _tr_str_release(hint);
            hint = _strtmp_t157;
        } else if (_t133.tag == Token_Error) {
            __auto_type em = _t133.data.Error.msg;
            /* pass */
        ...
        /* pass */
        ({ TrStr _at_t158 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unexpected ")), _tr_strz(tok_desc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" in expression"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag(self, _at_t158, hint); _tr_str_release(_at_t158); });
        /* pass */
        self->pos = (self->pos + 1LL);
    }
    /* pass */
...
__attribute__((hot)) Expr* Parser_parse_fstring(Parser* self, TrStr raw) {
    ...
    while (true) {
        ...
        if ((c == 123LL)) {
            ...
            if ((sb->buf->len > 0LL)) {
                /* pass */
                ({ TrStr _at_t159 = (StringObj_as_str(StringBuilder_to_string(sb))); List_ptr_append(fl, FStringPart_init_text(_at_t159)); _tr_str_release(_at_t159); });
                /* pass */
            ...
            if ((colon_pos >= 0LL)) {
                ...
                /* pass */
                TrStr _strtmp_t160 = _tr_str_wrap(_tr_str_strip(_tr_strz(_fs)));
                _tr_str_release(fmt_spec);
                fmt_spec = _strtmp_t160;
                /* pass */
                TrStr _es = _tr_str_wrap(_tr_str_slice(_tr_strz(expr_str), 0LL, colon_pos));
                /* pass */
                TrStr _strtmp_t161 = _tr_str_wrap(_tr_str_strip(_tr_strz(_es)));
                _tr_str_release(expr_str);
                expr_str = _strtmp_t161;
                _tr_str_release(_fs);
                _tr_str_release(_es);
            }
            /* pass */
    ...
    if ((sb->buf->len > 0LL)) {
        /* pass */
        ({ TrStr _at_t162 = (StringObj_as_str(StringBuilder_to_string(sb))); List_ptr_append(fl, FStringPart_init_text(_at_t162)); _tr_str_release(_at_t162); });
    }
    /* pass */
...
__attribute__((hot)) Program* Parser_parse_program(Parser* self) {
    ...
    while ((!Parser_at_end(self))) {
        ...
        while (sk) {
            ...
            sk = false;
            /* pass */
            __auto_type _t163 = Parser_peek(self);
            if ((_t163.tag == Token_Newline || _t163.tag == Token_Dedent)) {
                /* pass */
                self->pos = (self->pos + 1LL);
                /* pass */
                sk = true;
            } else if (_t163.tag == Token_Indent) {
                /* pass */
...
__attribute__((hot)) Decl* Parser_parse_decl(Parser* self) {
    ...
    while (_scan_mods) {
        ...
        _scan_mods = false;
        /* pass */
        __auto_type _t164 = Parser_peek(self);
        if (_t164.tag == Token_KwPub) {
            /* pass */
            is_public = true;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            _scan_mods = true;
        } else if (_t164.tag == Token_KwExport) {
            /* pass */
            is_export = true;
            /* pass */
            is_public = true;
    ...
    /* pass */
    __auto_type _t165 = Parser_peek(self);
    if (_t165.tag == Token_KwFrom) {
        /* pass */
        return Parser_parse_from_import(self);
    } else if (_t165.tag == Token_KwImport) {
        /* pass */
        return Parser_parse_import(self);
    } else if (_t165.tag == Token_Ident) {
        __auto_type type_kw = _t165.data.Ident.name;
        /* pass */
    ...
    } else if (_t165.tag == Token_KwClass) {
        /* pass */
        long long _cline = Parser_cur_line(self);
        /* pass */
        Decl* c_ptr = Parser_parse_class_decl(self);
        /* pass */
        __auto_type _t166 = (*c_ptr);
        if (_t166.tag == Decl_DClass) {
            __auto_type c = _t166.data.DClass.cls;
            /* pass */
            c->line = _cline;
            /* pass */
        ...
        /* pass */
        return c_ptr;
    } else if (_t165.tag == Token_KwEnum) {
        /* pass */
        long long _eline = Parser_cur_line(self);
        /* pass */
        Decl* e_ptr = Parser_parse_enum_decl(self);
        /* pass */
        __auto_type _t167 = (*e_ptr);
        if (_t167.tag == Decl_DEnum) {
            __auto_type e = _t167.data.DEnum.enm;
            /* pass */
            e->line = _eline;
            /* pass */
        ...
        /* pass */
        return e_ptr;
    } else if (_t165.tag == Token_KwInterface) {
        /* pass */
        long long _iline = Parser_cur_line(self);
        /* pass */
        Decl* i_ptr = Parser_parse_interface_decl(self);
        /* pass */
        __auto_type _t168 = (*i_ptr);
        if (_t168.tag == Decl_DInterface) {
            __auto_type i = _t168.data.DInterface.iface;
            /* pass */
            i->line = _iline;
            /* pass */
        ...
        /* pass */
        return i_ptr;
    } else if (_t165.tag == Token_KwExtend) {
        /* pass */
        return Parser_parse_extend_decl(self);
    } else if (_t165.tag == Token_KwDecorator) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t165.tag == Token_KwExtern) {
        /* pass */
        return Parser_parse_extern_decl(self);
    } else if (_t165.tag == Token_KwAsync) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t169 = Parser_peek(self);
        if (_t169.tag == Token_KwDef) {
            /* pass */
            FunctionDef* f = Parser_parse_function_def(self, false);
            /* pass */
            f->is_async = true;
...
__attribute__((hot)) Decl* Parser_parse_from_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t170 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t170;
    }
    /* pass */
    __auto_type _t171 = Parser_peek(self);
    if (_t171.tag == Token_KwImport) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t171;
    ...
    if ((_t172.tag == Token_LParen || _t172.tag == Token_LBracket)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        multi = true;
    ...
    while (going) {
        ...
        if ((_t173.tag == Token_RParen || _t173.tag == Token_RBracket || _t173.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if ((_t173.tag == Token_Newline || _t173.tag == Token_Dedent)) {
            /* pass */
            if ((!multi)) {
                /* pass */
                going = false;
    ...
    if (multi) {
        ...
        if ((_t174.tag == Token_RParen || _t174.tag == Token_RBracket)) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t174;
...
__attribute__((hot)) Decl* Parser_parse_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t175 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t175;
    }
    /* pass */
    ...
    if ((Parser_peek(self).tag == Token_make_KwAs().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t176 = Parser_consume_ident(self);
        _tr_str_release(alias);
        alias = _strtmp_t176;
    }
    /* pass */
...
__attribute__((hot)) FunctionDef* Parser_parse_function_def(Parser* self, bool is_method) {
    ...
    if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
        ...
        while ((Parser_peek(self).tag != Token_make_RBracket().tag)) {
            /* pass */
            ({ TrStr _at_t177 = (Parser_consume_ident(self)); List_TrStr_append(f->generics, _at_t177); _tr_str_release(_at_t177); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    if (_t179.tag == Token_Ident) {
        __auto_type wkw0 = _t179.data.Ident.name;
        /* pass */
    ...
    if (((!w_is) && (Parser_peek(self).tag == Token_make_Newline().tag))) {
        ...
        while (scanning) {
            /* pass */
            __auto_type _t180 = List_Token_get(self->tokens, scan);
            if ((_t180.tag == Token_Newline || _t180.tag == Token_Indent)) {
                /* pass */
                scan = (scan + 1LL);
            } else if (1) {
                __auto_type _ = _t180;
        ...
        /* pass */
        __auto_type _t181 = List_Token_get(self->tokens, scan);
        if (_t181.tag == Token_Ident) {
            __auto_type wkw1 = _t181.data.Ident.name;
            /* pass */
...
__attribute__((hot)) Decl* Parser_parse_class_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
        ...
        while ((Parser_peek(self).tag != Token_make_RBracket().tag)) {
            /* pass */
            ({ TrStr _at_t182 = (Parser_consume_ident(self)); List_TrStr_append(c->generics, _at_t182); _tr_str_release(_at_t182); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t183 = (Parser_consume_ident(self)); List_TrStr_append(c->region_params, _at_t183); _tr_str_release(_at_t183); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t184 = (Parser_consume_ident(self)); List_TrStr_append(c->region_params, _at_t184); _tr_str_release(_at_t184); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwExtends().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t185 = (Parser_consume_ident(self)); List_TrStr_append(c->base_classes, _at_t185); _tr_str_release(_at_t185); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t186 = (Parser_consume_ident(self)); List_TrStr_append(c->base_classes, _at_t186); _tr_str_release(_at_t186); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t187 = (Parser_consume_ident(self)); List_TrStr_append(c->iface_names, _at_t187); _tr_str_release(_at_t187); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((strcmp(_tr_strz(c->docstring), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            if (_t189.tag == Token_TripleStrLit) {
                __auto_type _ds = _t189.data.TripleStrLit.val;
                /* pass */
        ...
        if ((_t191.tag == Token_Dedent || _t191.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t191.tag == Token_KwDef) {
            /* pass */
        ...
        } else if (_t191.tag == Token_KwAsync) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            __auto_type _t192 = Parser_peek(self);
            if (_t192.tag == Token_KwDef) {
                /* pass */
                long long _mline = Parser_cur_line(self);
                /* pass */
                FunctionDef* m = Parser_parse_function_def(self, true);
        ...
        } else if (_t191.tag == Token_Ident) {
            __auto_type fname = _t191.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            AstType** ty_ptr = (AstType**)(0LL);
            ...
            /* pass */
            Parser_expect_newline(self);
        } else if (_t191.tag == Token_KwPass) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_expect_newline(self);
...
__attribute__((hot)) Decl* Parser_parse_enum_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t193 = (Parser_consume_ident(self)); List_TrStr_append(e->region_params, _at_t193); _tr_str_release(_at_t193); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t194 = (Parser_consume_ident(self)); List_TrStr_append(e->region_params, _at_t194); _tr_str_release(_at_t194); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t195 = (Parser_consume_ident(self)); List_TrStr_append(e->iface_names, _at_t195); _tr_str_release(_at_t195); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((_t198.tag == Token_Dedent || _t198.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t198.tag == Token_Ident) {
            __auto_type vname = _t198.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
        ...
        } else if (_t198.tag == Token_KwPass) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_expect_newline(self);
...
__attribute__((hot)) Decl* Parser_parse_interface_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t199 = (Parser_consume_ident(self)); List_TrStr_append(i->region_params, _at_t199); _tr_str_release(_at_t199); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t200 = (Parser_consume_ident(self)); List_TrStr_append(i->region_params, _at_t200); _tr_str_release(_at_t200); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_Colon().tag)) {
    ...
    while (going) {
        ...
        if ((_t203.tag == Token_Dedent || _t203.tag == Token_Eof)) {
            /* pass */
            going = false;
...
__attribute__((hot)) Decl* Parser_parse_extend_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            TrStr _strtmp_t204 = Parser_consume_ident(self);
...
__attribute__((hot)) Decl* Parser_parse_extern_decl(Parser* self) {
    ...
    if (_t208.tag == Token_StrLit) {
        __auto_type s = _t208.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t209 = _tr_str_retain(s);
        _tr_str_release(abi);
        abi = _strtmp_t209;
    } else if (1) {
        __auto_type _ = _t208;
    ...
    while (going) {
        ...
        if ((_t212.tag == Token_Dedent || _t212.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t212.tag == Token_KwDef) {
            /* pass */
