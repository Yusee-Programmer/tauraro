...
__attribute__((hot)) Stmt* Parser_parse_try_stmt(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_KwExcept().tag)) {
        ...
        if ((Parser_peek(self).tag != Token_make_Colon().tag)) {
            ...
            if (is_bare_var) {
                /* pass */
                TrStr _strtmp_t58 = Parser_consume_ident(self);
                _tr_str_release(err_name);
                err_name = _strtmp_t58;
            } else {
                /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_with_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if ((((unsigned long long)(item_e)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t62 = (*item_e);
            if (_t62.tag == Expr_ECast) {
                __auto_type cast_inner = _t62.data.ECast.expr;
__auto_type cast_ty_ptr = _t62.data.ECast.ty;
                /* pass */
                if ((((unsigned long long)(cast_ty_ptr)) != ((unsigned long long)(0LL)))) {
                    /* pass */
                    TrStr _strtmp_t63 = _tr_str_retain((*cast_ty_ptr)->name);
...
__attribute__((hot)) Stmt* Parser_parse_asm_stmt(Parser* self) {
    ...
    while (reading) {
        ...
        if (_t66.tag == Token_StrLit) {
            __auto_type s = _t66.data.StrLit.val;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    if ((parts->len > 0LL)) {
        /* pass */
        TrStr _strtmp_t69 = List_TrStr_get(parts, 0LL);
    ...
    if ((parts->len > 1LL)) {
        /* pass */
        TrStr _strtmp_t70 = List_TrStr_get(parts, 1LL);
    ...
    if ((parts->len > 2LL)) {
        /* pass */
        TrStr _strtmp_t71 = List_TrStr_get(parts, 2LL);
        _tr_str_release(ins);
        ins = _strtmp_t71;
    }
    /* pass */
    if ((parts->len > 3LL)) {
        /* pass */
        TrStr _strtmp_t72 = List_TrStr_get(parts, 3LL);
...
__attribute__((hot)) Stmt* Parser_parse_chan_select_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if (_t74.tag == Token_KwCase) {
            ...
            if (_t75.tag == Token_Ident) {
                __auto_type arm_nm = _t75.data.Ident.name;
                /* pass */
                if ((strcmp(_tr_strz(arm_nm), _tr_strz(_tr_str_lit("default"))) == 0)) {
                    ...
                    if (_t76.tag == Token_Eq) {
                        ...
                        /* pass */
                        TrStr _strtmp_t77 = _tr_str_retain(arm_nm);
            ...
            _tr_str_release(var_nm);
        } else if ((_t74.tag == Token_Dedent || _t74.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t74.tag == Token_Newline) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t74;
...
__attribute__((hot)) Stmt* Parser_parse_let_stmt(Parser* self, bool is_mut) {
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t79 = (Parser_consume_ident(self)); List_TrStr_append(names, _at_t79); _tr_str_release(_at_t79); });
        }
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_for_stmt(Parser* self) {
    ...
    if (((!for_is_ref) && (strcmp(_tr_strz(var), _tr_strz(_tr_str_lit("ref"))) == 0))) {
        ...
        if (_t92.tag == Token_KwIn) {
            /* pass */
        } else if (_t92.tag == Token_Comma) {
            /* pass */
        } else if (1) {
            __auto_type _ = _t92;
            /* pass */
            for_is_ref = true;
            /* pass */
            TrStr _strtmp_t93 = Parser_consume_ident(self);
            _tr_str_release(var);
            var = _strtmp_t93;
        }
    }
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t94 = (Parser_consume_ident(self)); List_TrStr_append(unpack_vars, _at_t94); _tr_str_release(_at_t94); });
        }
        /* pass */
...
__attribute__((hot)) List_ptr* Parser_parse_match_arms(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t99.tag == Token_Dedent || _t99.tag == Token_Eof || _t99.tag == Token_RParen || _t99.tag == Token_RBracket || _t99.tag == Token_RBrace)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t99;
        ...
        if (going) {
            ...
            if ((_t101.tag == Token_Newline || _t101.tag == Token_Indent)) {
                /* pass */
...
__attribute__((hot)) Pattern Parser_parse_pattern(Parser* self) {
    ...
    if (_t104.tag == Token_Ident) {
        __auto_type type_name = _t104.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t105 = Parser_peek(self);
        if (_t105.tag == Token_Dot) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ...
            if (_t106.tag == Token_LParen) {
                ...
                if ((fields->len == 1LL)) {
                    /* pass */
                    return ({ TrStr _at_t107 = (List_TrStr_get(fields, 0LL)); __auto_type _wr = (Pattern_ctor_PVariantBind(type_name, variant, _at_t107)); _tr_str_release(_at_t107); _wr; });
                }
                /* pass */
    ...
    } else if (_t104.tag == Token_IntLit) {
        __auto_type v = _t104.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitInt(v);
    } else if (_t104.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(true);
    } else if (_t104.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(false);
    } else if (_t104.tag == Token_StrLit) {
        __auto_type s = _t104.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_assign_or_expr_stmt(Parser* self) {
    ...
    if (_t108.tag == Token_Colon) {
        /* pass */
        __auto_type _t109 = (*lhs);
        if (_t109.tag == Expr_EIdent) {
            __auto_type name = _t109.data.EIdent.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    } else if (_t108.tag == Token_PlusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
    ...
    } else if (_t108.tag == Token_MinusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("-"), lhs, rhs))));
    } else if (_t108.tag == Token_StarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), lhs, rhs))));
    } else if (_t108.tag == Token_SlashEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), lhs, rhs))));
    } else if (_t108.tag == Token_PercentEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), lhs, rhs))));
    } else if (_t108.tag == Token_FloorDivEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), lhs, rhs))));
    } else if (_t108.tag == Token_StarStarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("&"), lhs, rhs))));
    } else if (_t108.tag == Token_PipeEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("|"), lhs, rhs))));
    } else if (_t108.tag == Token_CaretEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("^"), lhs, rhs))));
    } else if (_t108.tag == Token_LtLtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("<<"), lhs, rhs))));
    } else if (_t108.tag == Token_GtGtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
...
__attribute__((hot)) Expr* Parser_parse_if_expr(Parser* self) {
    ...
    if (_t110.tag == Token_KwElif) {
        /* pass */
        else_e = Parser_parse_if_expr(self);
    } else if (_t110.tag == Token_KwElse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_skip_newlines(self);
...
__attribute__((hot)) Expr* Parser_parse_comparison(Parser* self) {
    ...
    /* pass */
    Expr* result = ({ TrStr _at_t112 = (List_TrStr_get(ops, 0LL)); __auto_type _wr = (box_expr(Expr_ctor_EBinOp(_at_t112, ((Expr*)List_ptr_get(operands, 0LL)), ((Expr*)List_ptr_get(operands, 1LL))))); _tr_str_release(_at_t112); _wr; });
    /* pass */
    long long ci = 1LL;
    /* pass */
    while ((ci < ops->len)) {
        /* pass */
        Expr* cmp = ({ TrStr _at_t113 = (List_TrStr_get(ops, ci)); __auto_type _wr = (box_expr(Expr_ctor_EBinOp(_at_t113, ((Expr*)List_ptr_get(operands, ci)), ((Expr*)List_ptr_get(operands, (ci + 1LL)))))); _tr_str_release(_at_t113); _wr; });
        /* pass */
...
__attribute__((hot)) TrStr Parser__peek_cmp_op(Parser* self) {
    ...
    if (_t114.tag == Token_EqEq) {
        return _tr_str_lit("==");
    } else if (_t114.tag == Token_NotEq) {
        return _tr_str_lit("!=");
    } else if (_t114.tag == Token_Lt) {
        return _tr_str_lit("<");
    } else if (_t114.tag == Token_Gt) {
        return _tr_str_lit(">");
    } else if (_t114.tag == Token_LtEq) {
        return _tr_str_lit("<=");
    } else if (_t114.tag == Token_GtEq) {
        return _tr_str_lit(">=");
    } else if (_t114.tag == Token_KwIs) {
        return _tr_str_lit("is");
    } else if (_t114.tag == Token_KwIn) {
        return _tr_str_lit("in");
    } else if (1) {
        __auto_type _ = _t114;
        return _tr_str_lit("");
...
__attribute__((hot)) Expr* Parser_parse_multiplicative(Parser* self) {
    ...
    while (true) {
        ...
        if (_t117.tag == Token_Star) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), left, Parser_parse_power(self)));
        } else if (_t117.tag == Token_Slash) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), left, Parser_parse_power(self)));
        } else if (_t117.tag == Token_Percent) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), left, Parser_parse_power(self)));
        } else if (_t117.tag == Token_FloorDiv) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), left, Parser_parse_power(self)));
...
__attribute__((hot)) Expr* Parser_parse_unary(Parser* self) {
    ...
    if (_t118.tag == Token_Minus) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("-"), Parser_parse_unary(self)));
    } else if (_t118.tag == Token_Tilde) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("~"), Parser_parse_unary(self)));
    } else if (_t118.tag == Token_Amp) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("&"), Parser_parse_unary(self)));
    } else if (_t118.tag == Token_Star) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("*"), Parser_parse_unary(self)));
...
__attribute__((hot)) Expr* Parser_parse_postfix(Parser* self) {
    ...
    while (true) {
        ...
        } else if (_t119.tag == Token_LParen) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            e = box_expr(Expr_ctor_ECall(e, Parser_parse_arg_list(self)));
        } else if (_t119.tag == Token_LBracket) {
            /* pass */
        ...
        } else if (_t119.tag == Token_Question) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            e = box_expr(Expr_ctor_ETryExpr(e));
        } else if (_t119.tag == Token_KwAs) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
...
__attribute__((hot)) void Parser_emit_diag_at(Parser* self, long long ln, long long col, TrStr msg, TrStr hint) {
    ...
    if ((_tr_strlen(_tr_strz(self->current_file)) > 0LL)) {
        /* pass */
        TrStr _strtmp_t121 = _tr_str_retain(self->current_file);
        _tr_str_release(loc);
        loc = _strtmp_t121;
    }
    /* pass */
    ...
    if ((col > 0LL)) {
        /* pass */
        TrStr _strtmp_t122 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(head), _tr_strz(_tr_str_lit(":")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(col)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(head);
        head = _strtmp_t122;
    }
    /* pass */
...
__attribute__((hot)) void Parser_expect_rbracket(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t125.tag == Token_RBracket) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t125;
        /* pass */
        ({ TrStr _at_t126 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '[' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t126, _tr_str_lit("add the matching ']'.")); _tr_str_release(_at_t126); });
    }
}
...
__attribute__((hot)) List_ptr* Parser_parse_arg_list(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t129.tag == Token_RParen || _t129.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t129;
...
__attribute__((hot)) Expr* Parser_parse_primary(Parser* self) {
    ...
    if (_t131.tag == Token_IntLit) {
        __auto_type v = _t131.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitInt(v));
    } else if (_t131.tag == Token_FloatLit) {
        __auto_type v = _t131.data.FloatLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitFloat(v));
    } else if (_t131.tag == Token_StrLit) {
        __auto_type s = _t131.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t131.tag == Token_TripleStrLit) {
        __auto_type s = _t131.data.TripleStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t131.tag == Token_RawStrLit) {
        __auto_type s = _t131.data.RawStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ERawStr(s));
    } else if (_t131.tag == Token_ByteStrLit) {
        __auto_type s = _t131.data.ByteStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBytes(s));
    } else if (_t131.tag == Token_FStrLit) {
        __auto_type s = _t131.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Parser_parse_fstring(self, s);
    } else if (_t131.tag == Token_CharLit) {
        __auto_type v = _t131.data.CharLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitChar(v));
    } else if (_t131.tag == Token_BoolLit) {
        __auto_type v = _t131.data.BoolLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(v));
    } else if (_t131.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(true));
    } else if (_t131.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(false));
    } else if (_t131.tag == Token_KwNone) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_make_ELitNone());
    } else if (_t131.tag == Token_KwInt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("int")));
    } else if (_t131.tag == Token_KwFloat) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("float")));
    } else if (_t131.tag == Token_KwBool) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("bool")));
    } else if ((_t131.tag == Token_KwStr || _t131.tag == Token_KwString)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("str")));
    } else if (_t131.tag == Token_KwChar) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("char")));
    } else if (_t131.tag == Token_KwVoid) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("void")));
    } else if (_t131.tag == Token_KwSuper) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        ...
        if ((Parser_peek(self).tag == Token_make_LParen().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            TrStr _strtmp_t132 = Parser_consume_ident(self);
        ...
        if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
            ...
            if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
                ...
                self->pos = (self->pos + 1LL);
                /* pass */
                TrStr _strtmp_t133 = _tr_str_retain(super_next);
                _tr_str_release(super_base);
    ...
    } else if (_t131.tag == Token_Ident) {
        __auto_type name = _t131.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t131.tag == Token_KwSizeOf) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t134 = Parser_peek(self);
        if (_t134.tag == Token_LParen) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t134;
    ...
    } else if (_t131.tag == Token_LParen) {
        /* pass */
    ...
    } else if (_t131.tag == Token_LBracket) {
        /* pass */
    ...
    } else if (_t131.tag == Token_LBrace) {
        /* pass */
    ...
    } else if (_t131.tag == Token_KwTry) {
        /* pass */
        Stmt* st = Parser_parse_try_stmt(self);
        /* pass */
        __auto_type _t138 = (*st);
        if (_t138.tag == Stmt_STry) {
            __auto_type try_body = _t138.data.STry.try_body;
__auto_type catches = _t138.data.STry.catches;
__auto_type finally_b = _t138.data.STry.finally_b;
            /* pass */
    ...
    } else if (_t131.tag == Token_KwAwait) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EAwait(Parser_parse_expr(self)));
    } else if (_t131.tag == Token_KwYield) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EYield(Parser_parse_expr(self)));
    } else if ((_t131.tag == Token_KwDef || _t131.tag == Token_KwAsync)) {
        /* pass */
        bool is_async = false;
        /* pass */
        ...
        __auto_type raw = _t131.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    if ((!Parser_at_end(self))) {
        ...
        if (_t142.tag == Token_Newline) {
            /* pass */
            TrStr _strtmp_t143 = _tr_str_lit("end of line");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t143;
            /* pass */
            TrStr _strtmp_t144 = _tr_str_lit("an expression was expected before the end of this line - check for a missing value or trailing operator.");
            _tr_str_release(hint);
            hint = _strtmp_t144;
        } else if (_t142.tag == Token_Indent) {
            /* pass */
            TrStr _strtmp_t145 = _tr_str_lit("indentation");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t145;
            /* pass */
            TrStr _strtmp_t146 = _tr_str_lit("check that this line's indentation matches the surrounding block.");
            _tr_str_release(hint);
            hint = _strtmp_t146;
        } else if (_t142.tag == Token_Dedent) {
            /* pass */
            TrStr _strtmp_t147 = _tr_str_lit("dedent");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t147;
            /* pass */
            TrStr _strtmp_t148 = _tr_str_lit("check that this block is properly indented and closed.");
            _tr_str_release(hint);
            hint = _strtmp_t148;
        } else if (_t142.tag == Token_Ident) {
            __auto_type n = _t142.data.Ident.name;
            /* pass */
            TrStr _strtmp_t149 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("identifier '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t149;
            /* pass */
            TrStr _strtmp_t150 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("an operator, ':' or end of statement was expected before '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'."))); _tr_str_release(_cl); _cres; });
            _tr_str_release(hint);
            hint = _strtmp_t150;
        } else if (_t142.tag == Token_KwMut) {
            TrStr _strtmp_t151 = _tr_str_lit("keyword 'mut'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t151;
        } else if (_t142.tag == Token_KwConst) {
            TrStr _strtmp_t152 = _tr_str_lit("keyword 'const'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t152;
        } else if (_t142.tag == Token_KwPub) {
            TrStr _strtmp_t153 = _tr_str_lit("keyword 'pub'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t153;
        } else if (_t142.tag == Token_KwReturn) {
            TrStr _strtmp_t154 = _tr_str_lit("keyword 'return'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t154;
        } else if (_t142.tag == Token_KwIf) {
            TrStr _strtmp_t155 = _tr_str_lit("keyword 'if'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t155;
        } else if (_t142.tag == Token_KwWhile) {
            TrStr _strtmp_t156 = _tr_str_lit("keyword 'while'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t156;
        } else if (_t142.tag == Token_Comma) {
            /* pass */
            TrStr _strtmp_t157 = _tr_str_lit("','");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t157;
            /* pass */
            TrStr _strtmp_t158 = _tr_str_lit("remove the extra ',' or add the missing item before it.");
            _tr_str_release(hint);
            hint = _strtmp_t158;
        } else if (_t142.tag == Token_Colon) {
            /* pass */
            TrStr _strtmp_t159 = _tr_str_lit("':'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t159;
            /* pass */
            TrStr _strtmp_t160 = _tr_str_lit("remove the extra ':' or check the statement before it is complete.");
            _tr_str_release(hint);
            hint = _strtmp_t160;
        } else if (_t142.tag == Token_RParen) {
            /* pass */
            ...
            _tr_str_release(hint);
            hint = _strtmp_t162;
        } else if (_t142.tag == Token_RBracket) {
            /* pass */
            TrStr _strtmp_t163 = _tr_str_lit("']'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t163;
            /* pass */
            TrStr _strtmp_t164 = _tr_str_lit("check for an extra ']' or a missing matching '['.");
            _tr_str_release(hint);
            hint = _strtmp_t164;
        } else if (_t142.tag == Token_RBrace) {
            /* pass */
            ...
            _tr_str_release(hint);
            hint = _strtmp_t166;
        } else if (_t142.tag == Token_Error) {
            __auto_type em = _t142.data.Error.msg;
            /* pass */
        ...
        /* pass */
        ({ TrStr _at_t167 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unexpected ")), _tr_strz(tok_desc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" in expression"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag(self, _at_t167, hint); _tr_str_release(_at_t167); });
        /* pass */
        self->pos = (self->pos + 1LL);
    }
    /* pass */
    ...
    while (true) {
        ...
        if ((c == 123LL)) {
            ...
            if ((colon_pos >= 0LL)) {
                ...
                /* pass */
                TrStr _strtmp_t169 = _tr_str_wrap(_tr_str_strip(_tr_strz(_fs)));
                _tr_str_release(fmt_spec);
                fmt_spec = _strtmp_t169;
                /* pass */
                TrStr _es = _tr_str_wrap(_tr_str_slice(_tr_strz(expr_str), 0LL, colon_pos));
                /* pass */
                TrStr _strtmp_t170 = _tr_str_wrap(_tr_str_strip(_tr_strz(_es)));
                _tr_str_release(expr_str);
                expr_str = _strtmp_t170;
                _tr_str_release(_fs);
                _tr_str_release(_es);
            }
            /* pass */
...
__attribute__((hot)) Program* Parser_parse_program(Parser* self) {
    ...
    while ((!Parser_at_end(self))) {
        ...
        while (sk) {
            ...
            if ((_t172.tag == Token_Newline || _t172.tag == Token_Dedent)) {
                /* pass */
                self->pos = (self->pos + 1LL);
                /* pass */
                sk = true;
            } else if (_t172.tag == Token_Indent) {
                /* pass */
...
__attribute__((hot)) Decl* Parser_parse_decl(Parser* self) {
    ...
    while (_scan_mods) {
        ...
        if (_t173.tag == Token_KwPub) {
            ...
            /* pass */
            _scan_mods = true;
        } else if (_t173.tag == Token_KwExport) {
            /* pass */
            is_export = true;
            /* pass */
            is_public = true;
    ...
    if (_t174.tag == Token_KwFrom) {
    ...
    } else if (_t174.tag == Token_KwClass) {
        /* pass */
        long long _cline = Parser_cur_line(self);
        /* pass */
        Decl* c_ptr = Parser_parse_class_decl(self);
        /* pass */
        __auto_type _t175 = (*c_ptr);
        if (_t175.tag == Decl_DClass) {
            __auto_type c = _t175.data.DClass.cls;
            /* pass */
            c->line = _cline;
            /* pass */
        ...
        /* pass */
        return c_ptr;
    } else if (_t174.tag == Token_KwEnum) {
        /* pass */
        long long _eline = Parser_cur_line(self);
        /* pass */
        Decl* e_ptr = Parser_parse_enum_decl(self);
        /* pass */
        __auto_type _t176 = (*e_ptr);
        if (_t176.tag == Decl_DEnum) {
            __auto_type e = _t176.data.DEnum.enm;
            /* pass */
            e->line = _eline;
            /* pass */
        ...
        /* pass */
        return e_ptr;
    } else if (_t174.tag == Token_KwInterface) {
        /* pass */
        long long _iline = Parser_cur_line(self);
        /* pass */
        Decl* i_ptr = Parser_parse_interface_decl(self);
        /* pass */
        __auto_type _t177 = (*i_ptr);
        if (_t177.tag == Decl_DInterface) {
            __auto_type i = _t177.data.DInterface.iface;
            /* pass */
            i->line = _iline;
            /* pass */
        ...
        /* pass */
        return i_ptr;
    } else if (_t174.tag == Token_KwExtend) {
        /* pass */
        return Parser_parse_extend_decl(self);
    } else if (_t174.tag == Token_KwDecorator) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t174.tag == Token_KwMacro) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t174.tag == Token_KwExtern) {
        /* pass */
...
__attribute__((hot)) Decl* Parser_parse_from_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t179 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t179;
    }
    /* pass */
    __auto_type _t180 = Parser_peek(self);
    if (_t180.tag == Token_KwImport) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t180;
    ...
    if ((_t181.tag == Token_LParen || _t181.tag == Token_LBracket)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        multi = true;
    ...
    while (going) {
        ...
        if ((_t182.tag == Token_RParen || _t182.tag == Token_RBracket || _t182.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if ((_t182.tag == Token_Newline || _t182.tag == Token_Dedent)) {
            /* pass */
            if ((!multi)) {
                /* pass */
                going = false;
    ...
    if (multi) {
        ...
        if ((_t183.tag == Token_RParen || _t183.tag == Token_RBracket)) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t183;
...
__attribute__((hot)) Decl* Parser_parse_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t184 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t184;
    }
    /* pass */
    ...
    if ((Parser_peek(self).tag == Token_make_KwAs().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t185 = Parser_consume_ident(self);
        _tr_str_release(alias);
        alias = _strtmp_t185;
    }
    /* pass */
...
__attribute__((hot)) FunctionDef* Parser_parse_function_def(Parser* self, bool is_method) {
    ...
    if (_t189.tag == Token_Ident) {
        __auto_type wkw0 = _t189.data.Ident.name;
        /* pass */
    ...
    if (((!w_is) && (Parser_peek(self).tag == Token_make_Newline().tag))) {
        ...
        while (scanning) {
            ...
            if ((_t190.tag == Token_Newline || _t190.tag == Token_Indent)) {
                /* pass */
                scan = (scan + 1LL);
            } else if (1) {
                __auto_type _ = _t190;
        ...
        if (_t191.tag == Token_Ident) {
            __auto_type wkw1 = _t191.data.Ident.name;
            /* pass */
...
__attribute__((hot)) Decl* Parser_parse_class_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t196 = (Parser_consume_ident(self)); List_TrStr_append(c->iface_names, _at_t196); _tr_str_release(_at_t196); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((strcmp(_tr_strz(c->docstring), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            if (_t198.tag == Token_TripleStrLit) {
                __auto_type _ds = _t198.data.TripleStrLit.val;
                /* pass */
        ...
        if ((_t200.tag == Token_Dedent || _t200.tag == Token_Eof)) {
        ...
        } else if (_t200.tag == Token_KwAsync) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            __auto_type _t201 = Parser_peek(self);
            if (_t201.tag == Token_KwDef) {
                /* pass */
                long long _mline = Parser_cur_line(self);
                /* pass */
                FunctionDef* m = Parser_parse_function_def(self, true);
            ...
            __auto_type fname = _t200.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            AstType** ty_ptr = (AstType**)(0LL);
...
__attribute__((hot)) Decl* Parser_parse_enum_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t203 = (Parser_consume_ident(self)); List_TrStr_append(e->region_params, _at_t203); _tr_str_release(_at_t203); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t204 = (Parser_consume_ident(self)); List_TrStr_append(e->iface_names, _at_t204); _tr_str_release(_at_t204); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((_t207.tag == Token_Dedent || _t207.tag == Token_Eof)) {
            ...
            __auto_type vname = _t207.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
...
__attribute__((hot)) Decl* Parser_parse_interface_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t209 = (Parser_consume_ident(self)); List_TrStr_append(i->region_params, _at_t209); _tr_str_release(_at_t209); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_Colon().tag)) {
...
__attribute__((hot)) Decl* Parser_parse_extend_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            TrStr _strtmp_t213 = Parser_consume_ident(self);
    ...
    while (going) {
        ...
        if ((_t216.tag == Token_Dedent || _t216.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t216.tag == Token_KwDef) {
            /* pass */
            FunctionDef* m = Parser_parse_function_def(self, true);
            /* pass */
            m->is_public = is_p;
            ...
            _tr_obj_release(m, _trdrop_FunctionDef);
        } else if (_t216.tag == Token_KwPass) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_expect_newline(self);
...
__attribute__((hot)) Decl* Parser_parse_extern_decl(Parser* self) {
    ...
    if (_t217.tag == Token_StrLit) {
        __auto_type s = _t217.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t218 = _tr_str_retain(s);
        _tr_str_release(abi);
        abi = _strtmp_t218;
    } else if (1) {
        __auto_type _ = _t217;
