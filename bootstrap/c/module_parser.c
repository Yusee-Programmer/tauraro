...
__attribute__((hot)) AstType* Parser_parse_type(Parser* self) {
    ...
    if (_t31.tag == Token_KwNone) {
        ...
        while (((Parser_peek(self).tag != Token_make_RParen().tag) && (Parser_peek(self).tag != Token_make_Eof().tag))) {
            ...
            TrStr _ad_f_t32 = elem_t->name;
            TrStr _ad_f_t33 = elem_t->from_param;
            _tr_str_release(_ad_f_t32);
            _tr_str_release(_ad_f_t33);
        }
        /* pass */
        ...
        if ((Parser_peek(self).tag == Token_make_LParen().tag)) {
            ...
            while (((Parser_peek(self).tag != Token_make_RParen().tag) && (Parser_peek(self).tag != Token_make_Eof().tag))) {
                ...
                TrStr _ad_f_t34 = dpt->name;
                TrStr _ad_f_t35 = dpt->from_param;
                _tr_str_release(_ad_f_t34);
                _tr_str_release(_ad_f_t35);
            }
            /* pass */
            if ((Parser_peek(self).tag == Token_make_RParen().tag)) {
                /* pass */
        ...
        /* pass */
        TrStr _ad_f_t36 = dret->name;
        TrStr _ad_f_t37 = dret->from_param;
        _tr_str_release(_ad_f_t36);
        _tr_str_release(_ad_f_t37);
        _tr_str_release(name);
        return dfn_t;
        ...
        if (going) {
            ...
            if ((strcmp(_tr_strz(item_name), _tr_strz(_tr_str_lit(""))) != 0)) {
                ...
                if (_t44.tag == Token_Colon) {
                    ...
                    TrStr _ad_f_t45 = ty->name;
                    TrStr _ad_f_t46 = ty->from_param;
                    _tr_str_release(_ad_f_t45);
                    _tr_str_release(_ad_f_t46);
                } else if (1) {
                    __auto_type _ = _t44;
                    /* pass */
                    if ((strcmp(_tr_strz(item_name), _tr_strz(_tr_str_lit("ref"))) == 0)) {
                        ...
                        /* pass */
                        TrStr _strtmp_t47 = bt->name;
                        _tr_str_release(item_name);
                        item_name = _strtmp_t47;
                    }
                }
                /* pass */
...
__attribute__((hot)) Block* Parser_parse_block(Parser* self) {
    ...
    if (_t49.tag == Token_Indent) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (_t49.tag == Token_Newline) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_skip_newlines_and_indent(self);
    ...
    if (is_inline) {
        ...
        while (semi_going) {
            ...
            if (_t50.tag == Token_Semicolon) {
                ...
                if ((self->pos > 0LL)) {
                    /* pass */
                    __auto_type _t52 = List_Token_get(self->tokens, (self->pos - 1LL));
                    if (_t52.tag == Token_Semicolon) {
                        /* pass */
                        __auto_type _t53 = Parser_peek(self);
                        if ((_t53.tag == Token_Newline || _t53.tag == Token_Eof || _t53.tag == Token_Dedent)) {
                            /* pass */
                            /* pass */
                        } else if (1) {
                            __auto_type _ = _t53;
    ...
    while (going) {
        ...
        if ((_t54.tag == Token_Dedent || _t54.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t54;
        ...
        if (going) {
            ...
            if ((_t55.tag == Token_Dedent || _t55.tag == Token_Eof)) {
                /* pass */
                going = false;
            } else if (1) {
                __auto_type _ = _t55;
...
__attribute__((hot)) Stmt* Parser_parse_stmt(Parser* self) {
    ...
    if (_t57.tag == Token_KwReturn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t58 = Parser_peek(self);
        if ((_t58.tag == Token_Newline || _t58.tag == Token_Dedent || _t58.tag == Token_Eof)) {
            /* pass */
    ...
    } else if (_t57.tag == Token_KwBreak) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        ...
        if (_t59.tag == Token_Newline) {
            /* pass */
        } else if (_t59.tag == Token_Dedent) {
            /* pass */
        } else if (_t59.tag == Token_Eof) {
            /* pass */
        } else if (_t59.tag == Token_Semicolon) {
            /* pass */
        } else if (1) {
            __auto_type _ = _t59;
            /* pass */
    ...
    } else if (_t57.tag == Token_KwContinue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_expect_newline(self);
    ...
    } else if (_t57.tag == Token_KwRaise) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* e = Parser_parse_expr(self);
    ...
    } else if (_t57.tag == Token_KwDefer) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t57.tag == Token_KwWith) {
        /* pass */
        return Parser_parse_with_stmt(self);
    } else if (_t57.tag == Token_KwTry) {
        /* pass */
        return Parser_parse_try_stmt(self);
    } else if (_t57.tag == Token_KwAssert) {
        /* pass */
        return Parser_parse_assert_stmt(self);
    } else if (_t57.tag == Token_KwFrom) {
        /* pass */
        Parser_parse_from_import(self);
        /* pass */
        return box_stmt(Stmt_make_SPass());
    } else if (_t57.tag == Token_KwImport) {
        /* pass */
        Parser_parse_import(self);
        /* pass */
        return box_stmt(Stmt_make_SPass());
    } else if (_t57.tag == Token_KwClass) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t57.tag == Token_KwEnum) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t57.tag == Token_KwInterface) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t57.tag == Token_KwExtend) {
        /* pass */
        return box_stmt(Stmt_ctor_SLocalDecl(Parser_parse_decl(self)));
    } else if (_t57.tag == Token_KwDef) {
        /* pass */
    ...
    if (_t61.tag == Token_Ident) {
        __auto_type cs_nm = _t61.data.Ident.name;
        /* pass */
        if ((strcmp(_tr_strz(cs_nm), _tr_strz(_tr_str_lit("type"))) == 0)) {
            ...
            if ((Parser_peek(self).tag == Token_make_Eq().tag)) {
                ...
                TrStr _ad_f_t62 = _ta_ty->name;
                TrStr _ad_f_t63 = _ta_ty->from_param;
                _tr_str_release(_ad_f_t62);
                _tr_str_release(_ad_f_t63);
                return box_stmt(Stmt_make_SPass());
            }
        }
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_try_stmt(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_KwExcept().tag)) {
        ...
        if ((Parser_peek(self).tag != Token_make_Colon().tag)) {
            ...
            if (_t65.tag == Token_Ident) {
                __auto_type _ = _t65.data.Ident.name;
                /* pass */
            ...
            if (is_bare_var) {
                /* pass */
                TrStr _strtmp_t66 = Parser_consume_ident(self);
                _tr_str_release(err_name);
                err_name = _strtmp_t66;
            } else {
                /* pass */
                ...
                if ((Parser_peek(self).tag == Token_make_KwAs().tag)) {
                    ...
                    self->pos = (self->pos + 1LL);
                    /* pass */
                    TrStr _strtmp_t67 = Parser_consume_ident(self);
                    _tr_str_release(err_name);
                    err_name = _strtmp_t67;
                }
            }
        }
        /* pass */
        ...
        _tr_str_release(err_name);
        TrStr _ad_f_t69 = c->err_name;
        _tr_str_release(_ad_f_t69);
    }
    /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_with_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if ((((unsigned long long)(item_e)) != ((unsigned long long)(0LL)))) {
            /* pass */
            __auto_type _t71 = (*item_e);
            if (_t71.tag == Expr_ECast) {
                __auto_type cast_inner = _t71.data.ECast.expr;
__auto_type cast_ty_ptr = _t71.data.ECast.ty;
                /* pass */
                if ((((unsigned long long)(cast_ty_ptr)) != ((unsigned long long)(0LL)))) {
                    /* pass */
                    TrStr _strtmp_t72 = (*cast_ty_ptr)->name;
...
__attribute__((hot)) Stmt* Parser_parse_asm_stmt(Parser* self) {
    ...
    while (reading) {
        ...
        if (_t75.tag == Token_StrLit) {
            __auto_type s = _t75.data.StrLit.val;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    if ((parts->len > 0LL)) {
        /* pass */
        TrStr _strtmp_t78 = List_TrStr_get(parts, 0LL);
    ...
    if ((parts->len > 1LL)) {
        /* pass */
        TrStr _strtmp_t79 = List_TrStr_get(parts, 1LL);
    ...
    if ((parts->len > 2LL)) {
        /* pass */
        TrStr _strtmp_t80 = List_TrStr_get(parts, 2LL);
        _tr_str_release(ins);
        ins = _strtmp_t80;
    }
    /* pass */
    if ((parts->len > 3LL)) {
        /* pass */
        TrStr _strtmp_t81 = List_TrStr_get(parts, 3LL);
...
__attribute__((hot)) Stmt* Parser_parse_chan_select_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if (_t83.tag == Token_KwCase) {
            ...
            if (_t84.tag == Token_Ident) {
                __auto_type arm_nm = _t84.data.Ident.name;
                /* pass */
                if ((strcmp(_tr_strz(arm_nm), _tr_strz(_tr_str_lit("default"))) == 0)) {
                    ...
                    if (_t85.tag == Token_Eq) {
                        ...
                        /* pass */
                        TrStr _strtmp_t86 = _tr_str_retain(arm_nm);
            ...
            _tr_str_release(var_nm);
        } else if ((_t83.tag == Token_Dedent || _t83.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t83.tag == Token_Newline) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t83;
...
__attribute__((hot)) Stmt* Parser_parse_let_stmt(Parser* self, bool is_mut) {
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t88 = (Parser_consume_ident(self)); List_TrStr_append(names, _at_t88); _tr_str_release(_at_t88); });
        }
        /* pass */
    ...
    if (_t90.tag == Token_Colon) {
        ...
        /* pass */
        ty_ptr = box_asttype(ty);
        TrStr _ad_f_t91 = ty->name;
        TrStr _ad_f_t92 = ty->from_param;
        _tr_str_release(_ad_f_t91);
        _tr_str_release(_ad_f_t92);
    } else if (1) {
        __auto_type _ = _t90;
        /* pass */
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_shared_let_stmt(Parser* self) {
    ...
    if (_t94.tag == Token_Colon) {
        ...
        /* pass */
        ty_ptr = box_asttype(ty);
        TrStr _ad_f_t95 = ty->name;
        TrStr _ad_f_t96 = ty->from_param;
        _tr_str_release(_ad_f_t95);
        _tr_str_release(_ad_f_t96);
    } else if (1) {
        __auto_type _ = _t94;
        /* pass */
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_const_let_stmt(Parser* self) {
    ...
    if (_t98.tag == Token_Colon) {
        ...
        /* pass */
        ty_ptr = box_asttype(ty);
        TrStr _ad_f_t99 = ty->name;
        TrStr _ad_f_t100 = ty->from_param;
        _tr_str_release(_ad_f_t99);
        _tr_str_release(_ad_f_t100);
    } else if (1) {
        __auto_type _ = _t98;
        /* pass */
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_if_stmt(Parser* self) {
    ...
    while (going) {
        ...
        if (_t103.tag == Token_KwElif) {
            ...
            /* pass */
            going = true;
        } else if (_t103.tag == Token_KwElse) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_skip_newlines(self);
...
__attribute__((hot)) Stmt* Parser_parse_for_stmt(Parser* self) {
    ...
    if (((!for_is_ref) && (strcmp(_tr_strz(var), _tr_strz(_tr_str_lit("ref"))) == 0))) {
        ...
        if (_t107.tag == Token_KwIn) {
            /* pass */
        } else if (_t107.tag == Token_Comma) {
            /* pass */
        } else if (1) {
            __auto_type _ = _t107;
            /* pass */
            for_is_ref = true;
            /* pass */
            TrStr _strtmp_t108 = Parser_consume_ident(self);
            _tr_str_release(var);
            var = _strtmp_t108;
        }
    }
    ...
    if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
        ...
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t109 = (Parser_consume_ident(self)); List_TrStr_append(unpack_vars, _at_t109); _tr_str_release(_at_t109); });
        }
        /* pass */
...
__attribute__((hot)) List_ptr* Parser_parse_match_arms(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t114.tag == Token_Dedent || _t114.tag == Token_Eof || _t114.tag == Token_RParen || _t114.tag == Token_RBracket || _t114.tag == Token_RBrace)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t114;
        ...
        if (going) {
            ...
            if ((_t116.tag == Token_Newline || _t116.tag == Token_Indent)) {
                /* pass */
...
__attribute__((hot)) Pattern Parser_parse_pattern(Parser* self) {
    ...
    if (_t119.tag == Token_Ident) {
        __auto_type type_name = _t119.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        ...
        if (_t120.tag == Token_Dot) {
            ...
            if (_t121.tag == Token_LParen) {
                ...
                if ((fields->len == 1LL)) {
                    /* pass */
                    return ({ TrStr _at_t122 = (List_TrStr_get(fields, 0LL)); __auto_type _wr = (Pattern_ctor_PVariantBind(type_name, variant, _at_t122)); _tr_str_release(_at_t122); _wr; });
                }
                /* pass */
    ...
    } else if (_t119.tag == Token_IntLit) {
        __auto_type v = _t119.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitInt(v);
    } else if (_t119.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(true);
    } else if (_t119.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Pattern_ctor_PLitBool(false);
    } else if (_t119.tag == Token_StrLit) {
        __auto_type s = _t119.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Stmt* Parser_parse_assign_or_expr_stmt(Parser* self) {
    ...
    if (_t123.tag == Token_Colon) {
        /* pass */
        __auto_type _t124 = (*lhs);
        if (_t124.tag == Expr_EIdent) {
            __auto_type name = _t124.data.EIdent.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
    ...
    } else if (_t123.tag == Token_PlusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
    ...
    } else if (_t123.tag == Token_MinusEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("-"), lhs, rhs))));
    } else if (_t123.tag == Token_StarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), lhs, rhs))));
    } else if (_t123.tag == Token_SlashEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), lhs, rhs))));
    } else if (_t123.tag == Token_PercentEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), lhs, rhs))));
    } else if (_t123.tag == Token_FloorDivEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), lhs, rhs))));
    } else if (_t123.tag == Token_StarStarEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("&"), lhs, rhs))));
    } else if (_t123.tag == Token_PipeEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("|"), lhs, rhs))));
    } else if (_t123.tag == Token_CaretEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("^"), lhs, rhs))));
    } else if (_t123.tag == Token_LtLtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
        ...
        /* pass */
        return box_stmt(Stmt_ctor_SAssign(lhs, box_expr(Expr_ctor_EBinOp(_tr_str_lit("<<"), lhs, rhs))));
    } else if (_t123.tag == Token_GtGtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Expr* rhs = Parser_parse_expr(self);
...
__attribute__((hot)) Expr* Parser_parse_if_expr(Parser* self) {
    ...
    if (_t125.tag == Token_KwElif) {
        /* pass */
        else_e = Parser_parse_if_expr(self);
    } else if (_t125.tag == Token_KwElse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        Parser_skip_newlines(self);
...
__attribute__((hot)) Expr* Parser_parse_comparison(Parser* self) {
    ...
    if (_t127.tag == Token_EqEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("=="), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_NotEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("!="), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_Lt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("<"), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_Gt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit(">"), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_LtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("<="), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_GtEq) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit(">="), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_KwIs) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("is"), left, Parser_parse_bitor_expr(self)));
    } else if (_t127.tag == Token_KwIn) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Expr* Parser_parse_multiplicative(Parser* self) {
    ...
    while (true) {
        ...
        if (_t130.tag == Token_Star) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("*"), left, Parser_parse_power(self)));
        } else if (_t130.tag == Token_Slash) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("/"), left, Parser_parse_power(self)));
        } else if (_t130.tag == Token_Percent) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("%"), left, Parser_parse_power(self)));
        } else if (_t130.tag == Token_FloorDiv) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            left = box_expr(Expr_ctor_EBinOp(_tr_str_lit("//"), left, Parser_parse_power(self)));
...
__attribute__((hot)) Expr* Parser_parse_unary(Parser* self) {
    ...
    if (_t131.tag == Token_Minus) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("-"), Parser_parse_unary(self)));
    } else if (_t131.tag == Token_Tilde) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("~"), Parser_parse_unary(self)));
    } else if (_t131.tag == Token_Amp) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("&"), Parser_parse_unary(self)));
    } else if (_t131.tag == Token_Star) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EUnaryOp(_tr_str_lit("*"), Parser_parse_unary(self)));
...
__attribute__((hot)) Expr* Parser_parse_postfix(Parser* self) {
    ...
    while (true) {
        ...
        } else if (_t132.tag == Token_Question) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            e = box_expr(Expr_ctor_ETryExpr(e));
        } else if (_t132.tag == Token_KwAs) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
...
__attribute__((hot)) void Parser_emit_diag_at(Parser* self, long long ln, long long col, TrStr msg, TrStr hint) {
    ...
    if ((_tr_strlen(_tr_strz(self->current_file)) > 0LL)) {
        /* pass */
        TrStr _strtmp_t134 = self->current_file;
        _tr_str_release(loc);
        loc = _strtmp_t134;
    }
    /* pass */
    ...
    if ((col > 0LL)) {
        /* pass */
        TrStr _strtmp_t135 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(head), _tr_strz(_tr_str_lit(":")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(col)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(head);
        head = _strtmp_t135;
    }
    /* pass */
...
__attribute__((hot)) void Parser_expect_rparen(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t136.tag == Token_RParen) {
        ...
        __auto_type _ = _t136;
        /* pass */
        ({ TrStr _at_t137 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '(' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t137, _tr_str_lit("add the matching ')'.")); _tr_str_release(_at_t137); });
    }
}
...
__attribute__((hot)) void Parser_expect_rbracket(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t138.tag == Token_RBracket) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t138;
        /* pass */
        ({ TrStr _at_t139 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '[' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t139, _tr_str_lit("add the matching ']'.")); _tr_str_release(_at_t139); });
    }
}
...
__attribute__((hot)) void Parser_expect_rbrace(Parser* self, long long oln, long long ocol, TrStr what) {
    ...
    if (_t140.tag == Token_RBrace) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t140;
        /* pass */
        ({ TrStr _at_t141 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unclosed '{' — ")), _tr_strz(what))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" is never closed"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag_at(self, oln, ocol, _at_t141, _tr_str_lit("add the matching '}'.")); _tr_str_release(_at_t141); });
    }
}
...
__attribute__((hot)) List_ptr* Parser_parse_arg_list(Parser* self) {
    ...
    while (going) {
        ...
        if ((_t142.tag == Token_RParen || _t142.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (1) {
            __auto_type _ = _t142;
...
__attribute__((hot)) Expr* Parser_parse_primary(Parser* self) {
    ...
    if (_t144.tag == Token_IntLit) {
        __auto_type v = _t144.data.IntLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitInt(v));
    } else if (_t144.tag == Token_FloatLit) {
        __auto_type v = _t144.data.FloatLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitFloat(v));
    } else if (_t144.tag == Token_StrLit) {
        __auto_type s = _t144.data.StrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t144.tag == Token_TripleStrLit) {
        __auto_type s = _t144.data.TripleStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitStr(s));
    } else if (_t144.tag == Token_RawStrLit) {
        __auto_type s = _t144.data.RawStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ERawStr(s));
    } else if (_t144.tag == Token_ByteStrLit) {
        __auto_type s = _t144.data.ByteStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBytes(s));
    } else if (_t144.tag == Token_FStrLit) {
        __auto_type s = _t144.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return Parser_parse_fstring(self, s);
    } else if (_t144.tag == Token_CharLit) {
        __auto_type v = _t144.data.CharLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitChar(v));
    } else if (_t144.tag == Token_BoolLit) {
        __auto_type v = _t144.data.BoolLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(v));
    } else if (_t144.tag == Token_KwTrue) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(true));
    } else if (_t144.tag == Token_KwFalse) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_ELitBool(false));
    } else if (_t144.tag == Token_KwNone) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_make_ELitNone());
    } else if (_t144.tag == Token_KwInt) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("int")));
    } else if (_t144.tag == Token_KwFloat) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("float")));
    } else if (_t144.tag == Token_KwBool) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("bool")));
    } else if ((_t144.tag == Token_KwStr || _t144.tag == Token_KwString)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("str")));
    } else if (_t144.tag == Token_KwChar) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("char")));
    } else if (_t144.tag == Token_KwVoid) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EIdent(_tr_str_lit("void")));
    } else if (_t144.tag == Token_KwSuper) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        ...
        if ((Parser_peek(self).tag == Token_make_LParen().tag)) {
            ...
            self->pos = (self->pos + 1LL);
            /* pass */
            TrStr _strtmp_t145 = Parser_consume_ident(self);
            _tr_str_release(super_base);
            super_base = _strtmp_t145;
            /* pass */
            if ((Parser_peek(self).tag == Token_make_RParen().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
        ...
        if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
            ...
            if ((Parser_peek(self).tag == Token_make_Dot().tag)) {
                ...
                self->pos = (self->pos + 1LL);
                /* pass */
                TrStr _strtmp_t146 = _tr_str_retain(super_next);
                _tr_str_release(super_base);
                super_base = _strtmp_t146;
                /* pass */
    ...
    } else if (_t144.tag == Token_Ident) {
        __auto_type name = _t144.data.Ident.name;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t144.tag == Token_KwSizeOf) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        __auto_type _t147 = Parser_peek(self);
        if (_t147.tag == Token_LParen) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t147;
    ...
    } else if (_t144.tag == Token_LParen) {
        /* pass */
    ...
    } else if (_t144.tag == Token_LBracket) {
        /* pass */
        ...
        if ((Parser_peek(self).tag == Token_make_KwFor().tag)) {
            ...
            while ((Parser_peek(self).tag == Token_make_KwFor().tag)) {
                ...
                /* pass */
                __auto_type _t149 = Parser_peek(self);
                if (_t149.tag == Token_KwIn) {
                    /* pass */
                    self->pos = (self->pos + 1LL);
                } else if (1) {
                    __auto_type _ = _t149;
                ...
                TrStr _ad_f_t150 = c->target;
                _tr_str_release(_ad_f_t150);
            }
            /* pass */
    ...
    } else if (_t144.tag == Token_LBrace) {
        /* pass */
        ...
        if ((Parser_peek(self).tag != Token_make_RBrace().tag)) {
            ...
            if ((Parser_peek(self).tag == Token_make_Colon().tag)) {
                ...
                while (((Parser_peek(self).tag != Token_make_RBrace().tag) && (Parser_peek(self).tag != Token_make_Eof().tag))) {
                    ...
                    Parser_skip_newlines(self);
                    /* pass */
                    __auto_type _t151 = Parser_peek(self);
                    if (_t151.tag == Token_Colon) {
                        /* pass */
                        self->pos = (self->pos + 1LL);
                    } else if (1) {
                        __auto_type _ = _t151;
    ...
    } else if (_t144.tag == Token_KwTry) {
        /* pass */
        Stmt* st = Parser_parse_try_stmt(self);
        /* pass */
        __auto_type _t152 = (*st);
        if (_t152.tag == Stmt_STry) {
            __auto_type try_body = _t152.data.STry.try_body;
__auto_type catches = _t152.data.STry.catches;
__auto_type finally_b = _t152.data.STry.finally_b;
            /* pass */
    ...
    } else if (_t144.tag == Token_KwAwait) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EAwait(Parser_parse_expr(self)));
    } else if (_t144.tag == Token_KwYield) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        return box_expr(Expr_ctor_EYield(Parser_parse_expr(self)));
    } else if ((_t144.tag == Token_KwDef || _t144.tag == Token_KwAsync)) {
        /* pass */
        bool is_async = false;
        /* pass */
        ...
        __auto_type raw = _t144.data.FStrLit.val;
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    if ((!Parser_at_end(self))) {
        ...
        /* pass */
        __auto_type _t156 = Parser_peek(self);
        if (_t156.tag == Token_Newline) {
            /* pass */
            TrStr _strtmp_t157 = _tr_str_lit("end of line");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t157;
            /* pass */
            TrStr _strtmp_t158 = _tr_str_lit("an expression was expected before the end of this line - check for a missing value or trailing operator.");
            _tr_str_release(hint);
            hint = _strtmp_t158;
        } else if (_t156.tag == Token_Indent) {
            /* pass */
            TrStr _strtmp_t159 = _tr_str_lit("indentation");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t159;
            /* pass */
            TrStr _strtmp_t160 = _tr_str_lit("check that this line's indentation matches the surrounding block.");
            _tr_str_release(hint);
            hint = _strtmp_t160;
        } else if (_t156.tag == Token_Dedent) {
            /* pass */
            TrStr _strtmp_t161 = _tr_str_lit("dedent");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t161;
            /* pass */
            TrStr _strtmp_t162 = _tr_str_lit("check that this block is properly indented and closed.");
            _tr_str_release(hint);
            hint = _strtmp_t162;
        } else if (_t156.tag == Token_Ident) {
            __auto_type n = _t156.data.Ident.name;
            /* pass */
            TrStr _strtmp_t163 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("identifier '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t163;
            /* pass */
            TrStr _strtmp_t164 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("an operator, ':' or end of statement was expected before '")), _tr_strz(n))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'."))); _tr_str_release(_cl); _cres; });
            _tr_str_release(hint);
            hint = _strtmp_t164;
        } else if (_t156.tag == Token_KwMut) {
            TrStr _strtmp_t165 = _tr_str_lit("keyword 'mut'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t165;
        } else if (_t156.tag == Token_KwConst) {
            TrStr _strtmp_t166 = _tr_str_lit("keyword 'const'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t166;
        } else if (_t156.tag == Token_KwPub) {
            TrStr _strtmp_t167 = _tr_str_lit("keyword 'pub'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t167;
        } else if (_t156.tag == Token_KwReturn) {
            TrStr _strtmp_t168 = _tr_str_lit("keyword 'return'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t168;
        } else if (_t156.tag == Token_KwIf) {
            TrStr _strtmp_t169 = _tr_str_lit("keyword 'if'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t169;
        } else if (_t156.tag == Token_KwWhile) {
            TrStr _strtmp_t170 = _tr_str_lit("keyword 'while'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t170;
        } else if (_t156.tag == Token_Comma) {
            /* pass */
            TrStr _strtmp_t171 = _tr_str_lit("','");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t171;
            /* pass */
            TrStr _strtmp_t172 = _tr_str_lit("remove the extra ',' or add the missing item before it.");
            _tr_str_release(hint);
            hint = _strtmp_t172;
        } else if (_t156.tag == Token_Colon) {
            /* pass */
            TrStr _strtmp_t173 = _tr_str_lit("':'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t173;
            /* pass */
            TrStr _strtmp_t174 = _tr_str_lit("remove the extra ':' or check the statement before it is complete.");
            _tr_str_release(hint);
            hint = _strtmp_t174;
        } else if (_t156.tag == Token_RParen) {
            /* pass */
            TrStr _strtmp_t175 = _tr_str_lit("')'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t175;
            /* pass */
            TrStr _strtmp_t176 = _tr_str_lit("check for an extra ')' or a missing matching '('.");
            _tr_str_release(hint);
            hint = _strtmp_t176;
        } else if (_t156.tag == Token_RBracket) {
            /* pass */
            TrStr _strtmp_t177 = _tr_str_lit("']'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t177;
            /* pass */
            TrStr _strtmp_t178 = _tr_str_lit("check for an extra ']' or a missing matching '['.");
            _tr_str_release(hint);
            hint = _strtmp_t178;
        } else if (_t156.tag == Token_RBrace) {
            /* pass */
            TrStr _strtmp_t179 = _tr_str_lit("'}'");
            _tr_str_release(tok_desc);
            tok_desc = _strtmp_t179;
            /* pass */
            TrStr _strtmp_t180 = _tr_str_lit("check for an extra '}' or a missing matching '{'.");
            _tr_str_release(hint);
            hint = _strtmp_t180;
        } else if (_t156.tag == Token_Error) {
            __auto_type em = _t156.data.Error.msg;
            /* pass */
        ...
        /* pass */
        ({ TrStr _at_t181 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("unexpected ")), _tr_strz(tok_desc))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" in expression"))); _tr_str_release(_cl); _cres; })); Parser_emit_diag(self, _at_t181, hint); _tr_str_release(_at_t181); });
        /* pass */
        self->pos = (self->pos + 1LL);
    }
    /* pass */
...
__attribute__((hot)) Expr* Parser_parse_fstring(Parser* self, TrStr raw) {
    ...
    while (true) {
        ...
        if ((c == 123LL)) {
            ...
            if ((sb->buf->len > 0LL)) {
                /* pass */
                ({ TrStr _at_t182 = (StringObj_as_str(StringBuilder_to_string(sb))); List_ptr_append(fl, FStringPart_init_text(_at_t182)); _tr_str_release(_at_t182); });
                /* pass */
            ...
            if ((colon_pos >= 0LL)) {
                ...
                /* pass */
                TrStr _strtmp_t183 = _tr_str_wrap(_tr_str_strip(_tr_strz(_fs)));
                _tr_str_release(fmt_spec);
                fmt_spec = _strtmp_t183;
                /* pass */
                TrStr _es = _tr_str_wrap(_tr_str_slice(_tr_strz(expr_str), 0LL, colon_pos));
                /* pass */
                TrStr _strtmp_t184 = _tr_str_wrap(_tr_str_strip(_tr_strz(_es)));
                _tr_str_release(expr_str);
                expr_str = _strtmp_t184;
                _tr_str_release(_fs);
                _tr_str_release(_es);
            }
            /* pass */
    ...
    if ((sb->buf->len > 0LL)) {
        /* pass */
        ({ TrStr _at_t185 = (StringObj_as_str(StringBuilder_to_string(sb))); List_ptr_append(fl, FStringPart_init_text(_at_t185)); _tr_str_release(_at_t185); });
    }
    /* pass */
...
__attribute__((hot)) Program* Parser_parse_program(Parser* self) {
    ...
    while ((!Parser_at_end(self))) {
        ...
        while (sk) {
            ...
            if ((_t186.tag == Token_Newline || _t186.tag == Token_Dedent)) {
                /* pass */
                self->pos = (self->pos + 1LL);
                /* pass */
                sk = true;
            } else if (_t186.tag == Token_Indent) {
                /* pass */
...
__attribute__((hot)) Decl* Parser_parse_decl(Parser* self) {
    ...
    while (_scan_mods) {
        ...
        if (_t187.tag == Token_KwPub) {
            ...
            /* pass */
            _scan_mods = true;
        } else if (_t187.tag == Token_KwExport) {
            /* pass */
            is_export = true;
            /* pass */
            is_public = true;
    ...
    if (_t188.tag == Token_KwFrom) {
    ...
    } else if (_t188.tag == Token_KwClass) {
        /* pass */
        long long _cline = Parser_cur_line(self);
        /* pass */
        Decl* c_ptr = Parser_parse_class_decl(self);
        /* pass */
        __auto_type _t189 = (*c_ptr);
        if (_t189.tag == Decl_DClass) {
            __auto_type c = _t189.data.DClass.cls;
            /* pass */
            c->line = _cline;
            /* pass */
        ...
        /* pass */
        return c_ptr;
    } else if (_t188.tag == Token_KwEnum) {
        /* pass */
        long long _eline = Parser_cur_line(self);
        /* pass */
        Decl* e_ptr = Parser_parse_enum_decl(self);
        /* pass */
        __auto_type _t190 = (*e_ptr);
        if (_t190.tag == Decl_DEnum) {
            __auto_type e = _t190.data.DEnum.enm;
            /* pass */
            e->line = _eline;
            /* pass */
        ...
        /* pass */
        return e_ptr;
    } else if (_t188.tag == Token_KwInterface) {
        /* pass */
        long long _iline = Parser_cur_line(self);
        /* pass */
        Decl* i_ptr = Parser_parse_interface_decl(self);
        /* pass */
        __auto_type _t191 = (*i_ptr);
        if (_t191.tag == Decl_DInterface) {
            __auto_type i = _t191.data.DInterface.iface;
            /* pass */
            i->line = _iline;
            /* pass */
        ...
        /* pass */
        return i_ptr;
    } else if (_t188.tag == Token_KwExtend) {
        /* pass */
        return Parser_parse_extend_decl(self);
    } else if (_t188.tag == Token_KwDecorator) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t188.tag == Token_KwMacro) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
    ...
    } else if (_t188.tag == Token_KwExtern) {
        /* pass */
        return Parser_parse_extern_decl(self);
    } else if (_t188.tag == Token_KwAsync) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
...
__attribute__((hot)) Decl* Parser_parse_from_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t193 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t193;
    }
    /* pass */
    __auto_type _t194 = Parser_peek(self);
    if (_t194.tag == Token_KwImport) {
        /* pass */
        self->pos = (self->pos + 1LL);
    } else if (1) {
        __auto_type _ = _t194;
    ...
    if ((_t195.tag == Token_LParen || _t195.tag == Token_LBracket)) {
        /* pass */
        self->pos = (self->pos + 1LL);
        /* pass */
        multi = true;
    ...
    while (going) {
        ...
        if ((_t196.tag == Token_RParen || _t196.tag == Token_RBracket || _t196.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if ((_t196.tag == Token_Newline || _t196.tag == Token_Dedent)) {
            /* pass */
            if ((!multi)) {
                /* pass */
                going = false;
    ...
    if (multi) {
        ...
        if ((_t197.tag == Token_RParen || _t197.tag == Token_RBracket)) {
            /* pass */
            self->pos = (self->pos + 1LL);
        } else if (1) {
            __auto_type _ = _t197;
...
__attribute__((hot)) Decl* Parser_parse_import(Parser* self) {
    ...
    while ((Parser_peek(self).tag == Token_make_Dot().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t198 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".")))); TrStr _cr = (Parser_consume_module_ident(self)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(path);
        path = _strtmp_t198;
    }
    /* pass */
    ...
    if ((Parser_peek(self).tag == Token_make_KwAs().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        TrStr _strtmp_t199 = Parser_consume_ident(self);
        _tr_str_release(alias);
        alias = _strtmp_t199;
    }
    /* pass */
...
__attribute__((hot)) FunctionDef* Parser_parse_function_def(Parser* self, bool is_method) {
    ...
    if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
        ...
        while ((Parser_peek(self).tag != Token_make_RBracket().tag)) {
            /* pass */
            ({ TrStr _at_t200 = (Parser_consume_ident(self)); List_TrStr_append(f->generics, _at_t200); _tr_str_release(_at_t200); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    if (_t202.tag == Token_Ident) {
        __auto_type wkw0 = _t202.data.Ident.name;
        /* pass */
    ...
    if (((!w_is) && (Parser_peek(self).tag == Token_make_Newline().tag))) {
        ...
        while (scanning) {
            /* pass */
            __auto_type _t203 = List_Token_get(self->tokens, scan);
            if ((_t203.tag == Token_Newline || _t203.tag == Token_Indent)) {
                /* pass */
                scan = (scan + 1LL);
            } else if (1) {
                __auto_type _ = _t203;
        ...
        /* pass */
        __auto_type _t204 = List_Token_get(self->tokens, scan);
        if (_t204.tag == Token_Ident) {
            __auto_type wkw1 = _t204.data.Ident.name;
            /* pass */
...
__attribute__((hot)) Decl* Parser_parse_class_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
        ...
        while ((Parser_peek(self).tag != Token_make_RBracket().tag)) {
            /* pass */
            ({ TrStr _at_t205 = (Parser_consume_ident(self)); List_TrStr_append(c->generics, _at_t205); _tr_str_release(_at_t205); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t206 = (Parser_consume_ident(self)); List_TrStr_append(c->region_params, _at_t206); _tr_str_release(_at_t206); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t207 = (Parser_consume_ident(self)); List_TrStr_append(c->region_params, _at_t207); _tr_str_release(_at_t207); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwExtends().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t208 = (Parser_consume_ident(self)); List_TrStr_append(c->base_classes, _at_t208); _tr_str_release(_at_t208); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t209 = (Parser_consume_ident(self)); List_TrStr_append(c->base_classes, _at_t209); _tr_str_release(_at_t209); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t210 = (Parser_consume_ident(self)); List_TrStr_append(c->iface_names, _at_t210); _tr_str_release(_at_t210); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_LBracket().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((strcmp(_tr_strz(c->docstring), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            if (_t212.tag == Token_TripleStrLit) {
                __auto_type _ds = _t212.data.TripleStrLit.val;
                /* pass */
        ...
        } else if (_t214.tag == Token_KwAsync) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            __auto_type _t215 = Parser_peek(self);
            if (_t215.tag == Token_KwDef) {
                /* pass */
                long long _mline = Parser_cur_line(self);
                /* pass */
                FunctionDef* m = Parser_parse_function_def(self, true);
        ...
        } else if (_t214.tag == Token_Ident) {
            __auto_type fname = _t214.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            AstType** ty_ptr = (AstType**)(0LL);
        ...
        } else if (_t214.tag == Token_KwPass) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_expect_newline(self);
...
__attribute__((hot)) Decl* Parser_parse_enum_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t216 = (Parser_consume_ident(self)); List_TrStr_append(e->region_params, _at_t216); _tr_str_release(_at_t216); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t217 = (Parser_consume_ident(self)); List_TrStr_append(e->region_params, _at_t217); _tr_str_release(_at_t217); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_KwImplements().tag)) {
        ...
        while (true) {
            /* pass */
            ({ TrStr _at_t218 = (Parser_consume_ident(self)); List_TrStr_append(e->iface_names, _at_t218); _tr_str_release(_at_t218); });
            /* pass */
            if ((Parser_peek(self).tag == Token_make_Comma().tag)) {
                /* pass */
                self->pos = (self->pos + 1LL);
    ...
    while (going) {
        ...
        if ((_t221.tag == Token_Dedent || _t221.tag == Token_Eof)) {
            /* pass */
            going = false;
        } else if (_t221.tag == Token_Ident) {
            __auto_type vname = _t221.data.Ident.name;
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ...
            _tr_obj_release(m, _trdrop_FunctionDef);
        } else if (_t221.tag == Token_KwPass) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            Parser_expect_newline(self);
...
__attribute__((hot)) Decl* Parser_parse_interface_decl(Parser* self) {
    ...
    if ((Parser_peek(self).tag == Token_make_KwFrom().tag)) {
        ...
        self->pos = (self->pos + 1LL);
        /* pass */
        ({ TrStr _at_t222 = (Parser_consume_ident(self)); List_TrStr_append(i->region_params, _at_t222); _tr_str_release(_at_t222); });
        /* pass */
        while ((Parser_peek(self).tag == Token_make_Comma().tag)) {
            /* pass */
            self->pos = (self->pos + 1LL);
            /* pass */
            ({ TrStr _at_t223 = (Parser_consume_ident(self)); List_TrStr_append(i->region_params, _at_t223); _tr_str_release(_at_t223); });
        }
    }
    /* pass */
    if ((Parser_peek(self).tag == Token_make_Colon().tag)) {
