...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t2614 = (*lv);
        if (_t2614.tag == MacroVal_MInt) {
            __auto_type a = _t2614.data.MInt.n;
            /* pass */
            __auto_type _t2615 = (*rv);
            if (_t2615.tag == MacroVal_MInt) {
                __auto_type b = _t2615.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t2615;
                return ({ TrStr _at_t2616 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2616))); _tr_str_release(_at_t2616); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t2614;
            return ({ TrStr _at_t2617 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2617))); _tr_str_release(_at_t2617); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t2618 = (*lv);
    if (_t2618.tag == MacroVal_MInt) {
        __auto_type a = _t2618.data.MInt.n;
        /* pass */
        __auto_type _t2619 = (*rv);
        if (_t2619.tag == MacroVal_MInt) {
            __auto_type b = _t2619.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2620 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2620); _tr_str_release(_at_t2620); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2621 = (*eptr);
    if (_t2621.tag == Expr_ELitStr) {
        __auto_type s = _t2621.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2621.tag == Expr_ERawStr) {
        __auto_type s = _t2621.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2621.tag == Expr_ELitInt) {
        __auto_type n = _t2621.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t2621.tag == Expr_ELitBool) {
        __auto_type b = _t2621.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t2621.tag == Expr_EIdent) {
        __auto_type name = _t2621.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2622 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2622); _tr_str_release(_at_t2622); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2621.tag == Expr_EBinOp) {
        __auto_type op = _t2621.data.EBinOp.op;
__auto_type l = _t2621.data.EBinOp.left;
__auto_type r = _t2621.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t2621.tag == Expr_EUnaryOp) {
        __auto_type op = _t2621.data.EUnaryOp.op;
__auto_type x = _t2621.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t2623 = (*xv);
            if (_t2623.tag == MacroVal_MInt) {
                __auto_type n = _t2623.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t2624 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2624); _tr_str_release(_at_t2624); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2621.tag == Expr_EFString) {
        __auto_type parts = _t2621.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t2625 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t2625;
            } else {
                /* pass */
                TrStr _strtmp_t2626 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t2626;
            }
            /* pass */
        ...
        __auto_type obj = _t2621.data.EIndex.obj;
__auto_type idx = _t2621.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t2627 = (*ov);
        if (_t2627.tag == MacroVal_MList) {
            __auto_type items = _t2627.data.MList.items;
            /* pass */
            __auto_type _t2628 = (*iv);
            if (_t2628.tag == MacroVal_MInt) {
                __auto_type n = _t2628.data.MInt.n;
                /* pass */
        ...
        __auto_type obj = _t2621.data.EPropAccess.obj;
__auto_type prop = _t2621.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t2621.tag == Expr_EMethodCall) {
        __auto_type obj = _t2621.data.EMethodCall.obj;
__auto_type method = _t2621.data.EMethodCall.method;
__auto_type margs = _t2621.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t2630 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2630))); _tr_str_release(_at_t2630); _wr; });
        }
        /* pass */
        ({ TrStr _at_t2631 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2631); _tr_str_release(_at_t2631); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2621.tag == Expr_ECall) {
        __auto_type callee = _t2621.data.ECall.callee;
__auto_type cargs = _t2621.data.ECall.args;
        /* pass */
        __auto_type _t2632 = (*callee);
        if (_t2632.tag == Expr_EIdent) {
            __auto_type cn = _t2632.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2633 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t2633;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2634 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t2634;
                }
                /* pass */
                return ({ TrStr _at_t2635 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2635))); _tr_str_release(_at_t2635); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t2636 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2636))); _tr_str_release(_at_t2636); _wr; });
                }
                /* pass */
        ...
        __auto_type items = _t2621.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2637 = (*sptr);
    if (_t2637.tag == Stmt_SLet) {
        __auto_type name = _t2637.data.SLet.name;
__auto_type val = _t2637.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t2637.tag == Stmt_SAssign) {
        __auto_type target = _t2637.data.SAssign.target;
__auto_type val = _t2637.data.SAssign.val;
        /* pass */
        __auto_type _t2638 = (*target);
        if (_t2638.tag == Expr_EIdent) {
            __auto_type nm = _t2638.data.EIdent.name;
    ...
    } else if (_t2637.tag == Stmt_SReturn) {
        __auto_type val = _t2637.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t2637.tag == Stmt_SExpr) {
        __auto_type e = _t2637.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t2637.tag == Stmt_SFor) {
        __auto_type var = _t2637.data.SFor.var;
__auto_type iter = _t2637.data.SFor.iter;
__auto_type body = _t2637.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t2639 = (*iv);
        if (_t2639.tag == MacroVal_MList) {
            __auto_type items = _t2639.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t2637.tag == Stmt_SIf) {
        __auto_type cond = _t2637.data.SIf.cond;
__auto_type then_b = _t2637.data.SIf.then_b;
__auto_type elifs = _t2637.data.SIf.elifs;
__auto_type else_b = _t2637.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t2637.tag == Stmt_SPass) {
        /* pass */
    } else if (_t2637.tag == Stmt_SLine) {
        __auto_type _ = _t2637.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2640 = (*eptr);
    if (_t2640.tag == Expr_EMacroCall) {
        __auto_type name = _t2640.data.EMacroCall.name;
__auto_type args = _t2640.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t2640.tag == Expr_EBinOp) {
        __auto_type l = _t2640.data.EBinOp.left;
__auto_type r = _t2640.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t2640.tag == Expr_EUnaryOp) {
        __auto_type x = _t2640.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2640.tag == Expr_ECall) {
        __auto_type callee = _t2640.data.ECall.callee;
__auto_type cargs = _t2640.data.ECall.args;
        /* pass */
    ...
    } else if (_t2640.tag == Expr_EMethodCall) {
        __auto_type obj = _t2640.data.EMethodCall.obj;
__auto_type margs = _t2640.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t2640.tag == Expr_EPropAccess) {
        __auto_type obj = _t2640.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t2640.tag == Expr_EIndex) {
        __auto_type obj = _t2640.data.EIndex.obj;
__auto_type idx = _t2640.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t2640.tag == Expr_ECast) {
        __auto_type x = _t2640.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2640.tag == Expr_ETryExpr) {
        __auto_type x = _t2640.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2640.tag == Expr_EIfElse) {
        __auto_type c = _t2640.data.EIfElse.cond;
__auto_type t = _t2640.data.EIfElse.then_expr;
__auto_type e2 = _t2640.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t2640.tag == Expr_EList) {
        __auto_type items = _t2640.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2640.tag == Expr_ETuple) {
        __auto_type items = _t2640.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2640.tag == Expr_EFString) {
        __auto_type parts = _t2640.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t2640.tag == Expr_EDo) {
        __auto_type body = _t2640.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2640.tag == Expr_ELoop) {
        __auto_type body = _t2640.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2640.tag == Expr_EWhileExpr) {
        __auto_type c = _t2640.data.EWhileExpr.cond;
__auto_type body = _t2640.data.EWhileExpr.body;
__auto_type eb = _t2640.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t2640.tag == Expr_EMatch) {
        __auto_type subj = _t2640.data.EMatch.subj;
__auto_type arms = _t2640.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2641 = (*sptr);
    if (_t2641.tag == Stmt_SExpr) {
        __auto_type e = _t2641.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t2641.tag == Stmt_SLet) {
        __auto_type v = _t2641.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SMultiLet) {
        __auto_type v = _t2641.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SAssign) {
        __auto_type t = _t2641.data.SAssign.target;
__auto_type v = _t2641.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SReturn) {
        __auto_type v = _t2641.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SBreak) {
        __auto_type v = _t2641.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SRaise) {
        __auto_type v = _t2641.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SSpawn) {
        __auto_type v = _t2641.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2641.tag == Stmt_SAssert) {
        __auto_type c = _t2641.data.SAssert.cond;
__auto_type m = _t2641.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t2641.tag == Stmt_SIf) {
        __auto_type c = _t2641.data.SIf.cond;
__auto_type tb = _t2641.data.SIf.then_b;
__auto_type elifs = _t2641.data.SIf.elifs;
__auto_type eb = _t2641.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t2641.tag == Stmt_SWhile) {
        __auto_type c = _t2641.data.SWhile.cond;
__auto_type b = _t2641.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_SFor) {
        __auto_type it = _t2641.data.SFor.iter;
__auto_type b = _t2641.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_SForUnpack) {
        __auto_type it = _t2641.data.SForUnpack.iter;
__auto_type b = _t2641.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_SMatch) {
        __auto_type subj = _t2641.data.SMatch.expr;
__auto_type arms = _t2641.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t2641.tag == Stmt_SWith) {
        __auto_type items = _t2641.data.SWith.items;
__auto_type b = _t2641.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_STry) {
        __auto_type tb = _t2641.data.STry.try_body;
__auto_type catches = _t2641.data.STry.catches;
__auto_type fb = _t2641.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t2641.tag == Stmt_SUnsafe) {
        __auto_type b = _t2641.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_STaskGroup) {
        __auto_type b = _t2641.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_SGpuBlock) {
        __auto_type b = _t2641.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2641.tag == Stmt_SDefer) {
        __auto_type s = _t2641.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t2642 = (*dptr);
    if (_t2642.tag == Decl_DFunction) {
        __auto_type f = _t2642.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t2642.tag == Decl_DClass) {
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t2643 = (*recptr);
    if (_t2643.tag == MacroVal_MRec) {
        __auto_type keys = _t2643.data.MRec.keys;
__auto_type vals = _t2643.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2644 = (*vptr);
    if (_t2644.tag == MacroVal_MStr) {
        __auto_type s = _t2644.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t2644.tag == MacroVal_MInt) {
        __auto_type n = _t2644.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t2644.tag == MacroVal_MBool) {
        __auto_type b = _t2644.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t2644.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2645 = (*vptr);
    if (_t2645.tag == MacroVal_MBool) {
        __auto_type b = _t2645.data.MBool.b;
        return b;
    } else if (_t2645.tag == MacroVal_MInt) {
        __auto_type n = _t2645.data.MInt.n;
        return (n != 0LL);
    } else if (_t2645.tag == MacroVal_MStr) {
        __auto_type s = _t2645.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            /* pass */
            TrStr _strtmp_t2647 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t2647;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t2648 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t2648))); _tr_str_release(_at_t2648); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t2649 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2649))); _tr_str_release(_at_t2649); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t2650 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t2650;
        }
        /* pass */
        TrStr _strtmp_t2651 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t2651;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t2652 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t2652;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2653 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2653))); _tr_str_release(_at_t2653); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t2654 = (*declptr);
    if (_t2654.tag == Decl_DClass) {
        __auto_type c = _t2654.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2655 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t2655))); _tr_str_release(_at_t2655); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t2654.tag == Decl_DFunction) {
        __auto_type f = _t2654.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t2654.tag == Decl_DEnum) {
        __auto_type e = _t2654.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t2656 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t2656); _tr_str_release(_at_t2656); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t2654.tag == Decl_DInterface) {
        __auto_type ifc = _t2654.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t2657 = (*declptr);
    if (_t2657.tag == Decl_DClass) {
        __auto_type c = _t2657.data.DClass.cls;
        return c->decorators;
    } else if (_t2657.tag == Decl_DFunction) {
        __auto_type f = _t2657.data.DFunction.func;
        return f->decorators;
    } else if (_t2657.tag == Decl_DEnum) {
        __auto_type e = _t2657.data.DEnum.enm;
        return e->decorators;
    } else if (_t2657.tag == Decl_DInterface) {
        __auto_type ifc = _t2657.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    if (_t2658.tag == Expr_ELitInt) {
        __auto_type _ = _t2658.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t2658.tag == Expr_ELitFloat) {
        __auto_type _ = _t2658.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t2658.tag == Expr_ELitStr) {
        __auto_type _ = _t2658.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t2658.tag == Expr_ERawStr) {
        __auto_type _ = _t2658.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t2658.tag == Expr_ELitBool) {
        __auto_type _ = _t2658.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t2658.tag == Expr_ELitChar) {
        __auto_type _ = _t2658.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t2658.tag == Expr_EIdent) {
        __auto_type _ = _t2658.data.EIdent.name;
        ...
        __auto_type _ = _t2658.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t2658.tag == Expr_ETuple) {
        __auto_type _ = _t2658.data.ETuple.items;
        ...
        __auto_type _ = _t2658.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t2659 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2659))); _tr_str_release(_at_t2659); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t2660 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2660))); _tr_str_release(_at_t2660); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t2661 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t2661.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2661.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t2662 = (*dptr);
        if (_t2662.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2662.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
