...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t2632 = (*lv);
        if (_t2632.tag == MacroVal_MInt) {
            __auto_type a = _t2632.data.MInt.n;
            /* pass */
            __auto_type _t2633 = (*rv);
            if (_t2633.tag == MacroVal_MInt) {
                __auto_type b = _t2633.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t2633;
                return ({ TrStr _at_t2634 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2634))); _tr_str_release(_at_t2634); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t2632;
            return ({ TrStr _at_t2635 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2635))); _tr_str_release(_at_t2635); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t2636 = (*lv);
    if (_t2636.tag == MacroVal_MInt) {
        __auto_type a = _t2636.data.MInt.n;
        /* pass */
        __auto_type _t2637 = (*rv);
        if (_t2637.tag == MacroVal_MInt) {
            __auto_type b = _t2637.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2638 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2638); _tr_str_release(_at_t2638); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2639 = (*eptr);
    if (_t2639.tag == Expr_ELitStr) {
        __auto_type s = _t2639.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2639.tag == Expr_ERawStr) {
        __auto_type s = _t2639.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2639.tag == Expr_ELitInt) {
        __auto_type n = _t2639.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t2639.tag == Expr_ELitBool) {
        __auto_type b = _t2639.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t2639.tag == Expr_EIdent) {
        __auto_type name = _t2639.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2640 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2640); _tr_str_release(_at_t2640); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2639.tag == Expr_EBinOp) {
        __auto_type op = _t2639.data.EBinOp.op;
__auto_type l = _t2639.data.EBinOp.left;
__auto_type r = _t2639.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t2639.tag == Expr_EUnaryOp) {
        __auto_type op = _t2639.data.EUnaryOp.op;
__auto_type x = _t2639.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t2641 = (*xv);
            if (_t2641.tag == MacroVal_MInt) {
                __auto_type n = _t2641.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t2642 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2642); _tr_str_release(_at_t2642); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2639.tag == Expr_EFString) {
        __auto_type parts = _t2639.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t2643 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t2643;
            } else {
                /* pass */
                TrStr _strtmp_t2644 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t2644;
            }
            /* pass */
    ...
    } else if (_t2639.tag == Expr_EIndex) {
        __auto_type obj = _t2639.data.EIndex.obj;
__auto_type idx = _t2639.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t2645 = (*ov);
        if (_t2645.tag == MacroVal_MList) {
            __auto_type items = _t2645.data.MList.items;
            /* pass */
            __auto_type _t2646 = (*iv);
            if (_t2646.tag == MacroVal_MInt) {
                __auto_type n = _t2646.data.MInt.n;
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2639.tag == Expr_EPropAccess) {
        __auto_type obj = _t2639.data.EPropAccess.obj;
__auto_type prop = _t2639.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t2639.tag == Expr_EMethodCall) {
        __auto_type obj = _t2639.data.EMethodCall.obj;
__auto_type method = _t2639.data.EMethodCall.method;
__auto_type margs = _t2639.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t2647 = (*ov);
            if (_t2647.tag == MacroVal_MList) {
                __auto_type items = _t2647.data.MList.items;
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t2648 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2648))); _tr_str_release(_at_t2648); _wr; });
        }
        /* pass */
        ({ TrStr _at_t2649 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2649); _tr_str_release(_at_t2649); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2639.tag == Expr_ECall) {
        __auto_type callee = _t2639.data.ECall.callee;
__auto_type cargs = _t2639.data.ECall.args;
        /* pass */
        __auto_type _t2650 = (*callee);
        if (_t2650.tag == Expr_EIdent) {
            __auto_type cn = _t2650.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2651 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t2651;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2652 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t2652;
                }
                /* pass */
                return ({ TrStr _at_t2653 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2653))); _tr_str_release(_at_t2653); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t2654 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2654))); _tr_str_release(_at_t2654); _wr; });
                }
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2639.tag == Expr_EList) {
        __auto_type items = _t2639.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2655 = (*sptr);
    if (_t2655.tag == Stmt_SLet) {
        __auto_type name = _t2655.data.SLet.name;
__auto_type val = _t2655.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t2655.tag == Stmt_SAssign) {
        __auto_type target = _t2655.data.SAssign.target;
__auto_type val = _t2655.data.SAssign.val;
        /* pass */
        __auto_type _t2656 = (*target);
        if (_t2656.tag == Expr_EIdent) {
            __auto_type nm = _t2656.data.EIdent.name;
    ...
    } else if (_t2655.tag == Stmt_SReturn) {
        __auto_type val = _t2655.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t2655.tag == Stmt_SExpr) {
        __auto_type e = _t2655.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t2655.tag == Stmt_SFor) {
        __auto_type var = _t2655.data.SFor.var;
__auto_type iter = _t2655.data.SFor.iter;
__auto_type body = _t2655.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t2657 = (*iv);
        if (_t2657.tag == MacroVal_MList) {
            __auto_type items = _t2657.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t2655.tag == Stmt_SIf) {
        __auto_type cond = _t2655.data.SIf.cond;
__auto_type then_b = _t2655.data.SIf.then_b;
__auto_type elifs = _t2655.data.SIf.elifs;
__auto_type else_b = _t2655.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t2655.tag == Stmt_SPass) {
        /* pass */
    } else if (_t2655.tag == Stmt_SLine) {
        __auto_type _ = _t2655.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2658 = (*eptr);
    if (_t2658.tag == Expr_EMacroCall) {
        __auto_type name = _t2658.data.EMacroCall.name;
__auto_type args = _t2658.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t2658.tag == Expr_EBinOp) {
...
__auto_type r = _t2658.data.EBinOp.right;
    ...
    } else if (_t2658.tag == Expr_EUnaryOp) {
        __auto_type x = _t2658.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2658.tag == Expr_ECall) {
        __auto_type callee = _t2658.data.ECall.callee;
__auto_type cargs = _t2658.data.ECall.args;
        /* pass */
    ...
    } else if (_t2658.tag == Expr_EMethodCall) {
...
__auto_type margs = _t2658.data.EMethodCall.args;
    ...
    } else if (_t2658.tag == Expr_EPropAccess) {
        __auto_type obj = _t2658.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t2658.tag == Expr_EIndex) {
...
__auto_type idx = _t2658.data.EIndex._tr_v_index;
    ...
    } else if (_t2658.tag == Expr_ECast) {
        __auto_type x = _t2658.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2658.tag == Expr_ETryExpr) {
        __auto_type x = _t2658.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2658.tag == Expr_EIfElse) {
        __auto_type c = _t2658.data.EIfElse.cond;
__auto_type t = _t2658.data.EIfElse.then_expr;
__auto_type e2 = _t2658.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t2658.tag == Expr_ETuple) {
        __auto_type items = _t2658.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2658.tag == Expr_EFString) {
    ...
    } else if (_t2658.tag == Expr_EDo) {
        __auto_type body = _t2658.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2658.tag == Expr_ELoop) {
        __auto_type body = _t2658.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2658.tag == Expr_EWhileExpr) {
        __auto_type c = _t2658.data.EWhileExpr.cond;
__auto_type body = _t2658.data.EWhileExpr.body;
__auto_type eb = _t2658.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t2658.tag == Expr_EMatch) {
        __auto_type subj = _t2658.data.EMatch.subj;
__auto_type arms = _t2658.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2659 = (*sptr);
    if (_t2659.tag == Stmt_SExpr) {
        __auto_type e = _t2659.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t2659.tag == Stmt_SLet) {
        __auto_type v = _t2659.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SMultiLet) {
        __auto_type v = _t2659.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SAssign) {
        __auto_type t = _t2659.data.SAssign.target;
__auto_type v = _t2659.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SReturn) {
        __auto_type v = _t2659.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SBreak) {
        __auto_type v = _t2659.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SRaise) {
        __auto_type v = _t2659.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SSpawn) {
        __auto_type v = _t2659.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2659.tag == Stmt_SAssert) {
        __auto_type c = _t2659.data.SAssert.cond;
__auto_type m = _t2659.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t2659.tag == Stmt_SIf) {
        __auto_type c = _t2659.data.SIf.cond;
__auto_type tb = _t2659.data.SIf.then_b;
__auto_type elifs = _t2659.data.SIf.elifs;
__auto_type eb = _t2659.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t2659.tag == Stmt_SWhile) {
        __auto_type c = _t2659.data.SWhile.cond;
__auto_type b = _t2659.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_SFor) {
        __auto_type it = _t2659.data.SFor.iter;
__auto_type b = _t2659.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_SForUnpack) {
        __auto_type it = _t2659.data.SForUnpack.iter;
__auto_type b = _t2659.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_SMatch) {
        __auto_type subj = _t2659.data.SMatch.expr;
__auto_type arms = _t2659.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t2659.tag == Stmt_SWith) {
        __auto_type items = _t2659.data.SWith.items;
__auto_type b = _t2659.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_STry) {
        __auto_type tb = _t2659.data.STry.try_body;
__auto_type catches = _t2659.data.STry.catches;
__auto_type fb = _t2659.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t2659.tag == Stmt_SUnsafe) {
        __auto_type b = _t2659.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_STaskGroup) {
        __auto_type b = _t2659.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_SGpuBlock) {
        __auto_type b = _t2659.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2659.tag == Stmt_SDefer) {
        __auto_type s = _t2659.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t2660 = (*dptr);
    if (_t2660.tag == Decl_DFunction) {
        __auto_type f = _t2660.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t2660.tag == Decl_DClass) {
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t2661 = (*recptr);
    if (_t2661.tag == MacroVal_MRec) {
        __auto_type keys = _t2661.data.MRec.keys;
__auto_type vals = _t2661.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2662 = (*vptr);
    if (_t2662.tag == MacroVal_MStr) {
        __auto_type s = _t2662.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t2662.tag == MacroVal_MInt) {
        __auto_type n = _t2662.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t2662.tag == MacroVal_MBool) {
        __auto_type b = _t2662.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t2662.tag == MacroVal_MRec) {
        return mv_to_str(mrec_get(vptr, _tr_str_lit("src")));
    } else if (1) {
        __auto_type _ = _t2662;
        return _tr_str_lit("");
    }
}
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2663 = (*vptr);
    if (_t2663.tag == MacroVal_MBool) {
        __auto_type b = _t2663.data.MBool.b;
        return b;
    } else if (_t2663.tag == MacroVal_MInt) {
        __auto_type n = _t2663.data.MInt.n;
        return (n != 0LL);
    } else if (_t2663.tag == MacroVal_MStr) {
        __auto_type s = _t2663.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            /* pass */
            TrStr _strtmp_t2665 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t2665;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t2666 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t2666))); _tr_str_release(_at_t2666); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t2667 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2667))); _tr_str_release(_at_t2667); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        /* pass */
        TrStr _strtmp_t2669 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t2670 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t2670;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2671 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2671))); _tr_str_release(_at_t2671); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    if (_t2672.tag == Decl_DClass) {
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2673 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t2673))); _tr_str_release(_at_t2673); });
            /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t2674 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t2674); _tr_str_release(_at_t2674); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        __auto_type ifc = _t2672.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t2675 = (*declptr);
    if (_t2675.tag == Decl_DClass) {
        __auto_type c = _t2675.data.DClass.cls;
        return c->decorators;
    } else if (_t2675.tag == Decl_DFunction) {
        __auto_type f = _t2675.data.DFunction.func;
        return f->decorators;
    } else if (_t2675.tag == Decl_DEnum) {
        __auto_type e = _t2675.data.DEnum.enm;
        return e->decorators;
    } else if (_t2675.tag == Decl_DInterface) {
        __auto_type ifc = _t2675.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t2676 = (*e);
    if (_t2676.tag == Expr_ELitInt) {
        __auto_type _ = _t2676.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t2676.tag == Expr_ELitFloat) {
        __auto_type _ = _t2676.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t2676.tag == Expr_ELitStr) {
        __auto_type _ = _t2676.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t2676.tag == Expr_ERawStr) {
        __auto_type _ = _t2676.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t2676.tag == Expr_ELitBool) {
        __auto_type _ = _t2676.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t2676.tag == Expr_ELitChar) {
        __auto_type _ = _t2676.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t2676.tag == Expr_EIdent) {
        __auto_type _ = _t2676.data.EIdent.name;
        return _tr_str_lit("ident");
    } else if (_t2676.tag == Expr_ECall) {
        return _tr_str_lit("call");
    } else if (_t2676.tag == Expr_EMethodCall) {
        return _tr_str_lit("call");
    } else if (_t2676.tag == Expr_EBinOp) {
        return _tr_str_lit("binop");
    } else if (_t2676.tag == Expr_EUnaryOp) {
        return _tr_str_lit("unop");
    } else if (_t2676.tag == Expr_EList) {
        __auto_type _ = _t2676.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t2676.tag == Expr_ETuple) {
        __auto_type _ = _t2676.data.ETuple.items;
        return _tr_str_lit("tuple");
    } else if (_t2676.tag == Expr_EIndex) {
        return _tr_str_lit("index");
    } else if (_t2676.tag == Expr_EPropAccess) {
        return _tr_str_lit("field");
    } else if (_t2676.tag == Expr_EFString) {
        __auto_type _ = _t2676.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t2677 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2677))); _tr_str_release(_at_t2677); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t2678 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2678))); _tr_str_release(_at_t2678); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t2679 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t2679.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2679.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t2680 = (*dptr);
        if (_t2680.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2680.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
