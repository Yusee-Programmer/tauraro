...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t2529 = (*lv);
        if (_t2529.tag == MacroVal_MInt) {
            __auto_type a = _t2529.data.MInt.n;
            /* pass */
            __auto_type _t2530 = (*rv);
            if (_t2530.tag == MacroVal_MInt) {
                __auto_type b = _t2530.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t2530;
                return ({ TrStr _at_t2531 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2531))); _tr_str_release(_at_t2531); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t2529;
            return ({ TrStr _at_t2532 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2532))); _tr_str_release(_at_t2532); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t2533 = (*lv);
    if (_t2533.tag == MacroVal_MInt) {
        __auto_type a = _t2533.data.MInt.n;
        /* pass */
        __auto_type _t2534 = (*rv);
        if (_t2534.tag == MacroVal_MInt) {
            __auto_type b = _t2534.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2535 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2535); _tr_str_release(_at_t2535); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2536 = (*eptr);
    if (_t2536.tag == Expr_ELitStr) {
        __auto_type s = _t2536.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2536.tag == Expr_ERawStr) {
        __auto_type s = _t2536.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2536.tag == Expr_ELitInt) {
        __auto_type n = _t2536.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t2536.tag == Expr_ELitBool) {
        __auto_type b = _t2536.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t2536.tag == Expr_EIdent) {
        __auto_type name = _t2536.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2537 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2537); _tr_str_release(_at_t2537); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2536.tag == Expr_EBinOp) {
        __auto_type op = _t2536.data.EBinOp.op;
__auto_type l = _t2536.data.EBinOp.left;
__auto_type r = _t2536.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t2536.tag == Expr_EUnaryOp) {
        __auto_type op = _t2536.data.EUnaryOp.op;
__auto_type x = _t2536.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t2538 = (*xv);
            if (_t2538.tag == MacroVal_MInt) {
                __auto_type n = _t2538.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t2539 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2539); _tr_str_release(_at_t2539); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2536.tag == Expr_EFString) {
        __auto_type parts = _t2536.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t2540 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t2540;
            } else {
                /* pass */
                TrStr _strtmp_t2541 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t2541;
            }
            /* pass */
    ...
    } else if (_t2536.tag == Expr_EIndex) {
        __auto_type obj = _t2536.data.EIndex.obj;
__auto_type idx = _t2536.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t2542 = (*ov);
        if (_t2542.tag == MacroVal_MList) {
            __auto_type items = _t2542.data.MList.items;
            /* pass */
            __auto_type _t2543 = (*iv);
            if (_t2543.tag == MacroVal_MInt) {
                __auto_type n = _t2543.data.MInt.n;
                /* pass */
                ...
                __auto_type _ = _t2543;
                MacroCtx_fail(self, _tr_str_lit("macro: list index must be an int"));
            }
        } else if (1) {
            __auto_type _ = _t2542;
            MacroCtx_fail(self, _tr_str_lit("macro: indexing requires a list"));
        }
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2536.tag == Expr_EPropAccess) {
        __auto_type obj = _t2536.data.EPropAccess.obj;
__auto_type prop = _t2536.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t2536.tag == Expr_EMethodCall) {
        __auto_type obj = _t2536.data.EMethodCall.obj;
__auto_type method = _t2536.data.EMethodCall.method;
__auto_type margs = _t2536.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t2544 = (*ov);
            if (_t2544.tag == MacroVal_MList) {
                __auto_type items = _t2544.data.MList.items;
                return box_mv(MacroVal_ctor_MInt(items->len));
            } else if (1) {
                __auto_type _ = _t2544;
                /* pass */
            }
            /* pass */
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t2545 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2545))); _tr_str_release(_at_t2545); _wr; });
        }
        /* pass */
        ({ TrStr _at_t2546 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2546); _tr_str_release(_at_t2546); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2536.tag == Expr_ECall) {
        __auto_type callee = _t2536.data.ECall.callee;
__auto_type cargs = _t2536.data.ECall.args;
        /* pass */
        __auto_type _t2547 = (*callee);
        if (_t2547.tag == Expr_EIdent) {
            __auto_type cn = _t2547.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2548 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t2548;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2549 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t2549;
                }
                /* pass */
                return ({ TrStr _at_t2550 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2550))); _tr_str_release(_at_t2550); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t2551 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2551))); _tr_str_release(_at_t2551); _wr; });
                }
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2536.tag == Expr_EList) {
        __auto_type items = _t2536.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2552 = (*sptr);
    if (_t2552.tag == Stmt_SLet) {
        __auto_type name = _t2552.data.SLet.name;
__auto_type val = _t2552.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t2552.tag == Stmt_SAssign) {
        __auto_type target = _t2552.data.SAssign.target;
__auto_type val = _t2552.data.SAssign.val;
        /* pass */
        __auto_type _t2553 = (*target);
        if (_t2553.tag == Expr_EIdent) {
            __auto_type nm = _t2553.data.EIdent.name;
    ...
    } else if (_t2552.tag == Stmt_SReturn) {
        __auto_type val = _t2552.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t2552.tag == Stmt_SExpr) {
        __auto_type e = _t2552.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t2552.tag == Stmt_SFor) {
        __auto_type var = _t2552.data.SFor.var;
__auto_type iter = _t2552.data.SFor.iter;
__auto_type body = _t2552.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t2554 = (*iv);
        if (_t2554.tag == MacroVal_MList) {
            __auto_type items = _t2554.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t2552.tag == Stmt_SIf) {
        __auto_type cond = _t2552.data.SIf.cond;
__auto_type then_b = _t2552.data.SIf.then_b;
__auto_type elifs = _t2552.data.SIf.elifs;
__auto_type else_b = _t2552.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t2552.tag == Stmt_SPass) {
        /* pass */
    } else if (_t2552.tag == Stmt_SLine) {
        __auto_type _ = _t2552.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2555 = (*eptr);
    if (_t2555.tag == Expr_EMacroCall) {
        __auto_type name = _t2555.data.EMacroCall.name;
__auto_type args = _t2555.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t2555.tag == Expr_EBinOp) {
        __auto_type l = _t2555.data.EBinOp.left;
__auto_type r = _t2555.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t2555.tag == Expr_EUnaryOp) {
        __auto_type x = _t2555.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2555.tag == Expr_ECall) {
        __auto_type callee = _t2555.data.ECall.callee;
__auto_type cargs = _t2555.data.ECall.args;
        /* pass */
    ...
    } else if (_t2555.tag == Expr_EMethodCall) {
        __auto_type obj = _t2555.data.EMethodCall.obj;
__auto_type margs = _t2555.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t2555.tag == Expr_EPropAccess) {
        __auto_type obj = _t2555.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t2555.tag == Expr_EIndex) {
        __auto_type obj = _t2555.data.EIndex.obj;
__auto_type idx = _t2555.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t2555.tag == Expr_ECast) {
        __auto_type x = _t2555.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2555.tag == Expr_ETryExpr) {
        __auto_type x = _t2555.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2555.tag == Expr_EIfElse) {
        __auto_type c = _t2555.data.EIfElse.cond;
__auto_type t = _t2555.data.EIfElse.then_expr;
__auto_type e2 = _t2555.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t2555.tag == Expr_EList) {
        __auto_type items = _t2555.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2555.tag == Expr_ETuple) {
        __auto_type items = _t2555.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2555.tag == Expr_EFString) {
        __auto_type parts = _t2555.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t2555.tag == Expr_EDo) {
        __auto_type body = _t2555.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2555.tag == Expr_ELoop) {
        __auto_type body = _t2555.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2555.tag == Expr_EWhileExpr) {
        __auto_type c = _t2555.data.EWhileExpr.cond;
__auto_type body = _t2555.data.EWhileExpr.body;
__auto_type eb = _t2555.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t2555.tag == Expr_EMatch) {
        __auto_type subj = _t2555.data.EMatch.subj;
__auto_type arms = _t2555.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2556 = (*sptr);
    if (_t2556.tag == Stmt_SExpr) {
        __auto_type e = _t2556.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t2556.tag == Stmt_SLet) {
        __auto_type v = _t2556.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SMultiLet) {
        __auto_type v = _t2556.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SAssign) {
        __auto_type t = _t2556.data.SAssign.target;
__auto_type v = _t2556.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SReturn) {
        __auto_type v = _t2556.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SBreak) {
        __auto_type v = _t2556.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SRaise) {
        __auto_type v = _t2556.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SSpawn) {
        __auto_type v = _t2556.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2556.tag == Stmt_SAssert) {
        __auto_type c = _t2556.data.SAssert.cond;
__auto_type m = _t2556.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t2556.tag == Stmt_SIf) {
        __auto_type c = _t2556.data.SIf.cond;
__auto_type tb = _t2556.data.SIf.then_b;
__auto_type elifs = _t2556.data.SIf.elifs;
__auto_type eb = _t2556.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t2556.tag == Stmt_SWhile) {
        __auto_type c = _t2556.data.SWhile.cond;
__auto_type b = _t2556.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_SFor) {
        __auto_type it = _t2556.data.SFor.iter;
__auto_type b = _t2556.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_SForUnpack) {
        __auto_type it = _t2556.data.SForUnpack.iter;
__auto_type b = _t2556.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_SMatch) {
        __auto_type subj = _t2556.data.SMatch.expr;
__auto_type arms = _t2556.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t2556.tag == Stmt_SWith) {
        __auto_type items = _t2556.data.SWith.items;
__auto_type b = _t2556.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_STry) {
        __auto_type tb = _t2556.data.STry.try_body;
__auto_type catches = _t2556.data.STry.catches;
__auto_type fb = _t2556.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t2556.tag == Stmt_SUnsafe) {
        __auto_type b = _t2556.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_STaskGroup) {
        __auto_type b = _t2556.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_SGpuBlock) {
        __auto_type b = _t2556.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2556.tag == Stmt_SDefer) {
        __auto_type s = _t2556.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t2557 = (*dptr);
    if (_t2557.tag == Decl_DFunction) {
        __auto_type f = _t2557.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t2557.tag == Decl_DClass) {
        __auto_type c = _t2557.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t2558 = (*recptr);
    if (_t2558.tag == MacroVal_MRec) {
        __auto_type keys = _t2558.data.MRec.keys;
__auto_type vals = _t2558.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2559 = (*vptr);
    if (_t2559.tag == MacroVal_MStr) {
        __auto_type s = _t2559.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t2559.tag == MacroVal_MInt) {
        __auto_type n = _t2559.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t2559.tag == MacroVal_MBool) {
        __auto_type b = _t2559.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t2559.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2560 = (*vptr);
    if (_t2560.tag == MacroVal_MBool) {
        __auto_type b = _t2560.data.MBool.b;
        return b;
    } else if (_t2560.tag == MacroVal_MInt) {
        __auto_type n = _t2560.data.MInt.n;
        return (n != 0LL);
    } else if (_t2560.tag == MacroVal_MStr) {
        __auto_type s = _t2560.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t2561 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(s);
                s = _strtmp_t2561;
            }
            /* pass */
            TrStr _strtmp_t2562 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t2562;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t2563 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t2563))); _tr_str_release(_at_t2563); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t2564 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2564))); _tr_str_release(_at_t2564); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t2565 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t2565;
        }
        /* pass */
        TrStr _strtmp_t2566 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t2566;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t2567 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t2567;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2568 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2568))); _tr_str_release(_at_t2568); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t2569 = (*declptr);
    if (_t2569.tag == Decl_DClass) {
        __auto_type c = _t2569.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2570 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t2570))); _tr_str_release(_at_t2570); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t2569.tag == Decl_DFunction) {
        __auto_type f = _t2569.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t2569.tag == Decl_DEnum) {
        __auto_type e = _t2569.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t2571 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t2571); _tr_str_release(_at_t2571); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t2569.tag == Decl_DInterface) {
        __auto_type ifc = _t2569.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    ...
    if (_t2572.tag == Decl_DClass) {
        ...
        __auto_type ifc = _t2572.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t2573 = (*e);
    if (_t2573.tag == Expr_ELitInt) {
        __auto_type _ = _t2573.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t2573.tag == Expr_ELitFloat) {
        __auto_type _ = _t2573.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t2573.tag == Expr_ELitStr) {
        __auto_type _ = _t2573.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t2573.tag == Expr_ERawStr) {
        __auto_type _ = _t2573.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t2573.tag == Expr_ELitBool) {
        __auto_type _ = _t2573.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t2573.tag == Expr_ELitChar) {
        __auto_type _ = _t2573.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t2573.tag == Expr_EIdent) {
        __auto_type _ = _t2573.data.EIdent.name;
        return _tr_str_lit("ident");
    } else if (_t2573.tag == Expr_ECall) {
        return _tr_str_lit("call");
    } else if (_t2573.tag == Expr_EMethodCall) {
        return _tr_str_lit("call");
    } else if (_t2573.tag == Expr_EBinOp) {
        return _tr_str_lit("binop");
    } else if (_t2573.tag == Expr_EUnaryOp) {
        return _tr_str_lit("unop");
    } else if (_t2573.tag == Expr_EList) {
        __auto_type _ = _t2573.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t2573.tag == Expr_ETuple) {
        __auto_type _ = _t2573.data.ETuple.items;
        return _tr_str_lit("tuple");
    } else if (_t2573.tag == Expr_EIndex) {
        return _tr_str_lit("index");
    } else if (_t2573.tag == Expr_EPropAccess) {
        return _tr_str_lit("field");
    } else if (_t2573.tag == Expr_EFString) {
        __auto_type _ = _t2573.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t2574 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2574))); _tr_str_release(_at_t2574); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t2575 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2575))); _tr_str_release(_at_t2575); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t2576 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t2576.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2576.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t2577 = (*dptr);
        if (_t2577.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2577.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
