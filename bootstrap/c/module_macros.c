...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t2519 = (*lv);
        if (_t2519.tag == MacroVal_MInt) {
            __auto_type a = _t2519.data.MInt.n;
            /* pass */
            __auto_type _t2520 = (*rv);
            if (_t2520.tag == MacroVal_MInt) {
                __auto_type b = _t2520.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t2520;
                return ({ TrStr _at_t2521 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2521))); _tr_str_release(_at_t2521); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t2519;
            return ({ TrStr _at_t2522 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2522))); _tr_str_release(_at_t2522); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t2523 = (*lv);
    if (_t2523.tag == MacroVal_MInt) {
        __auto_type a = _t2523.data.MInt.n;
        /* pass */
        __auto_type _t2524 = (*rv);
        if (_t2524.tag == MacroVal_MInt) {
            __auto_type b = _t2524.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
        ...
        __auto_type _ = _t2523;
        /* pass */
    }
    /* pass */
    ({ TrStr _at_t2525 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2525); _tr_str_release(_at_t2525); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2526 = (*eptr);
    if (_t2526.tag == Expr_ELitStr) {
        __auto_type s = _t2526.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2526.tag == Expr_ERawStr) {
        __auto_type s = _t2526.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t2526.tag == Expr_ELitInt) {
        __auto_type n = _t2526.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t2526.tag == Expr_ELitBool) {
        __auto_type b = _t2526.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t2526.tag == Expr_EIdent) {
        __auto_type name = _t2526.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t2527 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2527); _tr_str_release(_at_t2527); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2526.tag == Expr_EBinOp) {
        __auto_type op = _t2526.data.EBinOp.op;
__auto_type l = _t2526.data.EBinOp.left;
__auto_type r = _t2526.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t2526.tag == Expr_EUnaryOp) {
        __auto_type op = _t2526.data.EUnaryOp.op;
__auto_type x = _t2526.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t2528 = (*xv);
            if (_t2528.tag == MacroVal_MInt) {
                __auto_type n = _t2528.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t2529 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2529); _tr_str_release(_at_t2529); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2526.tag == Expr_EFString) {
        __auto_type parts = _t2526.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t2530 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t2530;
            } else {
                /* pass */
                TrStr _strtmp_t2531 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t2531;
            }
            /* pass */
    ...
    } else if (_t2526.tag == Expr_EIndex) {
        __auto_type obj = _t2526.data.EIndex.obj;
__auto_type idx = _t2526.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t2532 = (*ov);
        if (_t2532.tag == MacroVal_MList) {
            __auto_type items = _t2532.data.MList.items;
            /* pass */
            __auto_type _t2533 = (*iv);
            if (_t2533.tag == MacroVal_MInt) {
                __auto_type n = _t2533.data.MInt.n;
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2526.tag == Expr_EPropAccess) {
        __auto_type obj = _t2526.data.EPropAccess.obj;
__auto_type prop = _t2526.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t2526.tag == Expr_EMethodCall) {
        __auto_type obj = _t2526.data.EMethodCall.obj;
__auto_type method = _t2526.data.EMethodCall.method;
__auto_type margs = _t2526.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t2534 = (*ov);
            if (_t2534.tag == MacroVal_MList) {
                __auto_type items = _t2534.data.MList.items;
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t2535 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2535))); _tr_str_release(_at_t2535); _wr; });
        }
        /* pass */
        ({ TrStr _at_t2536 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t2536); _tr_str_release(_at_t2536); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2526.tag == Expr_ECall) {
        __auto_type callee = _t2526.data.ECall.callee;
__auto_type cargs = _t2526.data.ECall.args;
        /* pass */
        __auto_type _t2537 = (*callee);
        if (_t2537.tag == Expr_EIdent) {
            __auto_type cn = _t2537.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2538 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t2538;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2539 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t2539;
                }
                /* pass */
                return ({ TrStr _at_t2540 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2540))); _tr_str_release(_at_t2540); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t2541 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t2541))); _tr_str_release(_at_t2541); _wr; });
                }
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t2526.tag == Expr_EList) {
        __auto_type items = _t2526.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2542 = (*sptr);
    if (_t2542.tag == Stmt_SLet) {
        __auto_type name = _t2542.data.SLet.name;
__auto_type val = _t2542.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t2542.tag == Stmt_SAssign) {
        __auto_type target = _t2542.data.SAssign.target;
__auto_type val = _t2542.data.SAssign.val;
        /* pass */
        __auto_type _t2543 = (*target);
        if (_t2543.tag == Expr_EIdent) {
            __auto_type nm = _t2543.data.EIdent.name;
    ...
    } else if (_t2542.tag == Stmt_SReturn) {
        __auto_type val = _t2542.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t2542.tag == Stmt_SExpr) {
        __auto_type e = _t2542.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t2542.tag == Stmt_SFor) {
        __auto_type var = _t2542.data.SFor.var;
__auto_type iter = _t2542.data.SFor.iter;
__auto_type body = _t2542.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t2544 = (*iv);
    ...
    } else if (_t2542.tag == Stmt_SIf) {
        __auto_type cond = _t2542.data.SIf.cond;
__auto_type then_b = _t2542.data.SIf.then_b;
__auto_type elifs = _t2542.data.SIf.elifs;
__auto_type else_b = _t2542.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t2542.tag == Stmt_SPass) {
        /* pass */
    } else if (_t2542.tag == Stmt_SLine) {
        __auto_type _ = _t2542.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t2545 = (*eptr);
    if (_t2545.tag == Expr_EMacroCall) {
        __auto_type name = _t2545.data.EMacroCall.name;
__auto_type args = _t2545.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t2545.tag == Expr_EBinOp) {
        __auto_type l = _t2545.data.EBinOp.left;
__auto_type r = _t2545.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t2545.tag == Expr_EUnaryOp) {
        __auto_type x = _t2545.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2545.tag == Expr_ECall) {
        __auto_type callee = _t2545.data.ECall.callee;
__auto_type cargs = _t2545.data.ECall.args;
        /* pass */
    ...
    } else if (_t2545.tag == Expr_EMethodCall) {
        __auto_type obj = _t2545.data.EMethodCall.obj;
__auto_type margs = _t2545.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t2545.tag == Expr_EPropAccess) {
        __auto_type obj = _t2545.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t2545.tag == Expr_EIndex) {
        __auto_type obj = _t2545.data.EIndex.obj;
__auto_type idx = _t2545.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t2545.tag == Expr_ECast) {
        __auto_type x = _t2545.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2545.tag == Expr_ETryExpr) {
        __auto_type x = _t2545.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t2545.tag == Expr_EIfElse) {
        __auto_type c = _t2545.data.EIfElse.cond;
__auto_type t = _t2545.data.EIfElse.then_expr;
__auto_type e2 = _t2545.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t2545.tag == Expr_EList) {
        __auto_type items = _t2545.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2545.tag == Expr_ETuple) {
        __auto_type items = _t2545.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t2545.tag == Expr_EFString) {
        __auto_type parts = _t2545.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t2545.tag == Expr_EDo) {
        __auto_type body = _t2545.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2545.tag == Expr_ELoop) {
        __auto_type body = _t2545.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t2545.tag == Expr_EWhileExpr) {
        __auto_type c = _t2545.data.EWhileExpr.cond;
__auto_type body = _t2545.data.EWhileExpr.body;
__auto_type eb = _t2545.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t2545.tag == Expr_EMatch) {
        __auto_type subj = _t2545.data.EMatch.subj;
__auto_type arms = _t2545.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t2546 = (*sptr);
    if (_t2546.tag == Stmt_SExpr) {
        __auto_type e = _t2546.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t2546.tag == Stmt_SLet) {
        __auto_type v = _t2546.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SMultiLet) {
        __auto_type v = _t2546.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SAssign) {
        __auto_type t = _t2546.data.SAssign.target;
__auto_type v = _t2546.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SReturn) {
        __auto_type v = _t2546.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SBreak) {
        __auto_type v = _t2546.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SRaise) {
        __auto_type v = _t2546.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SSpawn) {
        __auto_type v = _t2546.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t2546.tag == Stmt_SAssert) {
        __auto_type c = _t2546.data.SAssert.cond;
__auto_type m = _t2546.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t2546.tag == Stmt_SIf) {
        __auto_type c = _t2546.data.SIf.cond;
__auto_type tb = _t2546.data.SIf.then_b;
__auto_type elifs = _t2546.data.SIf.elifs;
__auto_type eb = _t2546.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t2546.tag == Stmt_SWhile) {
        __auto_type c = _t2546.data.SWhile.cond;
__auto_type b = _t2546.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_SFor) {
        __auto_type it = _t2546.data.SFor.iter;
__auto_type b = _t2546.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_SForUnpack) {
        __auto_type it = _t2546.data.SForUnpack.iter;
__auto_type b = _t2546.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_SMatch) {
        __auto_type subj = _t2546.data.SMatch.expr;
__auto_type arms = _t2546.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t2546.tag == Stmt_SWith) {
        __auto_type items = _t2546.data.SWith.items;
__auto_type b = _t2546.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_STry) {
        __auto_type tb = _t2546.data.STry.try_body;
__auto_type catches = _t2546.data.STry.catches;
__auto_type fb = _t2546.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t2546.tag == Stmt_SUnsafe) {
        __auto_type b = _t2546.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_STaskGroup) {
        __auto_type b = _t2546.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_SGpuBlock) {
        __auto_type b = _t2546.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t2546.tag == Stmt_SDefer) {
        __auto_type s = _t2546.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t2547 = (*dptr);
    if (_t2547.tag == Decl_DFunction) {
        __auto_type f = _t2547.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t2547.tag == Decl_DClass) {
        __auto_type c = _t2547.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t2548 = (*recptr);
    if (_t2548.tag == MacroVal_MRec) {
        __auto_type keys = _t2548.data.MRec.keys;
__auto_type vals = _t2548.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2549 = (*vptr);
    if (_t2549.tag == MacroVal_MStr) {
        __auto_type s = _t2549.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t2549.tag == MacroVal_MInt) {
        __auto_type n = _t2549.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t2549.tag == MacroVal_MBool) {
        __auto_type b = _t2549.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t2549.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t2550 = (*vptr);
    if (_t2550.tag == MacroVal_MBool) {
        __auto_type b = _t2550.data.MBool.b;
        return b;
    } else if (_t2550.tag == MacroVal_MInt) {
        __auto_type n = _t2550.data.MInt.n;
        return (n != 0LL);
    } else if (_t2550.tag == MacroVal_MStr) {
        __auto_type s = _t2550.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t2551 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(s);
                s = _strtmp_t2551;
            }
            /* pass */
            TrStr _strtmp_t2552 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t2552;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t2553 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t2553))); _tr_str_release(_at_t2553); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t2554 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2554))); _tr_str_release(_at_t2554); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t2555 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t2555;
        }
        /* pass */
        TrStr _strtmp_t2556 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t2556;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t2557 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t2557;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t2558 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2558))); _tr_str_release(_at_t2558); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t2559 = (*declptr);
    if (_t2559.tag == Decl_DClass) {
        __auto_type c = _t2559.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t2560 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t2560))); _tr_str_release(_at_t2560); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t2559.tag == Decl_DFunction) {
        __auto_type f = _t2559.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t2559.tag == Decl_DEnum) {
        __auto_type e = _t2559.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t2561 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t2561); _tr_str_release(_at_t2561); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t2559.tag == Decl_DInterface) {
        __auto_type ifc = _t2559.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t2562 = (*declptr);
    if (_t2562.tag == Decl_DClass) {
        __auto_type c = _t2562.data.DClass.cls;
        return c->decorators;
    } else if (_t2562.tag == Decl_DFunction) {
        __auto_type f = _t2562.data.DFunction.func;
        return f->decorators;
    } else if (_t2562.tag == Decl_DEnum) {
        __auto_type e = _t2562.data.DEnum.enm;
        return e->decorators;
    } else if (_t2562.tag == Decl_DInterface) {
        __auto_type ifc = _t2562.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t2563 = (*e);
    if (_t2563.tag == Expr_ELitInt) {
        __auto_type _ = _t2563.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t2563.tag == Expr_ELitFloat) {
        __auto_type _ = _t2563.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t2563.tag == Expr_ELitStr) {
        __auto_type _ = _t2563.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t2563.tag == Expr_ERawStr) {
        __auto_type _ = _t2563.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t2563.tag == Expr_ELitBool) {
        __auto_type _ = _t2563.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t2563.tag == Expr_ELitChar) {
        __auto_type _ = _t2563.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t2563.tag == Expr_EIdent) {
        __auto_type _ = _t2563.data.EIdent.name;
        ...
        __auto_type _ = _t2563.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t2563.tag == Expr_ETuple) {
        __auto_type _ = _t2563.data.ETuple.items;
        ...
        __auto_type _ = _t2563.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t2564 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2564))); _tr_str_release(_at_t2564); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t2565 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t2565))); _tr_str_release(_at_t2565); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t2566 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t2566.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2566.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t2567 = (*dptr);
        if (_t2567.tag == Decl_DDecoratorDef) {
            __auto_type f = _t2567.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
