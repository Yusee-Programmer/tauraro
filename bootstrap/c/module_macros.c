...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t3071 = (*lv);
        if (_t3071.tag == MacroVal_MInt) {
            __auto_type a = _t3071.data.MInt.n;
            /* pass */
            __auto_type _t3072 = (*rv);
            if (_t3072.tag == MacroVal_MInt) {
                __auto_type b = _t3072.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t3072;
                return ({ TrStr _at_t3073 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3073))); _tr_str_release(_at_t3073); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t3071;
            return ({ TrStr _at_t3074 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3074))); _tr_str_release(_at_t3074); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t3075 = (*lv);
    if (_t3075.tag == MacroVal_MInt) {
        __auto_type a = _t3075.data.MInt.n;
        /* pass */
        __auto_type _t3076 = (*rv);
        if (_t3076.tag == MacroVal_MInt) {
            __auto_type b = _t3076.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3077 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3077); _tr_str_release(_at_t3077); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3078 = (*eptr);
    if (_t3078.tag == Expr_ELitStr) {
        __auto_type s = _t3078.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3078.tag == Expr_ERawStr) {
        __auto_type s = _t3078.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3078.tag == Expr_ELitInt) {
        __auto_type n = _t3078.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t3078.tag == Expr_ELitBool) {
        __auto_type b = _t3078.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t3078.tag == Expr_EIdent) {
        __auto_type name = _t3078.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t3079 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3079); _tr_str_release(_at_t3079); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3078.tag == Expr_EBinOp) {
        __auto_type op = _t3078.data.EBinOp.op;
__auto_type l = _t3078.data.EBinOp.left;
__auto_type r = _t3078.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t3078.tag == Expr_EUnaryOp) {
        __auto_type op = _t3078.data.EUnaryOp.op;
__auto_type x = _t3078.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t3080 = (*xv);
            if (_t3080.tag == MacroVal_MInt) {
                __auto_type n = _t3080.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t3081 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3081); _tr_str_release(_at_t3081); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3078.tag == Expr_EFString) {
        __auto_type parts = _t3078.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t3082 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t3082;
            } else {
                /* pass */
                TrStr _strtmp_t3083 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t3083;
            }
            /* pass */
    ...
    } else if (_t3078.tag == Expr_EIndex) {
        __auto_type obj = _t3078.data.EIndex.obj;
__auto_type idx = _t3078.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t3084 = (*ov);
        if (_t3084.tag == MacroVal_MList) {
            __auto_type items = _t3084.data.MList.items;
            /* pass */
            __auto_type _t3085 = (*iv);
            if (_t3085.tag == MacroVal_MInt) {
                __auto_type n = _t3085.data.MInt.n;
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3078.tag == Expr_EPropAccess) {
        __auto_type obj = _t3078.data.EPropAccess.obj;
__auto_type prop = _t3078.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t3078.tag == Expr_EMethodCall) {
        __auto_type obj = _t3078.data.EMethodCall.obj;
__auto_type method = _t3078.data.EMethodCall.method;
__auto_type margs = _t3078.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t3086 = (*ov);
            if (_t3086.tag == MacroVal_MList) {
                __auto_type items = _t3086.data.MList.items;
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t3087 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3087))); _tr_str_release(_at_t3087); _wr; });
        }
        /* pass */
        ({ TrStr _at_t3088 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3088); _tr_str_release(_at_t3088); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3078.tag == Expr_ECall) {
        __auto_type callee = _t3078.data.ECall.callee;
__auto_type cargs = _t3078.data.ECall.args;
        /* pass */
        __auto_type _t3089 = (*callee);
        if (_t3089.tag == Expr_EIdent) {
            __auto_type cn = _t3089.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3090 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t3090;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3091 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t3091;
                }
                /* pass */
                return ({ TrStr _at_t3092 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3092))); _tr_str_release(_at_t3092); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t3093 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3093))); _tr_str_release(_at_t3093); _wr; });
                }
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3078.tag == Expr_EList) {
        __auto_type items = _t3078.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3094 = (*sptr);
    if (_t3094.tag == Stmt_SLet) {
        __auto_type name = _t3094.data.SLet.name;
__auto_type val = _t3094.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t3094.tag == Stmt_SAssign) {
        __auto_type target = _t3094.data.SAssign.target;
__auto_type val = _t3094.data.SAssign.val;
        /* pass */
        __auto_type _t3095 = (*target);
        if (_t3095.tag == Expr_EIdent) {
            __auto_type nm = _t3095.data.EIdent.name;
    ...
    } else if (_t3094.tag == Stmt_SReturn) {
        __auto_type val = _t3094.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t3094.tag == Stmt_SExpr) {
        __auto_type e = _t3094.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t3094.tag == Stmt_SFor) {
        __auto_type var = _t3094.data.SFor.var;
__auto_type iter = _t3094.data.SFor.iter;
__auto_type body = _t3094.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t3096 = (*iv);
        if (_t3096.tag == MacroVal_MList) {
            __auto_type items = _t3096.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t3094.tag == Stmt_SIf) {
        __auto_type cond = _t3094.data.SIf.cond;
__auto_type then_b = _t3094.data.SIf.then_b;
__auto_type elifs = _t3094.data.SIf.elifs;
__auto_type else_b = _t3094.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t3094.tag == Stmt_SPass) {
        /* pass */
    } else if (_t3094.tag == Stmt_SLine) {
        __auto_type _ = _t3094.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3097 = (*eptr);
    if (_t3097.tag == Expr_EMacroCall) {
        __auto_type name = _t3097.data.EMacroCall.name;
__auto_type args = _t3097.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t3097.tag == Expr_EBinOp) {
        __auto_type l = _t3097.data.EBinOp.left;
__auto_type r = _t3097.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t3097.tag == Expr_EUnaryOp) {
        __auto_type x = _t3097.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3097.tag == Expr_ECall) {
        __auto_type callee = _t3097.data.ECall.callee;
__auto_type cargs = _t3097.data.ECall.args;
        /* pass */
    ...
    } else if (_t3097.tag == Expr_EMethodCall) {
        __auto_type obj = _t3097.data.EMethodCall.obj;
__auto_type margs = _t3097.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t3097.tag == Expr_EPropAccess) {
        __auto_type obj = _t3097.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t3097.tag == Expr_EIndex) {
        __auto_type obj = _t3097.data.EIndex.obj;
__auto_type idx = _t3097.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t3097.tag == Expr_ECast) {
        __auto_type x = _t3097.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3097.tag == Expr_ETryExpr) {
        __auto_type x = _t3097.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3097.tag == Expr_EIfElse) {
        __auto_type c = _t3097.data.EIfElse.cond;
__auto_type t = _t3097.data.EIfElse.then_expr;
__auto_type e2 = _t3097.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t3097.tag == Expr_EList) {
        __auto_type items = _t3097.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3097.tag == Expr_ETuple) {
        __auto_type items = _t3097.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3097.tag == Expr_EFString) {
        __auto_type parts = _t3097.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t3097.tag == Expr_EDo) {
        __auto_type body = _t3097.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3097.tag == Expr_ELoop) {
        __auto_type body = _t3097.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3097.tag == Expr_EWhileExpr) {
        __auto_type c = _t3097.data.EWhileExpr.cond;
__auto_type body = _t3097.data.EWhileExpr.body;
__auto_type eb = _t3097.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t3097.tag == Expr_EMatch) {
        __auto_type subj = _t3097.data.EMatch.subj;
__auto_type arms = _t3097.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3098 = (*sptr);
    if (_t3098.tag == Stmt_SExpr) {
        __auto_type e = _t3098.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t3098.tag == Stmt_SLet) {
        __auto_type v = _t3098.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SMultiLet) {
        __auto_type v = _t3098.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SAssign) {
        __auto_type t = _t3098.data.SAssign.target;
__auto_type v = _t3098.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SReturn) {
        __auto_type v = _t3098.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SBreak) {
        __auto_type v = _t3098.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SRaise) {
        __auto_type v = _t3098.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SSpawn) {
        __auto_type v = _t3098.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3098.tag == Stmt_SAssert) {
        __auto_type c = _t3098.data.SAssert.cond;
__auto_type m = _t3098.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t3098.tag == Stmt_SIf) {
        __auto_type c = _t3098.data.SIf.cond;
__auto_type tb = _t3098.data.SIf.then_b;
__auto_type elifs = _t3098.data.SIf.elifs;
__auto_type eb = _t3098.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t3098.tag == Stmt_SWhile) {
        __auto_type c = _t3098.data.SWhile.cond;
__auto_type b = _t3098.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_SFor) {
        __auto_type it = _t3098.data.SFor.iter;
__auto_type b = _t3098.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_SForUnpack) {
        __auto_type it = _t3098.data.SForUnpack.iter;
__auto_type b = _t3098.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_SMatch) {
        __auto_type subj = _t3098.data.SMatch.expr;
__auto_type arms = _t3098.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t3098.tag == Stmt_SWith) {
        __auto_type items = _t3098.data.SWith.items;
__auto_type b = _t3098.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_STry) {
        __auto_type tb = _t3098.data.STry.try_body;
__auto_type catches = _t3098.data.STry.catches;
__auto_type fb = _t3098.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t3098.tag == Stmt_SUnsafe) {
        __auto_type b = _t3098.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_STaskGroup) {
        __auto_type b = _t3098.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_SGpuBlock) {
        __auto_type b = _t3098.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3098.tag == Stmt_SDefer) {
        __auto_type s = _t3098.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t3099 = (*dptr);
    if (_t3099.tag == Decl_DFunction) {
        __auto_type f = _t3099.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t3099.tag == Decl_DClass) {
        __auto_type c = _t3099.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t3100 = (*recptr);
    if (_t3100.tag == MacroVal_MRec) {
        __auto_type keys = _t3100.data.MRec.keys;
__auto_type vals = _t3100.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3101 = (*vptr);
    if (_t3101.tag == MacroVal_MStr) {
        __auto_type s = _t3101.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t3101.tag == MacroVal_MInt) {
        __auto_type n = _t3101.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t3101.tag == MacroVal_MBool) {
        __auto_type b = _t3101.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t3101.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3102 = (*vptr);
    if (_t3102.tag == MacroVal_MBool) {
        __auto_type b = _t3102.data.MBool.b;
        return b;
    } else if (_t3102.tag == MacroVal_MInt) {
        __auto_type n = _t3102.data.MInt.n;
        return (n != 0LL);
    } else if (_t3102.tag == MacroVal_MStr) {
        __auto_type s = _t3102.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            /* pass */
            TrStr _strtmp_t3104 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t3104;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t3105 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t3105))); _tr_str_release(_at_t3105); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t3106 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3106))); _tr_str_release(_at_t3106); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t3107 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t3107;
        }
        /* pass */
        TrStr _strtmp_t3108 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t3108;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t3109 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t3109;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3110 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3110))); _tr_str_release(_at_t3110); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t3111 = (*declptr);
    if (_t3111.tag == Decl_DClass) {
        __auto_type c = _t3111.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t3112 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t3112))); _tr_str_release(_at_t3112); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t3111.tag == Decl_DFunction) {
        __auto_type f = _t3111.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t3111.tag == Decl_DEnum) {
        __auto_type e = _t3111.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t3113 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t3113); _tr_str_release(_at_t3113); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t3111.tag == Decl_DInterface) {
        __auto_type ifc = _t3111.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t3114 = (*declptr);
    if (_t3114.tag == Decl_DClass) {
        __auto_type c = _t3114.data.DClass.cls;
        return c->decorators;
    } else if (_t3114.tag == Decl_DFunction) {
        __auto_type f = _t3114.data.DFunction.func;
        return f->decorators;
    } else if (_t3114.tag == Decl_DEnum) {
        __auto_type e = _t3114.data.DEnum.enm;
        return e->decorators;
    } else if (_t3114.tag == Decl_DInterface) {
        __auto_type ifc = _t3114.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    if (_t3115.tag == Expr_ELitInt) {
        __auto_type _ = _t3115.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t3115.tag == Expr_ELitFloat) {
        __auto_type _ = _t3115.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t3115.tag == Expr_ELitStr) {
        __auto_type _ = _t3115.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t3115.tag == Expr_ERawStr) {
        __auto_type _ = _t3115.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t3115.tag == Expr_ELitBool) {
        __auto_type _ = _t3115.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t3115.tag == Expr_ELitChar) {
        __auto_type _ = _t3115.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t3115.tag == Expr_EIdent) {
        __auto_type _ = _t3115.data.EIdent.name;
        return _tr_str_lit("ident");
    } else if (_t3115.tag == Expr_ECall) {
        return _tr_str_lit("call");
    } else if (_t3115.tag == Expr_EMethodCall) {
        return _tr_str_lit("call");
    } else if (_t3115.tag == Expr_EBinOp) {
        return _tr_str_lit("binop");
    } else if (_t3115.tag == Expr_EUnaryOp) {
        return _tr_str_lit("unop");
    } else if (_t3115.tag == Expr_EList) {
        __auto_type _ = _t3115.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t3115.tag == Expr_ETuple) {
        __auto_type _ = _t3115.data.ETuple.items;
        return _tr_str_lit("tuple");
    } else if (_t3115.tag == Expr_EIndex) {
        return _tr_str_lit("index");
    } else if (_t3115.tag == Expr_EPropAccess) {
        return _tr_str_lit("field");
    } else if (_t3115.tag == Expr_EFString) {
        __auto_type _ = _t3115.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t3116 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3116))); _tr_str_release(_at_t3116); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t3117 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3117))); _tr_str_release(_at_t3117); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t3118 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t3118.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3118.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t3119 = (*dptr);
        if (_t3119.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3119.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
