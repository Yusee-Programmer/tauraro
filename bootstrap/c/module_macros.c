...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if (_tr_str_eqv((op), (_tr_str_lit_len("+", 1LL)))) {
        /* pass */
        __auto_type _t3625 = (*lv);
        if (_t3625.tag == MacroVal_MInt) {
            __auto_type a = _t3625.data.MInt.n;
            /* pass */
            __auto_type _t3626 = (*rv);
            if (_t3626.tag == MacroVal_MInt) {
                __auto_type b = _t3626.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t3626;
                return ({ TrStr _at_t3627 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concatv(_cl, _cr); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3627))); _tr_str_release(_at_t3627); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t3625;
            return ({ TrStr _at_t3628 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concatv(_cl, _cr); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3628))); _tr_str_release(_at_t3628); _wr; });
        }
    }
    /* pass */
    ...
    /* pass */
    __auto_type _t3629 = (*lv);
    if (_t3629.tag == MacroVal_MInt) {
        __auto_type a = _t3629.data.MInt.n;
        /* pass */
        __auto_type _t3630 = (*rv);
        if (_t3630.tag == MacroVal_MInt) {
            __auto_type b = _t3630.data.MInt.n;
            /* pass */
            if (_tr_str_eqv((op), (_tr_str_lit_len("<", 1LL)))) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3631 = (({ TrStr _cl = (_tr_strx_concatv((_tr_str_lit_len("macro: unsupported operator '", 29LL)), (op))); TrStr _cres = _tr_strx_concatv(_cl, (_tr_str_lit_len("' in macro body", 15LL))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3631); _tr_str_release(_at_t3631); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    if (_t3632.tag == Expr_ELitStr) {
        __auto_type s = _t3632.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3632.tag == Expr_ERawStr) {
        __auto_type s = _t3632.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3632.tag == Expr_ELitInt) {
        __auto_type n = _t3632.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t3632.tag == Expr_ELitBool) {
        __auto_type b = _t3632.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t3632.tag == Expr_EIdent) {
        __auto_type name = _t3632.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t3633 = (({ TrStr _cl = (_tr_strx_concatv((_tr_str_lit_len("macro: unknown name '", 21LL)), (name))); TrStr _cres = _tr_strx_concatv(_cl, (_tr_str_lit_len("'", 1LL))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3633); _tr_str_release(_at_t3633); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3632.tag == Expr_EBinOp) {
        __auto_type op = _t3632.data.EBinOp.op;
...
__auto_type r = _t3632.data.EBinOp.right;
        ...
        __auto_type op = _t3632.data.EUnaryOp.op;
__auto_type x = _t3632.data.EUnaryOp.expr;
        ...
        if (_tr_str_eqv((op), (_tr_str_lit_len("-", 1LL)))) {
            /* pass */
            __auto_type _t3634 = (*xv);
            if (_t3634.tag == MacroVal_MInt) {
                __auto_type n = _t3634.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t3635 = (({ TrStr _cl = (_tr_strx_concatv((_tr_str_lit_len("macro: unsupported unary operator '", 35LL)), (op))); TrStr _cres = _tr_strx_concatv(_cl, (_tr_str_lit_len("' in macro body", 15LL))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3635); _tr_str_release(_at_t3635); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t3636 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concatv((out), _cr); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t3636;
            } else {
                /* pass */
                TrStr _strtmp_t3637 = _tr_strx_concatv((out), (part->text));
                _tr_str_release(out);
                out = _strtmp_t3637;
            }
            /* pass */
...
__auto_type idx = _t3632.data.EIndex._tr_v_index;
        ...
        if (_t3638.tag == MacroVal_MList) {
            ...
            /* pass */
            __auto_type _t3639 = (*iv);
            if (_t3639.tag == MacroVal_MInt) {
...
__auto_type prop = _t3632.data.EPropAccess.prop;
        /* pass */
...
__auto_type method = _t3632.data.EMethodCall.method;
__auto_type margs = _t3632.data.EMethodCall.args;
        ...
        if (_tr_str_eqv((method), (_tr_str_lit_len("len", 3LL)))) {
            /* pass */
            __auto_type _t3640 = (*ov);
            if (_t3640.tag == MacroVal_MList) {
                __auto_type items = _t3640.data.MList.items;
                return box_mv(MacroVal_ctor_MInt(items->len));
            } else if (1) {
                __auto_type _ = _t3640;
                /* pass */
            }
            /* pass */
        ...
        if ((_tr_str_eqv((method), (_tr_str_lit_len("to_str", 6LL))) || _tr_str_eqv((method), (_tr_str_lit_len("to_string", 9LL))))) {
            /* pass */
            return ({ TrStr _at_t3641 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3641))); _tr_str_release(_at_t3641); _wr; });
        }
        /* pass */
        ({ TrStr _at_t3642 = (({ TrStr _cl = (_tr_strx_concatv((_tr_str_lit_len("macro: unsupported method '", 27LL)), (method))); TrStr _cres = _tr_strx_concatv(_cl, (_tr_str_lit_len("' in macro body", 15LL))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3642); _tr_str_release(_at_t3642); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
...
__auto_type cargs = _t3632.data.ECall.args;
        /* pass */
        __auto_type _t3643 = (*callee);
        if (_t3643.tag == Expr_EIdent) {
            __auto_type cn = _t3643.data.EIdent.name;
            /* pass */
            ...
            if (_tr_str_eqv((cn), (_tr_str_lit_len("gensym", 6LL)))) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3645 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t3645;
                }
                /* pass */
                return ({ TrStr _at_t3646 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concatv((_tr_str_lit_len("__hyg_", 6LL)), (pfx))); TrStr _cres = _tr_strx_concatv(_cl, (_tr_str_lit_len("_", 1LL))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concatv(_cl, _cr); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3646))); _tr_str_release(_at_t3646); _wr; });
            }
            /* pass */
            if (_tr_str_eqv((cn), (_tr_str_lit_len("str", 3LL)))) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t3647 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3647))); _tr_str_release(_at_t3647); _wr; });
                }
                /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3648 = (*sptr);
    if (_t3648.tag == Stmt_SLet) {
        __auto_type name = _t3648.data.SLet.name;
__auto_type val = _t3648.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t3648.tag == Stmt_SAssign) {
        __auto_type target = _t3648.data.SAssign.target;
__auto_type val = _t3648.data.SAssign.val;
        /* pass */
        __auto_type _t3649 = (*target);
        if (_t3649.tag == Expr_EIdent) {
            __auto_type nm = _t3649.data.EIdent.name;
    ...
    } else if (_t3648.tag == Stmt_SReturn) {
        __auto_type val = _t3648.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t3648.tag == Stmt_SExpr) {
        __auto_type e = _t3648.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t3648.tag == Stmt_SFor) {
        __auto_type var = _t3648.data.SFor.var;
__auto_type iter = _t3648.data.SFor.iter;
__auto_type body = _t3648.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t3650 = (*iv);
        if (_t3650.tag == MacroVal_MList) {
            __auto_type items = _t3650.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t3648.tag == Stmt_SIf) {
        __auto_type cond = _t3648.data.SIf.cond;
__auto_type then_b = _t3648.data.SIf.then_b;
__auto_type elifs = _t3648.data.SIf.elifs;
__auto_type else_b = _t3648.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t3648.tag == Stmt_SPass) {
        /* pass */
    } else if (_t3648.tag == Stmt_SLine) {
        __auto_type _ = _t3648.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3651 = (*eptr);
    if (_t3651.tag == Expr_EMacroCall) {
        __auto_type name = _t3651.data.EMacroCall.name;
__auto_type args = _t3651.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        __auto_type l = _t3651.data.EBinOp.left;
__auto_type r = _t3651.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t3651.tag == Expr_EUnaryOp) {
        __auto_type x = _t3651.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3651.tag == Expr_ECall) {
        __auto_type callee = _t3651.data.ECall.callee;
__auto_type cargs = _t3651.data.ECall.args;
        /* pass */
        ...
        __auto_type obj = _t3651.data.EMethodCall.obj;
__auto_type margs = _t3651.data.EMethodCall.args;
        /* pass */
        ...
        __auto_type obj = _t3651.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t3651.tag == Expr_EIndex) {
        __auto_type obj = _t3651.data.EIndex.obj;
__auto_type idx = _t3651.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t3651.tag == Expr_ECast) {
        __auto_type x = _t3651.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3651.tag == Expr_ETryExpr) {
        __auto_type x = _t3651.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3651.tag == Expr_EIfElse) {
        __auto_type c = _t3651.data.EIfElse.cond;
__auto_type t = _t3651.data.EIfElse.then_expr;
__auto_type e2 = _t3651.data.EIfElse.else_expr;
        /* pass */
        ...
        __auto_type items = _t3651.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        __auto_type items = _t3651.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        __auto_type parts = _t3651.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t3651.tag == Expr_EDo) {
        __auto_type body = _t3651.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3651.tag == Expr_ELoop) {
        __auto_type body = _t3651.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3651.tag == Expr_EWhileExpr) {
        __auto_type c = _t3651.data.EWhileExpr.cond;
__auto_type body = _t3651.data.EWhileExpr.body;
__auto_type eb = _t3651.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t3651.tag == Expr_EMatch) {
        __auto_type subj = _t3651.data.EMatch.subj;
__auto_type arms = _t3651.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3652 = (*sptr);
    if (_t3652.tag == Stmt_SExpr) {
        __auto_type e = _t3652.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t3652.tag == Stmt_SLet) {
        __auto_type v = _t3652.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SMultiLet) {
        __auto_type v = _t3652.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SAssign) {
        __auto_type t = _t3652.data.SAssign.target;
__auto_type v = _t3652.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SReturn) {
        __auto_type v = _t3652.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SBreak) {
        __auto_type v = _t3652.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SRaise) {
        __auto_type v = _t3652.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SSpawn) {
        __auto_type v = _t3652.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3652.tag == Stmt_SAssert) {
        __auto_type c = _t3652.data.SAssert.cond;
__auto_type m = _t3652.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t3652.tag == Stmt_SIf) {
        __auto_type c = _t3652.data.SIf.cond;
__auto_type tb = _t3652.data.SIf.then_b;
__auto_type elifs = _t3652.data.SIf.elifs;
__auto_type eb = _t3652.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t3652.tag == Stmt_SWhile) {
        __auto_type c = _t3652.data.SWhile.cond;
__auto_type b = _t3652.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_SFor) {
        __auto_type it = _t3652.data.SFor.iter;
__auto_type b = _t3652.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_SForUnpack) {
        __auto_type it = _t3652.data.SForUnpack.iter;
__auto_type b = _t3652.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_SMatch) {
        __auto_type subj = _t3652.data.SMatch.expr;
__auto_type arms = _t3652.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t3652.tag == Stmt_SWith) {
        __auto_type items = _t3652.data.SWith.items;
__auto_type b = _t3652.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_STry) {
        __auto_type tb = _t3652.data.STry.try_body;
__auto_type catches = _t3652.data.STry.catches;
__auto_type fb = _t3652.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t3652.tag == Stmt_SUnsafe) {
        __auto_type b = _t3652.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_STaskGroup) {
        __auto_type b = _t3652.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_SGpuBlock) {
        __auto_type b = _t3652.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3652.tag == Stmt_SDefer) {
        __auto_type s = _t3652.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t3653 = (*dptr);
    if (_t3653.tag == Decl_DFunction) {
        __auto_type f = _t3653.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t3653.tag == Decl_DClass) {
        __auto_type c = _t3653.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t3654 = (*recptr);
    if (_t3654.tag == MacroVal_MRec) {
        __auto_type keys = _t3654.data.MRec.keys;
__auto_type vals = _t3654.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    } else if (_t3655.tag == MacroVal_MBool) {
    ...
    } else if (_t3655.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3656 = (*vptr);
    if (_t3656.tag == MacroVal_MBool) {
        __auto_type b = _t3656.data.MBool.b;
        return b;
    } else if (_t3656.tag == MacroVal_MInt) {
        __auto_type n = _t3656.data.MInt.n;
        return (n != 0LL);
    } else if (_t3656.tag == MacroVal_MStr) {
        __auto_type s = _t3656.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t3657 = _tr_strx_concatv((s), (_tr_str_lit_len(", ", 2LL)));
                _tr_str_release(s);
                s = _strtmp_t3657;
            }
            /* pass */
            TrStr _strtmp_t3658 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concatv((s), _cr); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t3658;
            /* pass */
            i = (i + 1LL);
        ...
        /* pass */
        TrStr _strtmp_t3659 = _tr_strx_concatv((s), (_tr_str_lit_len("]", 1LL)));
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t3660 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t3660))); _tr_str_release(_at_t3660); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t3661 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3661))); _tr_str_release(_at_t3661); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t3662 = _tr_strx_concatv((arglist), (_tr_str_lit_len(", ", 2LL)));
            _tr_str_release(arglist);
            arglist = _strtmp_t3662;
        }
        /* pass */
        TrStr _strtmp_t3663 = _tr_strx_concatv((arglist), (((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t3663;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t3664 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t3664;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3665 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3665))); _tr_str_release(_at_t3665); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t3666 = (*declptr);
    if (_t3666.tag == Decl_DClass) {
        __auto_type c = _t3666.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t3667 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t3667))); _tr_str_release(_at_t3667); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t3666.tag == Decl_DFunction) {
        __auto_type f = _t3666.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t3666.tag == Decl_DEnum) {
        __auto_type e = _t3666.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t3668 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t3668); _tr_str_release(_at_t3668); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t3666.tag == Decl_DInterface) {
        __auto_type ifc = _t3666.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t3669 = (*declptr);
    if (_t3669.tag == Decl_DClass) {
        __auto_type c = _t3669.data.DClass.cls;
        return c->decorators;
    } else if (_t3669.tag == Decl_DFunction) {
        __auto_type f = _t3669.data.DFunction.func;
        return f->decorators;
    } else if (_t3669.tag == Decl_DEnum) {
        __auto_type e = _t3669.data.DEnum.enm;
        return e->decorators;
    } else if (_t3669.tag == Decl_DInterface) {
        __auto_type ifc = _t3669.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t3670 = (*e);
    if (_t3670.tag == Expr_ELitInt) {
        __auto_type _ = _t3670.data.ELitInt.val;
        return _tr_str_lit_len("int", 3LL);
    } else if (_t3670.tag == Expr_ELitFloat) {
        __auto_type _ = _t3670.data.ELitFloat.val;
        return _tr_str_lit_len("float", 5LL);
    } else if (_t3670.tag == Expr_ELitStr) {
        return _tr_str_lit_len("str", 3LL);
    } else if (_t3670.tag == Expr_ERawStr) {
        return _tr_str_lit_len("str", 3LL);
    } else if (_t3670.tag == Expr_ELitBool) {
        __auto_type _ = _t3670.data.ELitBool.val;
        return _tr_str_lit_len("bool", 4LL);
    } else if (_t3670.tag == Expr_ELitChar) {
        __auto_type _ = _t3670.data.ELitChar.val;
        return _tr_str_lit_len("char", 4LL);
    } else if (_t3670.tag == Expr_EIdent) {
        __auto_type _ = _t3670.data.EIdent.name;
        return _tr_str_lit_len("ident", 5LL);
    } else if (_t3670.tag == Expr_ECall) {
        return _tr_str_lit_len("call", 4LL);
    } else if (_t3670.tag == Expr_EMethodCall) {
        return _tr_str_lit_len("call", 4LL);
    } else if (_t3670.tag == Expr_EBinOp) {
        return _tr_str_lit_len("binop", 5LL);
    } else if (_t3670.tag == Expr_EUnaryOp) {
        return _tr_str_lit_len("unop", 4LL);
    } else if (_t3670.tag == Expr_EList) {
        __auto_type _ = _t3670.data.EList.items;
        return _tr_str_lit_len("list", 4LL);
    } else if (_t3670.tag == Expr_ETuple) {
        __auto_type _ = _t3670.data.ETuple.items;
        return _tr_str_lit_len("tuple", 5LL);
    } else if (_t3670.tag == Expr_EIndex) {
        return _tr_str_lit_len("index", 5LL);
    } else if (_t3670.tag == Expr_EPropAccess) {
        return _tr_str_lit_len("field", 5LL);
    } else if (_t3670.tag == Expr_EFString) {
        __auto_type _ = _t3670.data.EFString.parts;
        return _tr_str_lit_len("fstring", 7LL);
    } else if (1) {
        __auto_type _ = _t3670;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t3671 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3671))); _tr_str_release(_at_t3671); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit_len("kind", 4LL));
    /* pass */
    ({ TrStr _at_t3672 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3672))); _tr_str_release(_at_t3672); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros_tracked(Program* prog, List_ptr* all_decls, List_TrStr* all_decl_modules) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t3673 = (*((Decl*)List_ptr_get(prog->decls, i)));
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t3674 = (*dptr);
        if (_t3674.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3674.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
    ...
    while ((gi < gen->len)) {
        ...
        if (have_module_info) {
            ...
            /* pass */
            ({ TrStr _at_t3675 = (List_TrStr_get(gen_modules, gi)); List_TrStr_append(all_decl_modules, _at_t3675); _tr_str_release(_at_t3675); });
        }
        /* pass */
        gi = (gi + 1LL);
    }
