...
__attribute__((hot)) List_TrStr* Bindgen_read_type_words(Bindgen* self) {
    ...
    while (going) {
        ...
        if ((Bindgen_ck(self) == 0LL)) {
            ...
            if (_is_ignored_word(w)) {
                ...
                /* pass */
                Bindgen_adv(self);
            } else if (({ TrStr _at_t777 = (Bindgen_nt(self)); __auto_type _wr = (((((words->len >= 1LL) || (stars > 0LL)) && _is_decl_term(Bindgen_nk(self), _at_t777)) && (!_is_prim_type_word(w)))); _tr_str_release(_at_t777); _wr; })) {
                /* pass */
                going = false;
            } else {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t778 = (_join_words(words)); List_TrStr_append(res, _at_t778); _tr_str_release(_at_t778); });
    /* pass */
    ({ TrStr _wt_t779 = (_tr_str_wrap(_tr_int_to_str((long long)(stars)))); TrStr _at_t780 = (_tr_str_wrap(_tr_int_to_str((long long)(stars)))); List_TrStr_append(res, _at_t780); _tr_str_release(_wt_t779); _tr_str_release(_at_t780); });
    /* pass */
    return res;
}
...
__attribute__((hot)) void Bindgen_emit_func(Bindgen* self, TrStr ret_words, long long ret_stars, TrStr name) {
    ...
    /* pass */
    ({ TrStr _sbt_t781 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    def ")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->funcs, _sbt_t781); _tr_str_release(_sbt_t781); });
    /* pass */
    Bindgen_adv(self);
    /* pass */
    bool first = true;
    ...
    while (((!Bindgen_is_punct(self, _tr_str_lit(")"))) && (Bindgen_ck(self) != 5LL))) {
        ...
        /* pass */
        long long pstars = ({ TrStr _at_t782 = (List_TrStr_get(tw, 1LL)); __auto_type _wr = (_to_int(_at_t782)); _tr_str_release(_at_t782); _wr; });
        /* pass */
        ...
        if ((Bindgen_is_punct(self, _tr_str_lit("(")) && (strcmp(_tr_strz(Bindgen_nt(self)), _tr_strz(_tr_str_lit("*"))) == 0))) {
            ...
            if ((Bindgen_ck(self) == 0LL)) {
                /* pass */
                TrStr _strtmp_t783 = Bindgen_ct(self);
            ...
            if ((strcmp(_tr_strz(pname), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t784 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(argn)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("arg")), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(pname);
                pname = _strtmp_t784;
            }
            /* pass */
            if (_is_tr_keyword(pname)) {
                /* pass */
                TrStr _strtmp_t785 = _tr_strx_concat(_tr_strz(pname), _tr_strz(_tr_str_lit("_")));
                _tr_str_release(pname);
                pname = _strtmp_t785;
            }
            /* pass */
            ...
            first = false;
            /* pass */
            ({ TrStr _sbt_t786 = (_tr_strx_concat(_tr_strz(pname), _tr_strz(_tr_str_lit(": Pointer[void]")))); StringBuilder_append(self->funcs, _sbt_t786); _tr_str_release(_sbt_t786); });
            /* pass */
            argn = (argn + 1LL);
            /* pass */
        ...
        if ((Bindgen_ck(self) == 0LL)) {
            /* pass */
            TrStr _strtmp_t787 = Bindgen_ct(self);
            _tr_str_release(pname);
            pname = _strtmp_t787;
            /* pass */
            Bindgen_adv(self);
        ...
        if ((strcmp(_tr_strz(pname), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t788 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(argn)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("arg")), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(pname);
            pname = _strtmp_t788;
        }
        /* pass */
        if (_is_tr_keyword(pname)) {
            /* pass */
            TrStr _strtmp_t789 = _tr_strx_concat(_tr_strz(pname), _tr_strz(_tr_str_lit("_")));
            _tr_str_release(pname);
            pname = _strtmp_t789;
        }
        /* pass */
        ...
        first = false;
        /* pass */
        ({ TrStr _sbt_t790 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(pname), _tr_strz(_tr_str_lit(": ")))); TrStr _cr = (map_type(pbase, pstars)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); StringBuilder_append(self->funcs, _sbt_t790); _tr_str_release(_sbt_t790); });
        /* pass */
        argn = (argn + 1LL);
        /* pass */
        if ((self->pos == ploop_before)) {
    ...
    if ((strcmp(_tr_strz(rt), _tr_strz(_tr_str_lit("void"))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t791 = (_tr_strx_concat(_tr_strz(_tr_str_lit(" -> ")), _tr_strz(rt))); StringBuilder_append(self->funcs, _sbt_t791); _tr_str_release(_sbt_t791); });
    }
    /* pass */
    StringBuilder_append(self->funcs, _tr_str_lit("\n"));
    /* pass */
...
__attribute__((hot)) void Bindgen_emit_struct(Bindgen* self, TrStr name, bool is_union) {
    ...
    while (((!Bindgen_is_punct(self, _tr_str_lit("}"))) && (Bindgen_ck(self) != 5LL))) {
        ...
        if (((strcmp(_tr_strz(Bindgen_ct(self)), _tr_strz(_tr_str_lit("struct"))) == 0) || (strcmp(_tr_strz(Bindgen_ct(self)), _tr_strz(_tr_str_lit("union"))) == 0))) {
            ...
            if (Bindgen_is_punct(self, _tr_str_lit("{"))) {
                ...
                while (((!Bindgen_is_punct(self, _tr_str_lit("}"))) && (Bindgen_ck(self) != 5LL))) {
                    ...
                    /* pass */
                    long long nstars = ({ TrStr _at_t793 = (List_TrStr_get(ntw, 1LL)); __auto_type _wr = (_to_int(_at_t793)); _tr_str_release(_at_t793); _wr; });
                    /* pass */
                    bool nmore = true;
                    /* pass */
                    while (nmore) {
                        ...
                        if ((nisarr && (strcmp(_tr_strz(narr), _tr_strz(_tr_str_lit(""))) != 0))) {
                            /* pass */
                            ({ TrStr _at_t795 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (map_type(nbase, nstars)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("[")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(narr)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(ntypes, _at_t795); _tr_str_release(_at_t795); });
                        } else {
                            /* pass */
                            ({ TrStr _at_t796 = (map_type(nbase, nstars)); List_TrStr_append(ntypes, _at_t796); _tr_str_release(_at_t796); });
                        }
                        /* pass */
                        if (Bindgen_is_punct(self, _tr_str_lit(","))) {
                            /* pass */
                ...
                while ((nk < nnames->len)) {
                    ...
                    if ((strcmp(_tr_strz(pfx), _tr_strz(_tr_str_lit(""))) != 0)) {
                        /* pass */
                        TrStr _strtmp_t798 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(pfx), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(nfn)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(nfn);
                        nfn = _strtmp_t798;
                    }
                    /* pass */
                    ({ TrStr _sbt_t799 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    pub ")), _tr_strz(nfn))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (List_TrStr_get(ntypes, nk)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t799); _tr_str_release(_sbt_t799); });
                    /* pass */
                    nfields = (nfields + 1LL);
                    /* pass */
                    nk = (nk + 1LL);
        ...
        /* pass */
        long long fstars = ({ TrStr _at_t800 = (List_TrStr_get(tw, 1LL)); __auto_type _wr = (_to_int(_at_t800)); _tr_str_release(_at_t800); _wr; });
        /* pass */
        if ((Bindgen_is_punct(self, _tr_str_lit("(")) && (strcmp(_tr_strz(Bindgen_nt(self)), _tr_strz(_tr_str_lit("*"))) == 0))) {
            /* pass */
            Bindgen_adv(self);
            ...
            if ((Bindgen_ck(self) == 0LL)) {
                /* pass */
                TrStr _strtmp_t801 = Bindgen_ct(self);
            ...
            if ((strcmp(_tr_strz(fpname), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                ({ TrStr _sbt_t802 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    pub ")), _tr_strz(fpname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": Pointer[void]\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t802); _tr_str_release(_sbt_t802); });
                /* pass */
                nfields = (nfields + 1LL);
            }
            /* pass */
        ...
        while (more) {
            ...
            while (Bindgen_is_punct(self, _tr_str_lit("["))) {
                ...
                if ((strcmp(_tr_strz(arrn), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    ({ TrStr _sbt_t804 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    pub ")), _tr_strz(fname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": ["))); _tr_str_release(_cl); _cres; })); TrStr _cr = (map_type(fbase, dstars)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(arrn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t804); _tr_str_release(_sbt_t804); });
                    /* pass */
                    nfields = (nfields + 1LL);
                    /* pass */
                    is_arr = true;
            ...
            if ((!is_arr)) {
                /* pass */
                ({ TrStr _sbt_t805 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    pub ")), _tr_strz(fname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (map_type(fbase, dstars)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t805); _tr_str_release(_sbt_t805); });
                /* pass */
                nfields = (nfields + 1LL);
            }
            /* pass */
...
__attribute__((hot)) void Bindgen_emit_enum(Bindgen* self, TrStr name) {
    ...
    if (((strcmp(_tr_strz(name), _tr_strz(_tr_str_lit(""))) != 0) && Bindgen_fresh(self, name))) {
        /* pass */
        ({ TrStr _sbt_t806 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = c_int\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->types, _sbt_t806); _tr_str_release(_sbt_t806); });
    }
    /* pass */
    Bindgen_adv(self);
    /* pass */
    ...
    while (((!Bindgen_is_punct(self, _tr_str_lit("}"))) && (Bindgen_ck(self) != 5LL))) {
        ...
        if (Bindgen_is_punct(self, _tr_str_lit("="))) {
            ...
            if ((Bindgen_ck(self) == 1LL)) {
                /* pass */
                ev = ({ TrStr _at_t807 = (Bindgen_ct(self)); __auto_type _wr = (_to_int(_at_t807)); _tr_str_release(_at_t807); _wr; });
                /* pass */
                Bindgen_adv(self);
                /* pass */
                if ((!(Bindgen_is_punct(self, _tr_str_lit(",")) || Bindgen_is_punct(self, _tr_str_lit("}"))))) {
...
__attribute__((hot)) void Bindgen_parse_decl(Bindgen* self) {
    ...
    if ((strcmp(_tr_strz(lead), _tr_strz(_tr_str_lit("typedef"))) == 0)) {
        ...
        if (((strcmp(_tr_strz(agg), _tr_strz(_tr_str_lit("struct"))) == 0) || (strcmp(_tr_strz(agg), _tr_strz(_tr_str_lit("union"))) == 0))) {
            ...
            if (Bindgen_is_punct(self, _tr_str_lit("{"))) {
                ...
                if ((strcmp(_tr_strz(cname), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t810 = _tr_str_retain(tag);
            ...
            if ((((ostars > 0LL) && (strcmp(_tr_strz(oname), _tr_strz(_tr_str_lit(""))) != 0)) && (strcmp(_tr_strz(tag), _tr_strz(_tr_str_lit(""))) != 0))) {
                ...
                if (Bindgen_fresh(self, tag)) {
                    /* pass */
                    ({ TrStr _sbt_t812 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(tag))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass    # opaque handle\n\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t812); _tr_str_release(_sbt_t812); });
                    /* pass */
                    self->n_structs = (self->n_structs + 1LL);
                }
                /* pass */
                if (Bindgen_fresh(self, oname)) {
                    /* pass */
                    ({ TrStr _sbt_t813 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _tr_strz(oname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = Pointer["))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tag)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->types, _sbt_t813); _tr_str_release(_sbt_t813); });
                }
            } else if (((strcmp(_tr_strz(oname), _tr_strz(_tr_str_lit(""))) != 0) && Bindgen_fresh(self, oname))) {
                /* pass */
                ({ TrStr _sbt_t814 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(oname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass    # opaque handle\n\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t814); _tr_str_release(_sbt_t814); });
                /* pass */
                self->n_structs = (self->n_structs + 1LL);
            }
            /* pass */
        ...
        if (_typedef_is_fnptr(self->toks, self->pos)) {
            ...
            if (((strcmp(_tr_strz(fpn), _tr_strz(_tr_str_lit(""))) != 0) && Bindgen_fresh(self, fpn))) {
                /* pass */
                ({ TrStr _sbt_t815 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _tr_strz(fpn))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = Pointer[void]    # C function pointer\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->types, _sbt_t815); _tr_str_release(_sbt_t815); });
            }
            /* pass */
            Bindgen_skip_to_semi(self);
            /* pass */
        ...
        /* pass */
        long long astars = ({ TrStr _at_t816 = (List_TrStr_get(tw, 1LL)); __auto_type _wr = (_to_int(_at_t816)); _tr_str_release(_at_t816); _wr; });
        /* pass */
        TrStr aname = _tr_str_lit("");
        /* pass */
        if ((Bindgen_ck(self) == 0LL)) {
            /* pass */
            TrStr _strtmp_t817 = Bindgen_ct(self);
        ...
        if (((((strcmp(_tr_strz(aname), _tr_strz(_tr_str_lit(""))) != 0) && (strcmp(_tr_strz(abase), _tr_strz(_tr_str_lit(""))) != 0)) && (strcmp(_tr_strz(aname), _tr_strz(abase)) != 0)) && Bindgen_fresh(self, aname))) {
            /* pass */
            ({ TrStr _sbt_t818 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _tr_strz(aname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (map_type(abase, astars)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->types, _sbt_t818); _tr_str_release(_sbt_t818); });
        }
        /* pass */
        Bindgen_skip_to_semi(self);
        /* pass */
    ...
    if (((strcmp(_tr_strz(lead), _tr_strz(_tr_str_lit("struct"))) == 0) || (strcmp(_tr_strz(lead), _tr_strz(_tr_str_lit("union"))) == 0))) {
        ...
        if (((Bindgen_is_punct(self, _tr_str_lit(";")) && (strcmp(_tr_strz(tag2), _tr_strz(_tr_str_lit(""))) != 0)) && Bindgen_fresh(self, tag2))) {
            /* pass */
            ({ TrStr _sbt_t820 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(tag2))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass    # opaque (forward-declared)\n\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(self->structs, _sbt_t820); _tr_str_release(_sbt_t820); });
            /* pass */
            self->n_structs = (self->n_structs + 1LL);
        }
        /* pass */
    ...
    /* pass */
    long long rstars = ({ TrStr _at_t822 = (List_TrStr_get(rw, 1LL)); __auto_type _wr = (_to_int(_at_t822)); _tr_str_release(_at_t822); _wr; });
    /* pass */
...
__attribute__((hot)) List_ptr* tokenize_c(TrStr src) {
    ...
    while ((i < n)) {
        ...
        if (_is_alpha(c)) {
            ...
            /* pass */
            ({ TrStr _at_t825 = (_tr_str_wrap(_tr_str_slice(_tr_strz(src), start, i))); List_ptr_append(toks, CTok_init(0LL, _at_t825)); _tr_str_release(_at_t825); });
            /* pass */
            continue;
        }
        /* pass */
        if (_is_digit(c)) {
            ...
            /* pass */
            ({ TrStr _at_t826 = (_tr_str_wrap(_tr_str_slice(_tr_strz(src), start, i))); List_ptr_append(toks, CTok_init(1LL, _at_t826)); _tr_str_release(_at_t826); });
            /* pass */
            continue;
        }
        /* pass */
        if ((c == 34LL)) {
            ...
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t827 = (_tr_str_wrap(_tr_str_slice(_tr_strz(src), start, i))); List_ptr_append(toks, CTok_init(2LL, _at_t827)); _tr_str_release(_at_t827); });
            /* pass */
            continue;
        }
        /* pass */
        if ((c == 39LL)) {
            ...
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t828 = (_tr_str_wrap(_tr_str_slice(_tr_strz(src), start, i))); List_ptr_append(toks, CTok_init(3LL, _at_t828)); _tr_str_release(_at_t828); });
            /* pass */
            continue;
        }
        /* pass */
        ({ TrStr _at_t829 = (_tr_str_wrap(_tr_str_slice(_tr_strz(src), i, (i + 1LL)))); List_ptr_append(toks, CTok_init(4LL, _at_t829)); _tr_str_release(_at_t829); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) TrStr map_type(TrStr words, long long stars) {
    ...
    if ((strcmp(_tr_strz(base), _tr_strz(_tr_str_lit("c_char"))) == 0)) {
        /* pass */
        TrStr _strtmp_t830 = _tr_str_lit("char");
    ...
    if ((strcmp(_tr_strz(base), _tr_strz(_tr_str_lit("void"))) == 0)) {
        /* pass */
        TrStr _strtmp_t831 = _tr_str_lit("void");
        _tr_str_release(inner);
        inner = _strtmp_t831;
    }
    /* pass */
    ...
    while ((d < stars)) {
        /* pass */
        TrStr _strtmp_t832 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("Pointer[")), _tr_strz(ty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(ty);
        ty = _strtmp_t832;
        /* pass */
        d = (d + 1LL);
...
__attribute__((hot)) TrMap* _runtime_symbols() {
    ...
    /* pass */
    TrStr _strtmp_t833 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("malloc calloc realloc free aligned_alloc abort exit _Exit atexit quick_exit system getenv setenv unsetenv abs labs llabs atoi atol atoll atof strtol strtoul strtoll strtoull strtod strtof rand srand qsort bsearch div ldiv lldiv ")));
    _tr_str_release(names);
    names = _strtmp_t833;
    /* pass */
    TrStr _strtmp_t834 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("memcpy memmove memset memcmp memchr strcpy strncpy strcat strncat strcmp strncmp strchr strrchr strstr strlen strnlen strdup strndup strtok strspn strcspn strpbrk strerror strcoll strxfrm strcasecmp strncasecmp ")));
    _tr_str_release(names);
    names = _strtmp_t834;
    /* pass */
    TrStr _strtmp_t835 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("sqrt sin cos tan asin acos atan atan2 sinh cosh tanh exp exp2 log log2 log10 pow cbrt hypot floor ceil round trunc fabs fmod ldexp frexp modf fmin fmax copysign nextafter nan isnan isinf signbit ")));
    _tr_str_release(names);
    names = _strtmp_t835;
    /* pass */
    TrStr _strtmp_t836 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("read write open close lseek unlink stat fstat mkdir rmdir access dup dup2 pipe fork execve waitpid kill getpid ")));
    _tr_str_release(names);
    names = _strtmp_t836;
    /* pass */
    TrStr _strtmp_t837 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("CreateWindow CloseWindow CreateWindowExA CreateWindowExW GetMessage DispatchMessage MessageBox MessageBoxA MessageBoxW ")));
    _tr_str_release(names);
    names = _strtmp_t837;
    /* pass */
    TrStr _strtmp_t838 = _tr_strx_concat(_tr_strz(names), _tr_strz(_tr_str_lit("Rectangle Ellipse Polygon Polyline Arc Chord Pie RoundRect LineTo MoveToEx FillRect FrameRect InvertRect DrawIcon DrawText DrawTextEx TextOut GetObject LoadImage CreateFont PlaySound Polygon PolyBezier ")));
    _tr_str_release(names);
    names = _strtmp_t838;
    /* pass */
    ...
    while ((i < parts->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(parts, i)), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            ({ TrStr _dkt_t839 = (List_TrStr_get(parts, i)); _tr_dict_set(m, _tr_strz(_dkt_t839), true); _tr_str_release(_dkt_t839); });
        }
        /* pass */
        i = (i + 1LL);
    }
...
__attribute__((hot)) TrStr _join_words(List_TrStr* words) {
    ...
    while ((i < words->len)) {
        ...
        if ((i > 0LL)) {
            /* pass */
            TrStr _strtmp_t840 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(" ")));
            _tr_str_release(s);
            s = _strtmp_t840;
        }
        /* pass */
        TrStr _strtmp_t841 = ({ TrStr _cr = (List_TrStr_get(words, i)); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(s);
        s = _strtmp_t841;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) TrStr _rename_word(TrStr text, TrStr old, TrStr new_) {
    ...
    while ((i < n)) {
        ...
        bool matched = false;
        /* pass */
        if (({ TrStr _wt_t842 = (_tr_str_wrap(_tr_str_slice(_tr_strz(text), i, (i + ol)))); __auto_type _wr = ((((i + ol) <= n) && (strcmp(_wt_t842.data, _tr_strz(old)) == 0))); _tr_str_release(_wt_t842); _wr; })) {
            /* pass */
        ...
        if ((!matched)) {
            /* pass */
            ({ TrStr _sbt_t843 = (_tr_str_wrap(_tr_str_slice(_tr_strz(text), i, (i + 1LL)))); StringBuilder_append(sb, _sbt_t843); _tr_str_release(_sbt_t843); });
            /* pass */
            i = (i + 1LL);
        }
    }
...
__attribute__((hot)) TrStr _marker_file(TrStr line) {
    ...
    /* pass */
    __auto_type q1 = ({ char* _t844 = strstr(_tr_strz(line), _tr_strz(_tr_str_lit("\""))); _t844 ? (long long)(_t844 - (_tr_strz(line))) : -1LL; });
    /* pass */
    if ((q1 < 0LL)) {
        /* pass */
        return _tr_str_lit("");
    ...
    /* pass */
    __auto_type q2 = ({ char* _t845 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit("\""))); _t845 ? (long long)(_t845 - (_tr_strz(rest))) : -1LL; });
    /* pass */
    if ((q2 < 0LL)) {
        /* pass */
...
__attribute__((hot)) bool _marker_is_system(TrStr line) {
    /* pass */
    __auto_type q1 = ({ char* _t846 = strstr(_tr_strz(line), _tr_strz(_tr_str_lit("\""))); _t846 ? (long long)(_t846 - (_tr_strz(line))) : -1LL; });
    /* pass */
    if ((q1 < 0LL)) {
        /* pass */
        return false;
    ...
    TrStr rest = _tr_str_wrap(_tr_str_slice(_tr_strz(line), (q1 + 1LL), _tr_strlen(_tr_strz(line))));
    /* pass */
    __auto_type q2 = ({ char* _t847 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit("\""))); _t847 ? (long long)(_t847 - (_tr_strz(rest))) : -1LL; });
    /* pass */
    if ((q2 < 0LL)) {
        /* pass */
        _tr_str_release(rest);
    ...
    /* pass */
    return ({ TrStr _wt_t848 = (_tr_str_wrap(_tr_str_slice(_tr_strz(rest), (q2 + 1LL), _tr_strlen(_tr_strz(rest))))); TrStr _wt_t849 = (_tr_str_wrap(_tr_str_slice(_tr_strz(rest), (q2 + 1LL), _tr_strlen(_tr_strz(rest))))); __auto_type _wr = ((({ char* _t850 = strstr(_wt_t849.data, _tr_strz(_tr_str_lit(" 3"))); _t850 ? (long long)(_t850 - (_wt_t849.data)) : -1LL; }) >= 0LL)); _tr_str_release(_wt_t848); _tr_str_release(_wt_t849); _wr; });
}
...
__attribute__((hot)) TrMap* _load_baseline(TrStr cc) {
    ...
    /* pass */
    ({ TrStr _aet_t851 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" -E -dM \"_bindgen_empty.h\" > \"_bindgen_base.i\" 2>_bindgen_err.txt")))); _tr_system(_aet_t851.data); _tr_str_release(_aet_t851); });
    /* pass */
    ...
    while ((i < lines->len)) {
        ...
        /* pass */
        TrStr nm = ({ TrStr _at_t852 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 8LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_macro_name(_at_t852)); _tr_str_release(_at_t852); _wr; });
        /* pass */
...
__attribute__((hot)) TrMap* _target_define_names(TrStr header) {
    ...
    while ((i < lines->len)) {
        /* pass */
        TrStr ln = ({ TrStr _at_t853 = (List_TrStr_get(lines, i)); __auto_type _wr = (_lstrip(_at_t853)); _tr_str_release(_at_t853); _wr; });
        /* pass */
        i = (i + 1LL);
        /* pass */
        if ((!_tr_str_starts_with(_tr_strz(ln), _tr_strz(_tr_str_lit("#define "))))) {
        ...
        /* pass */
        TrStr nm = ({ TrStr _at_t854 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 8LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_macro_name(_at_t854)); _tr_str_release(_at_t854); _wr; });
        /* pass */
        if ((strcmp(_tr_strz(nm), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            _tr_dict_set(m, _tr_strz(nm), true);
...
__attribute__((hot)) TrStr _opaque_fallbacks(TrStr body, TrMap* defined) {
    ...
    while ((i < n)) {
        ...
        if ((c == 58LL)) {
            /* pass */
            TrStr _strtmp_t855 = _ident_at(body, (i + 1LL));
            _tr_str_release(nm);
            nm = _strtmp_t855;
            /* pass */
            i = (i + 1LL);
            ...
            /* pass */
            TrStr _strtmp_t856 = _ident_at(body, (i + 2LL));
            _tr_str_release(nm);
            nm = _strtmp_t856;
            /* pass */
            i = (i + 2LL);
            ...
            /* pass */
            TrStr _strtmp_t857 = _ident_at(body, (i + 1LL));
            _tr_str_release(nm);
            nm = _strtmp_t857;
            /* pass */
            i = (i + 1LL);
    ...
    while ((k < order->len)) {
        /* pass */
        ({ TrStr _sbt_t858 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(order, k)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = Pointer[void]\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t858); _tr_str_release(_sbt_t858); });
        /* pass */
        k = (k + 1LL);
    }
    /* pass */
...
__attribute__((hot)) void emit_defines(Bindgen* bg, TrStr defs, TrMap* baseline, TrMap* allow) {
    ...
    while ((i < lines->len)) {
        ...
        /* pass */
        __auto_type sp = ({ char* _t859 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit(" "))); _t859 ? (long long)(_t859 - (_tr_strz(rest))) : -1LL; });
        /* pass */
        if ((sp < 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        if ((({ char* _t860 = strstr(_tr_strz(nm), _tr_strz(_tr_str_lit("("))); _t860 ? (long long)(_t860 - (_tr_strz(nm))) : -1LL; }) >= 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        ...
        /* pass */
        TrStr val = ({ TrStr _at_t861 = (_tr_str_wrap(_tr_str_slice(_tr_strz(rest), (sp + 1LL), _tr_strlen(_tr_strz(rest))))); __auto_type _wr = (_lstrip(_at_t861)); _tr_str_release(_at_t861); _wr; });
        /* pass */
        ...
        if ((c0 == 34LL)) {
            ...
            if (_is_single_string_literal(val)) {
                /* pass */
                ({ TrStr _sbt_t862 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("const ")), _tr_strz(nm))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(val)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(bg->consts, _sbt_t862); _tr_str_release(_sbt_t862); });
            }
            ...
            if (_is_single_int_literal(val)) {
                ...
                /* pass */
                ({ TrStr _sbt_t863 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("const ")), _tr_strz(nm))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": c_int = "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(iv)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(bg->consts, _sbt_t863); _tr_str_release(_sbt_t863); });
            }
        }
        _tr_str_release(ln);
        _tr_str_release(rest);
...
__attribute__((hot)) TrStr _cxx_of(TrStr cc) {
    ...
    /* pass */
    if ((({ char* _t864 = strstr(_tr_strz(cc), _tr_strz(_tr_str_lit("++"))); _t864 ? (long long)(_t864 - (_tr_strz(cc))) : -1LL; }) >= 0LL)) {
        /* pass */
    ...
    while ((i < n)) {
        ...
        if ((i == tp)) {
            ...
            if ((mode == 1LL)) {
                ...
                if ((!first)) {
                    /* pass */
                    TrStr _strtmp_t865 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
                    _tr_str_release(s);
                    s = _strtmp_t865;
                }
                /* pass */
                TrStr _strtmp_t866 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("char")));
                _tr_str_release(s);
                s = _strtmp_t866;
                /* pass */
                first = false;
        ...
        if ((!first)) {
            /* pass */
            TrStr _strtmp_t867 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(s);
            s = _strtmp_t867;
        }
        /* pass */
        ...
        if ((mode == 0LL)) {
            ...
            if ((atype == 0LL)) {
                /* pass */
                TrStr _strtmp_t868 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("void* a")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(s);
                s = _strtmp_t868;
            } else {
                /* pass */
                TrStr _strtmp_t869 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("intptr_t a")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(s);
                s = _strtmp_t869;
            }
        } else if ((mode == 1LL)) {
            /* pass */
            TrStr _strtmp_t870 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("a")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t870;
        } else {
            /* pass */
            if ((atype == 0LL)) {
                /* pass */
                TrStr _strtmp_t871 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("a")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": Pointer[void]"))); _tr_str_release(_cl); _cres; });
                _tr_str_release(s);
                s = _strtmp_t871;
            } else {
                /* pass */
                TrStr _strtmp_t872 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("a")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(i)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": c_intptr_t"))); _tr_str_release(_cl); _cres; });
                _tr_str_release(s);
                s = _strtmp_t872;
            }
        }
...
__attribute__((hot)) TrStr _ent_name(TrStr e) {
    /* pass */
    return _tr_str_wrap(_tr_str_slice(_tr_strz(e), 0LL, ({ char* _t873 = strstr(_tr_strz(e), _tr_strz(_tr_str_lit("|"))); _t873 ? (long long)(_t873 - (_tr_strz(e))) : -1LL; })));
}

__attribute__((hot)) long long _ent_arity(TrStr e) {
    /* pass */
    TrStr r = _tr_str_wrap(_tr_str_slice(_tr_strz(e), (({ char* _t874 = strstr(_tr_strz(e), _tr_strz(_tr_str_lit("|"))); _t874 ? (long long)(_t874 - (_tr_strz(e))) : -1LL; }) + 1LL), _tr_strlen(_tr_strz(e))));
    /* pass */
    __auto_type b = ({ char* _t875 = strstr(_tr_strz(r), _tr_strz(_tr_str_lit("|"))); _t875 ? (long long)(_t875 - (_tr_strz(r))) : -1LL; });
    /* pass */
    if ((b < 0LL)) {
        /* pass */
        return _to_int(r);
    ...
    /* pass */
    return ({ TrStr _at_t876 = (_tr_str_wrap(_tr_str_slice(_tr_strz(r), 0LL, b))); __auto_type _wr = (_to_int(_at_t876)); _tr_str_release(_at_t876); _wr; });
}

__attribute__((hot)) long long _ent_typepos(TrStr e) {
    /* pass */
    TrStr r = _tr_str_wrap(_tr_str_slice(_tr_strz(e), (({ char* _t877 = strstr(_tr_strz(e), _tr_strz(_tr_str_lit("|"))); _t877 ? (long long)(_t877 - (_tr_strz(e))) : -1LL; }) + 1LL), _tr_strlen(_tr_strz(e))));
    /* pass */
    __auto_type b = ({ char* _t878 = strstr(_tr_strz(r), _tr_strz(_tr_str_lit("|"))); _t878 ? (long long)(_t878 - (_tr_strz(r))) : -1LL; });
    /* pass */
    if ((b < 0LL)) {
        /* pass */
        _tr_str_release(r);
    ...
    /* pass */
    return ({ TrStr _at_t879 = (_tr_str_wrap(_tr_str_slice(_tr_strz(r), (b + 1LL), _tr_strlen(_tr_strz(r))))); __auto_type _wr = (_to_int(_at_t879)); _tr_str_release(_at_t879); _wr; });
}
...
__attribute__((hot)) bool _param_ptr_type(TrStr body, TrStr pname) {
    ...
    while (((i + plen) <= _tr_strlen(_tr_strz(body)))) {
        /* pass */
        if (({ TrStr _wt_t880 = (_tr_str_wrap(_tr_str_slice(_tr_strz(body), i, (i + plen)))); __auto_type _wr = ((strcmp(_wt_t880.data, _tr_strz(pname)) == 0)); _tr_str_release(_wt_t880); _wr; })) {
            /* pass */
            bool okb = true;
            /* pass */
...
__attribute__((hot)) List_TrStr* _collect_fn_macros(TrStr defs, TrMap* baseline) {
    ...
    while ((i < lines->len)) {
        ...
        TrStr rest = _tr_str_wrap(_tr_str_slice(_tr_strz(ln), 8LL, _tr_strlen(_tr_strz(ln))));
        /* pass */
        __auto_type par = ({ char* _t881 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit("("))); _t881 ? (long long)(_t881 - (_tr_strz(rest))) : -1LL; });
        /* pass */
        if ((par <= 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        __auto_type sp = ({ char* _t882 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit(" "))); _t882 ? (long long)(_t882 - (_tr_strz(rest))) : -1LL; });
        /* pass */
        if (((sp >= 0LL) && (sp < par))) {
            /* pass */
            continue;
        ...
        /* pass */
        __auto_type _tr_v_close = ({ char* _t883 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit(")"))); _t883 ? (long long)(_t883 - (_tr_strz(rest))) : -1LL; });
        /* pass */
        ...
        /* pass */
        if ((({ char* _t884 = strstr(_tr_strz(plist), _tr_strz(_tr_str_lit("..."))); _t884 ? (long long)(_t884 - (_tr_strz(plist))) : -1LL; }) >= 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        TrStr body = ({ TrStr _at_t885 = (_tr_str_wrap(_tr_str_slice(_tr_strz(rest), (_tr_v_close + 1LL), _tr_strlen(_tr_strz(rest))))); __auto_type _wr = (_lstrip(_at_t885)); _tr_str_release(_at_t885); _wr; });
        /* pass */
        ...
        /* pass */
        if (((((arity > 0LL) && (({ char* _t886 = strstr(_tr_strz(body), _tr_strz(_tr_str_lit("sizeof"))); _t886 ? (long long)(_t886 - (_tr_strz(body))) : -1LL; }) < 0LL)) && (({ char* _t887 = strstr(_tr_strz(body), _tr_strz(_tr_str_lit("offsetof"))); _t887 ? (long long)(_t887 - (_tr_strz(body))) : -1LL; }) < 0LL)) && (({ char* _t888 = strstr(_tr_strz(body), _tr_strz(_tr_str_lit("##"))); _t888 ? (long long)(_t888 - (_tr_strz(body))) : -1LL; }) < 0LL))) {
            /* pass */
        ...
        /* pass */
        ({ TrStr _at_t889 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(nm), _tr_strz(_tr_str_lit("|")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(arity)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("|"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(typepos)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); List_TrStr_append(out, _at_t889); _tr_str_release(_at_t889); });
        _tr_str_release(ln);
        _tr_str_release(rest);
        _tr_str_release(nm);
...
__attribute__((hot)) bool _has_cc_error(TrStr errtxt) {
    /* pass */
    return ((({ char* _t890 = strstr(_tr_strz(errtxt), _tr_strz(_tr_str_lit(": error:"))); _t890 ? (long long)(_t890 - (_tr_strz(errtxt))) : -1LL; }) >= 0LL) || (({ char* _t891 = strstr(_tr_strz(errtxt), _tr_strz(_tr_str_lit(": error :"))); _t891 ? (long long)(_t891 - (_tr_strz(errtxt))) : -1LL; }) >= 0LL));
}
...
__attribute__((hot)) TrMap* _macro_bad_names(TrStr errtxt) {
    ...
    while ((i < lines->len)) {
        ...
        i = (i + 1LL);
        /* pass */
        __auto_type fp = ({ char* _t892 = strstr(_tr_strz(ln), _tr_strz(key)); _t892 ? (long long)(_t892 - (_tr_strz(ln))) : -1LL; });
        /* pass */
        if ((fp < 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        __auto_type q1 = ({ char* _t893 = strstr(_tr_strz(after), _tr_strz(_tr_str_lit("'"))); _t893 ? (long long)(_t893 - (_tr_strz(after))) : -1LL; });
        /* pass */
        if ((q1 < 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        __auto_type q2 = ({ char* _t894 = strstr(_tr_strz(rest2), _tr_strz(_tr_str_lit("'"))); _t894 ? (long long)(_t894 - (_tr_strz(rest2))) : -1LL; });
        /* pass */
        if ((q2 < 0LL)) {
            /* pass */
            continue;
...
__attribute__((hot)) List_TrStr* _macro_probe_write(TrStr header, List_TrStr* macros, TrMap* cand, long long form, long long atype, bool bake) {
    ...
    /* pass */
    ({ TrStr _sbt_t895 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("#include \"")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\"\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(probe, _sbt_t895); _tr_str_release(_sbt_t895); });
    /* pass */
    ...
    while ((k < macros->len)) {
        ...
        /* pass */
        ({ TrStr _at_t896 = (_tr_strx_concat(_tr_strz(_tr_str_lit("mP_")), _tr_strz(nm))); TrStr _sbt_t897 = (_macro_shim_line(_at_t896, nm, _ent_arity(ent), form, atype, tp)); StringBuilder_append(probe, _sbt_t897); _tr_str_release(_at_t896); _tr_str_release(_sbt_t897); });
        /* pass */
        List_TrStr_append(order, nm);
        _tr_str_release(ent);
        _tr_str_release(nm);
    ...
    /* pass */
    ({ TrStr _at_t898 = (StringObj_as_str(StringBuilder_to_string(probe))); write_file(_tr_str_lit("_macroprobe.c"), _at_t898); _tr_str_release(_at_t898); });
    /* pass */
    return order;
}
...
__attribute__((hot)) TrMap* _macro_form_bad(TrStr header, List_TrStr* macros, TrMap* cand, long long form, long long atype, bool bake, TrStr cxx, TrStr extra) {
    ...
    /* pass */
    ({ TrStr _aet_t899 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cxx), _tr_strz(_tr_str_lit(" -std=c++17 -fsyntax-only -fmax-errors=0 -fpermissive -w ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(extra)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" _macroprobe.c > _macroprobe.err 2>&1"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t899.data); _tr_str_release(_aet_t899); });
    /* pass */
    TrStr errtxt = _tr_str_lit("");
    /* pass */
    if (file_exists(_tr_str_lit("_macroprobe.err"))) {
        /* pass */
        TrStr _strtmp_t900 = read_file(_tr_str_lit("_macroprobe.err"));
    ...
    while ((i < lines->len)) {
        ...
        i = (i + 1LL);
        /* pass */
        if ((({ char* _t901 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit(": error:"))); _t901 ? (long long)(_t901 - (_tr_strz(ln))) : -1LL; }) < 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        if ((({ char* _t902 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("is not allowed here"))); _t902 ? (long long)(_t902 - (_tr_strz(ln))) : -1LL; }) >= 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        if ((({ char* _t903 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("expected unqualified-id"))); _t903 ? (long long)(_t903 - (_tr_strz(ln))) : -1LL; }) >= 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        if ((({ char* _t904 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("expected declaration"))); _t904 ? (long long)(_t904 - (_tr_strz(ln))) : -1LL; }) >= 0LL)) {
            /* pass */
            continue;
        }
        /* pass */
        __auto_type fp = ({ char* _t905 = strstr(_tr_strz(ln), _tr_strz(key)); _t905 ? (long long)(_t905 - (_tr_strz(ln))) : -1LL; });
        /* pass */
        if ((fp < 0LL)) {
            /* pass */
            continue;
        ...
        TrStr after = _tr_str_wrap(_tr_str_slice(_tr_strz(ln), (fp + _tr_strlen(_tr_strz(key))), _tr_strlen(_tr_strz(ln))));
        /* pass */
        __auto_type colon = ({ char* _t906 = strstr(_tr_strz(after), _tr_strz(_tr_str_lit(":"))); _t906 ? (long long)(_t906 - (_tr_strz(after))) : -1LL; });
        /* pass */
        if ((colon < 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        long long idx = ({ TrStr _at_t907 = (_tr_str_wrap(_tr_str_slice(_tr_strz(after), 0LL, colon))); __auto_type _wr = ((_to_int(_at_t907) - 3LL)); _tr_str_release(_at_t907); _wr; });
        /* pass */
        if (((idx >= 0LL) && (idx < order->len))) {
            /* pass */
            ({ TrStr _dkt_t908 = (List_TrStr_get(order, idx)); _tr_dict_set(bad, _tr_strz(_dkt_t908), true); _tr_str_release(_dkt_t908); });
        }
        _tr_str_release(ln);
        _tr_str_release(after);
    }
...
__attribute__((hot)) TrMap* _macro_remaining(List_TrStr* macros, TrMap* done) {
    ...
    while ((k < macros->len)) {
        ...
        k = (k + 1LL);
        /* pass */
        TrStr nm = _tr_str_wrap(_tr_str_slice(_tr_strz(ent), 0LL, ({ char* _t909 = strstr(_tr_strz(ent), _tr_strz(_tr_str_lit("|"))); _t909 ? (long long)(_t909 - (_tr_strz(ent))) : -1LL; })));
        /* pass */
...
__attribute__((hot)) void _macro_mark_done(TrMap* done, TrMap* ok, List_TrStr* macros) {
    ...
    while ((k < macros->len)) {
        ...
        k = (k + 1LL);
        /* pass */
        TrStr nm = _tr_str_wrap(_tr_str_slice(_tr_strz(ent), 0LL, ({ char* _t910 = strstr(_tr_strz(ent), _tr_strz(_tr_str_lit("|"))); _t910 ? (long long)(_t910 - (_tr_strz(ent))) : -1LL; })));
        /* pass */
...
__attribute__((hot)) void _macro_pass(TrStr header, List_TrStr* macros, TrMap* done, TrMap* plan, long long form, long long atype, bool bake, TrStr cxx, TrStr extra) {
    ...
    if (bake) {
        /* pass */
        TrStr _strtmp_t911 = _tr_str_lit("1");
        _tr_str_release(bk);
        bk = _strtmp_t911;
    }
    /* pass */
    ...
    while ((k < macros->len)) {
        ...
        if ((_tr_dict_contains(ok, _tr_strz(nm)) && (!_tr_dict_contains(done, _tr_strz(nm))))) {
            ...
            _tr_dict_set(done, _tr_strz(nm), true);
            /* pass */
            ({ TrStr _dvt_t912 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_str_wrap(_tr_int_to_str((long long)(form)))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("|"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(atype)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("|"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(bk)); _tr_str_release(_cl); _cres; })); _tr_dict_set(plan, _tr_strz(nm), _tr_str_box(_tr_str_retain(_dvt_t912))); _tr_str_release(_dvt_t912); });
        }
        _tr_str_release(ent);
        _tr_str_release(nm);
    }
...
__attribute__((hot)) TrStr _gen_macro_shims(TrStr header, TrStr out, List_TrStr* macros, TrStr cxx, TrStr extra) {
    ...
    /* pass */
    ({ TrStr _sbt_t913 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("// Auto-generated macro shims for ")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" (tauraro-bindgen --macros).\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t913); _tr_str_release(_sbt_t913); });
    /* pass */
    ({ TrStr _sbt_t914 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("#include \"")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\"\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t914); _tr_str_release(_sbt_t914); });
    /* pass */
    ...
    while ((k2 < macros->len)) {
        ...
        /* pass */
        long long form = ({ TrStr _at_t915 = (List_TrStr_get(spec, 0LL)); __auto_type _wr = (_to_int(_at_t915)); _tr_str_release(_at_t915); _wr; });
        /* pass */
        long long atype = ({ TrStr _at_t916 = (List_TrStr_get(spec, 1LL)); __auto_type _wr = (_to_int(_at_t916)); _tr_str_release(_at_t916); _wr; });
        /* pass */
        long long tp = (0LL - 1LL);
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t917 = (_tr_strx_concat(_tr_strz(_tr_str_lit("m_")), _tr_strz(nm))); TrStr _sbt_t918 = (_macro_shim_line(_at_t917, nm, ar, form, atype, tp)); StringBuilder_append(shim, _sbt_t918); _tr_str_release(_at_t917); _tr_str_release(_sbt_t918); });
        /* pass */
        ...
        if ((form == 0LL)) {
            /* pass */
            TrStr _strtmp_t919 = _tr_strx_concat(_tr_strz(bl), _tr_strz(_tr_str_lit(" -> Pointer[void]")));
            _tr_str_release(bl);
            bl = _strtmp_t919;
        }
        /* pass */
        ({ TrStr _sbt_t920 = (_tr_strx_concat(_tr_strz(bl), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(binds, _sbt_t920); _tr_str_release(_sbt_t920); });
        /* pass */
        kept = (kept + 1LL);
        /* pass */
        if ((atype == 1LL)) {
    ...
    /* pass */
    ({ TrStr _at_t921 = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("_macros.c")))); TrStr _at_t922 = (StringObj_as_str(StringBuilder_to_string(shim))); write_file(_at_t921, _at_t922); _tr_str_release(_at_t921); _tr_str_release(_at_t922); });
    /* pass */
...
__attribute__((hot)) void run_bindgen(TrStr header, TrStr out, TrStr cc, TrStr extra, TrStr pkglibs, bool want_macros) {
    ...
    /* pass */
    ({ TrStr _aet_t923 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cc), _tr_strz(extra))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -E \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(header)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" > \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tmp_decls)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>_bindgen_err.txt"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t923.data); _tr_str_release(_aet_t923); });
    /* pass */
    ({ TrStr _aet_t924 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cc), _tr_strz(extra))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -E -dM \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(header)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" > \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tmp_defs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>_bindgen_err.txt"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t924.data); _tr_str_release(_aet_t924); });
    /* pass */
    ...
    /* pass */
    TrStr src = ({ TrStr _at_t925 = (read_file(tmp_decls)); __auto_type _wr = (_filter_to_target(_at_t925, header)); _tr_str_release(_at_t925); _wr; });
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t926 = (read_file(tmp_defs)); emit_defines(bg, _at_t926, baseline, _target_define_names(header)); _tr_str_release(_at_t926); });
    /* pass */
    ...
    if (want_macros) {
        /* pass */
        TrStr _strtmp_t929 = ({ TrStr _at_t927 = (read_file(tmp_defs)); TrStr _at_t928 = (_cxx_of(cc)); __auto_type _wr = (_gen_macro_shims(header, out, _collect_fn_macros(_at_t927, baseline), _at_t928, extra)); _tr_str_release(_at_t927); _tr_str_release(_at_t928); _wr; });
        _tr_str_release(macro_binds);
        macro_binds = _strtmp_t929;
        /* pass */
        if ((strcmp(_tr_strz(macro_binds), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t930 = ({ TrStr _cl = (_basename(out)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_macros.c"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(macro_shim);
            macro_shim = _strtmp_t930;
        }
    }
    /* pass */
    StringBuilder* sb = StringBuilder_init(4096LL);
    /* pass */
    ({ TrStr _sbt_t931 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# Auto-generated FFI bindings for ")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" (tauraro-bindgen).\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t931); _tr_str_release(_sbt_t931); });
    /* pass */
    if ((strcmp(_tr_strz(macro_shim), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t932 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-shim: ")), _tr_strz(macro_shim))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\r\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t932); _tr_str_release(_sbt_t932); });
        /* pass */
        ({ TrStr _sbt_t933 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-cflags: -fpermissive ")), _tr_strz(extra))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\r\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t933); _tr_str_release(_sbt_t933); });
    }
    /* pass */
    if ((strcmp(_tr_strz(pkglibs), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t934 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-linkflags:")), _tr_strz(pkglibs))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t934); _tr_str_release(_sbt_t934); });
    }
    /* pass */
    StringBuilder_append(sb, _tr_str_lit("\n"));
    /* pass */
    ...
    if ((strcmp(_tr_strz(macro_binds), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t935 = _tr_strx_concat(_tr_strz(fs), _tr_strz(macro_binds));
        _tr_str_release(fs);
        fs = _strtmp_t935;
    }
    /* pass */
    TrStr fb = ({ TrStr _at_t936 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(ts), _tr_strz(ss))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fs)); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_opaque_fallbacks(_at_t936, bg->seen)); _tr_str_release(_at_t936); _wr; });
    /* pass */
    ...
    if ((strcmp(_tr_strz(ts), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t937 = (_tr_strx_concat(_tr_strz(ts), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(sb, _sbt_t937); _tr_str_release(_sbt_t937); });
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(cs), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t938 = (_tr_strx_concat(_tr_strz(cs), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(sb, _sbt_t938); _tr_str_release(_sbt_t938); });
    }
    /* pass */
    ...
    while ((ri < bg->defined->len)) {
        ...
        if (_tr_dict_contains(bg->skip_syms, _tr_strz(dn))) {
            /* pass */
            TrStr _strtmp_t940 = ({ TrStr _at_t939 = (_tr_strx_concat(_tr_strz(dn), _tr_strz(_tr_str_lit("_")))); __auto_type _wr = (_rename_word(result, dn, _at_t939)); _tr_str_release(_at_t939); _wr; });
...
__attribute__((hot)) void _rm_files(TrStr files) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t942 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("del /q ")), _tr_strz(files))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" >nul 2>&1"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t942.data); _tr_str_release(_aet_t942); });
    } else {
        /* pass */
        ({ TrStr _aet_t943 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f ")), _tr_strz(files))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t943.data); _tr_str_release(_aet_t943); });
    }
}
...
__attribute__((hot)) TrStr _detect_libclang(TrStr cc) {
    ...
    /* pass */
    long long rc = ({ TrStr _aet_t944 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" _cxxprobe.c -o _cxxprobe.exe -lclang 2>_cxx_err.txt")))); __auto_type _wr = (_tr_system(_aet_t944.data)); _tr_str_release(_aet_t944); _wr; });
    /* pass */
...
__attribute__((hot)) CppType* _cpp_parse_type(TrStr spelling) {
    ...
    while ((i < _tr_strlen(_tr_strz(spelling)))) {
        ...
        if ((strcmp(_tr_strz(ch), _tr_strz(_tr_str_lit("*"))) == 0)) {
            /* pass */
            TrStr _strtmp_t945 = _tr_strx_concat(_tr_strz(norm), _tr_strz(_tr_str_lit(" * ")));
            _tr_str_release(norm);
            norm = _strtmp_t945;
        } else if ((strcmp(_tr_strz(ch), _tr_strz(_tr_str_lit("&"))) == 0)) {
            /* pass */
            TrStr _strtmp_t946 = _tr_strx_concat(_tr_strz(norm), _tr_strz(_tr_str_lit(" & ")));
            _tr_str_release(norm);
            norm = _strtmp_t946;
        } else {
            /* pass */
            TrStr _strtmp_t947 = _tr_strx_concat(_tr_strz(norm), _tr_strz(ch));
            _tr_str_release(norm);
            norm = _strtmp_t947;
        }
        /* pass */
    ...
    while ((wi < words->len)) {
        ...
        if ((strcmp(_tr_strz(bw), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t948 = _tr_str_retain(w);
            _tr_str_release(bw);
            bw = _strtmp_t948;
        } else {
            /* pass */
            TrStr _strtmp_t949 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bw), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(w)); _tr_str_release(_cl); _cres; });
            _tr_str_release(bw);
            bw = _strtmp_t949;
        }
        _tr_str_release(w);
...
__attribute__((hot)) TrStr _cpp_ident(TrStr s) {
    ...
    while ((i < _tr_strlen(_tr_strz(s)))) {
        ...
        if ((((((c >= 65LL) && (c <= 90LL)) || ((c >= 97LL) && (c <= 122LL))) || ((c >= 48LL) && (c <= 57LL))) || (c == 95LL))) {
            /* pass */
            TrStr _strtmp_t950 = ({ TrStr _cr = (_tr_str_wrap(_tr_str_slice(_tr_strz(s), i, (i + 1LL)))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(out);
            out = _strtmp_t950;
        } else {
            /* pass */
            TrStr _strtmp_t951 = _tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit("_")));
            _tr_str_release(out);
            out = _strtmp_t951;
        }
        /* pass */
...
__attribute__((hot)) TrStr _cpp_tr_type(CppType* t) {
    ...
    while ((k < eff)) {
        /* pass */
        TrStr _strtmp_t952 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("Pointer[")), _tr_strz(ty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(ty);
        ty = _strtmp_t952;
        /* pass */
        k = (k + 1LL);
...
__attribute__((hot)) List_TrStr* _cpp_ret(CppType* rt, TrStr call) {
    ...
    if (((strcmp(_tr_strz(rt->base), _tr_strz(_tr_str_lit("void"))) == 0) && (rt->ptr == 0LL))) {
        ...
        /* pass */
        ({ TrStr _at_t953 = (_tr_strx_concat(_tr_strz(call), _tr_strz(_tr_str_lit(";")))); List_TrStr_append(r, _at_t953); _tr_str_release(_at_t953); });
        /* pass */
    ...
    if (rt->is_prim) {
        ...
        /* pass */
        ({ TrStr _at_t955 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t955); _tr_str_release(_at_t955); });
        /* pass */
    ...
    if (rt->was_ptr) {
        /* pass */
        ({ TrStr _at_t957 = (_tr_strx_concat(_tr_strz(rt->base), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t957); _tr_str_release(_at_t957); });
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t959 = (_tr_strx_concat(_tr_strz(rt->base), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t959); _tr_str_release(_at_t959); });
        /* pass */
        ({ TrStr _at_t960 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return &(")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t960); _tr_str_release(_at_t960); });
        /* pass */
        List_TrStr_append(r, trret);
    } else {
        /* pass */
        ({ TrStr _at_t961 = (_tr_strx_concat(_tr_strz(rt->base), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t961); _tr_str_release(_at_t961); });
        /* pass */
        ({ TrStr _at_t962 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return new ")), _tr_strz(rt->base))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t962); _tr_str_release(_at_t962); });
        /* pass */
        List_TrStr_append(r, trret);
    }
    /* pass */
...
__attribute__((hot)) TrStr _cpp_opaque_handle(TrStr base, long long nd, TrMap* class_names, TrMap* value_structs, TrMap* seen, StringBuilder* opaque) {
    ...
    if ((_is_libc_ty_name(seg) || _is_system_record_ty(seg))) {
        ...
        handle = _strtmp_t965;
        /* pass */
        if (({ TrStr _dkt_t966 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(handle))); __auto_type _wr = ((!_tr_dict_contains(seen, _tr_strz(_dkt_t966)))); _tr_str_release(_dkt_t966); _wr; })) {
            /* pass */
            ({ TrStr _sbt_t967 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(handle))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(opaque, _sbt_t967); _tr_str_release(_sbt_t967); });
            /* pass */
            ({ TrStr _dkt_t968 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(handle))); _tr_dict_set(seen, _tr_strz(_dkt_t968), true); _tr_str_release(_dkt_t968); });
        }
    }
    /* pass */
    ...
    while ((k < nd)) {
        /* pass */
        TrStr _strtmp_t969 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("Pointer[")), _tr_strz(ty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(ty);
        ty = _strtmp_t969;
        /* pass */
        k = (k + 1LL);
...
__attribute__((hot)) List_TrStr* _cpp_ret_ex(TrStr desc, TrStr call, TrMap* value_structs, TrMap* class_names, TrMap* class_qual, TrMap* seen, StringBuilder* opaque) {
    ...
    if ((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("v"))) == 0)) {
        ...
        List_TrStr_append(r, _tr_str_lit("void"));
        /* pass */
        ({ TrStr _at_t971 = (_tr_strx_concat(_tr_strz(call), _tr_strz(_tr_str_lit(";")))); List_TrStr_append(r, _at_t971); _tr_str_release(_at_t971); });
        /* pass */
        List_TrStr_append(r, _tr_str_lit(""));
        /* pass */
        List_TrStr_free(d4);
    ...
    if ((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("p"))) == 0)) {
        ...
        if ((rdepth == 0LL)) {
            ...
            /* pass */
            ({ TrStr _at_t972 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t972); _tr_str_release(_at_t972); });
            /* pass */
        ...
        if (rref) {
            ...
            /* pass */
            ({ TrStr _at_t973 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (")), _tr_strz(cty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")(&("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("));"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t973); _tr_str_release(_at_t973); });
            /* pass */
            ...
            List_TrStr_append(r, cty);
            /* pass */
            ({ TrStr _at_t975 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (")), _tr_strz(cty))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t975); _tr_str_release(_at_t975); });
            /* pass */
    ...
    if ((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("e"))) == 0)) {
        ...
        if ((rdepth == 0LL)) {
            ...
            /* pass */
            ({ TrStr _at_t977 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t977); _tr_str_release(_at_t977); });
            /* pass */
        ...
        if (rref) {
            /* pass */
            ({ TrStr _at_t978 = (_tr_strx_concat(_tr_strz(espell), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t978); _tr_str_release(_at_t978); });
            /* pass */
            ({ TrStr _at_t979 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return &(")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t979); _tr_str_release(_at_t979); });
            /* pass */
            ({ TrStr _at_t980 = (_ptr_wrap(ealias, rdepth)); List_TrStr_append(r, _at_t980); _tr_str_release(_at_t980); });
        } else {
            /* pass */
            ({ TrStr _at_t981 = (_tr_strx_concat(_tr_strz(espell), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t981); _tr_str_release(_at_t981); });
            /* pass */
    ...
    if (((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("s"))) == 0) && (strcmp(_tr_strz(detail), _tr_strz(_tr_str_lit("string"))) == 0))) {
        ...
        /* pass */
        ({ TrStr _at_t984 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return _tr_cpp_strdup(")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t984); _tr_str_release(_at_t984); });
        /* pass */
    ...
    if ((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("f"))) == 0)) {
        ...
        List_TrStr_append(r, _tr_str_lit("void*"));
        /* pass */
        ({ TrStr _at_t985 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (void*)(")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t985); _tr_str_release(_at_t985); });
        /* pass */
    ...
    if ((rdepth == 0LL)) {
        /* pass */
        ({ TrStr _at_t988 = (_tr_strx_concat(_tr_strz(cb), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t988); _tr_str_release(_at_t988); });
        /* pass */
        ({ TrStr _at_t989 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return new ")), _tr_strz(cb))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t989); _tr_str_release(_at_t989); });
        /* pass */
        List_TrStr_append(r, handle);
    } else if (rref) {
        /* pass */
        ({ TrStr _at_t990 = (_tr_strx_concat(_tr_strz(cb), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t990); _tr_str_release(_at_t990); });
        /* pass */
        ({ TrStr _at_t991 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (")), _tr_strz(cb))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("*)(&("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("));"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t991); _tr_str_release(_at_t991); });
        /* pass */
        List_TrStr_append(r, handle);
    } else {
        /* pass */
        ({ TrStr _at_t992 = (_tr_strx_concat(_tr_strz(cb), _tr_strz(_tr_str_lit("*")))); List_TrStr_append(r, _at_t992); _tr_str_release(_at_t992); });
        /* pass */
        ({ TrStr _at_t993 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (")), _tr_strz(cb))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("*)("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");"))); _tr_str_release(_cl); _cres; })); List_TrStr_append(r, _at_t993); _tr_str_release(_at_t993); });
        /* pass */
        List_TrStr_append(r, handle);
    }
    /* pass */
...
__attribute__((hot)) TrStr _ns_pop(TrStr path) {
    ...
    while ((i < (parts->len - 1LL))) {
        ...
        if ((strcmp(_tr_strz(r), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            /* pass */
            TrStr _strtmp_t995 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(r), _tr_strz(_tr_str_lit("::")))); TrStr _cr = (List_TrStr_get(parts, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
            _tr_str_release(r);
            r = _strtmp_t995;
        }
        /* pass */
    ...
    while ((i < parts->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(parts, i)), _tr_strz(_tr_str_lit(""))) != 0)) {
            ...
            if ((strcmp(_tr_strz(r), _tr_strz(_tr_str_lit(""))) == 0)) {
                ...
                /* pass */
                TrStr _strtmp_t997 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(r), _tr_strz(_tr_str_lit("_")))); TrStr _cr = (List_TrStr_get(parts, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(r);
                r = _strtmp_t997;
            }
        }
...
__attribute__((hot)) TrStr _rstrip_cr(TrStr s) {
    ...
    /* pass */
    while (({ TrStr _wt_t998 = (_tr_str_wrap(_tr_str_slice(_tr_strz(s), (n - 1LL), n))); __auto_type _wr = (((n > 0LL) && (strcmp(_wt_t998.data, _tr_strz(_tr_str_lit("\r"))) == 0))); _tr_str_release(_wt_t998); _wr; })) {
        /* pass */
        n = (n - 1LL);
    }
    /* pass */
...
__attribute__((hot)) List_TrStr* _desc4(TrStr desc) {
    ...
    /* pass */
    ({ TrStr _at_t999 = (List_TrStr_get(parts, 0LL)); List_TrStr_append(r, _at_t999); _tr_str_release(_at_t999); });
    /* pass */
    ({ TrStr _at_t1000 = (List_TrStr_get(parts, 1LL)); List_TrStr_append(r, _at_t1000); _tr_str_release(_at_t1000); });
    /* pass */
    ({ TrStr _at_t1001 = (List_TrStr_get(parts, 2LL)); List_TrStr_append(r, _at_t1001); _tr_str_release(_at_t1001); });
    /* pass */
    TrStr det = _tr_str_lit("");
    /* pass */
    if ((parts->len > 3LL)) {
        /* pass */
        TrStr _strtmp_t1002 = List_TrStr_get(parts, 3LL);
        _tr_str_release(det);
        det = _strtmp_t1002;
    }
    /* pass */
    ...
    while ((k < parts->len)) {
        /* pass */
        TrStr _strtmp_t1003 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(det), _tr_strz(_tr_str_lit("~")))); TrStr _cr = (List_TrStr_get(parts, k)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(det);
        det = _strtmp_t1003;
        /* pass */
        k = (k + 1LL);
...
__attribute__((hot)) List_TrStr* _parse_tclass(TrStr rest) {
    ...
    while ((i < (parts->len - 1LL))) {
        ...
        if ((strcmp(_tr_strz(sp), _tr_strz(_tr_str_lit(""))) == 0)) {
            ...
            /* pass */
            TrStr _strtmp_t1005 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(sp), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(parts, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
            _tr_str_release(sp);
            sp = _strtmp_t1005;
        }
        /* pass */
...
__attribute__((hot)) TrStr _stars(long long n) {
    ...
    while ((i < n)) {
        /* pass */
        TrStr _strtmp_t1006 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("*")));
        _tr_str_release(s);
        s = _strtmp_t1006;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) TrStr _ptr_wrap(TrStr inner, long long n) {
    ...
    while ((i < n)) {
        /* pass */
        TrStr _strtmp_t1007 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("Pointer[")), _tr_strz(t))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("]"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(t);
        t = _strtmp_t1007;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) TrStr _cpp_field_type(TrStr desc, TrMap* value_structs, TrMap* enum_names) {
    ...
    List_TrStr* d4 = _desc4(desc);
    /* pass */
    long long depth = ({ TrStr _at_t1008 = (List_TrStr_get(d4, 0LL)); __auto_type _wr = (_to_int(_at_t1008)); _tr_str_release(_at_t1008); _wr; });
    /* pass */
    TrStr cat = List_TrStr_get(d4, 2LL);
    /* pass */
    TrStr detail = List_TrStr_get(d4, 3LL);
    ...
    if ((strcmp(_tr_strz(cat), _tr_strz(_tr_str_lit("e"))) == 0)) {
        /* pass */
        TrStr ealias = ({ TrStr _at_t1009 = (List_TrStr_get(_tr_str_split(_tr_strz(detail), _tr_strz(_tr_str_lit("#"))), 0LL)); __auto_type _wr = (_last_seg(_at_t1009)); _tr_str_release(_at_t1009); _wr; });
        /* pass */
        if ((depth == 0LL)) {
            /* pass */
            List_TrStr_free(d4);
...
__attribute__((hot)) TrStr _shim_body(TrStr ret_ctype, TrStr body) {
    ...
    if ((strcmp(_tr_strz(ret_ctype), _tr_strz(_tr_str_lit("void"))) == 0)) {
        /* pass */
        TrStr _strtmp_t1010 = _tr_str_lit("return;");
...
__attribute__((hot)) TrStr _fnptr_cast(TrStr fnty) {
    /* pass */
    __auto_type p = ({ char* _t1011 = strstr(_tr_strz(fnty), _tr_strz(_tr_str_lit("("))); _t1011 ? (long long)(_t1011 - (_tr_strz(fnty))) : -1LL; });
    /* pass */
    if ((p < 0LL)) {
        /* pass */
...
__attribute__((hot)) void _cpp_generate(TrStr ir, TrStr header, TrStr out, TrStr shim_cflags, TrStr pkglibs) {
    ...
    while ((pli < plines->len)) {
        /* pass */
        TrStr pl = ({ TrStr _at_t1012 = (List_TrStr_get(plines, pli)); __auto_type _wr = (_rstrip_cr(_at_t1012)); _tr_str_release(_at_t1012); _wr; });
        /* pass */
        pli = (pli + 1LL);
        /* pass */
        if (_tr_str_starts_with(_tr_strz(pl), _tr_strz(_tr_str_lit("ENUM ")))) {
            ...
            if ((cparts->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1013 = List_TrStr_get(cparts, 1LL);
            ...
            /* pass */
            List_TrStr* tp = ({ TrStr _at_t1014 = (_tr_str_wrap(_tr_str_slice(_tr_strz(pl), 7LL, _tr_strlen(_tr_strz(pl))))); __auto_type _wr = (_parse_tclass(_at_t1014)); _tr_str_release(_at_t1014); _wr; });
            /* pass */
            TrStr tnm = ({ TrStr _at_t1015 = (List_TrStr_get(tp, 0LL)); __auto_type _wr = (_cpp_ident(_at_t1015)); _tr_str_release(_at_t1015); _wr; });
            /* pass */
            _tr_dict_set(class_names, _tr_strz(tnm), true);
            /* pass */
            List_TrStr_append(ps_name, tnm);
            /* pass */
            ({ TrStr _at_t1016 = (List_TrStr_get(tp, 1LL)); List_TrStr_append(ps_pod, _at_t1016); _tr_str_release(_at_t1016); });
            /* pass */
            List_TrStr_append(ps_nf, _tr_str_lit("0"));
            List_TrStr_free(tp);
            _tr_str_release(tnm);
    ...
    while ((li < lines->len)) {
        /* pass */
        TrStr line = ({ TrStr _at_t1017 = (List_TrStr_get(lines, li)); __auto_type _wr = (_rstrip_cr(_at_t1017)); _tr_str_release(_at_t1017); _wr; });
        /* pass */
        li = (li + 1LL);
        /* pass */
        ...
        if ((cstk_name->len > 0LL)) {
            /* pass */
            TrStr _strtmp_t1018 = List_TrStr_get(cstk_name, (cstk_name->len - 1LL));
            _tr_str_release(cur_class);
            cur_class = _strtmp_t1018;
            /* pass */
            TrStr _strtmp_t1019 = List_TrStr_get(cstk_qual, (cstk_qual->len - 1LL));
            _tr_str_release(cur_class_qual);
            cur_class_qual = _strtmp_t1019;
            /* pass */
            TrStr _strtmp_t1020 = List_TrStr_get(cstk_pfx, (cstk_pfx->len - 1LL));
            _tr_str_release(class_pfx);
            class_pfx = _strtmp_t1020;
        }
        /* pass */
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("CTOR")))) {
            ...
            if ((_tr_strlen(_tr_strz(line)) > 5LL)) {
                /* pass */
                m_ndef = ({ TrStr _at_t1021 = (_tr_str_wrap(_tr_str_slice(_tr_strz(line), 5LL, _tr_strlen(_tr_strz(line))))); __auto_type _wr = (_to_int(_at_t1021)); _tr_str_release(_at_t1021); _wr; });
            }
            /* pass */
            TrStr _strtmp_t1022 = _tr_str_lit("ctor");
        ...
        if ((strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("ECLASS"))) == 0)) {
            /* pass */
            if (({ TrStr _dkt_t1026 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(cur_class))); __auto_type _wr = ((_is_clean_ident(cur_class) && (!_tr_dict_contains(seen, _tr_strz(_dkt_t1026))))); _tr_str_release(_dkt_t1026); _wr; })) {
                /* pass */
                if ((_tr_dict_contains(value_structs, _tr_strz(cur_class)) && (strcmp(_tr_strz(fld_buf), _tr_strz(_tr_str_lit(""))) != 0))) {
                    /* pass */
                    ({ TrStr _sbt_t1027 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("@value_type\nclass ")), _tr_strz(cur_class))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fld_buf)); _tr_str_release(_cl); _cres; })); StringBuilder_append(opaque, _sbt_t1027); _tr_str_release(_sbt_t1027); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t1028 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(cur_class))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(opaque, _sbt_t1028); _tr_str_release(_sbt_t1028); });
                }
                /* pass */
                ({ TrStr _dkt_t1029 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(cur_class))); _tr_dict_set(seen, _tr_strz(_dkt_t1029), true); _tr_str_release(_dkt_t1029); });
                /* pass */
            ...
            if ((fld_stack->len > 0LL)) {
                /* pass */
                TrStr _strtmp_t1030 = List_TrStr_pop(fld_stack);
                _tr_str_release(fld_buf);
                fld_buf = _strtmp_t1030;
            } else {
                /* pass */
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("FIELD ")))) {
            ...
            if ((fbar->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1032 = List_TrStr_get(fbar, 1LL);
                _tr_str_release(fnm);
                fnm = _strtmp_t1032;
            }
            /* pass */
            if (_is_clean_ident(fnm)) {
                ...
                if (_tr_dict_contains(value_structs, _tr_strz(cur_class))) {
                    ...
                    /* pass */
                    TrStr _strtmp_t1033 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(fld_buf), _tr_strz(_tr_str_lit("    pub ")))); TrStr _cr = (_cpp_tr_pname(fnm)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fmap)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
                    _tr_str_release(fld_buf);
                    fld_buf = _strtmp_t1033;
                    _tr_str_release(fmap);
                } else if (((_is_clean_ident(cur_class) && (({ char* _t1034 = strstr(_tr_strz(fdesc), _tr_strz(_tr_str_lit("type-parameter"))); _t1034 ? (long long)(_t1034 - (_tr_strz(fdesc))) : -1LL; }) < 0LL)) && (({ char* _t1035 = strstr(_tr_strz(fdesc), _tr_strz(_tr_str_lit("~d~"))); _t1035 ? (long long)(_t1035 - (_tr_strz(fdesc))) : -1LL; }) < 0LL))) {
                    /* pass */
                    List_TrStr* fri = ({ TrStr _at_t1036 = (_tr_strx_concat(_tr_strz(_tr_str_lit("self->")), _tr_strz(fnm))); __auto_type _wr = (_cpp_ret_ex(fdesc, _at_t1036, value_structs, class_names, class_qual, seen, opaque)); _tr_str_release(_at_t1036); _wr; });
                    /* pass */
                    TrStr fsym = ({ TrStr _at_t1037 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fnm)); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_uniq_sym(_at_t1037, sym_used)); _tr_str_release(_at_t1037); _wr; });
                    /* pass */
                    ({ TrStr _at_t1038 = (List_TrStr_get(fri, 0LL)); TrStr _at_t1039 = (List_TrStr_get(fri, 1LL)); TrStr _sbt_t1040 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (List_TrStr_get(fri, 0LL)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fsym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur_class_qual)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("* self) { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1038, _at_t1039)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1040); _tr_str_release(_at_t1038); _tr_str_release(_at_t1039); _tr_str_release(_sbt_t1040); });
                    /* pass */
                    ...
                    if ((strcmp(_tr_strz(List_TrStr_get(fri, 2LL)), _tr_strz(_tr_str_lit(""))) != 0)) {
                        /* pass */
                        TrStr _strtmp_t1041 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(fd), _tr_strz(_tr_str_lit(" -> ")))); TrStr _cr = (List_TrStr_get(fri, 2LL)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                        _tr_str_release(fd);
                        fd = _strtmp_t1041;
                    }
                    /* pass */
                    ({ TrStr _sbt_t1042 = (_tr_strx_concat(_tr_strz(fd), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(decls, _sbt_t1042); _tr_str_release(_sbt_t1042); });
                    /* pass */
                    n_fns = (n_fns + 1LL);
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("ITER ")))) {
            ...
            /* pass */
            if (((_is_clean_ident(cur_class) && (({ char* _t1043 = strstr(_tr_strz(idesc), _tr_strz(_tr_str_lit("type-parameter"))); _t1043 ? (long long)(_t1043 - (_tr_strz(idesc))) : -1LL; }) < 0LL)) && (({ char* _t1044 = strstr(_tr_strz(idesc), _tr_strz(_tr_str_lit("~d~"))); _t1044 ? (long long)(_t1044 - (_tr_strz(idesc))) : -1LL; }) < 0LL))) {
                /* pass */
                List_TrStr* iri = _cpp_ret_ex(idesc, _tr_str_lit("(*it)"), value_structs, class_names, class_qual, seen, opaque);
                /* pass */
                TrStr isym = ({ TrStr _at_t1045 = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_nth")))); __auto_type _wr = (_uniq_sym(_at_t1045, sym_used)); _tr_str_release(_at_t1045); _wr; });
                /* pass */
                ({ TrStr _at_t1046 = (List_TrStr_get(iri, 0LL)); TrStr _at_t1047 = (({ TrStr _cr = (List_TrStr_get(iri, 1LL)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("auto it = self->begin(); std::advance(it, (long)i); ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _sbt_t1048 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (List_TrStr_get(iri, 0LL)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(isym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur_class_qual)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("* self, long i) { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1046, _at_t1047)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1048); _tr_str_release(_at_t1046); _tr_str_release(_at_t1047); _tr_str_release(_sbt_t1048); });
                /* pass */
                ...
                if ((strcmp(_tr_strz(List_TrStr_get(iri, 2LL)), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1049 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(id), _tr_strz(_tr_str_lit(" -> ")))); TrStr _cr = (List_TrStr_get(iri, 2LL)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                    _tr_str_release(id);
                    id = _strtmp_t1049;
                }
                /* pass */
                ({ TrStr _sbt_t1050 = (_tr_strx_concat(_tr_strz(id), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(decls, _sbt_t1050); _tr_str_release(_sbt_t1050); });
                /* pass */
                n_fns = (n_fns + 1LL);
        ...
        if ((_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("ITERMAPKEY "))) || _tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("ITERMAPVAL "))))) {
            ...
            /* pass */
            if (((_is_clean_ident(cur_class) && (({ char* _t1051 = strstr(_tr_strz(mdesc), _tr_strz(_tr_str_lit("type-parameter"))); _t1051 ? (long long)(_t1051 - (_tr_strz(mdesc))) : -1LL; }) < 0LL)) && (({ char* _t1052 = strstr(_tr_strz(mdesc), _tr_strz(_tr_str_lit("~d~"))); _t1052 ? (long long)(_t1052 - (_tr_strz(mdesc))) : -1LL; }) < 0LL))) {
                /* pass */
                ...
                if (is_key) {
                    /* pass */
                    TrStr _strtmp_t1053 = _tr_str_lit("(it->first)");
                    _tr_str_release(mfield);
                    mfield = _strtmp_t1053;
                    /* pass */
                    TrStr _strtmp_t1054 = _tr_str_lit("_key_nth");
                ...
                /* pass */
                TrStr msym = ({ TrStr _at_t1055 = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(mname))); __auto_type _wr = (_uniq_sym(_at_t1055, sym_used)); _tr_str_release(_at_t1055); _wr; });
                /* pass */
                ({ TrStr _at_t1056 = (List_TrStr_get(mri, 0LL)); TrStr _at_t1057 = (({ TrStr _cr = (List_TrStr_get(mri, 1LL)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("auto it = self->begin(); std::advance(it, (long)i); ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _sbt_t1058 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (List_TrStr_get(mri, 0LL)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(msym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur_class_qual)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("* self, long i) { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1056, _at_t1057)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1058); _tr_str_release(_at_t1056); _tr_str_release(_at_t1057); _tr_str_release(_sbt_t1058); });
                /* pass */
                ...
                if ((strcmp(_tr_strz(List_TrStr_get(mri, 2LL)), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1059 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(md), _tr_strz(_tr_str_lit(" -> ")))); TrStr _cr = (List_TrStr_get(mri, 2LL)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                    _tr_str_release(md);
                    md = _strtmp_t1059;
                }
                /* pass */
                ({ TrStr _sbt_t1060 = (_tr_strx_concat(_tr_strz(md), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(decls, _sbt_t1060); _tr_str_release(_sbt_t1060); });
                /* pass */
                n_fns = (n_fns + 1LL);
                _tr_str_release(mfield);
                _tr_str_release(mname);
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("GVAR ")))) {
            ...
            if ((gbar->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1061 = List_TrStr_get(gbar, 1LL);
            ...
            /* pass */
            if ((((((_is_clean_ident(gvnm) && (({ char* _t1062 = strstr(_tr_strz(gvdesc), _tr_strz(_tr_str_lit("type-parameter"))); _t1062 ? (long long)(_t1062 - (_tr_strz(gvdesc))) : -1LL; }) < 0LL)) && (({ char* _t1063 = strstr(_tr_strz(gvdesc), _tr_strz(_tr_str_lit("~d~"))); _t1063 ? (long long)(_t1063 - (_tr_strz(gvdesc))) : -1LL; }) < 0LL)) && (strcmp(_tr_strz(gcat), _tr_strz(_tr_str_lit("u"))) != 0)) && (strcmp(_tr_strz(gcat), _tr_strz(_tr_str_lit("f"))) != 0)) && (strcmp(_tr_strz(gcat), _tr_strz(_tr_str_lit("v"))) != 0))) {
                /* pass */
                ...
                if ((strcmp(_tr_strz(cur_class), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1064 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gvnm)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(gqual);
                    gqual = _strtmp_t1064;
                    /* pass */
                    TrStr _strtmp_t1065 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gvnm)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(gsym0);
                    gsym0 = _strtmp_t1065;
                } else if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1066 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(ns_path), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gvnm)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(gqual);
                    gqual = _strtmp_t1066;
                    /* pass */
                    TrStr _strtmp_t1067 = ({ TrStr _cl = (({ TrStr _cl = (_ns_us(ns_path)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gvnm)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(gsym0);
                    gsym0 = _strtmp_t1067;
                }
                /* pass */
                ...
                /* pass */
                ({ TrStr _at_t1068 = (List_TrStr_get(gvri, 0LL)); TrStr _at_t1069 = (List_TrStr_get(gvri, 1LL)); TrStr _sbt_t1070 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (List_TrStr_get(gvri, 0LL)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gvs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("() { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1068, _at_t1069)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1070); _tr_str_release(_at_t1068); _tr_str_release(_at_t1069); _tr_str_release(_sbt_t1070); });
                /* pass */
                ...
                if ((strcmp(_tr_strz(List_TrStr_get(gvri, 2LL)), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1071 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(gvd), _tr_strz(_tr_str_lit(" -> ")))); TrStr _cr = (List_TrStr_get(gvri, 2LL)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                    _tr_str_release(gvd);
                    gvd = _strtmp_t1071;
                }
                /* pass */
                ({ TrStr _sbt_t1072 = (_tr_strx_concat(_tr_strz(gvd), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(decls, _sbt_t1072); _tr_str_release(_sbt_t1072); });
                /* pass */
                n_fns = (n_fns + 1LL);
                _tr_str_release(gqual);
                _tr_str_release(gsym0);
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("FTMPL ")))) {
            ...
            /* pass */
            long long ftnp = ({ TrStr _at_t1073 = (List_TrStr_get(ftbar, 0LL)); __auto_type _wr = (_to_int(_at_t1073)); _tr_str_release(_at_t1073); _wr; });
            /* pass */
            TrStr ftnm = _tr_str_lit("");
            /* pass */
            if ((ftbar->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1074 = List_TrStr_get(ftbar, 1LL);
                ...
                while ((fti < ftys->len)) {
                    ...
                    while ((fpi < ftnp)) {
                        ...
                        if ((strcmp(_tr_strz(fshimp), _tr_strz(_tr_str_lit(""))) != 0)) {
                            /* pass */
                            TrStr _strtmp_t1075 = _tr_strx_concat(_tr_strz(fshimp), _tr_strz(_tr_str_lit(", ")));
                            _tr_str_release(fshimp);
                            fshimp = _strtmp_t1075;
                        }
                        /* pass */
                        TrStr _strtmp_t1076 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(fshimp), _tr_strz(fcpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fan)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(fshimp);
                        fshimp = _strtmp_t1076;
                        /* pass */
                        if ((strcmp(_tr_strz(ftrp), _tr_strz(_tr_str_lit(""))) != 0)) {
                            /* pass */
                            TrStr _strtmp_t1077 = _tr_strx_concat(_tr_strz(ftrp), _tr_strz(_tr_str_lit(", ")));
                            _tr_str_release(ftrp);
                            ftrp = _strtmp_t1077;
                        }
                        /* pass */
                        TrStr _strtmp_t1078 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(ftrp), _tr_strz(fan))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fcty)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(ftrp);
                        ftrp = _strtmp_t1078;
                        /* pass */
                        if ((strcmp(_tr_strz(fcallargs), _tr_strz(_tr_str_lit(""))) != 0)) {
                            /* pass */
                            TrStr _strtmp_t1079 = _tr_strx_concat(_tr_strz(fcallargs), _tr_strz(_tr_str_lit(", ")));
                            _tr_str_release(fcallargs);
                            fcallargs = _strtmp_t1079;
                        }
                        /* pass */
                        TrStr _strtmp_t1080 = _tr_strx_concat(_tr_strz(fcallargs), _tr_strz(fan));
                        _tr_str_release(fcallargs);
                        fcallargs = _strtmp_t1080;
                        _tr_str_release(fan);
                    }
                    /* pass */
                    ...
                    if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) != 0)) {
                        /* pass */
                        TrStr _strtmp_t1081 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(ns_path), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ftnm)); _tr_str_release(_cl); _cres; });
                    ...
                    /* pass */
                    ({ TrStr _at_t1083 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(fcall))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t1084 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(fcpp), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ftsym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fshimp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(") { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(fcpp, _at_t1083)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1084); _tr_str_release(_at_t1083); _tr_str_release(_sbt_t1084); });
                    /* pass */
                    ({ TrStr _sbt_t1085 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    def ")), _tr_strz(ftsym))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ftrp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(") -> "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fcty)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(decls, _sbt_t1085); _tr_str_release(_sbt_t1085); });
                    /* pass */
                    n_fns = (n_fns + 1LL);
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("XSTRUCT ")))) {
            ...
            /* pass */
            TrStr _strtmp_t1086 = _tr_str_lit("");
            _tr_str_release(fld_buf);
            fld_buf = _strtmp_t1086;
            /* pass */
            continue;
        }
        /* pass */
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("SFIELD ")))) {
            ...
            if ((sbar->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1087 = List_TrStr_get(sbar, 1LL);
                _tr_str_release(snm);
                snm = _strtmp_t1087;
            }
            /* pass */
            if (_is_clean_ident(snm)) {
                /* pass */
                TrStr _strtmp_t1088 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(fld_buf), _tr_strz(_tr_str_lit("    pub ")))); TrStr _cr = (_cpp_tr_pname(snm)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(": "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sty)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; });
                _tr_str_release(fld_buf);
        ...
        if ((strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("EXSTRUCT"))) == 0)) {
            /* pass */
            if (({ TrStr _dkt_t1089 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(cur_class))); __auto_type _wr = ((_is_clean_ident(cur_class) && (!_tr_dict_contains(seen, _tr_strz(_dkt_t1089))))); _tr_str_release(_dkt_t1089); _wr; })) {
                /* pass */
                if ((strcmp(_tr_strz(fld_buf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    ({ TrStr _sbt_t1090 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("@value_type\nclass ")), _tr_strz(cur_class))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fld_buf)); _tr_str_release(_cl); _cres; })); StringBuilder_append(opaque, _sbt_t1090); _tr_str_release(_sbt_t1090); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t1091 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("class ")), _tr_strz(cur_class))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(":\n    pass\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(opaque, _sbt_t1091); _tr_str_release(_sbt_t1091); });
                }
                /* pass */
                ({ TrStr _dkt_t1092 = (_tr_strx_concat(_tr_strz(_tr_str_lit("class:")), _tr_strz(cur_class))); _tr_dict_set(seen, _tr_strz(_dkt_t1092), true); _tr_str_release(_dkt_t1092); });
                /* pass */
                n_classes = (n_classes + 1LL);
            }
            /* pass */
            ...
            if ((fld_stack->len > 0LL)) {
                /* pass */
                TrStr _strtmp_t1093 = List_TrStr_pop(fld_stack);
                _tr_str_release(fld_buf);
                fld_buf = _strtmp_t1093;
            } else {
                /* pass */
                TrStr _strtmp_t1094 = _tr_str_lit("");
                _tr_str_release(fld_buf);
                fld_buf = _strtmp_t1094;
            }
            /* pass */
            continue;
        }
        ...
        if ((strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("ENS"))) == 0)) {
            /* pass */
            TrStr _strtmp_t1095 = _ns_pop(ns_path);
            _tr_str_release(ns_path);
            ns_path = _strtmp_t1095;
            /* pass */
            continue;
        }
        /* pass */
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("NS ")))) {
            ...
            if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t1096 = _tr_str_retain(nn);
                _tr_str_release(ns_path);
                ns_path = _strtmp_t1096;
            } else {
                /* pass */
                TrStr _strtmp_t1097 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(ns_path), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(nn)); _tr_str_release(_cl); _cres; });
                _tr_str_release(ns_path);
                ns_path = _strtmp_t1097;
            }
            /* pass */
            if (({ TrStr _dkt_t1098 = (_tr_strx_concat(_tr_strz(_tr_str_lit("using:")), _tr_strz(ns_path))); __auto_type _wr = ((!_tr_dict_contains(seen, _tr_strz(_dkt_t1098)))); _tr_str_release(_dkt_t1098); _wr; })) {
                /* pass */
                ({ TrStr _sbt_t1099 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("using namespace ")), _tr_strz(ns_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(usings, _sbt_t1099); _tr_str_release(_sbt_t1099); });
                /* pass */
                ({ TrStr _dkt_t1100 = (_tr_strx_concat(_tr_strz(_tr_str_lit("using:")), _tr_strz(ns_path))); _tr_dict_set(seen, _tr_strz(_dkt_t1100), true); _tr_str_release(_dkt_t1100); });
            }
            /* pass */
            continue;
        }
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("TCLASS ")))) {
            /* pass */
            List_TrStr* tp2 = ({ TrStr _at_t1101 = (_tr_str_wrap(_tr_str_slice(_tr_strz(line), 7LL, _tr_strlen(_tr_strz(line))))); __auto_type _wr = (_parse_tclass(_at_t1101)); _tr_str_release(_at_t1101); _wr; });
            /* pass */
            ...
            List_TrStr_append(fld_stack, fld_buf);
            /* pass */
            TrStr _strtmp_t1102 = _tr_str_lit("");
            _tr_str_release(fld_buf);
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("CLASS ")))) {
            ...
            if ((strcmp(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t1103 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ncls)); _tr_str_release(_cl); _cres; });
                _tr_str_release(nqual);
                nqual = _strtmp_t1103;
            } else if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t1104 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(ns_path), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ncls)); _tr_str_release(_cl); _cres; });
                _tr_str_release(nqual);
                nqual = _strtmp_t1104;
            }
            /* pass */
            if ((strcmp(_tr_strz(class_pfx), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t1105 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ncls)); _tr_str_release(_cl); _cres; });
                _tr_str_release(npfx);
                npfx = _strtmp_t1105;
            } else if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t1106 = ({ TrStr _cl = (({ TrStr _cl = (_ns_us(ns_path)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ncls)); _tr_str_release(_cl); _cres; });
                _tr_str_release(npfx);
                npfx = _strtmp_t1106;
            }
            /* pass */
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("ENUM ")))) {
            ...
            if ((eps->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1108 = List_TrStr_get(eps, 1LL);
                _tr_str_release(eunder);
                eunder = _strtmp_t1108;
            }
            /* pass */
            if (({ TrStr _dkt_t1109 = (_tr_strx_concat(_tr_strz(_tr_str_lit("enum:")), _tr_strz(en))); __auto_type _wr = ((_is_clean_ident(en) && (!_tr_dict_contains(seen, _tr_strz(_dkt_t1109))))); _tr_str_release(_dkt_t1109); _wr; })) {
                /* pass */
                ({ TrStr _sbt_t1110 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("type ")), _tr_strz(en))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(eunder)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(consts, _sbt_t1110); _tr_str_release(_sbt_t1110); });
                /* pass */
                ({ TrStr _dkt_t1111 = (_tr_strx_concat(_tr_strz(_tr_str_lit("enum:")), _tr_strz(en))); _tr_dict_set(seen, _tr_strz(_dkt_t1111), true); _tr_str_release(_dkt_t1111); });
            }
            /* pass */
            continue;
        }
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("EVAL ")))) {
            ...
            if ((ep->len > 1LL)) {
                /* pass */
                TrStr _strtmp_t1112 = List_TrStr_get(ep, 1LL);
                _tr_str_release(eval_);
                eval_ = _strtmp_t1112;
            }
            /* pass */
            if (({ TrStr _dkt_t1113 = (_tr_strx_concat(_tr_strz(_tr_str_lit("eval:")), _tr_strz(ename))); __auto_type _wr = ((!_tr_dict_contains(seen, _tr_strz(_dkt_t1113)))); _tr_str_release(_dkt_t1113); _wr; })) {
                /* pass */
                ({ TrStr _sbt_t1114 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("const ")), _tr_strz(ename))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(eval_)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(consts, _sbt_t1114); _tr_str_release(_sbt_t1114); });
                /* pass */
                ({ TrStr _dkt_t1115 = (_tr_strx_concat(_tr_strz(_tr_str_lit("eval:")), _tr_strz(ename))); _tr_dict_set(seen, _tr_strz(_dkt_t1115), true); _tr_str_release(_dkt_t1115); });
            }
            /* pass */
            continue;
        }
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("METHOD ")))) {
            ...
            /* pass */
            TrStr _strtmp_t1116 = _tr_str_wrap(_tr_str_slice(_tr_strz(r), 0LL, 2LL));
            _tr_str_release(m_flags);
            m_flags = _strtmp_t1116;
            /* pass */
            TrStr r2 = _tr_str_wrap(_tr_str_slice(_tr_strz(r), 3LL, _tr_strlen(_tr_strz(r))));
            /* pass */
            __auto_type sp1 = ({ char* _t1117 = strstr(_tr_strz(r2), _tr_strz(_tr_str_lit(" "))); _t1117 ? (long long)(_t1117 - (_tr_strz(r2))) : -1LL; });
            /* pass */
            m_ndef = ({ TrStr _at_t1118 = (_tr_str_wrap(_tr_str_slice(_tr_strz(r2), 0LL, sp1))); __auto_type _wr = (_to_int(_at_t1118)); _tr_str_release(_at_t1118); _wr; });
            /* pass */
            ...
            /* pass */
            TrStr _strtmp_t1119 = List_TrStr_get(rn, 0LL);
            _tr_str_release(m_ret);
            m_ret = _strtmp_t1119;
            /* pass */
            TrStr _strtmp_t1120 = List_TrStr_get(rn, 1LL);
            _tr_str_release(m_name);
            m_name = _strtmp_t1120;
            /* pass */
            TrStr _strtmp_t1121 = _tr_str_lit("");
            _tr_str_release(m_qual);
            m_qual = _strtmp_t1121;
            /* pass */
            if ((rn->len > 2LL)) {
                /* pass */
                TrStr _strtmp_t1122 = List_TrStr_get(rn, 2LL);
                _tr_str_release(m_qual);
                m_qual = _strtmp_t1122;
            }
            /* pass */
            TrStr _strtmp_t1123 = _tr_str_lit("method");
            _tr_str_release(mode);
            mode = _strtmp_t1123;
            /* pass */
            params = (void*)List_TrStr_new();
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("FUNC ")))) {
            ...
            /* pass */
            __auto_type sp1 = ({ char* _t1124 = strstr(_tr_strz(r), _tr_strz(_tr_str_lit(" "))); _t1124 ? (long long)(_t1124 - (_tr_strz(r))) : -1LL; });
            /* pass */
            m_ndef = ({ TrStr _at_t1125 = (_tr_str_wrap(_tr_str_slice(_tr_strz(r), 0LL, sp1))); __auto_type _wr = (_to_int(_at_t1125)); _tr_str_release(_at_t1125); _wr; });
            /* pass */
            TrStr r3 = _tr_str_wrap(_tr_str_slice(_tr_strz(r), (sp1 + 1LL), _tr_strlen(_tr_strz(r))));
            /* pass */
            List_TrStr* rn = _tr_str_split(_tr_strz(r3), _tr_strz(_tr_str_lit("|")));
            /* pass */
            TrStr _strtmp_t1126 = List_TrStr_get(rn, 0LL);
            _tr_str_release(m_ret);
            m_ret = _strtmp_t1126;
            /* pass */
            TrStr _strtmp_t1127 = List_TrStr_get(rn, 1LL);
            _tr_str_release(m_name);
            m_name = _strtmp_t1127;
            /* pass */
            TrStr _strtmp_t1128 = _tr_str_lit("");
            _tr_str_release(m_qual);
            m_qual = _strtmp_t1128;
            /* pass */
            TrStr _strtmp_t1129 = _tr_str_lit("..");
            _tr_str_release(m_flags);
            m_flags = _strtmp_t1129;
            /* pass */
            TrStr _strtmp_t1130 = _tr_str_lit("func");
            _tr_str_release(mode);
            mode = _strtmp_t1130;
            /* pass */
            params = (void*)List_TrStr_new();
        ...
        if (_tr_str_starts_with(_tr_strz(line), _tr_strz(_tr_str_lit("PARAM ")))) {
            /* pass */
            ({ TrStr _wt_t1131 = (_tr_str_wrap(_tr_str_slice(_tr_strz(line), 6LL, _tr_strlen(_tr_strz(line))))); TrStr _at_t1132 = (_tr_str_wrap(_tr_str_slice(_tr_strz(line), 6LL, _tr_strlen(_tr_strz(line))))); List_TrStr_append(params, _at_t1132); _tr_str_release(_wt_t1131); _tr_str_release(_at_t1132); });
            /* pass */
            continue;
        }
        /* pass */
        if ((((strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("EMETHOD"))) == 0) || (strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("ECTOR"))) == 0)) || (strcmp(_tr_strz(line), _tr_strz(_tr_str_lit("EFUNC"))) == 0))) {
            /* pass */
            bool is_static = ({ TrStr _wt_t1133 = (_tr_str_wrap(_tr_str_slice(_tr_strz(m_flags), 0LL, 1LL))); __auto_type _wr = ((strcmp(_wt_t1133.data, _tr_strz(_tr_str_lit("s"))) == 0)); _tr_str_release(_wt_t1133); _wr; });
            /* pass */
            bool is_const = ({ TrStr _wt_t1134 = (_tr_str_wrap(_tr_str_slice(_tr_strz(m_flags), 1LL, 2LL))); __auto_type _wr = ((strcmp(_wt_t1134.data, _tr_strz(_tr_str_lit("c"))) == 0)); _tr_str_release(_wt_t1134); _wr; });
            /* pass */
            TrStr m_sym = _tr_str_retain(m_name);
            /* pass */
            if (({ TrStr _wt_t1135 = (_tr_str_wrap(_tr_str_slice(_tr_strz(m_name), 0LL, 8LL))); __auto_type _wr = ((((strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("ctor"))) != 0) && (_tr_strlen(_tr_strz(m_name)) >= 8LL)) && (strcmp(_wt_t1135.data, _tr_strz(_tr_str_lit("operator"))) == 0))); _tr_str_release(_wt_t1135); _wr; })) {
                /* pass */
                TrStr _strtmp_t1136 = _cpp_op_name(m_name, params->len, (strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("method"))) == 0));
            ...
            /* pass */
            bool has_dep = ((({ char* _t1139 = strstr(_tr_strz(m_ret), _tr_strz(_tr_str_lit("type-parameter"))); _t1139 ? (long long)(_t1139 - (_tr_strz(m_ret))) : -1LL; }) >= 0LL) || (({ char* _t1140 = strstr(_tr_strz(m_ret), _tr_strz(_tr_str_lit("~d~"))); _t1140 ? (long long)(_t1140 - (_tr_strz(m_ret))) : -1LL; }) >= 0LL));
            /* pass */
            long long pj = 0LL;
            /* pass */
            while ((pj < params->len)) {
                ...
                /* pass */
                if (((({ char* _t1141 = strstr(_tr_strz(pvd), _tr_strz(_tr_str_lit("type-parameter"))); _t1141 ? (long long)(_t1141 - (_tr_strz(pvd))) : -1LL; }) >= 0LL) || (({ char* _t1142 = strstr(_tr_strz(pvd), _tr_strz(_tr_str_lit("~d~"))); _t1142 ? (long long)(_t1142 - (_tr_strz(pvd))) : -1LL; }) >= 0LL))) {
                    /* pass */
                    has_dep = true;
                }
                /* pass */
                if ((((strcmp(_tr_strz(m_name), _tr_strz(_tr_str_lit("operator()"))) == 0) && _tr_str_starts_with(_tr_strz(pvd), _tr_strz(_tr_str_lit("0~")))) && (({ char* _t1143 = strstr(_tr_strz(pvd), _tr_strz(_tr_str_lit("~u~"))); _t1143 ? (long long)(_t1143 - (_tr_strz(pvd))) : -1LL; }) >= 0LL))) {
                    /* pass */
                    has_dep = true;
                }
                /* pass */
            ...
            if (has_dep) {
                /* pass */
                TrStr _strtmp_t1144 = _tr_str_lit("");
                _tr_str_release(mode);
                mode = _strtmp_t1144;
                /* pass */
                continue;
            ...
            while ((fpi < params->len)) {
                /* pass */
                ({ TrStr _at_t1145 = (List_TrStr_get(params, fpi)); List_TrStr_append(full_params, _at_t1145); _tr_str_release(_at_t1145); });
                /* pass */
                fpi = (fpi + 1LL);
            }
            /* pass */
            ...
            while ((arity >= min_arity)) {
                ...
                while ((tti < arity)) {
                    /* pass */
                    ({ TrStr _at_t1146 = (List_TrStr_get(full_params, tti)); List_TrStr_append(tparams, _at_t1146); _tr_str_release(_at_t1146); });
                    /* pass */
                    tti = (tti + 1LL);
                }
                /* pass */
                ...
                if (((strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("method"))) == 0) && (!is_static))) {
                    ...
                    if (is_const) {
                        /* pass */
                        TrStr _strtmp_t1147 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("const ")), _tr_strz(cur_class_qual))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("* self"))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(shimp);
                        shimp = _strtmp_t1147;
                    } else {
                        /* pass */
                        TrStr _strtmp_t1148 = _tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("* self")));
                        _tr_str_release(shimp);
                        shimp = _strtmp_t1148;
                    }
                    /* pass */
                    TrStr _strtmp_t1149 = _tr_strx_concat(_tr_strz(_tr_str_lit("obj: ")), _tr_strz(cur_class));
                    _tr_str_release(trp);
                    trp = _strtmp_t1149;
                }
                /* pass */
                ...
                while ((pi < params->len)) {
                    ...
                    if ((bar->len > 1LL)) {
                        /* pass */
                        TrStr _strtmp_t1150 = List_TrStr_get(bar, 1LL);
                        _tr_str_release(pname);
                        pname = _strtmp_t1150;
                    }
                    /* pass */
                    if ((strcmp(_tr_strz(pname), _tr_strz(_tr_str_lit(""))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1151 = ({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(pi)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("a")), _cr.data); _tr_str_release(_cr); _cres; });
                        _tr_str_release(pname);
                        pname = _strtmp_t1151;
                    }
                    /* pass */
                    ...
                    if ((strcmp(_tr_strz(spname), _tr_strz(_tr_str_lit("self"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1152 = _tr_str_lit("self_");
                        _tr_str_release(spname);
                        spname = _strtmp_t1152;
                    }
                    /* pass */
                    ...
                    /* pass */
                    long long pdepth = ({ TrStr _at_t1153 = (List_TrStr_get(d4, 0LL)); __auto_type _wr = (_to_int(_at_t1153)); _tr_str_release(_at_t1153); _wr; });
                    /* pass */
                    ...
                    if ((strcmp(_tr_strz(pcat), _tr_strz(_tr_str_lit("p"))) == 0)) {
                        ...
                        if ((pdepth == 0LL)) {
                            /* pass */
                            TrStr _strtmp_t1154 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cpp), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1154;
                            /* pass */
                            TrStr _strtmp_t1155 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1155;
                            /* pass */
                            TrStr _strtmp_t1156 = _tr_str_retain(pdet);
                            _tr_str_release(trt);
                            trt = _strtmp_t1156;
                        } else if (((strcmp(_tr_strz(prefk), _tr_strz(_tr_str_lit("2"))) == 0) && (pdepth == 1LL))) {
                            /* pass */
                            TrStr _strtmp_t1157 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cpp), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1157;
                            /* pass */
                            TrStr _strtmp_t1158 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1158;
                            /* pass */
                            TrStr _strtmp_t1159 = _tr_str_retain(pdet);
                            _tr_str_release(trt);
                            trt = _strtmp_t1159;
                        } else {
                            /* pass */
                            TrStr _strtmp_t1160 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cpp), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (_stars(pdepth)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1160;
                            /* pass */
                            if (pref) {
                                /* pass */
                                TrStr _strtmp_t1161 = _tr_strx_concat(_tr_strz(_tr_str_lit("*")), _tr_strz(spname));
                                _tr_str_release(fw);
                                fw = _strtmp_t1161;
                            } else {
                                /* pass */
                                TrStr _strtmp_t1162 = _tr_str_retain(spname);
                                _tr_str_release(fw);
                                fw = _strtmp_t1162;
                            }
                            /* pass */
                            TrStr _strtmp_t1163 = _ptr_wrap(pdet, pdepth);
                            _tr_str_release(trt);
                            trt = _strtmp_t1163;
                        }
                        ...
                        if ((pdepth == 0LL)) {
                            /* pass */
                            TrStr _strtmp_t1164 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(espell), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1164;
                            /* pass */
                            TrStr _strtmp_t1165 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1165;
                            /* pass */
                            TrStr _strtmp_t1166 = _tr_str_retain(ealias);
                            _tr_str_release(trt);
                            trt = _strtmp_t1166;
                        } else if (((strcmp(_tr_strz(prefk), _tr_strz(_tr_str_lit("2"))) == 0) && (pdepth == 1LL))) {
                            /* pass */
                            TrStr _strtmp_t1167 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(espell), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1167;
                            /* pass */
                            TrStr _strtmp_t1168 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1168;
                            /* pass */
                            TrStr _strtmp_t1169 = _tr_str_retain(ealias);
                            _tr_str_release(trt);
                            trt = _strtmp_t1169;
                        } else {
                            /* pass */
                            TrStr _strtmp_t1170 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(espell), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (_stars(pdepth)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1170;
                            /* pass */
                            if (pref) {
                                /* pass */
                                TrStr _strtmp_t1171 = _tr_strx_concat(_tr_strz(_tr_str_lit("*")), _tr_strz(spname));
                                _tr_str_release(fw);
                                fw = _strtmp_t1171;
                            } else {
                                /* pass */
                            ...
                            /* pass */
                            TrStr _strtmp_t1173 = _ptr_wrap(ealias, pdepth);
                            _tr_str_release(trt);
                            trt = _strtmp_t1173;
                        }
                    } else if (((strcmp(_tr_strz(pcat), _tr_strz(_tr_str_lit("s"))) == 0) && (strcmp(_tr_strz(pdet), _tr_strz(_tr_str_lit("string"))) == 0))) {
                        /* pass */
                        TrStr _strtmp_t1174 = _tr_strx_concat(_tr_strz(_tr_str_lit("const char* ")), _tr_strz(spname));
                        _tr_str_release(sc);
                        sc = _strtmp_t1174;
                        /* pass */
                        TrStr _strtmp_t1175 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("std::string(")), _tr_strz(spname))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(fw);
                        fw = _strtmp_t1175;
                        /* pass */
                        TrStr _strtmp_t1176 = _tr_str_lit("Pointer[char]");
                        _tr_str_release(trt);
                        trt = _strtmp_t1176;
                    } else if ((strcmp(_tr_strz(pcat), _tr_strz(_tr_str_lit("f"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1177 = _tr_strx_concat(_tr_strz(_tr_str_lit("void* ")), _tr_strz(spname));
                        _tr_str_release(sc);
                        sc = _strtmp_t1177;
                        /* pass */
                        TrStr _strtmp_t1178 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_fnptr_cast(pdet)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("(")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(fw);
                        fw = _strtmp_t1178;
                        /* pass */
                        TrStr _strtmp_t1179 = _tr_str_lit("Pointer[void]");
                        _tr_str_release(trt);
                        trt = _strtmp_t1179;
                        ...
                        /* pass */
                        TrStr _strtmp_t1180 = ({ TrStr _cl = (({ TrStr _cr = (_stars(nd)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("void ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(sc);
                        sc = _strtmp_t1180;
                        /* pass */
                        if (pref) {
                        ...
                        /* pass */
                        TrStr _strtmp_t1183 = _ptr_wrap(_tr_str_lit("void"), nd);
                        _tr_str_release(trt);
                        trt = _strtmp_t1183;
                        ...
                        if ((_tr_dict_contains(value_structs, _tr_strz(seg)) && (pdepth == 0LL))) {
                            /* pass */
                            TrStr _strtmp_t1184 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(pdet), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1184;
                            /* pass */
                            TrStr _strtmp_t1185 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1185;
                            /* pass */
                            TrStr _strtmp_t1186 = _tr_str_retain(seg);
                            _tr_str_release(trt);
                            trt = _strtmp_t1186;
                        } else {
                            /* pass */
                            ...
                            /* pass */
                            TrStr _strtmp_t1187 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_cpp_qual(pdet, class_qual)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_stars(nd)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sc);
                            sc = _strtmp_t1187;
                            /* pass */
                            if ((pdepth == 0LL)) {
                                /* pass */
                                TrStr _strtmp_t1188 = _tr_strx_concat(_tr_strz(_tr_str_lit("*")), _tr_strz(spname));
                                _tr_str_release(fw);
                                fw = _strtmp_t1188;
                            } else if (pref) {
                                /* pass */
                                TrStr _strtmp_t1189 = _tr_strx_concat(_tr_strz(_tr_str_lit("*")), _tr_strz(spname));
                                _tr_str_release(fw);
                                fw = _strtmp_t1189;
                            } else {
                                /* pass */
                            ...
                            /* pass */
                            TrStr _strtmp_t1191 = _cpp_opaque_handle(pdet, nd, class_names, value_structs, seen, opaque);
                            _tr_str_release(trt);
                            trt = _strtmp_t1191;
                        }
                        ...
                        /* pass */
                        TrStr _strtmp_t1192 = ({ TrStr _cl = (({ TrStr _cr = (_stars(nd)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("void ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(sc);
                        sc = _strtmp_t1192;
                        /* pass */
                        ...
                        fw = _strtmp_t1193;
                        /* pass */
                        TrStr _strtmp_t1194 = _ptr_wrap(_tr_str_lit("void"), nd);
                        _tr_str_release(trt);
                        trt = _strtmp_t1194;
                    } else {
                        /* pass */
                        ...
                        /* pass */
                        TrStr _strtmp_t1195 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(pdet), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (_stars(nd)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(spname)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(sc);
                        sc = _strtmp_t1195;
                        /* pass */
                        if ((pdepth == 0LL)) {
                            ...
                            /* pass */
                            TrStr _strtmp_t1198 = _tr_str_retain(spname);
                            _tr_str_release(fw);
                            fw = _strtmp_t1198;
                        }
                        /* pass */
                        TrStr _strtmp_t1199 = _cpp_opaque_handle(pdet, nd, class_names, value_structs, seen, opaque);
                        _tr_str_release(trt);
                        trt = _strtmp_t1199;
                    }
                    /* pass */
                    if ((strcmp(_tr_strz(shimp), _tr_strz(_tr_str_lit(""))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1200 = _tr_str_retain(sc);
                        _tr_str_release(shimp);
                        shimp = _strtmp_t1200;
                    } else {
                        /* pass */
                        TrStr _strtmp_t1201 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(shimp), _tr_strz(_tr_str_lit(", ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sc)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(shimp);
                        shimp = _strtmp_t1201;
                    }
                    /* pass */
                    if ((strcmp(_tr_strz(fargs), _tr_strz(_tr_str_lit(""))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1202 = _tr_str_retain(fw);
                        _tr_str_release(fargs);
                        fargs = _strtmp_t1202;
                    } else {
                        /* pass */
                        TrStr _strtmp_t1203 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(fargs), _tr_strz(_tr_str_lit(", ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fw)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(fargs);
                        fargs = _strtmp_t1203;
                    }
                    /* pass */
                    if ((strcmp(_tr_strz(trp), _tr_strz(_tr_str_lit(""))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1204 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(tpname), _tr_strz(_tr_str_lit(": ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(trt)); _tr_str_release(_cl); _cres; });
                        _tr_str_release(trp);
                        trp = _strtmp_t1204;
                    } else {
                        /* pass */
                ...
                if ((strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("ctor"))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t1206 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("new ")), _tr_strz(cur_class_qual))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
                    ...
                    if ((strcmp(_tr_strz(m_qual), _tr_strz(_tr_str_lit(""))) != 0)) {
                        /* pass */
                        TrStr _strtmp_t1207 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(m_qual), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m_name)); _tr_str_release(_cl); _cres; });
                    ...
                    if (is_static) {
                        /* pass */
                        TrStr _strtmp_t1208 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("::")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(call);
                        call = _strtmp_t1208;
                    } else {
                        /* pass */
                        TrStr _strtmp_t1209 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("self->")), _tr_strz(mcall))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(call);
                        call = _strtmp_t1209;
                    }
                } else {
                ...
                if ((strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("ctor"))) == 0)) {
                    /* pass */
                    TrStr sym = ({ TrStr _at_t1212 = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_new")))); __auto_type _wr = (_uniq_sym(_at_t1212, sym_used)); _tr_str_release(_at_t1212); _wr; });
                    /* pass */
                    ({ TrStr _at_t1213 = (_tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("*")))); TrStr _at_t1214 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(call))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t1215 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cur_class_qual), _tr_strz(_tr_str_lit("* ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(shimp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(") { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1213, _at_t1214)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1215); _tr_str_release(_at_t1213); _tr_str_release(_at_t1214); _tr_str_release(_sbt_t1215); });
                    /* pass */
                    ({ TrStr _sbt_t1216 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("    def ")), _tr_strz(sym))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(trp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(") -> "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur_class)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(decls, _sbt_t1216); _tr_str_release(_sbt_t1216); });
                    /* pass */
                    n_fns = (n_fns + 1LL);
                    _tr_str_release(sym);
                } else {
                    ...
                    if ((strcmp(_tr_strz(mode), _tr_strz(_tr_str_lit("method"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t1217 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(class_pfx), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m_sym)); _tr_str_release(_cl); _cres; });
                        ...
                        if ((strcmp(_tr_strz(ns_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                            /* pass */
                            TrStr _strtmp_t1218 = _tr_strx_concat(_tr_strz(_tr_str_lit("g_")), _tr_strz(m_sym));
                            _tr_str_release(sym0);
                            sym0 = _strtmp_t1218;
                        } else {
                            /* pass */
                            TrStr _strtmp_t1219 = ({ TrStr _cl = (({ TrStr _cl = (_ns_us(ns_path)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m_sym)); _tr_str_release(_cl); _cres; });
                            _tr_str_release(sym0);
                            sym0 = _strtmp_t1219;
                        }
                    }
                    ...
                    /* pass */
                    ({ TrStr _at_t1220 = (List_TrStr_get(ri, 0LL)); TrStr _at_t1221 = (List_TrStr_get(ri, 1LL)); TrStr _sbt_t1222 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (List_TrStr_get(ri, 0LL)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sym)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(shimp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(") { "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_shim_body(_at_t1220, _at_t1221)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(shim, _sbt_t1222); _tr_str_release(_at_t1220); _tr_str_release(_at_t1221); _tr_str_release(_sbt_t1222); });
                    /* pass */
                    ...
                    if ((strcmp(_tr_strz(List_TrStr_get(ri, 2LL)), _tr_strz(_tr_str_lit(""))) != 0)) {
                        /* pass */
                        TrStr _strtmp_t1223 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit(" -> ")))); TrStr _cr = (List_TrStr_get(ri, 2LL)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                        _tr_str_release(d);
                        d = _strtmp_t1223;
                    }
                    /* pass */
                    ({ TrStr _sbt_t1224 = (_tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(decls, _sbt_t1224); _tr_str_release(_sbt_t1224); });
                    /* pass */
                    n_fns = (n_fns + 1LL);
                    _tr_str_release(sym0);
                    _tr_str_release(sym);
            ...
            /* pass */
            TrStr _strtmp_t1225 = _tr_str_lit("");
            _tr_str_release(mode);
            mode = _strtmp_t1225;
            /* pass */
            continue;
    ...
    /* pass */
    if (({ TrStr _wt_t1226 = (_tr_str_wrap(_tr_str_slice(_tr_strz(base), (_tr_strlen(_tr_strz(base)) - 3LL), _tr_strlen(_tr_strz(base))))); __auto_type _wr = (((_tr_strlen(_tr_strz(base)) > 3LL) && (strcmp(_wt_t1226.data, _tr_strz(_tr_str_lit(".tr"))) == 0))); _tr_str_release(_wt_t1226); _wr; })) {
        /* pass */
        TrStr _strtmp_t1227 = _tr_str_wrap(_tr_str_slice(_tr_strz(base), 0LL, (_tr_strlen(_tr_strz(base)) - 3LL)));
        _tr_str_release(base);
        base = _strtmp_t1227;
    }
    /* pass */
    ...
    StringBuilder* sb = StringBuilder_init(4096LL);
    /* pass */
    ({ TrStr _sbt_t1228 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# Auto-generated C++ FFI bindings for ")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" (tauraro-bindgen -h cpp).\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t1228); _tr_str_release(_sbt_t1228); });
    /* pass */
    ({ TrStr _sbt_t1229 = (({ TrStr _cl = (({ TrStr _cr = (_basename(shim_name)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-shim: ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t1229); _tr_str_release(_sbt_t1229); });
    /* pass */
    StringBuilder_append(sb, _tr_str_lit("# tauraro-cpp-lib: stdc++\n"));
    /* pass */
    if ((strcmp(_tr_strz(pkglibs), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t1230 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-linkflags:")), _tr_strz(pkglibs))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t1230); _tr_str_release(_sbt_t1230); });
    }
    /* pass */
    if ((strcmp(_tr_strz(shim_cflags), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t1231 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# tauraro-cpp-cflags: ")), _tr_strz(shim_cflags))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t1231); _tr_str_release(_sbt_t1231); });
    }
    /* pass */
    ({ TrStr _sbt_t1232 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("# (opt out with --no-auto-cpp, then: c++ -c ")), _tr_strz(shim_name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" ; tauraroc app.tr --link "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(base)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_shim.o -lstdc++)\n\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t1232); _tr_str_release(_sbt_t1232); });
    /* pass */
    ...
    /* pass */
    TrStr fb = ({ TrStr _at_t1233 = (_tr_strx_concat(_tr_strz(os_), _tr_strz(ds2))); __auto_type _wr = (_opaque_fallbacks(_at_t1233, defined_names)); _tr_str_release(_at_t1233); _wr; });
    /* pass */
    if ((strcmp(_tr_strz(fb), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        StringBuilder_append(sb, fb);
    ...
    if ((strcmp(_tr_strz(os_), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t1234 = (_tr_strx_concat(_tr_strz(os_), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(sb, _sbt_t1234); _tr_str_release(_sbt_t1234); });
    }
    /* pass */
    if ((strcmp(_tr_strz(cs), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _sbt_t1235 = (_tr_strx_concat(_tr_strz(cs), _tr_strz(_tr_str_lit("\n")))); StringBuilder_append(sb, _sbt_t1235); _tr_str_release(_sbt_t1235); });
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t1236 = (StringObj_as_str(StringBuilder_to_string(sb))); write_file(out, _at_t1236); _tr_str_release(_at_t1236); });
    /* pass */
    StringBuilder* sh = StringBuilder_init(4096LL);
    /* pass */
    ({ TrStr _sbt_t1237 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("// Auto-generated C++ -> C shim for ")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" (tauraro-bindgen -h cpp).\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sh, _sbt_t1237); _tr_str_release(_sbt_t1237); });
    /* pass */
    ({ TrStr _sbt_t1238 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("// Compile:  c++ -c ")), _tr_strz(shim_name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sh, _sbt_t1238); _tr_str_release(_sbt_t1238); });
    /* pass */
    ({ TrStr _sbt_t1239 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("#include \"")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\"\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sh, _sbt_t1239); _tr_str_release(_sbt_t1239); });
    /* pass */
    ...
    /* pass */
    ({ TrStr _sbt_t1240 = (StringObj_as_str(StringBuilder_to_string(usings))); StringBuilder_append(sh, _sbt_t1240); _tr_str_release(_sbt_t1240); });
    /* pass */
    ...
    /* pass */
    ({ TrStr _sbt_t1241 = (StringObj_as_str(StringBuilder_to_string(shim))); StringBuilder_append(sh, _sbt_t1241); _tr_str_release(_sbt_t1241); });
    /* pass */
    StringBuilder_append(sh, _tr_str_lit("}\n"));
    /* pass */
    ({ TrStr _at_t1242 = (StringObj_as_str(StringBuilder_to_string(sh))); write_file(shim_name, _at_t1242); _tr_str_release(_at_t1242); });
    /* pass */
...
__attribute__((hot)) TrStr _cpp_detect_include_dirs(TrStr cc) {
    ...
    /* pass */
    ({ TrStr _aet_t1243 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" -x c++ -E -v _cxx_empty.cpp > _cxx_pp.txt 2> _cxx_inc.txt")))); _tr_system(_aet_t1243.data); _tr_str_release(_aet_t1243); });
    /* pass */
    TrStr out = _tr_str_lit("");
    /* pass */
    if (file_exists(_tr_str_lit("_cxx_inc.txt"))) {
        ...
        while ((li < lines->len)) {
            /* pass */
            TrStr ln = ({ TrStr _at_t1244 = (List_TrStr_get(lines, li)); __auto_type _wr = (_rstrip_cr(_at_t1244)); _tr_str_release(_at_t1244); _wr; });
            /* pass */
            li = (li + 1LL);
            /* pass */
            if ((({ char* _t1245 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("search starts here"))); _t1245 ? (long long)(_t1245 - (_tr_strz(ln))) : -1LL; }) >= 0LL)) {
                /* pass */
                collecting = true;
                /* pass */
                continue;
            ...
            /* pass */
            if ((({ char* _t1246 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("End of search list"))); _t1246 ? (long long)(_t1246 - (_tr_strz(ln))) : -1LL; }) >= 0LL)) {
                /* pass */
                collecting = false;
                /* pass */
                continue;
            ...
            if (collecting) {
                ...
                TrStr d = _lstrip(ln);
                /* pass */
                __auto_type fpos = ({ char* _t1247 = strstr(_tr_strz(d), _tr_strz(_tr_str_lit(" (framework directory)"))); _t1247 ? (long long)(_t1247 - (_tr_strz(d))) : -1LL; });
                /* pass */
                if ((fpos >= 0LL)) {
                    /* pass */
                    TrStr _strtmp_t1248 = _tr_str_wrap(_tr_str_slice(_tr_strz(d), 0LL, fpos));
                    _tr_str_release(d);
                    d = _strtmp_t1248;
                }
                /* pass */
                if ((strcmp(_tr_strz(d), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t1249 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(out), _tr_strz(_tr_str_lit(" -I\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(d)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                    _tr_str_release(out);
                    out = _strtmp_t1249;
                }
            }
...
__attribute__((hot)) TrStr _cpp_std_flag(TrStr extra) {
    /* pass */
    if ((({ char* _t1250 = strstr(_tr_strz(extra), _tr_strz(_tr_str_lit("-std="))); _t1250 ? (long long)(_t1250 - (_tr_strz(extra))) : -1LL; }) >= 0LL)) {
        /* pass */
        return _tr_str_lit("");
    }
    /* pass */
...
__attribute__((hot)) long long _cpp_fatal_count(TrStr diag) {
    ...
    while ((li < lines->len)) {
        /* pass */
        TrStr ln = ({ TrStr _at_t1251 = (List_TrStr_get(lines, li)); __auto_type _wr = (_rstrip_cr(_at_t1251)); _tr_str_release(_at_t1251); _wr; });
        /* pass */
        li = (li + 1LL);
        /* pass */
        if ((({ char* _t1252 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("DIAGERR "))); _t1252 ? (long long)(_t1252 - (_tr_strz(ln))) : -1LL; }) == 0LL)) {
            /* pass */
            List_TrStr* parts = _tr_str_split(_tr_strz(ln), _tr_strz(_tr_str_lit(" ")));
            /* pass */
            if ((parts->len >= 3LL)) {
                /* pass */
                f = ({ TrStr _at_t1253 = (List_TrStr_get(parts, 2LL)); __auto_type _wr = (_to_int(_at_t1253)); _tr_str_release(_at_t1253); _wr; });
            }
        }
        _tr_str_release(ln);
    }
...
__attribute__((hot)) void _cpp_print_diag(TrStr diag) {
    ...
    while ((li < lines->len)) {
        /* pass */
        TrStr ln = ({ TrStr _at_t1254 = (List_TrStr_get(lines, li)); __auto_type _wr = (_rstrip_cr(_at_t1254)); _tr_str_release(_at_t1254); _wr; });
        /* pass */
        li = (li + 1LL);
        /* pass */
        if (((({ char* _t1255 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("DIAG "))); _t1255 ? (long long)(_t1255 - (_tr_strz(ln))) : -1LL; }) == 0LL) && (shown < 12LL))) {
            /* pass */
...
__attribute__((hot)) bool _cpp_ir_is_empty(TrStr ir) {
    ...
    while ((li < lines->len)) {
        /* pass */
        if (({ TrStr _at_t1256 = (List_TrStr_get(lines, li)); __auto_type _wr = ((strcmp(_tr_strz(_rstrip_cr(_at_t1256)), _tr_strz(_tr_str_lit(""))) != 0)); _tr_str_release(_at_t1256); _wr; })) {
            /* pass */
            List_TrStr_free(lines);
            return false;
        }
...
__attribute__((hot)) bool _is_expr_proxy_spec(TrStr s) {
    /* pass */
    __auto_type lt = ({ char* _t1257 = strstr(_tr_strz(s), _tr_strz(_tr_str_lit("<"))); _t1257 ? (long long)(_t1257 - (_tr_strz(s))) : -1LL; });
    /* pass */
    if ((lt < 0LL)) {
        /* pass */
        return false;
    ...
    /* pass */
    if ((({ char* _t1258 = strstr(_tr_strz(inner), _tr_strz(_tr_str_lit("<"))); _t1258 ? (long long)(_t1258 - (_tr_strz(inner))) : -1LL; }) < 0LL)) {
        /* pass */
        _tr_str_release(inner);
        return false;
    }
...
__attribute__((hot)) List_TrStr* _collect_specs(TrStr ir) {
    ...
    while ((i < lines->len)) {
        /* pass */
        TrStr ln = ({ TrStr _at_t1259 = (List_TrStr_get(lines, i)); __auto_type _wr = (_rstrip_cr(_at_t1259)); _tr_str_release(_at_t1259); _wr; });
        /* pass */
        i = (i + 1LL);
        /* pass */
        if (_tr_str_starts_with(_tr_strz(ln), _tr_strz(_tr_str_lit("TDSPEC ")))) {
            ...
            /* pass */
            if ((((({ char* _t1260 = strstr(_tr_strz(td), _tr_strz(_tr_str_lit("<"))); _t1260 ? (long long)(_t1260 - (_tr_strz(td))) : -1LL; }) >= 0LL) && (!_is_expr_proxy_spec(td))) && (!_tr_dict_contains(seen, _tr_strz(td))))) {
                /* pass */
        ...
        /* pass */
        __auto_type p = ({ char* _t1261 = strstr(_tr_strz(ln), _tr_strz(_tr_str_lit("~r~"))); _t1261 ? (long long)(_t1261 - (_tr_strz(ln))) : -1LL; });
        /* pass */
        if ((p < 0LL)) {
            /* pass */
            continue;
        ...
        /* pass */
        __auto_type bar = ({ char* _t1262 = strstr(_tr_strz(rest), _tr_strz(_tr_str_lit("|"))); _t1262 ? (long long)(_t1262 - (_tr_strz(rest))) : -1LL; });
        /* pass */
        if ((bar >= 0LL)) {
            /* pass */
            TrStr _strtmp_t1263 = _tr_str_wrap(_tr_str_slice(_tr_strz(rest), 0LL, bar));
            _tr_str_release(detail);
            detail = _strtmp_t1263;
        }
        /* pass */
        if ((((({ char* _t1264 = strstr(_tr_strz(detail), _tr_strz(_tr_str_lit("<"))); _t1264 ? (long long)(_t1264 - (_tr_strz(detail))) : -1LL; }) >= 0LL) && (!_is_expr_proxy_spec(detail))) && (!_tr_dict_contains(seen, _tr_strz(detail))))) {
            /* pass */
...
__attribute__((hot)) void run_bindgen_cpp(TrStr header, TrStr out, TrStr cc, TrStr extra, TrStr pkglibs) {
    ...
    /* pass */
    ({ TrStr _at_t1265 = (_cxxwalk_src()); write_file(_tr_str_lit("_cxxwalk.c"), _at_t1265); _tr_str_release(_at_t1265); });
    /* pass */
    long long rc = ({ TrStr _aet_t1266 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" _cxxwalk.c -o _cxxwalk.exe -lclang 2>_cxx_err.txt")))); __auto_type _wr = (_tr_system(_aet_t1266.data)); _tr_str_release(_aet_t1266); _wr; });
    /* pass */
    ...
    /* pass */
    if (({ TrStr _at_t1270 = (read_file(_tr_str_lit("_cxx.ir"))); __auto_type _wr = (((!file_exists(_tr_str_lit("_cxx.ir"))) || _cpp_ir_is_empty(_at_t1270))); _tr_str_release(_at_t1270); _wr; })) {
        /* pass */
        ({ printf("%s", _tr_strz(_tr_strx_concat(_tr_strz(_tr_str_lit("bindgen: no bindable declarations found in ")), _tr_strz(header)))); printf("\n"); });
        /* pass */
        if ((({ char* _t1271 = strstr(_tr_strz(diag), _tr_strz(_tr_str_lit("DIAG "))); _t1271 ? (long long)(_t1271 - (_tr_strz(diag))) : -1LL; }) >= 0LL)) {
            /* pass */
    ...
    if ((specs->len > 0LL)) {
        ...
        /* pass */
        ({ TrStr _sbt_t1272 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("#include \"")), _tr_strz(header))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\"\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(fsb, _sbt_t1272); _tr_str_release(_sbt_t1272); });
        /* pass */
        long long si = 0LL;
        /* pass */
        while ((si < specs->len)) {
            /* pass */
            ({ TrStr _sbt_t1273 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(specs, si)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("template class ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(fsb, _sbt_t1273); _tr_str_release(_sbt_t1273); });
            /* pass */
            si = (si + 1LL);
        }
        /* pass */
        ({ TrStr _at_t1274 = (StringObj_as_str(StringBuilder_to_string(fsb))); write_file(_tr_str_lit("_cxx_force.cpp"), _at_t1274); _tr_str_release(_at_t1274); });
        /* pass */
        ({ TrStr _aet_t1275 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_local_exe(_tr_str_lit("_cxxwalk"))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" --inst _cxx_force.cpp "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(clang_args)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" > _cxx_inst.ir 2>> _cxx_diag.txt"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t1275.data); _tr_str_release(_aet_t1275); });
        /* pass */
        if (({ TrStr _at_t1276 = (read_file(_tr_str_lit("_cxx_inst.ir"))); __auto_type _wr = ((file_exists(_tr_str_lit("_cxx_inst.ir")) && (!_cpp_ir_is_empty(_at_t1276)))); _tr_str_release(_at_t1276); _wr; })) {
            /* pass */
            TrStr _strtmp_t1277 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(ir), _tr_strz(_tr_str_lit("\n")))); TrStr _cr = (read_file(_tr_str_lit("_cxx_inst.ir"))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
            _tr_str_release(ir);
            ir = _strtmp_t1277;
            /* pass */
            n_specs = specs->len;
    ...
    if ((strcmp(_tr_strz(extra), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t1278 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(shim_cflags), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(extra)); _tr_str_release(_cl); _cres; });
        _tr_str_release(shim_cflags);
        shim_cflags = _strtmp_t1278;
    }
    /* pass */
