...
__attribute__((hot)) bool LFunc_cur_terminated(LFunc* self) {
    /* pass */
    __auto_type _t2650 = ((LBlock*)List_ptr_get(self->blocks, self->cur))->term;
    if (_t2650.tag == LTerm_TUnset) {
        return false;
    } else if (1) {
...
__attribute__((hot)) TrStr LModule_resolve_method(LModule* self, TrStr cls, TrStr method) {
    ...
    while ((depth < 32LL)) {
        ...
        /* pass */
        TrStr _strtmp_t2652 = _tr_str_retain(((ClassLayout*)List_ptr_get(self->classes, ci))->base);
        _tr_str_release(cur);
        cur = _strtmp_t2652;
        /* pass */
        if (((((unsigned long long)(((char*)(_tr_strz(cur))))) == ((unsigned long long)(0LL))) || (strcmp(_tr_strz(cur), _tr_strz(_tr_str_lit(""))) == 0))) {
