...
int main() {
    ...
    // Simple program with no imports
    ...
    y = var_y_temp;
    var_result_temp_left = x;
    var_result_temp_right = y;
    var_result_temp = tauraro_value_new(); var_result_temp->type = TAURARO_INT; var_result_temp->data.int_val = tauraro_add_int(var_result_temp_left->data.int_val, var_result_temp_right->data.int_val);
    result = var_result_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("x =");
    arg_1 = x;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("y =");
    arg_1 = y;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("x + y =");
    arg_1 = result;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    return 0;
}
