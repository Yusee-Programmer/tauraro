...
int main(int argc, char** argv) {
    ...
    printf("%p\n", /* f-string: y = %g with args: ["y"] */);
    printf("%p\n", /* f-string: Name: %s with args: ["name"] */);
    printf("%p\n", /* f-string: Calculation: %lld * 2 = %lld with args: ["x", "(x * 2)"] */);
    /* unsupported statement */;
    printf("%s\n", "\n3. F-string with newline:");
    int64_t count = 5;
    printf("%p\n", /* f-string: Count is %lld\\nDone! with args: ["count"] */);
    printf("%s\n", "\n=== Tests Complete ===");
    return 0;
}
