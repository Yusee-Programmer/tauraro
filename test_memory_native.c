...
int main(int argc, char** argv) {
    ...
    int64_t result1 = calculate_sum(100);
    printf("%p\n", /* f-string: Sum of 0-99 = %lld with args: ["result1"] */);
    /* unsupported statement */;
    printf("%s\n", "\n2. Arena memory function:");
    int64_t result2 = calculate_factorial(10);
    printf("%p\n", /* f-string: Factorial of 10 = %lld with args: ["result2"] */);
    /* unsupported statement */;
    printf("%s\n", "\n3. Auto memory function:");
    int64_t result3 = fibonacci(20);
    printf("%p\n", /* f-string: Fibonacci(20) = %lld with args: ["result3"] */);
    /* unsupported statement */;
    printf("%s\n", "\n4. Using all decorated functions together:");
    int64_t sum_val = calculate_sum(50);
    int64_t fact_val = calculate_factorial(5);
    int64_t fib_val = fibonacci(10);
    printf("%p\n", /* f-string: Sum: %lld, Factorial: %lld, Fibonacci: %lld with args: ["sum_val", "fact_val", "fib_val"] */);
    printf("%s\n", "\n=== Tests Complete ===");
    return 0;
}
