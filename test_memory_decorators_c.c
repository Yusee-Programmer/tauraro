...
// Global variables
tauraro_value_t* result1;
tauraro_value_t* result2;
tauraro_value_t* result3;
tauraro_value_t* sum_val;
tauraro_value_t* fact_val;
tauraro_value_t* fib_val;

// Forward declarations for user-defined functions
tauraro_value_t* fibonacci(int argc, tauraro_value_t** argv);
tauraro_value_t* calculate_factorial(int argc, tauraro_value_t** argv);
tauraro_value_t* calculate_sum(int argc, tauraro_value_t** argv);

tauraro_value_t* fibonacci(int argc, tauraro_value_t** argv) {
    // Extract parameters
    int64_t n = (argc > 0) ? argv[0]->data.int_val : 0;

    // Local variables
    tauraro_value_t* temp_result = tauraro_value_new(); temp_result->type = TAURARO_NONE;
    if (tauraro_is_truthy(temp_result)) {
        tauraro_value_t* temp_result_1 = n;
        return temp_result;
    }
    tauraro_value_t* temp_result_2 = tauraro_value_new(); temp_result_2->type = TAURARO_INT; temp_result_2->data.int_val = 0;
    tauraro_value_t* a = temp_result;
    tauraro_value_t* temp_result_3 = tauraro_value_new(); temp_result_3->type = TAURARO_INT; temp_result_3->data.int_val = 1;
    tauraro_value_t* b = temp_result;
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 2;
    tauraro_value_t* arg_1_left = n;
    tauraro_value_t* arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_INT; arg_1_right->data.int_val = 1;
    tauraro_value_t* arg_1 = tauraro_add(arg_1_left, arg_1_right);
    tauraro_value_t* temp_result_4 = tauraro_range(2, (tauraro_value_t*[]){arg_0, arg_1});
    // For loop: i in temp_result
    tauraro_value_t* i_iter = temp_result;
    int i_index = 0;
    if (i_iter->type == TAURARO_LIST) {
        int iter_len = tauraro_len(1, (tauraro_value_t*[]){i_iter})-> data.int_val;
        for (i_index = 0; i_index < iter_len; i_index++) {
            tauraro_value_t* i = i_iter->data.list_val[i_index];
            ...
            tauraro_value_t* temp = temp_result;
            tauraro_value_t* temp_result_6 = b;
            a = temp_result;
            tauraro_value_t* temp_result_7 = temp;
            b = temp_result;
        }
    } else if (i_iter->type == TAURARO_RANGE) {
        ...
        for (int i = start; (step > 0) ? (i < stop) : (i > stop); i += step) {
            ...
            i->type = TAURARO_INT;
            i->data.int_val = i;
            tauraro_value_t* binop_left_1 = a;
            tauraro_value_t* binop_right_1 = b;
            tauraro_value_t* temp_result_8 = tauraro_add(binop_left, binop_right);
            temp = temp_result;
            tauraro_value_t* temp_result_9 = b;
            a = temp_result;
            tauraro_value_t* temp_result_10 = temp;
            b = temp_result;
        }
    } else {
        // TODO: Handle other iterable types (dict, tuple, set, string)
    }
    tauraro_value_t* temp_result_11 = b;
    return temp_result;
}
...
tauraro_value_t* calculate_factorial(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* temp_result = tauraro_value_new(); temp_result->type = TAURARO_NONE;
    if (tauraro_is_truthy(temp_result)) {
        tauraro_value_t* temp_result_1 = tauraro_value_new(); temp_result_1->type = TAURARO_INT; temp_result_1->data.int_val = 1;
        return temp_result;
    }
    ...
    tauraro_value_t* arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_INT; arg_1_right->data.int_val = 1;
    tauraro_value_t* arg_1 = tauraro_add(arg_1_left, arg_1_right);
    tauraro_value_t* temp_result_3 = tauraro_range(2, (tauraro_value_t*[]){arg_0, arg_1});
    // For loop: i in temp_result
    tauraro_value_t* i_iter = temp_result;
    int i_index = 0;
    if (i_iter->type == TAURARO_LIST) {
        ...
        for (i_index = 0; i_index < iter_len; i_index++) {
            tauraro_value_t* i = i_iter->data.list_val[i_index];
            tauraro_value_t* binop_left = result;
            tauraro_value_t* binop_right = i;
        ...
        for (int i = start; (step > 0) ? (i < stop) : (i > stop); i += step) {
            ...
            tauraro_value_t* binop_right_1 = i;
    ...
    tauraro_value_t* temp_result_6 = result;
    return temp_result;
}
...
tauraro_value_t* calculate_sum(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* total = temp_result;
    tauraro_value_t* arg_0 = n;
    tauraro_value_t* temp_result_1 = tauraro_range(1, (tauraro_value_t*[]){arg_0});
    // For loop: i in temp_result
    tauraro_value_t* i_iter = temp_result;
    int i_index = 0;
    if (i_iter->type == TAURARO_LIST) {
        ...
        for (i_index = 0; i_index < iter_len; i_index++) {
            tauraro_value_t* i = i_iter->data.list_val[i_index];
            tauraro_value_t* binop_left = total;
            tauraro_value_t* binop_right = i;
        ...
        for (int i = start; (step > 0) ? (i < stop) : (i > stop); i += step) {
            ...
            i->type = TAURARO_INT;
            i->data.int_val = i;
            tauraro_value_t* binop_left_1 = total;
            tauraro_value_t* binop_right_1 = i;
    ...
    tauraro_value_t* temp_result_4 = total;
    return temp_result;
}


int main() {
    tauraro_value_t* var_sum_val_temp = NULL;
    tauraro_value_t* arg_0_right_3 = NULL;
    tauraro_value_t* var_fact_val_temp = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* arg_0_right_5 = NULL;
    tauraro_value_t* sum_val = NULL;
    tauraro_value_t* arg_0_left_4 = NULL;
    tauraro_value_t* arg_0_right_1 = NULL;
    char* arg_0_right_2 = NULL;
    tauraro_value_t* var_result2_temp = NULL;
    char* arg_0_right_4 = NULL;
    tauraro_value_t* arg_0_result_4 = NULL;
    tauraro_value_t* arg_0_left_2 = NULL;
    tauraro_value_t* arg_0_result_5 = NULL;
    tauraro_value_t* var_result1_temp = NULL;
    tauraro_value_t* fact_val = NULL;
    tauraro_value_t* result2 = NULL;
    tauraro_value_t* fib_val = NULL;
    tauraro_value_t* var_result3_temp = NULL;
    tauraro_value_t* temp = NULL;
    char* arg_0_left_1 = NULL;
    tauraro_value_t* result1 = NULL;
    tauraro_value_t* result3 = NULL;
    tauraro_value_t* var_fib_val_temp = NULL;
    tauraro_value_t* arg_0_left_3 = NULL;
    tauraro_value_t* arg_0_result_1 = NULL;
    tauraro_value_t* arg_0_result_2 = NULL;
    tauraro_value_t* arg_0_left_5 = NULL;
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Memory Management Decorators C Test ===");
    ...
    temp = calculate_sum(1, (tauraro_value_t*[]){arg_0});
    var_result1_temp = temp; // Typed load
    result1 = var_result1_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Sum of 0-99 = ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = result1;
    ...
    temp = calculate_factorial(1, (tauraro_value_t*[]){arg_0});
    var_result2_temp = temp; // Typed load
    result2 = var_result2_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Factorial of 10 = ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = result2;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 20;
    temp = fibonacci(1, (tauraro_value_t*[]){arg_0});
    var_result3_temp = temp; // Typed load
    result3 = var_result3_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Fibonacci(20) = ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = result3;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    ...
    temp = calculate_sum(1, (tauraro_value_t*[]){arg_0});
    var_sum_val_temp = temp; // Typed load
    sum_val = var_sum_val_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 5;
    temp = calculate_factorial(1, (tauraro_value_t*[]){arg_0});
    var_fact_val_temp = temp; // Typed load
    fact_val = var_fact_val_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 10;
    temp = fibonacci(1, (tauraro_value_t*[]){arg_0});
    var_fib_val_temp = temp; // Typed load
    fib_val = var_fib_val_temp; // Typed as int
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Sum: ");
    arg_0_left_1 = arg_0;
    arg_0_right_1 = sum_val;
    arg_0_result_1 = tauraro_add(arg_0_left_1, arg_0_right_1);
    arg_0 = arg_0_result_1;
    arg_0_left_2 = arg_0;
    arg_0_right_2 = strdup(", Factorial: ");
    arg_0_result_2 = tauraro_add(arg_0_left_2, arg_0_right_2);
    arg_0 = arg_0_result_2;
    arg_0_left_3 = arg_0;
    arg_0_right_3 = fact_val;
    arg_0_result_3 = tauraro_add(arg_0_left_3, arg_0_right_3);
    arg_0 = arg_0_result_3;
    arg_0_left_4 = arg_0;
    arg_0_right_4 = strdup(", Fibonacci: ");
    arg_0_result_4 = tauraro_add(arg_0_left_4, arg_0_right_4);
    arg_0 = arg_0_result_4;
    arg_0_left_5 = arg_0;
    arg_0_right_5 = fib_val;
    arg_0_result_5 = tauraro_add(arg_0_left_5, arg_0_right_5);
    arg_0 = arg_0_result_5;
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n=== Tests Complete ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    return 0;
