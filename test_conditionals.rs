...
fn test_conditionals() -> () {
    ...
    if temp_result {
        let arg_0 = "x is less than y";
        println!("{}", arg_0);
    } else {
        let arg_0 = "x is not less than y";
        println!("{}", arg_0);
    }
    let temp_result = 15;
    let z = temp_result;
    ...
    let temp_result = comp_left - comp_right;
    if temp_result {
        let arg_0 = "z is small";
        println!("{}", arg_0);
    } else if temp_result {
        let comp_left = z;
        let comp_right = 20;
        let temp_result = comp_left - comp_right;
        let arg_0 = "z is medium";
        println!("{}", arg_0);
    } else {
        let arg_0 = "z is large";
        println!("{}", arg_0);
    }
    let arg_0 = "Conditionals test completed";
    println!("{}", arg_0);
}


fn main() {
    let temp = test_conditionals();
}
