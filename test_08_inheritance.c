...
void Dog__info(tauraro_value_t* self) {
    // Local variables
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Breed:");
...
void Animal__speak(tauraro_value_t* self) {
    // Local variables
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Animal");
    tauraro_value_t* arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    tauraro_value_t* arg_2 = tauraro_value_new(); arg_2->type = TAURARO_STRING; arg_2->data.str_val = strdup("makes a sound");
    tauraro_value_t* temp_result = tauraro_print(3, (tauraro_value_t*[]){arg_0, arg_1, arg_2});
}

void Dog____init__(tauraro_value_t* self, tauraro_value_t* name, tauraro_value_t* breed) {
    // Local variables
    tauraro_value_t* temp_result = name;
    tauraro_object_set_attr(self, "name", temp_result);
    tauraro_value_t* temp_result_1 = breed;
    tauraro_object_set_attr(self, "breed", temp_result);
}

void Dog__speak(tauraro_value_t* self) {
    // Local variables
    tauraro_value_t* arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Dog");
    tauraro_value_t* arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    tauraro_value_t* arg_2 = tauraro_value_new(); arg_2->type = TAURARO_STRING; arg_2->data.str_val = strdup("barks!");
    tauraro_value_t* temp_result = tauraro_print(3, (tauraro_value_t*[]){arg_0, arg_1, arg_2});
}

void Animal____init__(tauraro_value_t* self, tauraro_value_t* name) {
    // Local variables
    tauraro_value_t* temp_result = name;
    tauraro_object_set_attr(self, "name", temp_result);
}
...
int main() {
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 8: Inheritance ===");
