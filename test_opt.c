...
int main() {
    tauraro_value_t* var_s2_temp = NULL;
    tauraro_value_t* arg_2 = NULL;
    tauraro_value_t* var_c_temp_left = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* var_d_temp_right = NULL;
    tauraro_value_t* var_b_temp = NULL;
    tauraro_value_t* var_c_temp_right = NULL;
    tauraro_value_t* var_result_temp = NULL;
    tauraro_value_t* var_ftotal_temp = NULL;
    tauraro_value_t* var_d_temp_left = NULL;
    tauraro_value_t* var_s_temp = NULL;
    tauraro_value_t* temp = NULL;
    tauraro_value_t* var_c_temp = NULL;
    tauraro_value_t* var_total_temp = NULL;
    tauraro_value_t* var_a_temp = NULL;
    tauraro_value_t* var_d_temp = NULL;
    tauraro_value_t* var_result_temp_right = NULL;
    tauraro_value_t* var_result_temp_left = NULL;
    tauraro_value_t* arg_1 = NULL;
    // Quick test for all optimization types
    // Test 1: Integer (already working)
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Test 1: Integer");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_total_temp = tauraro_value_new(); var_total_temp->type = TAURARO_INT; var_total_temp->data.int_val = 0;
    total = var_total_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Integer result:");
    arg_1 = total;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    temp = tauraro_print(0, NULL);
    // Test 2: Float
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Test 2: Float");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_ftotal_temp = tauraro_value_new(); var_ftotal_temp->type = TAURARO_FLOAT; var_ftotal_temp->data.float_val = 0;
    ftotal = var_ftotal_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Float result:");
    arg_1 = ftotal;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    temp = tauraro_print(0, NULL);
    // Test 3: String
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Test 3: String");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_s_temp = tauraro_value_new(); var_s_temp->type = TAURARO_STRING; var_s_temp->data.str_val = strdup("Hello");
    s = var_s_temp;
    var_s2_temp = tauraro_value_new(); var_s2_temp->type = TAURARO_STRING; var_s2_temp->data.str_val = strdup(" World");
    s2 = var_s2_temp;
    var_result_temp_left = s;
    var_result_temp_right = s2;
    var_result_temp = tauraro_value_new(); var_result_temp->type = TAURARO_STRING; var_result_temp->data.str_val = tauraro_add_string(var_result_temp_left->data.str_val, var_result_temp_right->data.str_val);
    result = var_result_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("String result:");
    arg_1 = result;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    temp = tauraro_print(0, NULL);
    // Test 4: Mixed
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Test 4: Mixed");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_a_temp = tauraro_value_new(); var_a_temp->type = TAURARO_INT; var_a_temp->data.int_val = 10;
    a = var_a_temp;
    var_b_temp = tauraro_value_new(); var_b_temp->type = TAURARO_FLOAT; var_b_temp->data.float_val = 20.5;
    b = var_b_temp;
    var_c_temp_left = a;
    var_c_temp_right = a;
    var_c_temp = tauraro_value_new(); var_c_temp->type = TAURARO_INT; var_c_temp->data.int_val = tauraro_add_int(var_c_temp_left->data.int_val, var_c_temp_right->data.int_val);
    c = var_c_temp;
    var_d_temp_left = b;
    var_d_temp_right = b;
    var_d_temp = tauraro_value_new(); var_d_temp->type = TAURARO_FLOAT; var_d_temp->data.float_val = tauraro_add_float(var_d_temp_left->data.float_val, var_d_temp_right->data.float_val);
    d = var_d_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Mixed results:");
    arg_1 = c;
    arg_2 = d;
    temp = tauraro_print(3, (tauraro_value_t*[]){arg_0, arg_1, arg_2});
    return 0;
}
