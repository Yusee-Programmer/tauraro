...
fn test_dicts() -> () {
    let arg_0 = "=== Dictionary Test ===";
    println!("{}", arg_0);
    let temp_key_0 = "name";
    let temp_value_0 = "Alice";
    let temp_key_1 = "age";
    let temp_value_1 = "30";
    let temp_key_2 = "city";
    let temp_value_2 = "NYC";
    let mut temp_result = HashMap::new();
    temp_result.insert(temp_key_0, temp_value_0);
    temp_result.insert(temp_key_1, temp_value_1);
    temp_result.insert(temp_key_2, temp_value_2);
    let person = temp_result;
    let arg_0 = "Created dictionary";
    println!("{}", arg_0);
    let temp_result = 0;
    let name = temp_result;
    let arg_0 = "Name: ";
    println!("{}", arg_0);
    let arg_0 = name;
    println!("{}", arg_0);
    ...
    let arg_0 = age;
    println!("{}", arg_0);
    let arg_0 = "Dictionary test completed";
    println!("{}", arg_0);
}
