...
tauraro_value_t* pos;
tauraro_value_t* neg;
tauraro_value_t* str1;
tauraro_value_t* str2;

int main() {
    tauraro_value_t* var_y_temp = NULL;
    tauraro_value_t* arg_1_left_left = NULL;
    tauraro_value_t* arg_1_right = NULL;
    tauraro_value_t* var_t_temp = NULL;
    tauraro_value_t* var_pos_temp = NULL;
    tauraro_value_t* var_str2_temp = NULL;
    tauraro_value_t* arg_1_left = NULL;
    tauraro_value_t* var_x_temp = NULL;
    tauraro_value_t* arg_1_left_right = NULL;
    tauraro_value_t* arg_1 = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* var_neg_temp = NULL;
    tauraro_value_t* var_q_temp = NULL;
    tauraro_value_t* temp = NULL;
    tauraro_value_t* var_p_temp = NULL;
    tauraro_value_t* var_num_temp_left = NULL;
    tauraro_value_t* var_b_temp = NULL;
    tauraro_value_t* var_f_temp = NULL;
    tauraro_value_t* var_num_temp_right = NULL;
    tauraro_value_t* var_str1_temp = NULL;
    tauraro_value_t* var_a_temp = NULL;
    tauraro_value_t* var_num_temp = NULL;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Testing All Operators ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- Arithmetic Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_a_temp = tauraro_value_new(); var_a_temp->type = TAURARO_INT; var_a_temp->data.int_val = 10;
    a = var_a_temp;
    var_b_temp = tauraro_value_new(); var_b_temp->type = TAURARO_INT; var_b_temp->data.int_val = 3;
    b = var_b_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("a = 10, b = 3");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Addition (a + b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Subtraction (a - b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_sub(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Multiplication (a * b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_mul(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Division (a / b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_div(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Modulo (a % b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_mod(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Floor Division (a // b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Exponentiation (a ** b):");
    arg_1_left = a;
    arg_1_right = b;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- Comparison Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_x_temp = tauraro_value_new(); var_x_temp->type = TAURARO_INT; var_x_temp->data.int_val = 5;
    x = var_x_temp;
    var_y_temp = tauraro_value_new(); var_y_temp->type = TAURARO_INT; var_y_temp->data.int_val = 10;
    y = var_y_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("x = 5, y = 10");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Equal (x == y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Not Equal (x != y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Less Than (x < y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Less or Equal (x <= y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Greater Than (x > y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Greater or Equal (x >= y):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- Logical Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_t_temp = tauraro_value_new(); var_t_temp->type = TAURARO_BOOL; var_t_temp->data.bool_val = true;
    t = var_t_temp;
    var_f_temp = tauraro_value_new(); var_f_temp->type = TAURARO_BOOL; var_f_temp->data.bool_val = false;
    f = var_f_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("t = True, f = False");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("AND (t and f):");
    arg_1_left = t;
    arg_1_right = f;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("OR (t or f):");
    arg_1_left = t;
    arg_1_right = f;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("NOT (!t):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("NOT (!f):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- Bitwise Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_p_temp = tauraro_value_new(); var_p_temp->type = TAURARO_INT; var_p_temp->data.int_val = 12;
    p = var_p_temp;
    var_q_temp = tauraro_value_new(); var_q_temp->type = TAURARO_INT; var_q_temp->data.int_val = 10;
    q = var_q_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("p = 12, q = 10");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Bitwise AND (p & q):");
    arg_1_left = p;
    arg_1_right = q;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Bitwise OR (p | q):");
    arg_1_left = p;
    arg_1_right = q;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Bitwise XOR (p ^ q):");
    arg_1_left = p;
    arg_1_right = q;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Bitwise NOT (~p):");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Left Shift (p << 1):");
    arg_1_left = p;
    arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_INT; arg_1_right->data.int_val = 1;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Right Shift (p >> 1):");
    arg_1_left = p;
    arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_INT; arg_1_right->data.int_val = 1;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_num_temp = tauraro_value_new(); var_num_temp->type = TAURARO_INT; var_num_temp->data.int_val = 5;
    num = var_num_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Initial num:");
    arg_1 = num;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_num_temp_left = num;
    var_num_temp_right = tauraro_value_new(); var_num_temp_right->type = TAURARO_INT; var_num_temp_right->data.int_val = 3;
    var_num_temp = tauraro_value_new(); var_num_temp->type = TAURARO_INT; var_num_temp->data.int_val = tauraro_add_int(var_num_temp_left->data.int_val, var_num_temp_right->data.int_val);
    num = var_num_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("After num += 3:");
    arg_1 = num;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_num_temp_left = num;
    var_num_temp_right = tauraro_value_new(); var_num_temp_right->type = TAURARO_INT; var_num_temp_right->data.int_val = 2;
    var_num_temp = tauraro_add(var_num_temp_left, var_num_temp_right); // Typed operation
    num = var_num_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("After num -= 2:");
    arg_1 = num;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_num_temp_left = num;
    var_num_temp_right = tauraro_value_new(); var_num_temp_right->type = TAURARO_INT; var_num_temp_right->data.int_val = 4;
    var_num_temp = tauraro_add(var_num_temp_left, var_num_temp_right); // Typed operation
    num = var_num_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("After num *= 4:");
    arg_1 = num;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_num_temp_left = num;
    var_num_temp_right = tauraro_value_new(); var_num_temp_right->type = TAURARO_INT; var_num_temp_right->data.int_val = 2;
    ...
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- Unary Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_pos_temp = tauraro_value_new(); var_pos_temp->type = TAURARO_INT; var_pos_temp->data.int_val = 5;
    pos = var_pos_temp;
    temp = tauraro_value_new(); temp->type = TAURARO_NONE;
    var_neg_temp = temp;
    neg = var_neg_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Positive:");
    arg_1 = pos;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Negative:");
    arg_1 = neg;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Negation of negative:");
    arg_1 = tauraro_value_new(); arg_1->type = TAURARO_NONE;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("\n--- String Operators ---");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_str1_temp = tauraro_value_new(); var_str1_temp->type = TAURARO_STRING; var_str1_temp->data.str_val = strdup("Hello");
    str1 = var_str1_temp;
    var_str2_temp = tauraro_value_new(); var_str2_temp->type = TAURARO_STRING; var_str2_temp->data.str_val = strdup("World");
    str2 = var_str2_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Concatenation:");
    arg_1_left_left = str1;
    arg_1_left_right = tauraro_value_new(); arg_1_left_right->type = TAURARO_STRING; arg_1_left_right->data.str_val = strdup(" ");
    arg_1_left = tauraro_add(arg_1_left_left, arg_1_left_right);
    arg_1_right = str2;
    arg_1 = tauraro_add(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Repetition:");
    arg_1_left = str1;
    arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_INT; arg_1_right->data.int_val = 3;
    arg_1 = tauraro_mul(arg_1_left, arg_1_right);
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
