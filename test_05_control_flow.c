...
int main() {
    tauraro_value_t* var_count_temp = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* var_x_temp = NULL;
    tauraro_value_t* temp = NULL;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 5: Control Flow ===");
    ...
    x = var_x_temp;
    var_count_temp = tauraro_value_new(); var_count_temp->type = TAURARO_INT; var_count_temp->data.int_val = 0;
    count = var_count_temp;
