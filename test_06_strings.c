...
// Global variables
tauraro_value_t* first;
tauraro_value_t* last;
tauraro_value_t* full;
tauraro_value_t* repeat;
tauraro_value_t* text;
tauraro_value_t* message;

int main() {
    tauraro_value_t* var_full_temp = NULL;
    tauraro_value_t* var_full_temp_left = NULL;
    tauraro_value_t* arg_1_arg_0 = NULL;
    tauraro_value_t* var_message_temp = NULL;
    tauraro_value_t* arg_1 = NULL;
    tauraro_value_t* var_text_temp = NULL;
    tauraro_value_t* var_last_temp = NULL;
    tauraro_value_t* var_full_temp_left_left = NULL;
    tauraro_value_t* var_first_temp = NULL;
    tauraro_value_t* temp = NULL;
    tauraro_value_t* var_full_temp_right = NULL;
    tauraro_value_t* var_repeat_temp_right = NULL;
    tauraro_value_t* arg_0 = NULL;
    tauraro_value_t* var_repeat_temp = NULL;
    tauraro_value_t* var_repeat_temp_left = NULL;
    tauraro_value_t* var_full_temp_left_right = NULL;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 6: String Operations ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_first_temp = tauraro_value_new(); var_first_temp->type = TAURARO_STRING; var_first_temp->data.str_val = strdup("Hello");
    first = var_first_temp;
    var_last_temp = tauraro_value_new(); var_last_temp->type = TAURARO_STRING; var_last_temp->data.str_val = strdup("World");
    last = var_last_temp;
    var_full_temp_left_left = first;
    var_full_temp_left_right = tauraro_value_new(); var_full_temp_left_right->type = TAURARO_STRING; var_full_temp_left_right->data.str_val = strdup(" ");
    var_full_temp_left = tauraro_add(var_full_temp_left_left, var_full_temp_left_right);
    var_full_temp_right = last;
    var_full_temp = tauraro_add(var_full_temp_left, var_full_temp_right);
    full = var_full_temp;
    ...
    var_repeat_temp_left = tauraro_value_new(); var_repeat_temp_left->type = TAURARO_STRING; var_repeat_temp_left->data.str_val = strdup("Ha");
    var_repeat_temp_right = tauraro_value_new(); var_repeat_temp_right->type = TAURARO_INT; var_repeat_temp_right->data.int_val = 3;
    var_repeat_temp = tauraro_mul(var_repeat_temp_left, var_repeat_temp_right);
    repeat = var_repeat_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Repetition:");
    arg_1 = repeat;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_text_temp = tauraro_value_new(); var_text_temp->type = TAURARO_STRING; var_text_temp->data.str_val = strdup("Tauraro");
    text = var_text_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Length of 'Tauraro':");
    arg_1_arg_0 = text;
    arg_1 = tauraro_len(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_message_temp = tauraro_value_new(); var_message_temp->type = TAURARO_STRING; var_message_temp->data.str_val = strdup("hello world");
    message = var_message_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Original:");
    arg_1 = message;
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
