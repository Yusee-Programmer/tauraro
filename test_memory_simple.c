...
// Native list type definition (needed for len function)
...
// Native dict types (needed for len function)
...
// typedefs already defined above
/*
typedef struct tauraro_dict_entry {
    char* key;
    void* value;
...
int main(int argc, char** argv) {
    ...
    printf("%s\n", "=== Memory Management Simple C Test ===");
    /* unsupported statement */;
