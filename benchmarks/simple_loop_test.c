...
int main() {
    tauraro_value_t* arg_0_left_right_arg_0_right = NULL;
    tauraro_value_t* arg_0_left_right_arg_0 = NULL;
    ...
    tauraro_value_t* arg_0_right_arg_0 = NULL;
    tauraro_value_t* arg_0_left_left = NULL;
    tauraro_value_t* arg_0_left_right_arg_0_left = NULL;
    tauraro_value_t* var_total_temp = NULL;
    // Simple loop test for C transpiler
    // Import module: time
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Starting simple loop test...");
    ...
    // For loop: i in temp_iterable
    tauraro_value_t* i_iter = temp_iterable;
    int i_index = 0;
    ...
    arg_0_left_left = tauraro_value_new(); arg_0_left_left->type = TAURARO_STRING; arg_0_left_left->data.str_val = strdup("Loop completed in: ");
    arg_0_left_right_arg_0_left = end;
    arg_0_left_right_arg_0_right = start;
    arg_0_left_right_arg_0 = tauraro_sub(arg_0_left_right_arg_0_left, arg_0_left_right_arg_0_right);
    arg_0_left_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_left_right_arg_0});
    arg_0_left = tauraro_add(arg_0_left_left, arg_0_left_right);
    arg_0_right = tauraro_value_new(); arg_0_right->type = TAURARO_STRING; arg_0_right->data.str_val = strdup("s");
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Total: ");
    arg_0_right_arg_0 = total;
    arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    return 0;
}
