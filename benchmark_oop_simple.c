...
tauraro_value_t* i;
tauraro_value_t* total_mag;
tauraro_value_t* i;
tauraro_value_t* dot_sum;
tauraro_value_t* v1;
tauraro_value_t* i;
tauraro_value_t* sum_x;
tauraro_value_t* sum_y;
tauraro_value_t* sum_z;
tauraro_value_t* i;

// Forward declarations for user-defined functions
tauraro_value_t* Point__distance_from_origin(int argc, tauraro_value_t** argv);
tauraro_value_t* Point__add(int argc, tauraro_value_t** argv);
tauraro_value_t* Point____init__(int argc, tauraro_value_t** argv);
tauraro_value_t* Vector__magnitude(int argc, tauraro_value_t** argv);
tauraro_value_t* Vector____init__(int argc, tauraro_value_t** argv);
tauraro_value_t* Vector__dot(int argc, tauraro_value_t** argv);
...
tauraro_value_t* Point__distance_from_origin(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* temp_result_1 = tauraro_object_get_attr(self, "x");
    tauraro_value_t* binop_right = temp_result;
    tauraro_value_t* temp_result_2 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* dx = temp_result;
    tauraro_value_t* temp_result_3 = tauraro_object_get_attr(self, "y");
    tauraro_value_t* binop_left_1 = temp_result;
    tauraro_value_t* temp_result_4 = tauraro_object_get_attr(self, "y");
    tauraro_value_t* binop_right_1 = temp_result;
    tauraro_value_t* temp_result_5 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* dy = temp_result;
    tauraro_value_t* binop_left_2 = dx;
    tauraro_value_t* binop_right_2 = dy;
...
tauraro_value_t* Point__add(int argc, tauraro_value_t** argv) {
    // Extract parameters
    tauraro_value_t* self = (argc > 0) ? argv[0] : NULL;
    tauraro_value_t* other = (argc > 1) ? argv[1] : NULL;
    ...
    tauraro_value_t* arg_1_left = tauraro_value_new(); arg_1_left->type = TAURARO_NONE;
    tauraro_value_t* arg_1_right = tauraro_value_new(); arg_1_right->type = TAURARO_NONE;
    tauraro_value_t* arg_1 = tauraro_add(arg_1_left, arg_1_right);
    tauraro_value_t* temp_result = tauraro_object_create("Point");
    tauraro_value_t* result = temp_result;
    tauraro_value_t* temp_result_1 = result;
    return temp_result;
}
...
tauraro_value_t* Vector__magnitude(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* temp_result_5 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* dy = temp_result;
    tauraro_value_t* temp_result_6 = tauraro_object_get_attr(self, "z");
    tauraro_value_t* binop_left_2 = temp_result;
    tauraro_value_t* temp_result_7 = tauraro_object_get_attr(self, "z");
    tauraro_value_t* binop_right_2 = temp_result;
    tauraro_value_t* temp_result_8 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* dz = temp_result;
    tauraro_value_t* binop_left_3 = dx;
    tauraro_value_t* binop_right_3 = dy;
    tauraro_value_t* temp_result_9 = tauraro_add(binop_left, binop_right);
    tauraro_value_t* binop_left_4 = temp_result;
    tauraro_value_t* binop_right_4 = dz;
    tauraro_value_t* temp_result_10 = tauraro_add(binop_left, binop_right);
    return temp_result;
}
...
tauraro_value_t* Vector____init__(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* x = (argc > 1) ? argv[1] : NULL;
    tauraro_value_t* y = (argc > 2) ? argv[2] : NULL;
    tauraro_value_t* z = (argc > 3) ? argv[3] : NULL;
    ...
    tauraro_value_t* temp_result_2 = Point____init__(3, (tauraro_value_t*[]){self, method_arg_0, method_arg_1});
    tauraro_value_t* temp_result_3 = z;
    tauraro_object_set_attr(self, "z", temp_result);
    // Implicit return None
    tauraro_value_t* none_val = tauraro_value_new();
    none_val->type = TAURARO_NONE;
    return none_val;
...
tauraro_value_t* Vector__dot(int argc, tauraro_value_t** argv) {
    ...
    tauraro_value_t* temp_result = tauraro_object_get_attr(self, "x");
    tauraro_value_t* binop_left = temp_result;
    tauraro_value_t* temp_result_1 = tauraro_object_get_attr(other, "x");
    tauraro_value_t* binop_right = temp_result;
    tauraro_value_t* temp_result_2 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* binop_left_1 = temp_result;
    tauraro_value_t* temp_result_3 = tauraro_object_get_attr(self, "y");
    tauraro_value_t* binop_left_2 = temp_result;
    tauraro_value_t* temp_result_4 = tauraro_object_get_attr(other, "y");
    tauraro_value_t* binop_right_1 = temp_result;
    tauraro_value_t* temp_result_5 = tauraro_mul(binop_left, binop_right);
    tauraro_value_t* binop_right_2 = temp_result;
    tauraro_value_t* temp_result_6 = tauraro_add(binop_left, binop_right);
    ...
    tauraro_value_t* temp_result_7 = tauraro_object_get_attr(self, "z");
    tauraro_value_t* binop_left_4 = temp_result;
    tauraro_value_t* temp_result_8 = tauraro_object_get_attr(other, "z");
    tauraro_value_t* binop_right_3 = temp_result;
    tauraro_value_t* temp_result_9 = tauraro_mul(binop_left, binop_right);
...
int main() {
    ...
    tauraro_value_t* total_mag = NULL;
    tauraro_value_t* var_v1_temp = NULL;
    int64_t var_sum_y_temp = 0;
    int64_t var_sum_x_temp = 0;
    int64_t sum_y = 0;
    int64_t var_sum_z_temp = 0;
    int64_t arg_2 = 0;
    tauraro_value_t* temp = NULL;
    tauraro_value_t* arg_0_left = NULL;
    int64_t var_total_mag_temp = 0;
    int64_t temp_right = 0;
    tauraro_value_t* total = NULL;
    int64_t arg_0_right_arg_0 = 0;
    tauraro_value_t* arg_0_right = NULL;
    int64_t sum_z = 0;
    tauraro_value_t* dot_sum = NULL;
    int64_t temp_left = 0;
    int64_t arg_1 = 0;
    tauraro_value_t* arg_0 = NULL;
    int64_t i = 0;
    tauraro_value_t* v1 = NULL;
    int64_t sum_x = 0;
    int64_t var_dot_sum_temp = 0;
    int64_t var_i_temp = 0;

    // === Class Initialization ===
    // Initialize class: Point
    tauraro_class_t* class_Point = tauraro_class_create("Point", NULL);
    tauraro_class_add_method(class_Point, "distance_from_origin", (void*)&Point__distance_from_origin);
    tauraro_class_add_method(class_Point, "add", (void*)&Point__add);
    tauraro_class_add_method(class_Point, "__init__", (void*)&Point____init__);

    // Initialize class: Vector
    tauraro_class_t* class_Vector = tauraro_class_create("Vector", NULL);
    tauraro_class_add_method(class_Vector, "magnitude", (void*)&Vector__magnitude);
    tauraro_class_add_method(class_Vector, "__init__", (void*)&Vector____init__);
    tauraro_class_add_method(class_Vector, "dot", (void*)&Vector__dot);

    // === End Class Initialization ===

    // OOP Benchmark - Pure computation version for C compilation
    // Benchmark 1: Object creation and method calls
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Benchmark 1: Object Creation + Method Calls ===");
    ...
    if (class_Point) {
        ...
        p = temp_result;
        binop_left = total;
        // Object method call: p.distance_from_origin()
    if (p && p->type == TAURARO_OBJECT) {
        tauraro_object_t* obj_p = (tauraro_object_t*)p->data.obj_val;
        if (obj_p->class_ptr) {
            tauraro_value_t* method = tauraro_class_get_method(obj_p->class_ptr, "distance_from_origin");
            if (method && method->type == TAURARO_FUNCTION) {
                ...
                temp_result = func_ptr(1, (tauraro_value_t*[]){p});
            }
        }
    }
        ...
        temp_left = i;
        temp_right = tauraro_value_new(); temp_right->type = TAURARO_INT; temp_right->data.int_val = 1000000;
        temp = tauraro_lt(temp_left, temp_right);
    }
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Total distance: ");
    arg_0_right_arg_0 = total;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_total_mag_temp = 0;
    total_mag = var_total_mag_temp;
    var_i_temp = 0;
    i = var_i_temp;
    temp_left = i;
    temp_right = 1000000;
    ...
    while (tauraro_is_truthy(temp)) {
        ...
        arg_1 = tauraro_add(arg_1_left, arg_1_right);
        arg_2_left = i;
        arg_2_right = tauraro_value_new(); arg_2_right->type = TAURARO_INT; arg_2_right->data.int_val = 2;
        arg_2 = tauraro_add(arg_2_left, arg_2_right);
        temp_result = tauraro_object_create("Vector");
    if (class_Vector) {
        ((tauraro_object_t*)temp_result->data.obj_val)->class_ptr = class_Vector;
    }
        v = temp_result;
        binop_left = total_mag;
        // Object method call: v.magnitude()
    if (v && v->type == TAURARO_OBJECT) {
        tauraro_object_t* obj_v = (tauraro_object_t*)v->data.obj_val;
        if (obj_v->class_ptr) {
            tauraro_value_t* method = tauraro_class_get_method(obj_v->class_ptr, "magnitude");
            if (method && method->type == TAURARO_FUNCTION) {
                // Call method function pointer with self
                typedef tauraro_value_t* (*method_func_t)(int, tauraro_value_t**);
                method_func_t func_ptr = (method_func_t)method->data.ptr_val;
                temp_result = func_ptr(1, (tauraro_value_t*[]){v});
            }
        }
    }
        binop_right = temp_result;
        temp_result = tauraro_add(binop_left, binop_right);
        total_mag = temp_result;
        binop_left = i;
        binop_right = tauraro_value_new(); binop_right->type = TAURARO_INT; binop_right->data.int_val = 1;
        temp_result = tauraro_add(binop_left, binop_right);
        i = temp_result;
    ...
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Total magnitude: ");
    arg_0_right_arg_0 = total_mag;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_dot_sum_temp = 0;
    dot_sum = var_dot_sum_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_INT; arg_0->data.int_val = 1;
    arg_1 = 2;
    arg_2 = 3;
    temp = tauraro_object_create("Vector");
    if (class_Vector) {
        ((tauraro_object_t*)temp->data.obj_val)->class_ptr = class_Vector;
        // Auto-call __init__ with constructor arguments
        tauraro_value_t* init_method = tauraro_class_get_method(class_Vector, "__init__");
        if (init_method && init_method->type == TAURARO_FUNCTION) {
            typedef tauraro_value_t* (*method_func_t)(int, tauraro_value_t**);
            method_func_t init_func = (method_func_t)init_method->data.ptr_val;
            init_func(4, (tauraro_value_t*[]){temp, arg_0, arg_1, arg_2});
        }
    }
    var_v1_temp = temp;
    v1 = var_v1_temp;
    ...
    if (class_Vector) {
        ...
        temp_result = v1__dot(2, (tauraro_value_t*[]){v1, method_arg_0});
        binop_right = temp_result;
        temp_result = tauraro_add(binop_left, binop_right);
        dot_sum = temp_result;
        binop_left = i;
    ...
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Dot product sum: ");
    arg_0_right_arg_0 = dot_sum;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    ...
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_sum_x_temp = 0;
    sum_x = var_sum_x_temp;
    var_sum_y_temp = 0;
    sum_y = var_sum_y_temp;
    var_sum_z_temp = 0;
    sum_z = var_sum_z_temp;
    var_i_temp = 0;
    i = var_i_temp;
    temp_left = i;
    temp_right = 1000000;
    ...
    if (class_Vector) {
        ...
        v = temp_result;
        binop_left = sum_x;
        temp_result = tauraro_object_get_attr(v, "x");
        binop_right = temp_result;
        temp_result = tauraro_add(binop_left, binop_right);
        sum_x = temp_result;
        binop_left = sum_y;
        temp_result = tauraro_object_get_attr(v, "y");
        binop_right = temp_result;
        temp_result = tauraro_add(binop_left, binop_right);
        sum_y = temp_result;
        binop_left = sum_z;
        temp_result = tauraro_object_get_attr(v, "z");
        binop_right = temp_result;
        temp_result = tauraro_add(binop_left, binop_right);
        sum_z = temp_result;
        binop_left = i;
    ...
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Sum X: ");
    arg_0_right_arg_0 = sum_x;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Sum Y: ");
    arg_0_right_arg_0 = sum_y;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    arg_0_left = tauraro_value_new(); arg_0_left->type = TAURARO_STRING; arg_0_left->data.str_val = strdup("Sum Z: ");
    arg_0_right_arg_0 = sum_z;
    tauraro_value_t* arg_0_right_arg_0_as_value = tauraro_value_new(); arg_0_right_arg_0_as_value->type = TAURARO_INT; arg_0_right_arg_0_as_value->data.int_val = arg_0_right_arg_0; arg_0_right = tauraro_str(1, (tauraro_value_t*[]){arg_0_right_arg_0_as_value});
    arg_0 = tauraro_add(arg_0_left, arg_0_right);
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
