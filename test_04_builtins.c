...
tauraro_value_t* tauraro_type(int argc, tauraro_value_t** args);
...
int main() {
    ...
    tauraro_value_t* var_z_temp = NULL;
    tauraro_value_t* arg_1 = NULL;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("=== Test 4: Built-in Functions ===");
    temp = tauraro_print(1, (tauraro_value_t*[]){arg_0});
    var_x_temp = tauraro_value_new(); var_x_temp->type = TAURARO_STRING; var_x_temp->data.str_val = strdup("42");
    x = var_x_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("str to int:");
    arg_1_arg_0 = x;
    arg_1 = tauraro_int(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_y_temp = tauraro_value_new(); var_y_temp->type = TAURARO_FLOAT; var_y_temp->data.float_val = 3.14;
    y = var_y_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("float to int:");
    arg_1_arg_0 = y;
    arg_1 = tauraro_int(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_z_temp = tauraro_value_new(); var_z_temp->type = TAURARO_INT; var_z_temp->data.int_val = 10;
    z = var_z_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("int to float:");
    arg_1_arg_0 = z;
    arg_1 = tauraro_float(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("int to str:");
    arg_1_arg_0 = z;
    arg_1 = tauraro_str(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("int to bool:");
    arg_1_arg_0 = z;
    arg_1 = tauraro_bool(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    var_text_temp = tauraro_value_new(); var_text_temp->type = TAURARO_STRING; var_text_temp->data.str_val = strdup("Hello");
    text = var_text_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("len('Hello'):");
    arg_1_arg_0 = text;
    arg_1 = tauraro_len(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("type(42):");
    arg_1_arg_0 = tauraro_value_new(); arg_1_arg_0->type = TAURARO_INT; arg_1_arg_0->data.int_val = 42;
    arg_1 = tauraro_type(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("type(3.14):");
    arg_1_arg_0 = tauraro_value_new(); arg_1_arg_0->type = TAURARO_FLOAT; arg_1_arg_0->data.float_val = 3.14;
    arg_1 = tauraro_type(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("type('hello'):");
    arg_1_arg_0 = tauraro_value_new(); arg_1_arg_0->type = TAURARO_STRING; arg_1_arg_0->data.str_val = strdup("hello");
    arg_1 = tauraro_type(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("type(True):");
    arg_1_arg_0 = tauraro_value_new(); arg_1_arg_0->type = TAURARO_BOOL; arg_1_arg_0->data.bool_val = true;
    arg_1 = tauraro_type(1, (tauraro_value_t*[]){arg_1_arg_0});
    temp = tauraro_print(2, (tauraro_value_t*[]){arg_0, arg_1});
