...
int main() {
    ...
    // Simple float test
    var_total_temp = tauraro_value_new(); var_total_temp->type = TAURARO_FLOAT; var_total_temp->data.float_val = 0;
    total = var_total_temp;
    arg_0 = tauraro_value_new(); arg_0->type = TAURARO_STRING; arg_0->data.str_val = strdup("Float total:");
    arg_1 = total;
